...
class Instruction:
    ...
    def NextState(self, s, cond):
        ...
        if source34_.is_ArithOp:
            ...
            if (((d_456_opcode_) == (EVMConstants.default__.POP)) and (((s).Size()) >= (1))) and (not(cond)):
                ...
                return ((s).Push(StackElement.StackElem_Value(default__.GetArgValuePush((self).arg)))).Skip((1) + ((d_456_opcode_) - (EVMConstants.default__.PUSH0)))
            ...
            d_457___mcc_h60_ = source34_.name
            d_458___mcc_h61_ = source34_.opcode
            d_459___mcc_h62_ = source34_.minCapacity
            d_460___mcc_h63_ = source34_.minOperands
            d_461___mcc_h64_ = source34_.pushes
            d_462___mcc_h65_ = source34_.pops
            d_463_pops_ = d_462___mcc_h65_
            d_464_pushes_ = d_461___mcc_h64_
            if (((s).Size()) >= (d_463_pops_)) and (not(cond)):
                return ((s).PopN(d_463_pops_)).Skip(1)
            elif True:
                return State.AState_Error(_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "LogOp error")))
        elif True:
            d_465___mcc_h66_ = source34_.name
            d_466___mcc_h67_ = source34_.opcode
            d_467___mcc_h68_ = source34_.minCapacity
            d_468___mcc_h69_ = source34_.minOperands
            d_469___mcc_h70_ = source34_.pushes
            d_470___mcc_h71_ = source34_.pops
            d_471_pops_ = d_470___mcc_h71_
            d_472_pushes_ = d_469___mcc_h70_
            d_473_op_ = d_466___mcc_h67_
            if ((((d_473_op_) == (EVMConstants.default__.INVALID)) or ((d_473_op_) == (EVMConstants.default__.STOP))) or ((d_473_op_) == (EVMConstants.default__.RETURN))) or ((d_473_op_) == (EVMConstants.default__.REVERT)):
                return State.AState_Error(_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "SysOp error")))
            elif (((s).Size()) >= (d_471_pops_)) and (not(cond)):
                return (((s).PopN(d_471_pops_)).PushNRandom(d_472_pushes_)).Skip(1)
            elif True:
                return State.AState_Error(_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "SysOp error")))
    ...
    def WPre(self, c):
        ...
        if source37_.is_ArithOp:
            d_474___mcc_h0_ = source37_.name
            d_475___mcc_h1_ = source37_.opcode
            d_476___mcc_h2_ = source37_.minCapacity
            d_477___mcc_h3_ = source37_.minOperands
            d_478___mcc_h4_ = source37_.pushes
            d_479___mcc_h5_ = source37_.pops
            d_480_pops_ = d_479___mcc_h5_
            d_481_pushes_ = d_478___mcc_h4_
            if (0) in ((c).TrackedPos()):
                return WeakPre.Cond_StFalse()
            elif True:
                def lambda3_(d_483_pos_):
                    return (d_483_pos_) + (1)

                d_482_shiftByOne_ = MiscTypes.default__.Map((c).TrackedPos(), lambda3_)
                return WeakPre.Cond_StCond(d_482_shiftByOne_, (c).TrackedVals())
        elif source37_.is_CompOp:
            d_484___mcc_h6_ = source37_.name
            d_485___mcc_h7_ = source37_.opcode
            d_486___mcc_h8_ = source37_.minCapacity
            d_487___mcc_h9_ = source37_.minOperands
            d_488___mcc_h10_ = source37_.pushes
            d_489___mcc_h11_ = source37_.pops
            d_490_pops_ = d_489___mcc_h11_
            d_491_pushes_ = d_488___mcc_h10_
            if (0) in ((c).TrackedPos()):
                return WeakPre.Cond_StFalse()
            elif True:
                def lambda4_(d_493_pops_, d_494_pushes_):
                    def lambda5_(d_495_pos_):
                        return ((d_495_pos_) + (d_493_pops_)) - (d_494_pushes_)

                    return lambda5_

                d_492_shiftBy_ = MiscTypes.default__.Map((c).TrackedPos(), lambda4_(d_490_pops_, d_491_pushes_))
                return WeakPre.Cond_StCond(d_492_shiftBy_, (c).TrackedVals())
        elif source37_.is_BitwiseOp:
            d_496___mcc_h12_ = source37_.name
            d_497___mcc_h13_ = source37_.opcode
            d_498___mcc_h14_ = source37_.minCapacity
            d_499___mcc_h15_ = source37_.minOperands
            d_500___mcc_h16_ = source37_.pushes
            d_501___mcc_h17_ = source37_.pops
            d_502_pops_ = d_501___mcc_h17_
            d_503_pushes_ = d_500___mcc_h16_
            if (0) in ((c).TrackedPos()):
                return WeakPre.Cond_StFalse()
            elif True:
                def lambda6_(d_505_pops_, d_506_pushes_):
                    def lambda7_(d_507_pos_):
                        return ((d_507_pos_) + (d_505_pops_)) - (d_506_pushes_)

                    return lambda7_

                d_504_shiftBy_ = MiscTypes.default__.Map((c).TrackedPos(), lambda6_(d_502_pops_, d_503_pushes_))
                return WeakPre.Cond_StCond(d_504_shiftBy_, (c).TrackedVals())
        elif source37_.is_KeccakOp:
            d_508___mcc_h18_ = source37_.name
            d_509___mcc_h19_ = source37_.opcode
            d_510___mcc_h20_ = source37_.minCapacity
            d_511___mcc_h21_ = source37_.minOperands
            d_512___mcc_h22_ = source37_.pushes
            d_513___mcc_h23_ = source37_.pops
            d_514_pops_ = d_513___mcc_h23_
            d_515_pushes_ = d_512___mcc_h22_
            if (0) in ((c).TrackedPos()):
                return WeakPre.Cond_StFalse()
            elif True:
                def lambda8_(d_517_pos_):
                    return (d_517_pos_) + (1)

                d_516_shiftByOne_ = MiscTypes.default__.Map((c).TrackedPos(), lambda8_)
                return WeakPre.Cond_StCond(d_516_shiftByOne_, (c).TrackedVals())
        elif source37_.is_EnvOp:
            d_518___mcc_h24_ = source37_.name
            d_519___mcc_h25_ = source37_.opcode
            d_520___mcc_h26_ = source37_.minCapacity
            d_521___mcc_h27_ = source37_.minOperands
            d_522___mcc_h28_ = source37_.pushes
            d_523___mcc_h29_ = source37_.pops
            d_524_pops_ = d_523___mcc_h29_
            d_525_pushes_ = d_522___mcc_h28_
            if ((d_525_pushes_) == (1)) and ((d_524_pops_) == (0)):
                if (0) in ((c).TrackedPos()):
                    return WeakPre.Cond_StFalse()
                elif True:
                    def lambda9_(d_527_pos_):
                        return (d_527_pos_) - (1)

                    d_526_shiftByOne_ = MiscTypes.default__.Map((c).TrackedPos(), lambda9_)
                    return WeakPre.Cond_StCond(d_526_shiftByOne_, (c).TrackedVals())
            elif ((d_525_pushes_) == (1)) and ((d_524_pops_) == (1)):
                if (0) in ((c).TrackedPos()):
                    return WeakPre.Cond_StFalse()
                elif True:
                    return c
            elif True:
                def lambda10_(d_529_pops_, d_530_pushes_):
                    def lambda11_(d_531_pos_):
                        return ((d_531_pos_) + (d_529_pops_)) - (d_530_pushes_)

                    return lambda11_

                d_528_shiftBy_ = MiscTypes.default__.Map((c).TrackedPos(), lambda10_(d_524_pops_, d_525_pushes_))
                return WeakPre.Cond_StCond(d_528_shiftBy_, (c).TrackedVals())
        elif source37_.is_MemOp:
            d_532___mcc_h30_ = source37_.name
            d_533___mcc_h31_ = source37_.opcode
            d_534___mcc_h32_ = source37_.minCapacity
            d_535___mcc_h33_ = source37_.minOperands
            d_536___mcc_h34_ = source37_.pushes
            d_537___mcc_h35_ = source37_.pops
            d_538_pops_ = d_537___mcc_h35_
            d_539_pushes_ = d_536___mcc_h34_
            if (d_539_pushes_) == (0):
                def lambda12_(d_541_pos_):
                    return (d_541_pos_) + (2)

                d_540_shiftByTwo_ = MiscTypes.default__.Map((c).TrackedPos(), lambda12_)
                return WeakPre.Cond_StCond(d_540_shiftByTwo_, (c).TrackedVals())
            elif True:
                if (0) in ((c).TrackedPos()):
                    return WeakPre.Cond_StFalse()
                elif True:
            ...
            d_542___mcc_h36_ = source37_.name
            d_543___mcc_h37_ = source37_.opcode
            d_544___mcc_h38_ = source37_.minCapacity
            d_545___mcc_h39_ = source37_.minOperands
            d_546___mcc_h40_ = source37_.pushes
            d_547___mcc_h41_ = source37_.pops
            d_548_pops_ = d_547___mcc_h41_
            d_549_pushes_ = d_546___mcc_h40_
            if (d_549_pushes_) == (0):
                def lambda13_(d_551_pos_):
                    return (d_551_pos_) + (2)

                d_550_shiftByTwo_ = MiscTypes.default__.Map((c).TrackedPos(), lambda13_)
                return WeakPre.Cond_StCond(d_550_shiftByTwo_, (c).TrackedVals())
            elif True:
                if (0) in ((c).TrackedPos()):
                    return WeakPre.Cond_StFalse()
                elif True:
            ...
            d_552___mcc_h42_ = source37_.name
            d_553___mcc_h43_ = source37_.opcode
            d_554___mcc_h44_ = source37_.minCapacity
            d_555___mcc_h45_ = source37_.minOperands
            d_556___mcc_h46_ = source37_.pushes
            d_557___mcc_h47_ = source37_.pops
            d_558_opcode_ = d_553___mcc_h43_
            if (d_558_opcode_) == (EVMConstants.default__.JUMPDEST):
                return c
            elif ((EVMConstants.default__.JUMP) <= (d_558_opcode_)) and ((d_558_opcode_) <= (EVMConstants.default__.JUMPI)):
                d_559_k_ = ((d_558_opcode_) - (EVMConstants.default__.JUMP)) + (1)
                def lambda14_(d_561_k_):
                    def lambda15_(d_562_pos_):
                        return (d_562_pos_) + (d_561_k_)

                    return lambda15_

                d_560_shiftBy_ = MiscTypes.default__.Map((c).TrackedPos(), lambda14_(d_559_k_))
                return WeakPre.Cond_StCond(d_560_shiftBy_, (c).TrackedVals())
            elif True:
                return WeakPre.Cond_StFalse()
        elif source37_.is_RunOp:
            d_563___mcc_h48_ = source37_.name
            d_564___mcc_h49_ = source37_.opcode
            d_565___mcc_h50_ = source37_.minCapacity
            d_566___mcc_h51_ = source37_.minOperands
            d_567___mcc_h52_ = source37_.pushes
            d_568___mcc_h53_ = source37_.pops
            d_569_opcode_ = d_564___mcc_h49_
            if (0) in ((c).TrackedPos()):
                return WeakPre.Cond_StFalse()
            elif True:
                def lambda16_(d_571_pos_):
                    return (d_571_pos_) - (1)

                d_570_shiftByOne_ = MiscTypes.default__.Map((c).TrackedPos(), lambda16_)
                return WeakPre.Cond_StCond(d_570_shiftByOne_, (c).TrackedVals())
        elif source37_.is_StackOp:
            d_572___mcc_h54_ = source37_.name
            d_573___mcc_h55_ = source37_.opcode
            d_574___mcc_h56_ = source37_.minCapacity
            d_575___mcc_h57_ = source37_.minOperands
            d_576___mcc_h58_ = source37_.pushes
            d_577___mcc_h59_ = source37_.pops
            d_578_opcode_ = d_573___mcc_h55_
            if ((EVMConstants.default__.PUSH0) <= (d_578_opcode_)) and ((d_578_opcode_) <= (EVMConstants.default__.PUSH32)):
                source38_ = MiscTypes.default__.Find((c).TrackedPos(), 0)
                if source38_.is_None:
                    def lambda17_(d_580_pos_):
                        return (d_580_pos_) - (1)

                    d_579_shiftByMinusOne_ = MiscTypes.default__.Map((c).TrackedPos(), lambda17_)
                    return WeakPre.Cond_StCond(d_579_shiftByMinusOne_, (c).TrackedVals())
                elif True:
                    d_581___mcc_h72_ = source38_.v
                    d_582_i_ = d_581___mcc_h72_
                    d_583_argVal_ = Hex.default__.HexToU256((_dafny.SeqWithoutIsStrInference([_dafny.CodePoint('0') for d_584___v142_ in range((64) - (len((self).arg)))])) + ((self).arg))
                    if ((c).TrackedValAt(d_582_i_)) == ((d_583_argVal_).Extract()):
                        d_585_filtered_ = (_dafny.SeqWithoutIsStrInference(((c).TrackedPos())[:d_582_i_:])) + (_dafny.SeqWithoutIsStrInference(((c).TrackedPos())[(d_582_i_) + (1)::]))
                        if (len(d_585_filtered_)) == (0):
                            return WeakPre.Cond_StTrue()
                        elif True:
                            def lambda18_(d_587_pos_):
                                return (d_587_pos_) - (1)

                            d_586_shiftByMinusOne_ = MiscTypes.default__.Map(d_585_filtered_, lambda18_)
                            return WeakPre.Cond_StCond(d_586_shiftByMinusOne_, (_dafny.SeqWithoutIsStrInference(((c).TrackedVals())[:d_582_i_:])) + (_dafny.SeqWithoutIsStrInference(((c).TrackedVals())[(d_582_i_) + (1)::])))
                    elif True:
                        return WeakPre.Cond_StFalse()
            elif ((EVMConstants.default__.DUP1) <= (d_578_opcode_)) and ((d_578_opcode_) <= (EVMConstants.default__.DUP16)):
                source39_ = MiscTypes.default__.Find((c).TrackedPos(), 0)
                if source39_.is_None:
                    def lambda19_(d_589_pos_):
                        return (d_589_pos_) - (1)

                    d_588_shiftByMinusOneButZero_ = MiscTypes.default__.Map((c).TrackedPos(), lambda19_)
                    return WeakPre.Cond_StCond(d_588_shiftByMinusOneButZero_, (c).TrackedVals())
                elif True:
                    d_590___mcc_h73_ = source39_.v
                    d_591_index0_ = d_590___mcc_h73_
                    source40_ = MiscTypes.default__.Find((c).TrackedPos(), ((d_578_opcode_) - (EVMConstants.default__.DUP1)) + (1))
                    if source40_.is_None:
                        def lambda20_(d_593_opcode_):
                            def lambda21_(d_594_pos_):
                                return ((d_593_opcode_) - (EVMConstants.default__.DUP1) if (d_594_pos_) == (0) else (d_594_pos_) - (1))

                            return lambda21_

                        d_592_shiftByMinusOneButZero_ = MiscTypes.default__.Map((c).TrackedPos(), lambda20_(d_578_opcode_))
                        return WeakPre.Cond_StCond(d_592_shiftByMinusOneButZero_, (c).TrackedVals())
                    elif True:
                        d_595___mcc_h74_ = source40_.v
                        d_596_index_ = d_595___mcc_h74_
                        if ((c).TrackedValAt(d_591_index0_)) == ((c).TrackedValAt(d_596_index_)):
                            d_597_filtered_ = (_dafny.SeqWithoutIsStrInference(((c).TrackedPos())[:d_591_index0_:])) + (_dafny.SeqWithoutIsStrInference(((c).TrackedPos())[(d_591_index0_) + (1)::]))
                            def lambda22_(d_599_pos_):
                                return (d_599_pos_) - (1)

                            d_598_shiftByMinusOne_ = MiscTypes.default__.Map(d_597_filtered_, lambda22_)
                            return WeakPre.Cond_StCond(d_598_shiftByMinusOne_, (_dafny.SeqWithoutIsStrInference(((c).TrackedVals())[:d_591_index0_:])) + (_dafny.SeqWithoutIsStrInference(((c).TrackedVals())[(d_591_index0_) + (1)::])))
                        elif True:
                            return WeakPre.Cond_StFalse()
            elif ((EVMConstants.default__.SWAP1) <= (d_578_opcode_)) and ((d_578_opcode_) <= (EVMConstants.default__.SWAP16)):
                d_600_k_ = ((d_578_opcode_) - (EVMConstants.default__.SWAP1)) + (1)
                def lambda23_(d_602_k_):
                    def lambda24_(d_603_pos_):
                        return (d_602_k_ if (d_603_pos_) == (0) else (0 if (d_603_pos_) == (d_602_k_) else d_603_pos_))

                    return lambda24_

                d_601_swapZeroAndk_ = MiscTypes.default__.Map((c).TrackedPos(), lambda23_(d_600_k_))
                return WeakPre.Cond_StCond(d_601_swapZeroAndk_, (c).TrackedVals())
            elif True:
                def lambda25_(d_605_i_):
                    return (d_605_i_) + (1)

                d_604_shiftByOne_ = MiscTypes.default__.Map((c).TrackedPos(), lambda25_)
                return WeakPre.Cond_StCond(d_604_shiftByOne_, (c).TrackedVals())
        elif source37_.is_LogOp:
            d_606___mcc_h60_ = source37_.name
            d_607___mcc_h61_ = source37_.opcode
            d_608___mcc_h62_ = source37_.minCapacity
            d_609___mcc_h63_ = source37_.minOperands
            d_610___mcc_h64_ = source37_.pushes
            d_611___mcc_h65_ = source37_.pops
            d_612_pops_ = d_611___mcc_h65_
            d_613_pushes_ = d_610___mcc_h64_
            d_614_opcode_ = d_607___mcc_h61_
            def lambda26_(d_616_pops_):
                def lambda27_(d_617_pos_):
                    return (d_617_pos_) + (d_616_pops_)

                return lambda27_

            d_615_shiftBy_ = MiscTypes.default__.Map((c).TrackedPos(), lambda26_(d_612_pops_))
            return WeakPre.Cond_StCond(d_615_shiftBy_, (c).TrackedVals())
        elif True:
            d_618___mcc_h66_ = source37_.name
            d_619___mcc_h67_ = source37_.opcode
            d_620___mcc_h68_ = source37_.minCapacity
            d_621___mcc_h69_ = source37_.minOperands
            d_622___mcc_h70_ = source37_.pushes
            d_623___mcc_h71_ = source37_.pops
            d_624_pops_ = d_623___mcc_h71_
            d_625_pushes_ = d_622___mcc_h70_
            d_626_opcode_ = d_619___mcc_h67_
            if (d_625_pushes_) == (0):
                def lambda28_(d_628_pops_):
                    def lambda29_(d_629_pos_):
                        return (d_629_pos_) + (d_628_pops_)

                    return lambda29_

                d_627_shiftBy_ = MiscTypes.default__.Map((c).TrackedPos(), lambda28_(d_624_pops_))
                return WeakPre.Cond_StCond(d_627_shiftBy_, (c).TrackedVals())
            elif True:
                if (0) in ((c).TrackedPos()):
                    return WeakPre.Cond_StFalse()
                elif True:
                    def lambda30_(d_631_pops_):
                        def lambda31_(d_632_pos_):
                            return (d_632_pos_) + (d_631_pops_)

                        return lambda31_

                    d_630_shiftBy_ = MiscTypes.default__.Map((c).TrackedPos(), lambda30_(d_624_pops_))
                    return WeakPre.Cond_StCond(d_630_shiftBy_, (c).TrackedVals())
