        ...
        while True:
            with _dafny.label():
                if (len(xs)) == (0):
                    ...
                    d_648_next_ = ((xs)[0]).NextState(s, False)
                    source44_ = d_648_next_
                    if source44_.is_EState:
                        d_649___mcc_h0_ = source44_.pc
                        d_650___mcc_h1_ = source44_.stack
...
class LinSeg:
    ...
    def IsValid(self):
        ...
        if source45_.is_JUMPSeg:
            d_655___mcc_h0_ = source45_.ins
            d_656___mcc_h1_ = source45_.lastIns
            d_657___mcc_h2_ = source45_.netOpEffect
            return ((((self).lastIns).op).opcode) == (EVMConstants.default__.JUMP)
        elif source45_.is_JUMPISeg:
            d_658___mcc_h3_ = source45_.ins
            d_659___mcc_h4_ = source45_.lastIns
            d_660___mcc_h5_ = source45_.netOpEffect
            return ((((self).lastIns).op).opcode) == (EVMConstants.default__.JUMPI)
        elif source45_.is_RETURNSeg:
            d_661___mcc_h6_ = source45_.ins
            d_662___mcc_h7_ = source45_.lastIns
            d_663___mcc_h8_ = source45_.netOpEffect
            return ((((self).lastIns).op).opcode) == (EVMConstants.default__.RETURN)
        elif source45_.is_STOPSeg:
            d_664___mcc_h9_ = source45_.ins
            d_665___mcc_h10_ = source45_.lastIns
            d_666___mcc_h11_ = source45_.netOpEffect
            ...
            d_667___mcc_h12_ = source45_.ins
            d_668___mcc_h13_ = source45_.lastIns
            d_669___mcc_h14_ = source45_.netOpEffect
            return ((((self).lastIns).op).opcode) != (EVMConstants.default__.INVALID)
        elif True:
            d_670___mcc_h15_ = source45_.ins
            d_671___mcc_h16_ = source45_.lastIns
            d_672___mcc_h17_ = source45_.netOpEffect
            return ((((self).lastIns).op).opcode) == (EVMConstants.default__.INVALID)
    ...
    def Run(self, s, exit):
        d_674_s_k_ = default__.RunIns((self).ins, s)
        if (d_674_s_k_).is_Error:
            return d_674_s_k_
        elif True:
            return ((self).lastIns).NextState(d_674_s_k_, exit)
    ...
    def HasExit(self, b):
        ...
        if source46_.is_JUMPSeg:
            d_675___mcc_h0_ = source46_.ins
            d_676___mcc_h1_ = source46_.lastIns
            d_677___mcc_h2_ = source46_.netOpEffect
            return b
        elif source46_.is_JUMPISeg:
            d_678___mcc_h6_ = source46_.ins
            d_679___mcc_h7_ = source46_.lastIns
            d_680___mcc_h8_ = source46_.netOpEffect
            return True
        elif source46_.is_RETURNSeg:
            d_681___mcc_h12_ = source46_.ins
            d_682___mcc_h13_ = source46_.lastIns
            d_683___mcc_h14_ = source46_.netOpEffect
            return False
        elif source46_.is_STOPSeg:
            d_684___mcc_h18_ = source46_.ins
            d_685___mcc_h19_ = source46_.lastIns
            d_686___mcc_h20_ = source46_.netOpEffect
            return False
        elif source46_.is_CONTSeg:
            d_687___mcc_h24_ = source46_.ins
            d_688___mcc_h25_ = source46_.lastIns
            d_689___mcc_h26_ = source46_.netOpEffect
            return not(b)
        elif True:
            d_690___mcc_h30_ = source46_.ins
            d_691___mcc_h31_ = source46_.lastIns
            d_692___mcc_h32_ = source46_.netOpEffect
            return False
    ...
    def LeadsTo(self, k, exit):
        if (k) >= (Int.default__.TWO__256):
            ...
            if source47_.is_JUMPSeg:
                d_693___mcc_h0_ = source47_.ins
                d_694___mcc_h1_ = source47_.lastIns
                d_695___mcc_h2_ = source47_.netOpEffect
                if exit:
                ...
                d_697___mcc_h3_ = source47_.ins
                d_698___mcc_h4_ = source47_.lastIns
                d_699___mcc_h5_ = source47_.netOpEffect
                if exit:
                ...
                d_701___mcc_h6_ = source47_.ins
                d_702___mcc_h7_ = source47_.lastIns
                d_703___mcc_h8_ = source47_.netOpEffect
                return WeakPre.Cond_StTrue()
            elif source47_.is_STOPSeg:
                d_704___mcc_h9_ = source47_.ins
                d_705___mcc_h10_ = source47_.lastIns
                d_706___mcc_h11_ = source47_.netOpEffect
                return WeakPre.Cond_StTrue()
            elif source47_.is_CONTSeg:
                d_707___mcc_h12_ = source47_.ins
                d_708___mcc_h13_ = source47_.lastIns
                d_709___mcc_h14_ = source47_.netOpEffect
                if (not(exit)) and ((k) == ((self).StartAddressNextSeg())):
                    return WeakPre.Cond_StTrue()
                elif True:
                    return WeakPre.Cond_StFalse()
            elif True:
                d_710___mcc_h15_ = source47_.ins
                d_711___mcc_h16_ = source47_.lastIns
                d_712___mcc_h17_ = source47_.netOpEffect
                return WeakPre.Cond_StFalse()
