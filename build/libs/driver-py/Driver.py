    ...
    def Main(args):
        ...
        if ((len(args)) < (2)) or (((args)[1]) == (_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "--help")))):
            ...
            if (len((args)[1])) == (0):
                ...
                d_1052_x_ = BinaryDecoder.default__.Disassemble((_dafny.SeqWithoutIsStrInference(((args)[1])[2::]) if (_dafny.SeqWithoutIsStrInference(((args)[1])[:2:])) == (_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "0x"))) else (args)[1]), _dafny.SeqWithoutIsStrInference([]), 0)
            ...
            if (len(d_1053_stringToProcess_)) == (0):
                _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "String must be non empty \n"))).VerbatimString(False))
            elif (_dafny.euclidian_modulus(len(d_1053_stringToProcess_), 2)) != (0):
                ...
                _dafny.print(_dafny.string_of(len(d_1053_stringToProcess_)))
                _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n"))).VerbatimString(False))
            elif not(Hex.default__.IsHexString((_dafny.SeqWithoutIsStrInference((d_1053_stringToProcess_)[2::]) if (_dafny.SeqWithoutIsStrInference((d_1053_stringToProcess_)[:2:])) == (_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "0x"))) else d_1053_stringToProcess_))):
                _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "String must be hexadecimal\n"))).VerbatimString(False))
            elif True:
                d_1054_x_: _dafny.Seq
                d_1054_x_ = BinaryDecoder.default__.Disassemble((_dafny.SeqWithoutIsStrInference((d_1053_stringToProcess_)[2::]) if (_dafny.SeqWithoutIsStrInference((d_1053_stringToProcess_)[:2:])) == (_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "0x"))) else d_1053_stringToProcess_), _dafny.SeqWithoutIsStrInference([]), 0)
                ...
                if (((d_1063_cfgDepthOpt_) > (0)) and ((len(d_1070_y_)) > (0))) and ((((d_1070_y_)[0]).StartAddress()) == (0)):
                    ...
                    if d_1067_rawOpt_:
                        ...
                        if not((d_1076_g_k_).IsValid()):
                            raise _dafny.HaltException("src/dafny/Driver.dfy(152,12): " + (_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "expectation violation"))).VerbatimString(False))
