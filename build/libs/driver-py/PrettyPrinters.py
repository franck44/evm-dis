...
class default__:
    ...
    def PrintInstructions(s):
        while True:
            with _dafny.label():
                if (len(s)) > (0):
                    d_734_formattedAddress_: _dafny.Seq
                    d_734_formattedAddress_ = (Hex.default__.U32ToHex(((s)[0]).address) if (((s)[0]).address) < (Int.default__.TWO__32) else _dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "OutofRange")))
                    _dafny.print((d_734_formattedAddress_).VerbatimString(False))
        ...
        while True:
            with _dafny.label():
                if (len(xs)) > (0):
                    ...
                    _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n"))).VerbatimString(False))
                    d_735_k_: int
                    d_735_k_ = ((xs)[0]).WeakestPreOperands(0)
                    d_736_l_: int
                    d_736_l_ = ((xs)[0]).WeakestPreCapacity(0)
                    if (((xs)[0]).is_JUMPSeg) or (((xs)[0]).is_JUMPISeg):
                        ...
                        d_737_r_: MiscTypes.Either
                        d_737_r_ = SegBuilder.default__.JUMPResolver((xs)[0])
                        source50_ = d_737_r_
                        if source50_.is_Left:
                            d_738___mcc_h0_ = source50_.l
                            d_739_v_ = d_738___mcc_h0_
                            source51_ = d_739_v_
                            if source51_.is_Value:
                                d_740___mcc_h2_ = source51_.v
                                d_741_address_ = d_740___mcc_h2_
                                _dafny.print(((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "0x"))) + (Hex.default__.NatToHex(d_741_address_))).VerbatimString(False))
                            elif True:
                                d_742___mcc_h3_ = source51_.s
                                d_743_msg_ = d_742___mcc_h3_
                                _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "Could not determine stack value"))).VerbatimString(False))
                        elif True:
                            d_744___mcc_h1_ = source50_.r
                            d_745_stackPos_ = d_744___mcc_h1_
                            _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "Peek("))).VerbatimString(False))
                            _dafny.print(_dafny.string_of(d_745_stackPos_))
                            _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, ")"))).VerbatimString(False))
                        _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n"))).VerbatimString(False))
                    if ((xs)[0]).is_CONTSeg:
                        if (((((xs)[0]).lastIns).op).opcode) != (EVMConstants.default__.INVALID):
                            d_746_nextPC_: int
                            d_746_nextPC_ = ((xs)[0]).StartAddressNextSeg()
                            _dafny.print(((((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "CONT: PC of instruction after last is: "))) + (_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, " 0x")))) + (Hex.default__.NatToHex(d_746_nextPC_))) + (_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n")))).VerbatimString(False))
                        elif True:
    ...
    def CollectJumpDest(xs):
        ...
        while True:
            with _dafny.label():
                if (len(xs)) == (0):
                    return (d_747___accumulator_) + (_dafny.SeqWithoutIsStrInference([]))
                elif True:
                    d_747___accumulator_ = (d_747___accumulator_) + (((xs)[0]).CollectJumpDest())
        ...
        while True:
            with _dafny.label():
                if (len(xs)) == (0):
                    ...
                    d_748___accumulator_ = (d_748___accumulator_) + (((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, " ensures s.IsJumpDest(0x"))) + (Hex.default__.NatToHex((xs)[0]))) + (_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, " as u256)\n"))))
    ...
    def PrintProofObjectToDafny(xs, pathToEVMDafny):
        ...
        _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n"))).VerbatimString(False))
        d_749_j_: _dafny.Seq
        d_749_j_ = default__.CollectJumpDestAsString(default__.CollectJumpDest(xs))
        if (len(d_749_j_)) > (0):
            ...
            _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n"))).VerbatimString(False))
            _dafny.print((d_749_j_).VerbatimString(False))
            _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n"))).VerbatimString(False))
    ...
    def PrintProofObjectBody(xs, num):
        while True:
            with _dafny.label():
                if (len(xs)) > (0):
                    d_750_startAddress_: _dafny.Seq
                    d_750_startAddress_ = Hex.default__.NatToHex((((((xs)[0]).s).Ins())[0]).address)
                    _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n/** Code starting at 0x"))).VerbatimString(False))
                    _dafny.print((d_750_startAddress_).VerbatimString(False))
                    _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, " */\n"))).VerbatimString(False))
                    ...
                    if (((xs)[0]).is_JUMP) and ((((((xs)[0]).s).lastIns).op).IsJump()):
                        if True:
                            ...
                            if source52_.is_Left:
                                d_751___mcc_h0_ = source52_.l
                                _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, ""))).VerbatimString(False))
                            elif True:
                                d_752___mcc_h2_ = source52_.r
                                d_753_v_ = d_752___mcc_h2_
                                _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "  requires s0.IsJumpDest(s0.Peek("))).VerbatimString(False))
                                _dafny.print(_dafny.string_of(d_753_v_))
                                _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "))\n"))).VerbatimString(False))
                    source53_ = (xs)[0]
                    if source53_.is_JUMP:
                        d_754___mcc_h4_ = source53_.s
                        d_755___mcc_h5_ = source53_.wpOp
                        d_756___mcc_h6_ = source53_.wpCap
                        d_757___mcc_h7_ = source53_.tgt
                        d_758___mcc_h8_ = source53_.stacks
                        d_759_tgt_ = d_757___mcc_h7_
                        d_760_s_ = d_754___mcc_h4_
                        ...
                        if True:
                            source54_ = d_759_tgt_
                            if source54_.is_Left:
                                d_761___mcc_h17_ = source54_.l
                                d_762_xc_ = d_761___mcc_h17_
                                source55_ = d_762_xc_
                                if source55_.is_Value:
                                    d_763___mcc_h19_ = source55_.v
                                    d_764_v_ = d_763___mcc_h19_
                                    _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "0x"))).VerbatimString(False))
                                    _dafny.print((Hex.default__.NatToHex((d_762_xc_).Extract())).VerbatimString(False))
                                elif True:
                                    d_765___mcc_h21_ = source55_.s
                                    _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "Could not extract value "))).VerbatimString(False))
                            elif True:
                                d_766___mcc_h18_ = source54_.r
                                d_767_v_ = d_766___mcc_h18_
                                _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "s0.Peek("))).VerbatimString(False))
                                _dafny.print(_dafny.string_of(d_767_v_))
                                _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, ") as nat"))).VerbatimString(False))
                        if ((((d_760_s_).lastIns).op).opcode) == (EVMConstants.default__.JUMPI):
                            _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, " || s'.PC() == 0x"))).VerbatimString(False))
                            _dafny.print((Hex.default__.NatToHex((((d_760_s_).lastIns).address) + (1))).VerbatimString(False))
                        _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n"))).VerbatimString(False))
                        d_768_n_: int
                        d_768_n_ = ((xs)[0]).StackEffect()
                        _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "  ensures s'.Operands() == s0.Operands()"))).VerbatimString(False))
                        if (d_768_n_) >= (0):
                            _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, " + "))).VerbatimString(False))
                            _dafny.print(_dafny.string_of(d_768_n_))
                        elif True:
                            _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, " - "))).VerbatimString(False))
                            _dafny.print(_dafny.string_of((0) - (d_768_n_)))
                        _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n"))).VerbatimString(False))
                    elif source53_.is_CONT:
                        d_769___mcc_h9_ = source53_.s
                        d_770___mcc_h10_ = source53_.wpOp
                        d_771___mcc_h11_ = source53_.wpCap
                        d_772___mcc_h12_ = source53_.stacks
                        d_773_s_ = d_769___mcc_h9_
                        _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "  ensures s'.EXECUTING?\n"))).VerbatimString(False))
                        if ((((d_773_s_).lastIns).op).opcode) != (EVMConstants.default__.INVALID):
                            d_774_nextPC_: int
                            d_774_nextPC_ = (d_773_s_).StartAddressNextSeg()
                            _dafny.print((((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "  ensures s'.PC() == 0x"))) + (Hex.default__.NatToHex(d_774_nextPC_))) + (_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n")))).VerbatimString(False))
                            d_775_n_: int
                            d_775_n_ = ((xs)[0]).StackEffect()
                            _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "  ensures s'.Operands() == s0.Operands()"))).VerbatimString(False))
                            if (d_775_n_) >= (0):
                                _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, " + "))).VerbatimString(False))
                                _dafny.print(_dafny.string_of(d_775_n_))
                            elif True:
                                _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, " - "))).VerbatimString(False))
                                _dafny.print(_dafny.string_of((0) - (d_775_n_)))
                        elif True:
                            _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "  Last instruction is invalid"))).VerbatimString(False))
                        _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n"))).VerbatimString(False))
                    elif True:
                        d_776___mcc_h13_ = source53_.s
                        d_777___mcc_h14_ = source53_.wpOp
                        d_778___mcc_h15_ = source53_.wpCap
                        d_779___mcc_h16_ = source53_.stacks
                        d_780_s_ = d_776___mcc_h13_
    ...
    def PrintInstructionsToDafny(xs, pos):
        while True:
            with _dafny.label():
                if (len(xs)) > (0):
                    d_781_k_: _dafny.Seq
                    d_781_k_ = PrettyIns.default__.PrintInstructionToDafny((xs)[0], pos, (pos) + (1))
                    _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "  "))).VerbatimString(False))
                    _dafny.print((d_781_k_).VerbatimString(False))
                    _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n"))).VerbatimString(False))
