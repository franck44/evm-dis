                ...
                if (len(xs)) > (0):
                    ...
                    if (((xs)[0]).is_JUMPSeg) or (((xs)[0]).is_JUMPISeg):
                        ...
                        if source49_.is_Left:
                            d_738___mcc_h0_ = source49_.l
                            d_739_v_ = d_738___mcc_h0_
                            source50_ = d_739_v_
                            if source50_.is_Value:
                                d_740___mcc_h2_ = source50_.v
            ...
            with _dafny.label():
                if (len(xs)) > (0):
                    ...
                    if (((xs)[0]).is_JUMP) and ((((((xs)[0]).s).lastIns).op).IsJump()):
                        if True:
                            ...
                            if source51_.is_Left:
                                d_751___mcc_h0_ = source51_.l
                                _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, ""))).VerbatimString(False))
                            elif True:
                                d_752___mcc_h2_ = source51_.r
                    ...
                    if source52_.is_JUMP:
                        d_754___mcc_h4_ = source52_.s
                        d_755___mcc_h5_ = source52_.wpOp
                        d_756___mcc_h6_ = source52_.wpCap
                        d_757___mcc_h7_ = source52_.tgt
                        d_758___mcc_h8_ = source52_.stacks
                        ...
                        if True:
                            source53_ = d_759_tgt_
                            if source53_.is_Left:
                                d_761___mcc_h17_ = source53_.l
                                d_762_xc_ = d_761___mcc_h17_
                                source54_ = d_762_xc_
                                if source54_.is_Value:
                                    d_763___mcc_h19_ = source54_.v
                        ...
                        d_769___mcc_h9_ = source52_.s
                        d_770___mcc_h10_ = source52_.wpOp
                        d_771___mcc_h11_ = source52_.wpCap
                        d_772___mcc_h12_ = source52_.stacks
                        ...
                        d_776___mcc_h13_ = source52_.s
                        d_777___mcc_h14_ = source52_.wpOp
                        d_778___mcc_h15_ = source52_.wpCap
                        d_779___mcc_h16_ = source52_.stacks
