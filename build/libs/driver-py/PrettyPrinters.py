...
class default__:
    ...
    def PrintInstructions(s):
        while True:
            with _dafny.label():
                if (len(s)) > (0):
                    d_749_formattedAddress_: _dafny.Seq
                    d_749_formattedAddress_ = (Hex.default__.U32ToHex(((s)[0]).address) if (((s)[0]).address) < (Int.default__.TWO__32) else _dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "OutofRange")))
                    _dafny.print((d_749_formattedAddress_).VerbatimString(False))
                    ...
                    in78_ = _dafny.SeqWithoutIsStrInference((s)[1::])
                    s = in78_
        ...
        while True:
            with _dafny.label():
                if (len(xs)) > (0):
                    ...
                    _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n"))).VerbatimString(False))
                    d_750_k_: int
                    d_750_k_ = ((xs)[0]).WeakestPreOperands(((xs)[0]).Ins(), 0)
                    d_751_l_: int
                    d_751_l_ = ((xs)[0]).WeakestPreCapacity(0)
                    if (((xs)[0]).is_JUMPSeg) or (((xs)[0]).is_JUMPISeg):
                        ...
                        d_752_r_: MiscTypes.Either
                        d_752_r_ = SegBuilder.default__.JUMPResolver((xs)[0])
                        source49_ = d_752_r_
                        if source49_.is_Left:
                            d_753___mcc_h0_ = source49_.l
                            d_754_v_ = d_753___mcc_h0_
                            source50_ = d_754_v_
                            if source50_.is_Value:
                                d_755___mcc_h2_ = source50_.v
                                d_756_address_ = d_755___mcc_h2_
                                _dafny.print(((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "0x"))) + (Hex.default__.NatToHex(d_756_address_))).VerbatimString(False))
                            elif True:
                                d_757___mcc_h3_ = source50_.s
                                d_758_msg_ = d_757___mcc_h3_
                                _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "Could not determine stack value"))).VerbatimString(False))
                        elif True:
                            d_759___mcc_h1_ = source49_.r
                            d_760_stackPos_ = d_759___mcc_h1_
                            _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "Peek("))).VerbatimString(False))
                            _dafny.print(_dafny.string_of(d_760_stackPos_))
                            _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, ")"))).VerbatimString(False))
                        _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n"))).VerbatimString(False))
                    if ((xs)[0]).is_CONTSeg:
                        if (((((xs)[0]).lastIns).op).opcode) != (EVMConstants.default__.INVALID):
                            d_761_nextPC_: int
                            d_761_nextPC_ = ((xs)[0]).StartAddressNextSeg()
                            _dafny.print(((((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "CONT: PC of instruction after last is: "))) + (_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, " 0x")))) + (Hex.default__.NatToHex(d_761_nextPC_))) + (_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n")))).VerbatimString(False))
                        elif True:
    ...
    def CollectJumpDest(xs):
        d_762___accumulator_ = _dafny.SeqWithoutIsStrInference([])
        while True:
            with _dafny.label():
                if (len(xs)) == (0):
                    return (d_762___accumulator_) + (_dafny.SeqWithoutIsStrInference([]))
                elif True:
                    d_762___accumulator_ = (d_762___accumulator_) + (((xs)[0]).CollectJumpDest())
        ...
        while True:
            with _dafny.label():
                if (len(xs)) == (0):
                    ...
                    d_763___accumulator_ = (d_763___accumulator_) + (((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, " ensures s.IsJumpDest(0x"))) + (Hex.default__.NatToHex((xs)[0]))) + (_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, " as u256)\n"))))
    ...
    def PrintProofObjectToDafny(xs, pathToEVMDafny):
        ...
        _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n"))).VerbatimString(False))
        d_764_j_: _dafny.Seq
        d_764_j_ = default__.CollectJumpDestAsString(default__.CollectJumpDest(xs))
        if (len(d_764_j_)) > (0):
            ...
            _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n"))).VerbatimString(False))
            _dafny.print((d_764_j_).VerbatimString(False))
            _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n"))).VerbatimString(False))
    ...
    def PrintProofObjectBody(xs, num):
        while True:
            with _dafny.label():
                if (len(xs)) > (0):
                    d_765_startAddress_: _dafny.Seq
                    d_765_startAddress_ = Hex.default__.NatToHex((((((xs)[0]).s).Ins())[0]).address)
                    _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n/** Code starting at 0x"))).VerbatimString(False))
                    _dafny.print((d_765_startAddress_).VerbatimString(False))
                    _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, " */\n"))).VerbatimString(False))
                    ...
                    if (((xs)[0]).is_JUMP) and ((((((xs)[0]).s).lastIns).op).IsJump()):
                        if True:
                            ...
                            if source51_.is_Left:
                                d_766___mcc_h0_ = source51_.l
                                _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, ""))).VerbatimString(False))
                            elif True:
                                d_767___mcc_h2_ = source51_.r
                                d_768_v_ = d_767___mcc_h2_
                    ...
                    if source52_.is_JUMP:
                        d_769___mcc_h4_ = source52_.s
                        d_770___mcc_h5_ = source52_.wpOp
                        d_771___mcc_h6_ = source52_.wpCap
                        d_772___mcc_h7_ = source52_.tgt
                        d_773___mcc_h8_ = source52_.stacks
                        d_774_tgt_ = d_772___mcc_h7_
                        d_775_s_ = d_769___mcc_h4_
                        ...
                        if True:
                            source53_ = d_774_tgt_
                            if source53_.is_Left:
                                d_776___mcc_h17_ = source53_.l
                                d_777_xc_ = d_776___mcc_h17_
                                source54_ = d_777_xc_
                                if source54_.is_Value:
                                    d_778___mcc_h19_ = source54_.v
                                    d_779_v_ = d_778___mcc_h19_
                                    _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "0x"))).VerbatimString(False))
                                    _dafny.print((Hex.default__.NatToHex((d_777_xc_).Extract())).VerbatimString(False))
                                elif True:
                                    d_780___mcc_h21_ = source54_.s
                                    _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "Could not extract value "))).VerbatimString(False))
                            elif True:
                                d_781___mcc_h18_ = source53_.r
                                d_782_v_ = d_781___mcc_h18_
                                _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "s0.Peek("))).VerbatimString(False))
                                _dafny.print(_dafny.string_of(d_782_v_))
                                _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, ") as nat"))).VerbatimString(False))
                        if ((((d_775_s_).lastIns).op).opcode) == (EVMConstants.default__.JUMPI):
                            _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, " || s'.PC() == 0x"))).VerbatimString(False))
                            _dafny.print((Hex.default__.NatToHex((((d_775_s_).lastIns).address) + (1))).VerbatimString(False))
                        _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n"))).VerbatimString(False))
                        d_783_n_: int
                        d_783_n_ = ((xs)[0]).StackEffect()
                        _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "  ensures s'.Operands() == s0.Operands()"))).VerbatimString(False))
                        if (d_783_n_) >= (0):
                            _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, " + "))).VerbatimString(False))
                            _dafny.print(_dafny.string_of(d_783_n_))
                        elif True:
                            _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, " - "))).VerbatimString(False))
                            _dafny.print(_dafny.string_of((0) - (d_783_n_)))
                        _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n"))).VerbatimString(False))
                    elif source52_.is_CONT:
                        d_784___mcc_h9_ = source52_.s
                        d_785___mcc_h10_ = source52_.wpOp
                        d_786___mcc_h11_ = source52_.wpCap
                        d_787___mcc_h12_ = source52_.stacks
                        d_788_s_ = d_784___mcc_h9_
                        _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "  ensures s'.EXECUTING?\n"))).VerbatimString(False))
                        if ((((d_788_s_).lastIns).op).opcode) != (EVMConstants.default__.INVALID):
                            d_789_nextPC_: int
                            d_789_nextPC_ = (d_788_s_).StartAddressNextSeg()
                            _dafny.print((((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "  ensures s'.PC() == 0x"))) + (Hex.default__.NatToHex(d_789_nextPC_))) + (_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n")))).VerbatimString(False))
                            d_790_n_: int
                            d_790_n_ = ((xs)[0]).StackEffect()
                            _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "  ensures s'.Operands() == s0.Operands()"))).VerbatimString(False))
                            if (d_790_n_) >= (0):
                                _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, " + "))).VerbatimString(False))
                                _dafny.print(_dafny.string_of(d_790_n_))
                            elif True:
                                _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, " - "))).VerbatimString(False))
                                _dafny.print(_dafny.string_of((0) - (d_790_n_)))
                        elif True:
                            _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "  Last instruction is invalid"))).VerbatimString(False))
                        _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n"))).VerbatimString(False))
                    elif True:
                        d_791___mcc_h13_ = source52_.s
                        d_792___mcc_h14_ = source52_.wpOp
                        d_793___mcc_h15_ = source52_.wpCap
                        d_794___mcc_h16_ = source52_.stacks
                        d_795_s_ = d_791___mcc_h13_
    ...
    def PrintInstructionsToDafny(xs, pos):
        while True:
            with _dafny.label():
                if (len(xs)) > (0):
                    d_796_k_: _dafny.Seq
                    d_796_k_ = PrettyIns.default__.PrintInstructionToDafny((xs)[0], pos, (pos) + (1))
                    _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "  "))).VerbatimString(False))
                    _dafny.print((d_796_k_).VerbatimString(False))
                    _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n"))).VerbatimString(False))
