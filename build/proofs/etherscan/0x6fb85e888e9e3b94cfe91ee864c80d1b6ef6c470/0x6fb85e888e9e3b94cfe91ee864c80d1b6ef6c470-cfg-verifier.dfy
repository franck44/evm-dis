...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push2(s1, 0x093a);
      var s3 := Dup4(s2);
      var s4 := Push2(s3, 0x07a6);
      var s5 := Jump(s4);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x93a;
      assert s11.Peek(9) == 0x1cb;
      assert s11.Peek(10) == 0x103;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x07bd);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Swap2(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x0948);
      var s5 := Push1(s4, 0x20);
      var s6 := Dup5(s5);
      var s7 := Add(s6);
      var s8 := Push2(s7, 0x07a6);
      var s9 := Jump(s8);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Dup3(s19);
      var s21 := Add(s20);
      assert s21.Peek(6) == 0x295;
      assert s21.Peek(10) == 0xef;
      var s22 := MStore(s21);
      ...
      var s31 := Add(s30);
      assert s31.Peek(4) == 0x295;
      assert s31.Peek(8) == 0xef;
      var s32 := Push2(s31, 0x034c);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s15 := Push1(s14, 0x20);
      var s16 := Add(s15);
      var s17 := Push2(s16, 0x09e4);
      var s18 := Push1(s17, 0x26);
      var s19 := Swap2(s18);
      var s20 := CodeCopy(s19);
      var s21 := Push1(s20, 0x01);
      assert s21.Peek(3) == 0x699;
      assert s21.Peek(7) == 0x295;
      assert s21.Peek(11) == 0xef;
      ...
      var s30 := Dup2(s29);
      var s31 := MStore(s30);
      assert s31.Peek(3) == 0x699;
      assert s31.Peek(7) == 0x295;
      assert s31.Peek(11) == 0xef;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s43(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[7] == 0x295

    requires s0.stack[11] == 0xef
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(4) == 0x699;
      assert s1.Peek(8) == 0x295;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := Add(s8);
      var s10 := Push2(s9, 0x034c);
      var s11 := Swap2(s10);
      assert s11.Peek(2) == 0x34c;
      assert s11.Peek(7) == 0x699;
      assert s11.Peek(11) == 0x295;
      assert s11.Peek(15) == 0xef;
      var s12 := Swap1(s11);
      var s13 := Push2(s12, 0x0758);
      var s14 := Jump(s13);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s46(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[11] == 0x295

    requires s0.stack[15] == 0xef
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(13) == 0x699;
      assert s11.Peek(17) == 0x295;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(12) == 0x699;
      assert s11.Peek(16) == 0x295;
      assert s11.Peek(20) == 0xef;
      var s12 := Not(s11);
      ...
      var s20 := Swap3(s19);
      var s21 := Pop(s20);
      assert s21.Peek(5) == 0x34c;
      assert s21.Peek(10) == 0x699;
      assert s21.Peek(14) == 0x295;
      assert s21.Peek(18) == 0xef;
      var s22 := Pop(s21);
      var s23 := Pop(s22);
      var s24 := Swap3(s23);
      var s25 := Swap2(s24);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s31.Peek(8) == 0xef;
      var s32 := SLoad(s31);
      var s33 := Push2(s32, 0x06c8);
      var s34 := Swap1(s33);
      var s35 := Dup3(s34);
      var s36 := Push2(s35, 0x0745);
      var s37 := Jump(s36);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s54(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x751

    requires s0.stack[6] == 0x6c8

    requires s0.stack[10] == 0x295
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(14) == 0x295;
      assert s11.Peek(18) == 0xef;
      var s12 := Revert(s11);
      // Segment is terminal (Revert, Stop or Return)
      s12
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Dup3(s19);
      var s21 := Swap1(s20);
      assert s21.Peek(10) == 0x295;
      assert s21.Peek(14) == 0xef;
      var s22 := Keccak256(s21);
      var s23 := Swap5(s22);
      var s24 := Swap1(s23);
      var s25 := Swap5(s24);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s29 := Dup1(s28);
      var s30 := SLoad(s29);
      var s31 := Push2(s30, 0x0231);
      assert s31.Peek(0) == 0x231;
      assert s31.Peek(8) == 0xc6;
      var s32 := Swap1(s31);
      var s33 := Push2(s32, 0x0951);
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x751;
      assert s11.Peek(8) == 0x15c;
      assert s11.Peek(9) == 0x103;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x07bd);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x088f);
      assert s1.Peek(0) == 0x88f;
      assert s1.Peek(8) == 0x147;
      assert s1.Peek(9) == 0x14c;
      var s2 := Push2(s1, 0x0828);
      var s3 := Jump(s2);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s22 := IsZero(s21);
      var s23 := Push2(s22, 0x08b4);
      var s24 := JumpI(s23);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s23.stack[1] > 0 then
        ExecuteFromCFGNode_s115(s24, gas - 1)
      else
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x08b4);
      assert s1.Peek(0) == 0x8b4;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x08e8);
      assert s1.Peek(0) == 0x8e8;
      assert s1.Peek(10) == 0x147;
      assert s1.Peek(11) == 0x14c;
      var s2 := Dup6(s1);
      var s3 := Push2(s2, 0x07a6);
      var s4 := Jump(s3);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x8e8;
      assert s11.Peek(14) == 0x147;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0375);
      assert s1.Peek(0) == 0x375;
      assert s1.Peek(6) == 0x14c;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s16 := Pop(s15);
      var s17 := Swap1(s16);
      var s18 := Push2(s17, 0x03c8);
      var s19 := Swap1(s18);
      var s20 := Dup3(s19);
      var s21 := Swap1(s20);
      assert s21.Peek(2) == 0x3c8;
      assert s21.Peek(7) == 0x14c;
      var s22 := Dup2(s21);
      var s23 := Swap1(s22);
      var s24 := Push2(s23, 0x0719);
      var s25 := Jump(s24);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Dup6(s0);
      assert s1.Peek(7) == 0x34c;
      assert s1.Peek(12) == 0x3c8;
      assert s1.Peek(17) == 0x14c;
      var s2 := Dup2(s1);
      var s3 := Add(s2);
      var s4 := Dup4(s3);
      var s5 := Add(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s27 := SLoad(s26);
      var s28 := Push2(s27, 0x0412);
      var s29 := Swap1(s28);
      var s30 := Dup3(s29);
      var s31 := Push2(s30, 0x0745);
      assert s31.Peek(0) == 0x745;
      assert s31.Peek(3) == 0x412;
      assert s31.Peek(8) == 0x14c;
      var s32 := Jump(s31);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s145(s32, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s12 := Swap1(s11);
      var s13 := Pop(s12);
      var s14 := Push2(s13, 0x0449);
      var s15 := Dup2(s14);
      var s16 := Push2(s15, 0x09b7);
      var s17 := Jump(s16);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Push1(s29, 0x84);
      var s31 := Add(s30);
      assert s31.Peek(4) == 0x2ac;
      assert s31.Peek(9) == 0xef;
      var s32 := Push2(s31, 0x034c);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s31 := MStore(s30);
      assert s31.Peek(3) == 0x699;
      assert s31.Peek(7) == 0x2ac;
      assert s31.Peek(12) == 0xef;
      var s32 := Push1(s31, 0x20);
      var s33 := Dup2(s32);
      var s34 := Swap1(s33);
      var s35 := MStore(s34);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(7) == 0x34c;
      assert s1.Peek(12) == 0x699;
      assert s1.Peek(16) == 0x2ac;
      assert s1.Peek(21) == 0xef;
      var s2 := Dup2(s1);
      var s3 := Add(s2);
      var s4 := Dup4(s3);
      var s5 := Add(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s21.Peek(5) == 0x34c;
      assert s21.Peek(10) == 0x699;
      assert s21.Peek(14) == 0x2ac;
      assert s21.Peek(19) == 0xef;
      var s22 := Pop(s21);
      var s23 := Pop(s22);
      var s24 := Swap3(s23);
      var s25 := Swap2(s24);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(6) == 0x751;
      assert s11.Peek(10) == 0x6c8;
      assert s11.Peek(14) == 0x2ac;
      assert s11.Peek(19) == 0xef;
      var s12 := Revert(s11);
      // Segment is terminal (Revert, Stop or Return)
      s12
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x00);
      var s11 := Dup2(s10);
      assert s11.Peek(8) == 0x2ac;
      assert s11.Peek(13) == 0xef;
      var s12 := Dup2(s11);
      var s13 := MStore(s12);
      var s14 := Push1(s13, 0x20);
      var s15 := Dup2(s14);
      ...
      var s20 := Dup3(s19);
      var s21 := Swap1(s20);
      assert s21.Peek(10) == 0x2ac;
      assert s21.Peek(15) == 0xef;
      var s22 := Keccak256(s21);
      var s23 := Swap5(s22);
      var s24 := Swap1(s23);
      var s25 := Swap5(s24);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s19 := Add(s18);
      var s20 := Push2(s19, 0x0a0a);
      var s21 := Push1(s20, 0x28);
      assert s21.Peek(5) == 0x2f9;
      assert s21.Peek(8) == 0x2fe;
      assert s21.Peek(13) == 0xef;
      var s22 := Swap2(s21);
      ...
      assert s31.Peek(4) == 0x2f9;
      assert s31.Peek(7) == 0x2fe;
      assert s31.Peek(12) == 0xef;
      var s32 := Swap1(s31);
      var s33 := Dup2(s32);
      var s34 := MStore(s33);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s21 := Pop(s20);
      assert s21.Peek(5) == 0x34c;
      assert s21.Peek(10) == 0x2f9;
      assert s21.Peek(13) == 0x2fe;
      assert s21.Peek(18) == 0xef;
      var s22 := Pop(s21);
      var s23 := Pop(s22);
      var s24 := Swap3(s23);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Dup3(s29);
      var s31 := MStore(s30);
      assert s31.Peek(8) == 0x2fe;
      assert s31.Peek(13) == 0xef;
      var s32 := Swap2(s31);
      var s33 := Dup3(s32);
      var s34 := Swap1(s33);
