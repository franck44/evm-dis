...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s16 := Swap3(s15);
      var s17 := Swap1(s16);
      var s18 := Push2(s17, 0x05d6);
      var s19 := Swap1(s18);
      var s20 := Dup5(s19);
      var s21 := Swap1(s20);
      assert s21.Peek(2) == 0x5d6;
      assert s21.Peek(9) == 0xe6;
      var s22 := Push2(s21, 0x0929);
      var s23 := Jump(s22);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s27 := Swap3(s26);
      var s28 := Swap1(s27);
      var s29 := Push2(s28, 0x0602);
      var s30 := Swap1(s29);
      var s31 := Dup5(s30);
      assert s31.Peek(2) == 0x602;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0815);
      assert s1.Peek(0) == 0x815;
      assert s1.Peek(9) == 0x13e;
      assert s1.Peek(10) == 0x143;
      var s2 := Push2(s1, 0x07b2);
      var s3 := Jump(s2);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x083a);
      assert s1.Peek(0) == 0x83a;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s27 := Dup1(s26);
      var s28 := Dup1(s27);
      var s29 := Push2(s28, 0x0532);
      var s30 := Swap1(s29);
      var s31 := Push2(s30, 0x0963);
      assert s31.Peek(0) == 0x963;
      assert s31.Peek(2) == 0x532;
      assert s31.Peek(7) == 0x143;
      var s32 := Jump(s31);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0974);
      assert s1.Peek(0) == 0x974;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x24);
      var s11 := Push0(s10);
      assert s11.Peek(2) == 0x974;
      assert s11.Peek(5) == 0x532;
      assert s11.Peek(10) == 0x143;
      var s12 := Revert(s11);
      // Segment is terminal (Revert, Stop or Return)
      s12
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x078b);
      assert s11.Peek(0) == 0x78b;
