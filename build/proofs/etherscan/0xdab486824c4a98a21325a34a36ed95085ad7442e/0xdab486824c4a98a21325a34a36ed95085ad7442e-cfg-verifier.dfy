...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s36 := Jump(s35);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s27(s36, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0868);
      assert s1.Peek(0) == 0x868;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Dup4(s9);
      var s11 := Add(s10);
      assert s11.Peek(11) == 0x15b;
      assert s11.Peek(12) == 0x160;
      var s12 := And(s11);
      var s13 := Dup2(s12);
      var s14 := Add(s13);
      var s15 := Dup2(s14);
      ...
      var s20 := Gt(s19);
      var s21 := Or(s20);
      assert s21.Peek(11) == 0x15b;
      assert s21.Peek(12) == 0x160;
      var s22 := IsZero(s21);
      var s23 := Push2(s22, 0x088d);
      var s24 := JumpI(s23);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s23.stack[1] > 0 then
        ExecuteFromCFGNode_s103(s24, gas - 1)
      else
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x088d);
      assert s1.Peek(0) == 0x88d;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x24);
      var s11 := Push0(s10);
      assert s11.Peek(2) == 0x88d;
      assert s11.Peek(13) == 0x15b;
      assert s11.Peek(14) == 0x160;
      var s12 := Revert(s11);
      // Segment is terminal (Revert, Stop or Return)
      s12
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s21.Peek(11) == 0x160;
      var s22 := Push2(s21, 0x08aa);
      var s23 := JumpI(s22);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s22.stack[1] > 0 then
        ExecuteFromCFGNode_s105(s23, gas - 1)
      else
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x8c0;
      assert s11.Peek(14) == 0x15b;
      assert s11.Peek(15) == 0x160;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x0788);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Pop(s9);
      var s11 := Pop(s10);
      assert s11.Peek(0) == 0x15b;
      assert s11.Peek(2) == 0x160;
      var s12 := Jump(s11);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s26 := Add(s25);
      //  Go to the next instruction at pc + 1
      ExecuteFromCFGNode_s116(s26, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s31.Peek(8) == 0x160;
      var s32 := Jump(s31);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s133(s32, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s16 := Jump(s15);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s181(s16, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s28 := Jump(s27);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s184(s28, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s37 := Jump(s36);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s187(s37, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s28 := Jump(s27);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s202(s28, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s207(s33, gas - 1)
  }
