...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(7) == 0x3af;
      assert s11.Peek(12) == 0x7cf;
      ...
      var s20 := Pop(s19);
      var s21 := Pop(s20);
      assert s21.Peek(4) == 0x3af;
      assert s21.Peek(9) == 0x7cf;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s28 := SLoad(s27);
      var s29 := Push2(s28, 0x080a);
      var s30 := Swap1(s29);
      var s31 := Dup3(s30);
      assert s31.Peek(2) == 0x80a;
      assert s31.Peek(6) == 0x2ce;
      assert s31.Peek(10) == 0xf9;
      var s32 := Push2(s31, 0x0892);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push0(s1);
      var s3 := Push2(s2, 0x089d);
      var s4 := Dup3(s3);
      var s5 := Dup5(s4);
      var s6 := Push2(s5, 0x0b6a);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s51(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0x89d

    requires s0.stack[7] == 0x80a
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(4) == 0x89d;
      assert s1.Peek(8) == 0x80a;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s32 := Swap1(s31);
      var s33 := Push2(s32, 0x0aec);
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s67(s34, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0a2a);
      assert s1.Peek(0) == 0xa2a;
      assert s1.Peek(8) == 0x1cb;
      assert s1.Peek(9) == 0x1d0;
      var s2 := Push2(s1, 0x09b0);
      var s3 := Jump(s2);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0a6d);
      assert s1.Peek(0) == 0xa6d;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0aa0);
      assert s1.Peek(0) == 0xaa0;
      assert s1.Peek(10) == 0x1cb;
      assert s1.Peek(11) == 0x1d0;
      var s2 := Dup6(s1);
      var s3 := Push2(s2, 0x090e);
      var s4 := Jump(s3);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Dup3(s19);
      var s21 := Add(s20);
      assert s21.Peek(4) == 0x1d0;
      var s22 := MStore(s21);
      var s23 := Push1(s22, 0x64);
      var s24 := Add(s23);
      //  Go to the next instruction at pc + 1
      ExecuteFromCFGNode_s114(s24, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Swap1(s10);
      assert s11.Peek(5) == 0x1d0;
      var s12 := Push2(s11, 0x044d);
      var s13 := Swap1(s12);
      var s14 := Dup3(s13);
      var s15 := Swap1(s14);
      var s16 := Dup2(s15);
      var s17 := Swap1(s16);
      var s18 := Push2(s17, 0x0867);
      var s19 := Jump(s18);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s122(s19, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s27 := Jump(s26);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s128(s27, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s23 := SLoad(s22);
      var s24 := Push2(s23, 0x04a3);
      var s25 := Swap1(s24);
      var s26 := Dup3(s25);
      var s27 := Push2(s26, 0x0892);
      var s28 := Jump(s27);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s131(s28, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x0970);
      assert s11.Peek(0) == 0x970;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s31 := Jump(s30);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s173(s31, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s31 := Jump(s30);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s206(s31, gas - 1)
  }
