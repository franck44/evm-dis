...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0569);
      assert s1.Peek(0) == 0x569;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := Add(s8);
      var s10 := Push2(s9, 0x02ca);
      var s11 := Swap2(s10);
      assert s11.Peek(2) == 0x2ca;
      assert s11.Peek(7) == 0x6a8;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Swap3(s19);
      var s21 := Pop(s20);
      assert s21.Peek(5) == 0x2ca;
      assert s21.Peek(10) == 0x6a8;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s31.Peek(8) == 0xdb;
      var s32 := SLoad(s31);
      var s33 := Push2(s32, 0x06d6);
      var s34 := Swap1(s33);
      var s35 := Dup3(s34);
      var s36 := Push2(s35, 0x0594);
      var s37 := Jump(s36);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x089b);
      assert s11.Peek(0) == 0x89b;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s122(s33, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s37 := Jump(s36);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s136(s37, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push2(s1, 0x0420);
      var s3 := Dup5(s2);
      var s4 := Caller(s3);
      var s5 := Push2(s4, 0x041b);
      var s6 := Dup6(s5);
      ...
      assert s21.Peek(5) == 0x41b;
      assert s21.Peek(8) == 0x420;
      assert s21.Peek(13) == 0xdb;
      var s22 := Swap2(s21);
      ...
      var s30 := And(s29);
      var s31 := Push0(s30);
      assert s31.Peek(4) == 0x41b;
      assert s31.Peek(7) == 0x420;
      assert s31.Peek(12) == 0xdb;
      var s32 := Swap1(s31);
      var s33 := Dup2(s32);
      var s34 := MStore(s33);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Dup4(s0);
      assert s1.Peek(7) == 0x41b;
      assert s1.Peek(10) == 0x420;
      assert s1.Peek(15) == 0xdb;
      var s2 := Keccak256(s1);
      var s3 := Caller(s2);
      var s4 := Dup5(s3);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s147(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[7] == 0x41b

    requires s0.stack[10] == 0x420
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s21 := Pop(s20);
      assert s21.Peek(5) == 0x2ca;
      assert s21.Peek(10) == 0x41b;
      assert s21.Peek(13) == 0x420;
      assert s21.Peek(18) == 0xdb;
      var s22 := Pop(s21);
      var s23 := Pop(s22);
      var s24 := Swap3(s23);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0816);
      assert s1.Peek(0) == 0x816;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Dup4(s9);
      var s11 := Add(s10);
      assert s11.Peek(11) == 0x10b;
      assert s11.Peek(12) == 0x110;
      var s12 := And(s11);
      var s13 := Dup2(s12);
      var s14 := Add(s13);
      var s15 := Dup2(s14);
      ...
      var s20 := Gt(s19);
      var s21 := Or(s20);
      assert s21.Peek(11) == 0x10b;
      assert s21.Peek(12) == 0x110;
      var s22 := IsZero(s21);
      var s23 := Push2(s22, 0x083b);
      var s24 := JumpI(s23);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s23.stack[1] > 0 then
        ExecuteFromCFGNode_s176(s24, gas - 1)
      else
        ExecuteFromCFGNode_s174(s24, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Gt(s19);
      var s21 := IsZero(s20);
      assert s21.Peek(10) == 0x10b;
      assert s21.Peek(11) == 0x110;
      var s22 := Push2(s21, 0x0858);
      var s23 := JumpI(s22);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x086e);
      assert s1.Peek(0) == 0x86e;
      assert s1.Peek(10) == 0x10b;
      assert s1.Peek(11) == 0x110;
      var s2 := Dup6(s1);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x86e;
      assert s11.Peek(14) == 0x10b;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s182(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x86e

    requires s0.stack[12] == 0x10b
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push0(s0);
      assert s1.Peek(3) == 0x86e;
      assert s1.Peek(13) == 0x10b;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x86e;
      assert s1.Peek(12) == 0x10b;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Add(s9);
      var s11 := Swap3(s10);
      assert s11.Peek(9) == 0x10b;
      assert s11.Peek(10) == 0x110;
      var s12 := Push2(s11, 0x085d);
      var s13 := Jump(s12);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push0(s1);
      //  Go to the next instruction at pc + 1
      ExecuteFromCFGNode_s191(s2, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s16 := Pop(s15);
      var s17 := Swap1(s16);
      var s18 := Push2(s17, 0x0343);
      var s19 := Swap1(s18);
      var s20 := Dup3(s19);
      var s21 := Swap1(s20);
      assert s21.Peek(2) == 0x343;
      assert s21.Peek(7) == 0x110;
      var s22 := Dup2(s21);
      var s23 := Swap1(s22);
      var s24 := Push2(s23, 0x0569);
      var s25 := Jump(s24);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s197(s25, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s21 := Pop(s20);
      assert s21.Peek(5) == 0x2ca;
      assert s21.Peek(10) == 0x343;
      assert s21.Peek(15) == 0x110;
      var s22 := Pop(s21);
      var s23 := Pop(s22);
      var s24 := Swap3(s23);
      var s25 := Swap2(s24);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s27 := SLoad(s26);
      var s28 := Push2(s27, 0x038c);
      var s29 := Swap1(s28);
      var s30 := Dup3(s29);
      var s31 := Push2(s30, 0x0594);
      assert s31.Peek(0) == 0x594;
      assert s31.Peek(3) == 0x38c;
      assert s31.Peek(8) == 0x110;
      var s32 := Jump(s31);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s206(s32, gas - 1)
  }
