...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Add(s9);
      var s11 := SLt(s10);
      assert s11.Peek(7) == 0x194;
      assert s11.Peek(8) == 0x199;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(10) == 0x194;
      assert s11.Peek(11) == 0x199;
      var s12 := Revert(s11);
      // Segment is terminal (Revert, Stop or Return)
      s12
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Gt(s19);
      var s21 := Or(s20);
      assert s21.Peek(11) == 0x194;
      assert s21.Peek(12) == 0x199;
      var s22 := IsZero(s21);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Swap3(s9);
      var s11 := Pop(s10);
      assert s11.Peek(8) == 0x194;
      assert s11.Peek(9) == 0x199;
      var s12 := Dup4(s11);
      var s13 := Dup2(s12);
      var s14 := Add(s13);
      var s15 := Dup6(s14);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Swap4(s9);
      var s11 := MStore(s10);
      assert s11.Peek(6) == 0x199;
      var s12 := Swap1(s11);
      var s13 := Swap3(s12);
      var s14 := Pop(s13);
      var s15 := Swap1(s14);
      var s16 := Push2(s15, 0x040d);
      var s17 := Swap1(s16);
      var s18 := Dup3(s17);
      var s19 := Swap1(s18);
      var s20 := Dup2(s19);
      var s21 := Swap1(s20);
      assert s21.Peek(3) == 0x40d;
      assert s21.Peek(8) == 0x199;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s8 := Push1(s7, 0x04);
      var s9 := Add(s8);
      var s10 := Push2(s9, 0x037c);
      var s11 := Swap2(s10);
      assert s11.Peek(2) == 0x37c;
      assert s11.Peek(7) == 0x40d;
      assert s11.Peek(12) == 0x199;
      var s12 := Swap1(s11);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Dup3(s9);
      var s11 := Dup6(s10);
      assert s11.Peek(8) == 0x37c;
      assert s11.Peek(13) == 0x40d;
      assert s11.Peek(18) == 0x199;
      var s12 := Add(s11);
      var s13 := MStore(s12);
      var s14 := Push0(s13);
      //  Go to the next instruction at pc + 1
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(12) == 0x40d;
      assert s1.Peek(17) == 0x199;
      var s2 := Dup2(s1);
      var s3 := Add(s2);
      var s4 := Dup4(s3);
      var s5 := Add(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Swap3(s19);
      var s21 := Pop(s20);
      assert s21.Peek(5) == 0x37c;
      assert s21.Peek(10) == 0x40d;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s27 := SLoad(s26);
      var s28 := Push2(s27, 0x0456);
      var s29 := Swap1(s28);
      var s30 := Dup3(s29);
      var s31 := Push2(s30, 0x07cd);
      assert s31.Peek(0) == 0x7cd;
      assert s31.Peek(3) == 0x456;
      assert s31.Peek(8) == 0x199;
      var s32 := Jump(s31);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s70(s32, gas - 1)
  }
