...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s32 := Jump(s31);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s57(s32, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s37 := Jump(s36);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s81(s37, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s103(s34, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s40 := Jump(s39);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s128(s40, gas - 1)
  }
