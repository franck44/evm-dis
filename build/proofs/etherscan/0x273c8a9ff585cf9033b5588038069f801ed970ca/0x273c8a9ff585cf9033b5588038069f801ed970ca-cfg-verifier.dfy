...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Add(s9);
      var s11 := SLt(s10);
      assert s11.Peek(7) == 0x1ac;
      assert s11.Peek(8) == 0x1b1;
      var s12 := Push2(s11, 0x0927);
      var s13 := JumpI(s12);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0939);
      assert s1.Peek(0) == 0x939;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Dup4(s9);
      var s11 := Add(s10);
      assert s11.Peek(11) == 0x1ac;
      assert s11.Peek(12) == 0x1b1;
      var s12 := And(s11);
      var s13 := Dup2(s12);
      var s14 := Add(s13);
      var s15 := Dup2(s14);
      ...
      var s20 := Gt(s19);
      var s21 := Or(s20);
      assert s21.Peek(11) == 0x1ac;
      assert s21.Peek(12) == 0x1b1;
      var s22 := IsZero(s21);
      var s23 := Push2(s22, 0x095e);
      var s24 := JumpI(s23);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Gt(s19);
      var s21 := IsZero(s20);
      assert s21.Peek(10) == 0x1ac;
      assert s21.Peek(11) == 0x1b1;
      var s22 := Push2(s21, 0x097b);
      var s23 := JumpI(s22);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0991);
      assert s1.Peek(0) == 0x991;
      assert s1.Peek(10) == 0x1ac;
      assert s1.Peek(11) == 0x1b1;
      var s2 := Dup6(s1);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x991;
      assert s11.Peek(14) == 0x1ac;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push0(s0);
      assert s1.Peek(3) == 0x991;
      assert s1.Peek(13) == 0x1ac;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(10) == 0x1b1;
      var s12 := Push2(s11, 0x0980);
      var s13 := Jump(s12);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s14 := Pop(s13);
      var s15 := Swap1(s14);
      var s16 := Push2(s15, 0x0401);
      var s17 := Swap1(s16);
      var s18 := Dup3(s17);
      var s19 := Swap1(s18);
      var s20 := Dup2(s19);
      var s21 := Swap1(s20);
      assert s21.Peek(3) == 0x401;
      assert s21.Peek(8) == 0x1b1;
      var s22 := Push2(s21, 0x07a2);
      var s23 := Jump(s22);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s95(s23, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Dup6(s10);
      assert s11.Peek(8) == 0x370;
      assert s11.Peek(13) == 0x401;
      assert s11.Peek(18) == 0x1b1;
      var s12 := Add(s11);
      var s13 := MStore(s12);
      var s14 := Push0(s13);
      //  Go to the next instruction at pc + 1
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s98(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[11] == 0x401

    requires s0.stack[16] == 0x1b1
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(6) == 0x370;
      assert s1.Peek(11) == 0x401;
      assert s1.Peek(16) == 0x1b1;
      var s2 := Dup2(s1);
      var s3 := Dup2(s2);
      var s4 := Lt(s3);
      var s5 := IsZero(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Dup6(s0);
      assert s1.Peek(7) == 0x370;
      assert s1.Peek(12) == 0x401;
      assert s1.Peek(17) == 0x1b1;
      var s2 := Dup2(s1);
      var s3 := Add(s2);
      var s4 := Dup4(s3);
      var s5 := Add(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Push1(s10, 0x1f);
      assert s11.Peek(7) == 0x370;
      assert s11.Peek(12) == 0x401;
      assert s11.Peek(17) == 0x1b1;
      var s12 := Not(s11);
      var s13 := Push1(s12, 0x1f);
      var s14 := Dup4(s13);
      var s15 := Add(s14);
      ...
      var s21 := Pop(s20);
      assert s21.Peek(5) == 0x370;
      assert s21.Peek(10) == 0x401;
      assert s21.Peek(15) == 0x1b1;
      var s22 := Pop(s21);
      var s23 := Pop(s22);
      var s24 := Swap3(s23);
      var s25 := Swap2(s24);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s27 := SLoad(s26);
      var s28 := Push2(s27, 0x044a);
      var s29 := Swap1(s28);
      var s30 := Dup3(s29);
      var s31 := Push2(s30, 0x07cd);
      assert s31.Peek(0) == 0x7cd;
      assert s31.Peek(3) == 0x44a;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0ab8);
      assert s1.Peek(0) == 0xab8;
