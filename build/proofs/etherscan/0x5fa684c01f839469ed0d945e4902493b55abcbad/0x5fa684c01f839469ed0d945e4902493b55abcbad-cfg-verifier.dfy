...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s3 := Push2(s2, 0x028a);
      var s4 := CallDataSize(s3);
      var s5 := Push1(s4, 0x04);
      var s6 := Push2(s5, 0x0c70);
      var s7 := Jump(s6);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push2(s1, 0x0c8b);
      var s3 := Dup3(s2);
      var s4 := Push2(s3, 0x0bd5);
      var s5 := Jump(s4);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(8) == 0x28a;
      assert s11.Peek(9) == 0x1a6;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x0bec);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Swap1(s10);
      assert s11.Peek(1) == 0x3c6;
      assert s11.Peek(3) == 0x1a6;
      var s12 := Push2(s11, 0x0d28);
      var s13 := Jump(s12);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s31 := Add(s30);
      assert s31.Peek(2) == 0x1a6;
      var s32 := Push2(s31, 0x03c6);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s21.Peek(8) == 0x42d;
      assert s21.Peek(10) == 0x1a6;
      var s22 := Not(s21);
      var s23 := Dup6(s22);
      var s24 := And(s23);
      var s25 := Or(s24);
      ...
      var s30 := MLoad(s29);
      var s31 := Swap4(s30);
      assert s31.Peek(0) == 0x100;
      assert s31.Peek(6) == 0x42d;
      ...
      var s37 := Dup3(s36);
      var s38 := Swap1(s37);
      var s39 := Push32(s38, 0x8be0079c531659141344cd1fd0a4f28419497f9722a3daafe3b4186f6b6457e0);
      var s40 := Swap1(s39);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s3 := Push2(s2, 0x0251);
      var s4 := CallDataSize(s3);
      var s5 := Push1(s4, 0x04);
      var s6 := Push2(s5, 0x0c92);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Swap2(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x0cbc);
      var s5 := Push1(s4, 0x20);
      var s6 := Dup5(s5);
      var s7 := Add(s6);
      var s8 := Push2(s7, 0x0bd5);
      var s9 := Jump(s8);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := SLoad(s19);
      var s21 := Dup2(s20);
      assert s21.Peek(5) == 0x32e;
      assert s21.Peek(9) == 0x136;
      var s22 := Dup2(s21);
      var s23 := Lt(s22);
      var s24 := IsZero(s23);
      var s25 := Push2(s24, 0x086d);
      var s26 := JumpI(s25);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s25.stack[1] > 0 then
        ExecuteFromCFGNode_s63(s26, gas - 1)
      else
        ExecuteFromCFGNode_s61(s26, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Push1(s29, 0x84);
      var s31 := Add(s30);
      assert s31.Peek(5) == 0x32e;
      assert s31.Peek(9) == 0x136;
      var s32 := Push2(s31, 0x03c6);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s62(s33, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0332);
      assert s1.Peek(0) == 0x332;
      assert s1.Peek(4) == 0x8a4;
      assert s1.Peek(12) == 0x32e;
      assert s1.Peek(16) == 0x136;
      var s2 := Push2(s1, 0x0cff);
      var s3 := Jump(s2);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s26 := MLoad(s25);
      var s27 := Push2(s26, 0x08f0);
      var s28 := Swap2(s27);
      var s29 := Dup2(s28);
      var s30 := MStore(s29);
      var s31 := Push1(s30, 0x20);
      assert s31.Peek(2) == 0x8f0;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := SLoad(s29);
      var s31 := Dup3(s30);
      assert s31.Peek(5) == 0x136;
      var s32 := Dup2(s31);
      var s33 := Lt(s32);
      var s34 := IsZero(s33);
      var s35 := Push2(s34, 0x0548);
      var s36 := JumpI(s35);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s85(s33, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(6) == 0x1a6;
      var s12 := Shl(s11);
      var s13 := Sub(s12);
      var s14 := And(s13);
      var s15 := Dup3(s14);
      var s16 := Push2(s15, 0x0a9e);
      var s17 := Jump(s16);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s16 := Add(s15);
      var s17 := MStore(s16);
      var s18 := Push32(s17, 0x45524332303a2063726561746520746f20746865207a65726f20616464726573);
      var s19 := Push1(s18, 0x44);
      var s20 := Dup3(s19);
      var s21 := Add(s20);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := Swap2(s8);
      var s10 := Swap1(s9);
      var s11 := Push2(s10, 0x0d15);
      assert s11.Peek(0) == 0xd15;
      assert s11.Peek(3) == 0xb10;
      assert s11.Peek(9) == 0x42d;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Swap1(s19);
      var s21 := MStore(s20);
      assert s21.Peek(3) == 0x42d;
      assert s21.Peek(5) == 0x1a6;
      ...
      var s28 := Swap3(s27);
      var s29 := Swap1(s28);
      var s30 := Push2(s29, 0x0b3d);
      var s31 := Swap1(s30);
      assert s31.Peek(1) == 0xb3d;
      assert s31.Peek(7) == 0x42d;
      assert s31.Peek(9) == 0x1a6;
      var s32 := Dup5(s31);
      var s33 := Swap1(s32);
      var s34 := Push2(s33, 0x0d15);
      var s35 := Jump(s34);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s118(s35, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s4 := Dup1(s3);
      var s5 := SLoad(s4);
      var s6 := Push2(s5, 0x029e);
      var s7 := Swap1(s6);
      var s8 := Push2(s7, 0x0cc5);
      var s9 := Jump(s8);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s29 := Dup1(s28);
      var s30 := SLoad(s29);
      var s31 := Push2(s30, 0x02ca);
      assert s31.Peek(0) == 0x2ca;
      assert s31.Peek(8) == 0x10d;
      var s32 := Swap1(s31);
      var s33 := Push2(s32, 0x0cc5);
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s31 := Swap4(s30);
      assert s31.Peek(0) == 0x100;
      assert s31.Peek(6) == 0x46a;
      assert s31.Peek(7) == 0x1a6;
      var s32 := Swap1(s31);
      var s33 := Swap3(s32);
      var s34 := Div(s33);
      var s35 := And(s34);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s21.Peek(6) == 0x1a6;
      var s22 := Dup2(s21);
      var s23 := Lt(s22);
      var s24 := IsZero(s23);
      var s25 := Push2(s24, 0x09d2);
      var s26 := JumpI(s25);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s25.stack[1] > 0 then
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s29 := Swap3(s28);
      var s30 := Swap1(s29);
      var s31 := Push2(s30, 0x0a01);
      assert s31.Peek(0) == 0xa01;
      assert s31.Peek(8) == 0x42d;
      assert s31.Peek(10) == 0x1a6;
      var s32 := Swap1(s31);
      var s33 := Dup5(s32);
      var s34 := Swap1(s33);
      var s35 := Push2(s34, 0x0d5d);
      var s36 := Jump(s35);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Jump(s0);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s202(s1, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x0c30);
      assert s11.Peek(0) == 0xc30;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s236(s33, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s25.stack[1] > 0 then
        ExecuteFromCFGNode_s242(s26, gas - 1)
      else
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Push1(s29, 0x84);
      var s31 := Add(s30);
      assert s31.Peek(5) == 0x345;
      assert s31.Peek(10) == 0x136;
      var s32 := Push2(s31, 0x03c6);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s241(s33, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Dup2(s29);
      var s31 := MStore(s30);
      assert s31.Peek(6) == 0x345;
      assert s31.Peek(11) == 0x136;
      var s32 := Swap1(s31);
      var s33 := Dup2(s32);
      var s34 := Keccak256(s33);
      var s35 := Dup1(s34);
      ...
      var s41 := Swap1(s40);
      //  Go to the next instruction at pc + 1
      ExecuteFromCFGNode_s243(s41, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Pop(s9);
      var s11 := Pop(s10);
      assert s11.Peek(1) == 0x345;
      assert s11.Peek(6) == 0x136;
      var s12 := Pop(s11);
      var s13 := Jump(s12);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := SLoad(s29);
      var s31 := Dup3(s30);
      assert s31.Peek(6) == 0x136;
      var s32 := Dup2(s31);
      var s33 := Lt(s32);
      var s34 := IsZero(s33);
      var s35 := Push2(s34, 0x03cf);
      var s36 := JumpI(s35);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s35.stack[1] > 0 then
        ExecuteFromCFGNode_s253(s36, gas - 1)
      else
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s31 := Add(s30);
      //  Go to the next instruction at pc + 1
      ExecuteFromCFGNode_s252(s31, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Push1(s29, 0x84);
      var s31 := Add(s30);
      assert s31.Peek(4) == 0x3dc;
      assert s31.Peek(10) == 0x136;
      var s32 := Push2(s31, 0x03c6);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s256(s33, gas - 1)
  }
