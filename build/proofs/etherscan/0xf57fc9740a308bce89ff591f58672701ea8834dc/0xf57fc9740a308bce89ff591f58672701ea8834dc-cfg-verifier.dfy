...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x069e);
      assert s1.Peek(0) == 0x69e;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s18(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[6] == 0x5d9

    requires s0.stack[10] == 0x6ac
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(6) == 0x5d9;
      assert s1.Peek(10) == 0x6ac;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s19(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[5] == 0x5d9

    requires s0.stack[9] == 0x6ac
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(5) == 0x5d9;
      assert s1.Peek(9) == 0x6ac;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s13 := Add(s12);
      var s14 := MStore(s13);
      var s15 := Push2(s14, 0x07d2);
      var s16 := Dup2(s15);
      var s17 := Push2(s16, 0x0799);
      var s18 := Jump(s17);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s34(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[5] == 0x7d2

    requires s0.stack[8] == 0x436
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(5) == 0x7d2;
      assert s1.Peek(8) == 0x436;
      ...
      var s10 := Pop(s9);
      var s11 := Swap3(s10);
      assert s11.Peek(0) == 0x7a5;
      assert s11.Peek(6) == 0x7d2;
      assert s11.Peek(9) == 0x436;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(6) == 0x436;
      assert s1.Peek(8) == 0x160;
      var s2 := Swap2(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x07b0);
      var s5 := Dup3(s4);
      var s6 := Push2(s5, 0x0771);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Push1(s5, 0x04);
      var s7 := Add(s6);
      var s8 := Push2(s7, 0x04a4);
      var s9 := Swap1(s8);
      var s10 := Push2(s9, 0x0849);
      var s11 := Jump(s10);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Sub(s9);
      var s11 := Push0(s10);
      assert s11.Peek(4) == 0x4a4;
      assert s11.Peek(6) == 0x160;
      var s12 := Dup4(s11);
      var s13 := Add(s12);
      var s14 := MStore(s13);
      var s15 := Push2(s14, 0x0860);
      var s16 := Dup2(s15);
      var s17 := Push2(s16, 0x0827);
      var s18 := Jump(s17);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x860;
      assert s1.Peek(4) == 0x4a4;
      assert s1.Peek(6) == 0x160;
      var s2 := Push0(s1);
      var s3 := Push2(s2, 0x0833);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s44(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x833

    requires s0.stack[5] == 0x860
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x833;
      assert s1.Peek(5) == 0x860;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0x860;
      assert s1.Peek(6) == 0x4a4;
      assert s1.Peek(8) == 0x160;
      var s2 := Swap2(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x083e);
      var s5 := Dup3(s4);
      var s6 := Push2(s5, 0x07d9);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s46(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0x83e

    requires s0.stack[4] == 0x860
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x83e;
      assert s1.Peek(4) == 0x860;
      ...
      var s10 := Add(s9);
      var s11 := MStore(s10);
      assert s11.Peek(1) == 0x83e;
      assert s11.Peek(4) == 0x860;
      assert s11.Peek(7) == 0x4a4;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push0(s1);
      var s3 := Push32(s2, 0x00000000000000000000000012fc680eac20e3dd72b8ba8d94ea608bd39e3ee6);
      var s4 := Swap1(s3);
      var s5 := Pop(s4);
      var s6 := Swap1(s5);
      var s7 := Jump(s6);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Swap1(s5);
      var s7 := Pop(s6);
      var s8 := Push2(s7, 0x0684);
      var s9 := Push0(s8);
      var s10 := Dup4(s9);
      var s11 := Add(s10);
      assert s11.Peek(1) == 0x684;
      assert s11.Peek(5) == 0x13d;
      var s12 := Dup5(s11);
      var s13 := Push2(s12, 0x0662);
      var s14 := Jump(s13);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push32(s1, 0x000000000000000000000000296a522ac9dcf102c040171526e78420107af419);
      var s3 := Dup2(s2);
      var s4 := Jump(s3);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push32(s1, 0x00000000000000000000000012fc680eac20e3dd72b8ba8d94ea608bd39e3ee6);
      var s3 := Dup2(s2);
      var s4 := Jump(s3);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push0(s1);
      var s3 := Push32(s2, 0x000000000000000000000000296a522ac9dcf102c040171526e78420107af419);
      var s4 := Swap1(s3);
      var s5 := Pop(s4);
      var s6 := Swap1(s5);
      var s7 := Jump(s6);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x0629);
      assert s11.Peek(0) == 0x629;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Push2(s5, 0x0647);
      var s7 := Dup7(s6);
      var s8 := Dup3(s7);
      var s9 := Dup8(s8);
      var s10 := Add(s9);
      var s11 := Push2(s10, 0x05cb);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s4 := Pop(s3);
      var s5 := Push1(s4, 0x40);
      var s6 := Push2(s5, 0x0658);
      var s7 := Dup7(s6);
      var s8 := Dup3(s7);
      var s9 := Dup8(s8);
      var s10 := Add(s9);
      var s11 := Push2(s10, 0x05fe);
      assert s11.Peek(0) == 0x5fe;
      assert s11.Peek(3) == 0x658;
      assert s11.Peek(10) == 0x9f;
      assert s11.Peek(11) == 0xa4;
      var s12 := Jump(s11);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s5 := Swap1(s4);
      var s6 := Pop(s5);
      var s7 := Push2(s6, 0x060c);
      var s8 := Dup2(s7);
      var s9 := Push2(s8, 0x05e8);
      var s10 := Jump(s9);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s161(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0x60c

    requires s0.stack[7] == 0x658
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(3) == 0x60c;
      assert s1.Peek(7) == 0x658;
      assert s1.Peek(14) == 0x9f;
      assert s1.Peek(15) == 0xa4;
      var s2 := Push0(s1);
      var s3 := Dup2(s2);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s162(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x60c

    requires s0.stack[6] == 0x658
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x60c;
      assert s1.Peek(6) == 0x658;
      assert s1.Peek(13) == 0x9f;
      assert s1.Peek(14) == 0xa4;
      var s2 := Dup2(s1);
      var s3 := Eq(s2);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Push1(s5, 0x04);
      var s7 := Add(s6);
      var s8 := Push2(s7, 0x01e7);
      var s9 := Swap1(s8);
      var s10 := Push2(s9, 0x070f);
      var s11 := Jump(s10);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s13 := Add(s12);
      var s14 := MStore(s13);
      var s15 := Push2(s14, 0x0726);
      var s16 := Dup2(s15);
      var s17 := Push2(s16, 0x06ed);
      var s18 := Jump(s17);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Swap2(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x0704);
      var s5 := Dup3(s4);
      var s6 := Push2(s5, 0x06c5);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Dup4(s5);
      var s7 := Push32(s6, 0x00000000000000000000000012fc680eac20e3dd72b8ba8d94ea608bd39e3ee6);
      var s8 := Dup5(s7);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Swap1(s5);
      var s7 := Pop(s6);
      var s8 := Push2(s7, 0x074f);
      var s9 := Push0(s8);
      var s10 := Dup4(s9);
      var s11 := Add(s10);
      assert s11.Peek(1) == 0x74f;
      assert s11.Peek(7) == 0x24d;
      assert s11.Peek(13) == 0xa4;
      var s12 := Dup7(s11);
      var s13 := Push2(s12, 0x0662);
      var s14 := Jump(s13);
