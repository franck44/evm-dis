...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Dup4(s9);
      var s11 := Add(s10);
      assert s11.Peek(11) == 0x1d4;
      assert s11.Peek(12) == 0x1d9;
      var s12 := And(s11);
      var s13 := Dup2(s12);
      var s14 := Add(s13);
      var s15 := Dup2(s14);
      ...
      var s20 := Gt(s19);
      var s21 := Or(s20);
      assert s21.Peek(11) == 0x1d4;
      assert s21.Peek(12) == 0x1d9;
      var s22 := IsZero(s21);
      var s23 := Push2(s22, 0x09a2);
      var s24 := JumpI(s23);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x09a2);
      assert s1.Peek(0) == 0x9a2;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x24);
      var s11 := Push1(s10, 0x00);
      assert s11.Peek(2) == 0x9a2;
      assert s11.Peek(13) == 0x1d4;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Gt(s19);
      var s21 := IsZero(s20);
      assert s21.Peek(10) == 0x1d4;
      assert s21.Peek(11) == 0x1d9;
      var s22 := Push2(s21, 0x09c0);
      var s23 := JumpI(s22);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x09d6);
      assert s1.Peek(0) == 0x9d6;
      assert s1.Peek(10) == 0x1d4;
      assert s1.Peek(11) == 0x1d9;
      var s2 := Dup6(s1);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x9d6;
      assert s11.Peek(14) == 0x1d4;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s32 := Jump(s31);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s55(s32, gas - 1)
  }
