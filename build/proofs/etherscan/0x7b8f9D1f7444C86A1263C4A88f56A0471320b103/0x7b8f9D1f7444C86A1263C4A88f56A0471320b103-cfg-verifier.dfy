...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x085b);
      assert s11.Peek(0) == 0x85b;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s32 := Gt(s31);
      var s33 := IsZero(s32);
      var s34 := Push2(s33, 0x044c);
      var s35 := JumpI(s34);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s34.stack[1] > 0 then
        ExecuteFromCFGNode_s117(s35, gas - 1)
      else
        ExecuteFromCFGNode_s115(s35, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s27 := Swap3(s26);
      var s28 := Swap1(s27);
      var s29 := Push2(s28, 0x049f);
      var s30 := Swap1(s29);
      var s31 := Dup5(s30);
      assert s31.Peek(2) == 0x49f;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s26 := MLoad(s25);
      var s27 := Push2(s26, 0x0522);
      var s28 := Swap2(s27);
      var s29 := Dup2(s28);
      var s30 := MStore(s29);
      var s31 := Push1(s30, 0x20);
      assert s31.Peek(2) == 0x522;
      assert s31.Peek(10) == 0xe6;
      var s32 := Add(s31);
      var s33 := Swap1(s32);
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s134(s34, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Gt(s19);
      var s21 := Or(s20);
      assert s21.Peek(12) == 0x104;
      assert s21.Peek(13) == 0x109;
      var s22 := IsZero(s21);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Gt(s19);
      var s21 := IsZero(s20);
      assert s21.Peek(11) == 0x104;
      assert s21.Peek(12) == 0x109;
      var s22 := Push2(s21, 0x0814);
      var s23 := JumpI(s22);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s22.stack[1] > 0 then
        ExecuteFromCFGNode_s151(s23, gas - 1)
      else
        ExecuteFromCFGNode_s150(s23, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s25 := Add(s24);
      //  Go to the next instruction at pc + 1
      ExecuteFromCFGNode_s162(s25, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0356);
      assert s1.Peek(0) == 0x356;
      assert s1.Peek(7) == 0x109;
