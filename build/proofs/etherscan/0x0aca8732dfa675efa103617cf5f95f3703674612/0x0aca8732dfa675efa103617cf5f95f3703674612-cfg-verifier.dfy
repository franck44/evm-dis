...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Caller(s9);
      var s11 := Eq(s10);
      assert s11.Peek(2) == 0x1cc;
      var s12 := Push2(s11, 0x0849);
      var s13 := JumpI(s12);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := Add(s8);
      var s10 := Push2(s9, 0x03b8);
      var s11 := Swap1(s10);
      assert s11.Peek(1) == 0x3b8;
      assert s11.Peek(3) == 0x1cc;
      var s12 := Push2(s11, 0x0f69);
      var s13 := Jump(s12);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := Add(s8);
      var s10 := MStore(s9);
      var s11 := PushN(s10, 19, 0x31b0b63632b91034b9903737ba1030b236b4b7);
      assert s11.Peek(2) == 0x3b8;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Swap2(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x0ebb);
      var s5 := Push1(s4, 0x20);
      var s6 := Dup5(s5);
      var s7 := Add(s6);
      var s8 := Push2(s7, 0x0ded);
      var s9 := Jump(s8);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s36 := Jump(s35);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s51(s36, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := Add(s8);
      var s10 := MStore(s9);
      var s11 := PushN(s10, 12, 0x1d1bdad95b881b1bd8dad959);
      assert s11.Peek(2) == 0x3b8;
      assert s11.Peek(6) == 0x162;
      var s12 := Push1(s11, 0xa2);
      var s13 := Shl(s12);
      var s14 := Push1(s13, 0x40);
      var s15 := Dup3(s14);
      var s16 := Add(s15);
      ...
      var s21 := Jump(s20);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s65(s21, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s16 := Add(s15);
      var s17 := MStore(s16);
      var s18 := Push32(s17, 0x6d73672e73656e64657220726573747269637465642066726f6d207472616e73);
      var s19 := Push1(s18, 0x44);
      var s20 := Dup3(s19);
      var s21 := Add(s20);
      assert s21.Peek(6) == 0x162;
      var s22 := MStore(s21);
      var s23 := Push4(s22, 0x66657273);
      ...
      var s31 := Add(s30);
      assert s31.Peek(4) == 0x162;
      var s32 := Push2(s31, 0x03b8);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(2) == 0xf4c;
      assert s11.Peek(6) == 0xada;
      assert s11.Peek(11) == 0x389;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0f64);
      assert s1.Peek(0) == 0xf64;
      assert s1.Peek(4) == 0xb10;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s86(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[0] == 0xf64

    requires s0.stack[4] == 0xb10

    requires s0.stack[12] == 0x389
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x24);
      var s11 := Push1(s10, 0x00);
      assert s11.Peek(2) == 0xf64;
      assert s11.Peek(6) == 0xb10;
      assert s11.Peek(14) == 0x389;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s26 := MLoad(s25);
      var s27 := Push2(s26, 0x0b5c);
      var s28 := Swap2(s27);
      var s29 := Dup2(s28);
      var s30 := MStore(s29);
      var s31 := Push1(s30, 0x20);
      assert s31.Peek(2) == 0xb5c;
      assert s31.Peek(10) == 0x389;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s25 := Jump(s24);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s25(s25, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s36 := Lt(s35);
      var s37 := IsZero(s36);
      var s38 := Push2(s37, 0x06da);
      var s39 := JumpI(s38);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s38.stack[1] > 0 then
        ExecuteFromCFGNode_s122(s39, gas - 1)
      else
        ExecuteFromCFGNode_s120(s39, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s21 := Jump(s20);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s144(s21, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Push1(s29, 0x84);
      var s31 := Add(s30);
      assert s31.Peek(3) == 0x57c;
      assert s31.Peek(6) == 0x1cc;
      var s32 := Push2(s31, 0x03b8);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := SLoad(s19);
      var s21 := Dup2(s20);
      assert s21.Peek(4) == 0x57c;
      assert s21.Peek(7) == 0x1cc;
      var s22 := Dup2(s21);
      var s23 := Lt(s22);
      var s24 := IsZero(s23);
      var s25 := Push2(s24, 0x0d1d);
      var s26 := JumpI(s25);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s25.stack[1] > 0 then
        ExecuteFromCFGNode_s155(s26, gas - 1)
      else
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Push1(s29, 0x84);
      var s31 := Add(s30);
      assert s31.Peek(4) == 0x57c;
      assert s31.Peek(7) == 0x1cc;
      var s32 := Push2(s31, 0x03b8);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s156(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0xd27

    requires s0.stack[6] == 0x57c
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0xd27;
      assert s1.Peek(6) == 0x57c;
      assert s1.Peek(9) == 0x1cc;
      var s2 := Push1(s1, 0x00);
      var s3 := Dup3(s2);
      var s4 := Dup3(s3);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s157(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0xd27

    requires s0.stack[7] == 0x57c
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0f4c);
      assert s1.Peek(0) == 0xf4c;
      assert s1.Peek(4) == 0xd27;
      assert s1.Peek(8) == 0x57c;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s158(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[4] == 0xd27

    requires s0.stack[8] == 0x57c
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Push1(s10, 0x00);
      assert s11.Peek(2) == 0xf4c;
      assert s11.Peek(6) == 0xd27;
      assert s11.Peek(10) == 0x57c;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0xd27;
      assert s1.Peek(7) == 0x57c;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s28 := Swap3(s27);
      var s29 := Swap1(s28);
      var s30 := Push2(s29, 0x0d55);
      var s31 := Swap1(s30);
      assert s31.Peek(1) == 0xd55;
      assert s31.Peek(8) == 0x57c;
      assert s31.Peek(11) == 0x1cc;
      var s32 := Dup5(s31);
      var s33 := Swap1(s32);
      var s34 := Push2(s33, 0x0f3a);
      var s35 := Jump(s34);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s161(s35, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0f4c);
      assert s1.Peek(0) == 0xf4c;
      assert s1.Peek(4) == 0xd55;
      assert s1.Peek(11) == 0x57c;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s163(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[4] == 0xd55

    requires s0.stack[11] == 0x57c
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Push1(s10, 0x00);
      assert s11.Peek(2) == 0xf4c;
      assert s11.Peek(6) == 0xd55;
      assert s11.Peek(13) == 0x57c;
      assert s11.Peek(16) == 0x1cc;
      var s12 := Revert(s11);
      // Segment is terminal (Revert, Stop or Return)
      s12
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s4 := Dup1(s3);
      var s5 := SLoad(s4);
      var s6 := Push2(s5, 0x02f9);
      var s7 := Swap1(s6);
      var s8 := Push2(s7, 0x0ec4);
      var s9 := Jump(s8);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s29 := Dup1(s28);
      var s30 := SLoad(s29);
      var s31 := Push2(s30, 0x0325);
      assert s31.Peek(0) == 0x325;
      assert s31.Peek(8) == 0x139;
      var s32 := Swap1(s31);
      var s33 := Push2(s32, 0x0ec4);
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s182(s34, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s16 := Jump(s15);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s210(s16, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s21 := Jump(s20);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s51(s21, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s16 := Add(s15);
      var s17 := MStore(s16);
      var s18 := Push32(s17, 0x45524332303a206d696e7420746f20746865207a65726f206164647265737300);
      var s19 := Push1(s18, 0x44);
      var s20 := Dup3(s19);
      var s21 := Add(s20);
      assert s21.Peek(5) == 0x57c;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Dup3(s5);
      var s7 := SLoad(s6);
      var s8 := Push2(s7, 0x0bd2);
      var s9 := Swap2(s8);
      var s10 := Swap1(s9);
      var s11 := Push2(s10, 0x0f51);
      assert s11.Peek(0) == 0xf51;
      assert s11.Peek(3) == 0xbd2;
      assert s11.Peek(9) == 0x57c;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Push1(s10, 0x00);
      assert s11.Peek(2) == 0xf64;
      assert s11.Peek(6) == 0xbd2;
      assert s11.Peek(12) == 0x57c;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Shl(s9);
      var s11 := Sub(s10);
      assert s11.Peek(3) == 0x57c;
      assert s11.Peek(6) == 0x1cc;
      var s12 := Dup3(s11);
      var s13 := And(s12);
      var s14 := Push1(s13, 0x00);
      var s15 := Swap1(s14);
      ...
      var s20 := Swap1(s19);
      var s21 := MStore(s20);
      assert s21.Peek(3) == 0x57c;
      assert s21.Peek(6) == 0x1cc;
      ...
      var s28 := Swap3(s27);
      var s29 := Swap1(s28);
      var s30 := Push2(s29, 0x0bff);
      var s31 := Swap1(s30);
      assert s31.Peek(1) == 0xbff;
      assert s31.Peek(7) == 0x57c;
      assert s31.Peek(10) == 0x1cc;
      var s32 := Dup5(s31);
      var s33 := Swap1(s32);
      var s34 := Push2(s33, 0x0f51);
      var s35 := Jump(s34);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s255(s35, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s35 := Jump(s34);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s167(s35, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s35 := Dup6(s34);
      var s36 := Swap1(s35);
      var s37 := Push2(s36, 0x04de);
      var s38 := Swap1(s37);
      var s39 := Dup7(s38);
      var s40 := Swap1(s39);
      var s41 := Push2(s40, 0x0f51);
      //  Go to the next instruction at pc + 1
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s270(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[0] == 0xf51

    requires s0.stack[3] == 0x4de
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Jump(s0);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s271(s1, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Push1(s10, 0x00);
      assert s11.Peek(2) == 0xf64;
      assert s11.Peek(6) == 0x4de;
      assert s11.Peek(9) == 0x389;
      assert s11.Peek(13) == 0x162;
      var s12 := Revert(s11);
      // Segment is terminal (Revert, Stop or Return)
      s12
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Dup3(s29);
      var s31 := MStore(s30);
      assert s31.Peek(8) == 0x389;
      assert s31.Peek(12) == 0x162;
      var s32 := Swap2(s31);
      var s33 := Dup3(s32);
      var s34 := Swap1(s33);
      var s35 := Keccak256(s34);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x0e48);
      assert s11.Peek(0) == 0xe48;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0xe51;
      assert s11.Peek(10) == 0x192;
      assert s11.Peek(11) == 0x162;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x0e04);
      var s14 := JumpI(s13);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push1(s0, 0x00);
      assert s1.Peek(3) == 0xe51;
      assert s1.Peek(9) == 0x192;
      assert s1.Peek(10) == 0x162;
      var s2 := Dup1(s1);
      var s3 := Revert(s2);
      // Segment is terminal (Revert, Stop or Return)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Push1(s19, 0xff);
      var s21 := And(s20);
      assert s21.Peek(5) == 0x162;
      var s22 := IsZero(s21);
      var s23 := IsZero(s22);
      var s24 := Push1(s23, 0x01);
      var s25 := Sub(s24);
      var s26 := Push2(s25, 0x043f);
      var s27 := JumpI(s26);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s26.stack[1] > 0 then
        ExecuteFromCFGNode_s309(s27, gas - 1)
      else
        ExecuteFromCFGNode_s308(s27, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s16 := Add(s15);
      var s17 := MStore(s16);
      var s18 := Push32(s17, 0x73656e646572206164647265737320726573747269637465642066726f6d2074);
      var s19 := Push1(s18, 0x44);
      var s20 := Dup3(s19);
      var s21 := Add(s20);
      assert s21.Peek(7) == 0x162;
      var s22 := MStore(s21);
      var s23 := Push8(s22, 0x72616e7366657273);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Push1(s29, 0x84);
      var s31 := Add(s30);
      assert s31.Peek(4) == 0x44a;
      assert s31.Peek(9) == 0x162;
      var s32 := Push2(s31, 0x03b8);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s312(s33, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      if s25.stack[1] > 0 then
        ...
        ExecuteFromCFGNode_s316(s26, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Push1(s29, 0x84);
      var s31 := Add(s30);
      assert s31.Peek(5) == 0x44a;
      assert s31.Peek(10) == 0x162;
      var s32 := Push2(s31, 0x03b8);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s317(s33, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s33 := Lt(s32);
      var s34 := IsZero(s33);
      var s35 := Push2(s34, 0x04cf);
      var s36 := JumpI(s35);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s35.stack[1] > 0 then
        ExecuteFromCFGNode_s333(s36, gas - 1)
      else
        ExecuteFromCFGNode_s332(s36, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s3 := Dup6(s2);
      var s4 := Caller(s3);
      var s5 := Push2(s4, 0x04de);
      var s6 := Dup7(s5);
      var s7 := Dup6(s6);
      var s8 := Push2(s7, 0x0f3a);
      var s9 := Jump(s8);
      //  JUMP to the target at Peek(0)
