...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0ceb);
      assert s1.Peek(0) == 0xceb;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push0(s1);
      var s3 := Push2(s2, 0x0cf9);
      var s4 := Dup6(s3);
      var s5 := Dup3(s4);
      var s6 := Dup7(s5);
      var s7 := Add(s6);
      var s8 := Push2(s7, 0x0b47);
      var s9 := Jump(s8);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s19(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0xb3a

    requires s0.stack[3] == 0xb55
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s20(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[6] == 0xb55

    requires s0.stack[10] == 0xcf9
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(6) == 0xb55;
      assert s1.Peek(10) == 0xcf9;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s21(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[5] == 0xb55

    requires s0.stack[9] == 0xcf9
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(5) == 0xb55;
      assert s1.Peek(9) == 0xcf9;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Push2(s5, 0x0d0a);
      var s7 := Dup6(s6);
      var s8 := Dup3(s7);
      var s9 := Dup7(s8);
      var s10 := Add(s9);
      var s11 := Push2(s10, 0x0b47);
      assert s11.Peek(0) == 0xb47;
      assert s11.Peek(3) == 0xd0a;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Swap1(s5);
      var s7 := Pop(s6);
      var s8 := Push2(s7, 0x0c21);
      var s9 := Push0(s8);
      var s10 := Dup4(s9);
      var s11 := Add(s10);
      assert s11.Peek(1) == 0xc21;
      assert s11.Peek(5) == 0x26a;
      var s12 := Dup5(s11);
      var s13 := Push2(s12, 0x0bff);
      var s14 := Jump(s13);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push2(s1, 0x0c08);
      var s3 := Dup2(s2);
      var s4 := Push2(s3, 0x0b5b);
      var s5 := Jump(s4);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s43(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0xc08

    requires s0.stack[4] == 0xc21
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0xc08;
      assert s1.Peek(4) == 0xc21;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0ba3);
      assert s1.Peek(0) == 0xba3;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s4 := Pop(s3);
      var s5 := Push1(s4, 0x20);
      var s6 := Push2(s5, 0x0bc2);
      var s7 := Dup6(s6);
      var s8 := Dup3(s7);
      var s9 := Dup7(s8);
      var s10 := Add(s9);
      var s11 := Push2(s10, 0x0b7a);
      assert s11.Peek(0) == 0xb7a;
      assert s11.Peek(3) == 0xbc2;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s5 := Swap1(s4);
      var s6 := Pop(s5);
      var s7 := Push2(s6, 0x0b88);
      var s8 := Dup2(s7);
      var s9 := Push2(s8, 0x0b64);
      var s10 := Jump(s9);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s63(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0xb88

    requires s0.stack[5] == 0xbc2
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0xb88;
      assert s1.Peek(5) == 0xbc2;
      assert s1.Peek(11) == 0x228;
      assert s1.Peek(12) == 0x22d;
      var s2 := Push2(s1, 0x0b6d);
      var s3 := Dup2(s2);
      var s4 := Push2(s3, 0x0b5b);
      var s5 := Jump(s4);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s64(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0xb6d

    requires s0.stack[3] == 0xb88

    requires s0.stack[7] == 0xbc2
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0xb6d;
      assert s1.Peek(3) == 0xb88;
      assert s1.Peek(7) == 0xbc2;
      assert s1.Peek(13) == 0x228;
      assert s1.Peek(14) == 0x22d;
      var s2 := Push0(s1);
      var s3 := Dup2(s2);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s65(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0xb88

    requires s0.stack[6] == 0xbc2
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0xb88;
      assert s1.Peek(6) == 0xbc2;
      assert s1.Peek(12) == 0x228;
      assert s1.Peek(13) == 0x22d;
      var s2 := Dup2(s1);
      var s3 := Eq(s2);
      var s4 := Push2(s3, 0x0b77);
      var s5 := JumpI(s4);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s4.stack[1] > 0 then
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s76(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0x842

    requires s0.stack[5] == 0x4fb
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x842;
      assert s1.Peek(5) == 0x4fb;
      assert s1.Peek(10) == 0x22d;
      var s2 := Push0(s1);
      var s3 := Push1(s2, 0x20);
      var s4 := Dup3(s3);
      ...
      var s10 := Sub(s9);
      var s11 := Push0(s10);
      assert s11.Peek(4) == 0x842;
      assert s11.Peek(8) == 0x4fb;
      assert s11.Peek(13) == 0x22d;
      var s12 := Dup4(s11);
      var s13 := Add(s12);
      var s14 := MStore(s13);
      var s15 := Push2(s14, 0x106a);
      var s16 := Dup2(s15);
      var s17 := Push2(s16, 0x1031);
      var s18 := Jump(s17);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s77(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0x106a

    requires s0.stack[4] == 0x842

    requires s0.stack[8] == 0x4fb
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x106a;
      assert s1.Peek(4) == 0x842;
      assert s1.Peek(8) == 0x4fb;
      assert s1.Peek(13) == 0x22d;
      var s2 := Push0(s1);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s78(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[5] == 0x106a

    requires s0.stack[8] == 0x842

    requires s0.stack[12] == 0x4fb
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(5) == 0x106a;
      assert s1.Peek(8) == 0x842;
      assert s1.Peek(12) == 0x4fb;
      assert s1.Peek(17) == 0x22d;
      var s2 := Push0(s1);
      var s3 := Dup3(s2);
      var s4 := Dup3(s3);
      ...
      assert s11.Peek(6) == 0x106a;
      assert s11.Peek(9) == 0x842;
      assert s11.Peek(13) == 0x4fb;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s79(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0x106a

    requires s0.stack[6] == 0x842
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0x106a;
      assert s1.Peek(6) == 0x842;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s80(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[4] == 0x106a

    requires s0.stack[7] == 0x842

    requires s0.stack[11] == 0x4fb
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(4) == 0x106a;
      assert s1.Peek(7) == 0x842;
      assert s1.Peek(11) == 0x4fb;
      assert s1.Peek(16) == 0x22d;
      ...
      var s10 := Add(s9);
      var s11 := MStore(s10);
      assert s11.Peek(1) == 0x1048;
      assert s11.Peek(4) == 0x106a;
      assert s11.Peek(7) == 0x842;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s81(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x106a

    requires s0.stack[5] == 0x842
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x106a;
      assert s1.Peek(5) == 0x842;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s82(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0x842

    requires s0.stack[7] == 0x4fb
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0x842;
      assert s1.Peek(7) == 0x4fb;
      assert s1.Peek(12) == 0x22d;
      var s2 := Swap1(s1);
      var s3 := Pop(s2);
      var s4 := Swap2(s3);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Push1(s5, 0x04);
      var s7 := Add(s6);
      var s8 := Push2(s7, 0x08b0);
      var s9 := Swap1(s8);
      var s10 := Push2(s9, 0x10e1);
      var s11 := Jump(s10);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Sub(s9);
      var s11 := Push0(s10);
      assert s11.Peek(4) == 0x8b0;
      assert s11.Peek(8) == 0x4fb;
      assert s11.Peek(13) == 0x22d;
      var s12 := Dup4(s11);
      var s13 := Add(s12);
      var s14 := MStore(s13);
      var s15 := Push2(s14, 0x10f8);
      var s16 := Dup2(s15);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Pop(s9);
      var s11 := Swap3(s10);
      assert s11.Peek(0) == 0x10cb;
      assert s11.Peek(6) == 0x10f8;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Add(s9);
      var s11 := MStore(s10);
      assert s11.Peek(1) == 0x10d6;
      assert s11.Peek(4) == 0x10f8;
      assert s11.Peek(7) == 0x8b0;
      assert s11.Peek(11) == 0x4fb;
      assert s11.Peek(16) == 0x22d;
      var s12 := Pop(s11);
      var s13 := Jump(s12);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Keccak256(s19);
      var s21 := SLoad(s20);
      assert s21.Peek(5) == 0x4fb;
      assert s21.Peek(10) == 0x22d;
      var s22 := Swap1(s21);
      var s23 := Pop(s22);
      var s24 := Dup2(s23);
      var s25 := Dup2(s24);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Sub(s9);
      var s11 := Push0(s10);
      assert s11.Peek(4) == 0x93e;
      assert s11.Peek(9) == 0x4fb;
      assert s11.Peek(14) == 0x22d;
      var s12 := Dup4(s11);
      var s13 := Add(s12);
      var s14 := MStore(s13);
      var s15 := Push2(s14, 0x1186);
      var s16 := Dup2(s15);
      var s17 := Push2(s16, 0x114d);
      var s18 := Jump(s17);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s100(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x1159

    requires s0.stack[5] == 0x1186

    requires s0.stack[8] == 0x93e

    requires s0.stack[13] == 0x4fb
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x1159;
      assert s1.Peek(5) == 0x1186;
      assert s1.Peek(8) == 0x93e;
      assert s1.Peek(13) == 0x4fb;
      ...
      var s10 := Pop(s9);
      var s11 := Swap3(s10);
      assert s11.Peek(0) == 0x1159;
      assert s11.Peek(6) == 0x1186;
      assert s11.Peek(9) == 0x93e;
      assert s11.Peek(14) == 0x4fb;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s101(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0x1186

    requires s0.stack[6] == 0x93e
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0x1186;
      assert s1.Peek(6) == 0x93e;
      assert s1.Peek(11) == 0x4fb;
      assert s1.Peek(16) == 0x22d;
      var s2 := Swap2(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x1164);
      var s5 := Dup3(s4);
      var s6 := Push2(s5, 0x10ff);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s102(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0x1164

    requires s0.stack[4] == 0x1186
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x1164;
      assert s1.Peek(4) == 0x1186;
      ...
      var s10 := Add(s9);
      var s11 := MStore(s10);
      assert s11.Peek(1) == 0x1164;
      assert s11.Peek(4) == 0x1186;
      assert s11.Peek(7) == 0x93e;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Add(s19);
      var s21 := Push0(s20);
      assert s21.Peek(7) == 0x4fb;
      assert s21.Peek(12) == 0x22d;
      ...
      assert s31.Peek(9) == 0x4fb;
      assert s31.Peek(14) == 0x22d;
      var s32 := And(s31);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s26 := MLoad(s25);
      var s27 := Push2(s26, 0x0a30);
      var s28 := Swap2(s27);
      var s29 := Swap1(s28);
      var s30 := Push2(s29, 0x0c0e);
      var s31 := Jump(s30);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push2(s1, 0x0be0);
      var s3 := Dup2(s2);
      var s4 := Push2(s3, 0x0bcc);
      var s5 := Jump(s4);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Push1(s5, 0x04);
      var s7 := Add(s6);
      var s8 := Push2(s7, 0x04c2);
      var s9 := Swap1(s8);
      var s10 := Push2(s9, 0x0e41);
      var s11 := Jump(s10);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Sub(s9);
      var s11 := Push0(s10);
      assert s11.Peek(4) == 0x4c2;
      assert s11.Peek(10) == 0x1fd;
      var s12 := Dup4(s11);
      var s13 := Add(s12);
      var s14 := MStore(s13);
      var s15 := Push2(s14, 0x0e58);
      var s16 := Dup2(s15);
      var s17 := Push2(s16, 0x0e1f);
      var s18 := Jump(s17);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s157(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0xe2b

    requires s0.stack[5] == 0xe58

    requires s0.stack[8] == 0x4c2
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0xe2b;
      assert s1.Peek(5) == 0xe58;
      assert s1.Peek(8) == 0x4c2;
      assert s1.Peek(14) == 0x1fd;
      var s2 := Push0(s1);
      var s3 := Dup3(s2);
      var s4 := Dup3(s3);
      ...
      assert s11.Peek(6) == 0xe58;
      assert s11.Peek(9) == 0x4c2;
      assert s11.Peek(15) == 0x1fd;
      var s12 := Swap2(s11);
      var s13 := Pop(s12);
      var s14 := Pop(s13);
      var s15 := Jump(s14);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(6) == 0x4c2;
      assert s1.Peek(12) == 0x1fd;
      var s2 := Swap2(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x0e36);
      var s5 := Dup3(s4);
      var s6 := Push2(s5, 0x0dd1);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s159(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0xe36

    requires s0.stack[4] == 0xe58

    requires s0.stack[7] == 0x4c2
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0xe36;
      assert s1.Peek(4) == 0xe58;
      assert s1.Peek(7) == 0x4c2;
      assert s1.Peek(13) == 0x1fd;
      ...
      var s10 := Add(s9);
      var s11 := MStore(s10);
      assert s11.Peek(1) == 0xe36;
      assert s11.Peek(4) == 0xe58;
      assert s11.Peek(7) == 0x4c2;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(5) == 0x1fd;
      var s2 := Push2(s1, 0x04d8);
      var s3 := Dup3(s2);
      var s4 := Dup7(s3);
      var s5 := Dup7(s4);
      var s6 := Dup5(s5);
      var s7 := Sub(s6);
      var s8 := Push2(s7, 0x058f);
      var s9 := Jump(s8);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Push1(s5, 0x04);
      var s7 := Add(s6);
      var s8 := Push2(s7, 0x05f4);
      var s9 := Swap1(s8);
      var s10 := Push2(s9, 0x0ecf);
      var s11 := Jump(s10);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(8) == 0x4d8;
      assert s11.Peek(14) == 0x1fd;
      var s12 := Dup4(s11);
      var s13 := Add(s12);
      var s14 := MStore(s13);
      var s15 := Push2(s14, 0x0ee6);
      var s16 := Dup2(s15);
      var s17 := Push2(s16, 0x0ead);
      var s18 := Jump(s17);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s168(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[5] == 0xee6

    requires s0.stack[8] == 0x5f4

    requires s0.stack[12] == 0x4d8
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(5) == 0xee6;
      assert s1.Peek(8) == 0x5f4;
      assert s1.Peek(12) == 0x4d8;
      ...
      var s10 := Pop(s9);
      var s11 := Swap3(s10);
      assert s11.Peek(0) == 0xeb9;
      assert s11.Peek(6) == 0xee6;
      assert s11.Peek(9) == 0x5f4;
      assert s11.Peek(13) == 0x4d8;
      assert s11.Peek(19) == 0x1fd;
      var s12 := Swap2(s11);
      var s13 := Pop(s12);
      var s14 := Pop(s13);
      var s15 := Jump(s14);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s169(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[6] == 0x5f4

    requires s0.stack[10] == 0x4d8
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(6) == 0x5f4;
      assert s1.Peek(10) == 0x4d8;
      assert s1.Peek(16) == 0x1fd;
      var s2 := Swap2(s1);
      var s3 := Pop(s2);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s170(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[7] == 0x5f4

    requires s0.stack[11] == 0x4d8
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(7) == 0x5f4;
      assert s1.Peek(11) == 0x4d8;
      assert s1.Peek(17) == 0x1fd;
      ...
      var s10 := Add(s9);
      var s11 := MStore(s10);
      assert s11.Peek(1) == 0xec4;
      assert s11.Peek(4) == 0xee6;
      assert s11.Peek(7) == 0x5f4;
      assert s11.Peek(11) == 0x4d8;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s171(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0xee6

    requires s0.stack[5] == 0x5f4

    requires s0.stack[9] == 0x4d8
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0xee6;
      assert s1.Peek(5) == 0x5f4;
      assert s1.Peek(9) == 0x4d8;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s178(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0xf47

    requires s0.stack[5] == 0xf74

    requires s0.stack[8] == 0x662
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Pop(s9);
      var s11 := Swap3(s10);
      assert s11.Peek(0) == 0xf47;
      assert s11.Peek(6) == 0xf74;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Swap2(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x0f52);
      var s5 := Dup3(s4);
      var s6 := Push2(s5, 0x0eed);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Keccak256(s19);
      var s21 := Push0(s20);
      assert s21.Peek(6) == 0x4d8;
      assert s21.Peek(12) == 0x1fd;
      var s22 := Dup5(s21);
      var s23 := Push20(s22, 0xffffffffffffffffffffffffffffffffffffffff);
      var s24 := And(s23);
      var s25 := Push20(s24, 0xffffffffffffffffffffffffffffffffffffffff);
      ...
      var s30 := Add(s29);
      var s31 := Swap1(s30);
      assert s31.Peek(6) == 0x4d8;
      assert s31.Peek(12) == 0x1fd;
      var s32 := Dup2(s31);
      var s33 := MStore(s32);
      var s34 := Push1(s33, 0x20);
      var s35 := Add(s34);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := MLoad(s9);
      var s11 := Push2(s10, 0x0745);
      assert s11.Peek(0) == 0x745;
      assert s11.Peek(9) == 0x4d8;
      assert s11.Peek(15) == 0x1fd;
      var s12 := Swap2(s11);
      var s13 := Swap1(s12);
      var s14 := Push2(s13, 0x0c0e);
      var s15 := Jump(s14);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Add(s10);
      assert s11.Peek(1) == 0xc21;
      assert s11.Peek(5) == 0x745;
      assert s11.Peek(12) == 0x4d8;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s187(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[6] == 0x745

    requires s0.stack[13] == 0x4d8
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0xc21;
      assert s1.Peek(6) == 0x745;
      assert s1.Peek(13) == 0x4d8;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s188(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[8] == 0x745

    requires s0.stack[15] == 0x4d8

    requires s0.stack[21] == 0x1fd
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(1) == 0xc08;
      assert s1.Peek(4) == 0xc21;
      assert s1.Peek(8) == 0x745;
      assert s1.Peek(15) == 0x4d8;
      assert s1.Peek(21) == 0x1fd;
      var s2 := Push0(s1);
      var s3 := Dup2(s2);
      var s4 := Swap1(s3);
      var s5 := Pop(s4);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s189(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[7] == 0x745

    requires s0.stack[14] == 0x4d8
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0xc21;
      assert s1.Peek(7) == 0x745;
      assert s1.Peek(14) == 0x4d8;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup1(s10);
      assert s11.Peek(4) == 0x3ee;
      assert s11.Peek(7) == 0x1cd;
      var s12 := Push2(s11, 0x0d58);
      var s13 := JumpI(s12);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0d6a);
      assert s1.Peek(0) == 0xd6a;
      assert s1.Peek(4) == 0x3ee;
      assert s1.Peek(7) == 0x1cd;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s29 := Dup1(s28);
      var s30 := SLoad(s29);
      var s31 := Push2(s30, 0x041a);
      assert s31.Peek(0) == 0x41a;
      assert s31.Peek(8) == 0x1cd;
      var s32 := Swap1(s31);
      var s33 := Push2(s32, 0x0d41);
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s13 := Add(s12);
      var s14 := MStore(s13);
      var s15 := Push2(s14, 0x0af5);
      var s16 := Dup2(s15);
      var s17 := Dup5(s16);
      var s18 := Push2(s17, 0x0aa5);
      var s19 := Jump(s18);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push0(s1);
      var s3 := Push2(s2, 0x0aaf);
      var s4 := Dup3(s3);
      var s5 := Push2(s4, 0x0a53);
      var s6 := Jump(s5);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Pop(s9);
      var s11 := Swap3(s10);
      assert s11.Peek(0) == 0xab9;
      assert s11.Peek(8) == 0xaf5;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Swap4(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x0ac9);
      var s5 := Dup2(s4);
      var s6 := Dup6(s5);
      var s7 := Push1(s6, 0x20);
      var s8 := Dup7(s7);
      var s9 := Add(s8);
      var s10 := Push2(s9, 0x0a6d);
      var s11 := Jump(s10);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s226(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0xac9

    requires s0.stack[8] == 0xaf5
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s227(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[4] == 0xac9

    requires s0.stack[9] == 0xaf5
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(4) == 0xac9;
      assert s1.Peek(9) == 0xaf5;
      assert s1.Peek(13) == 0x1da;
      var s2 := Dup4(s1);
      var s3 := Dup2(s2);
      var s4 := Lt(s3);
      var s5 := IsZero(s4);
      var s6 := Push2(s5, 0x0a8a);
      var s7 := JumpI(s6);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s6.stack[1] > 0 then
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Dup1(s0);
      assert s1.Peek(5) == 0xac9;
      assert s1.Peek(10) == 0xaf5;
      ...
      var s10 := Dup2(s9);
      var s11 := Add(s10);
      assert s11.Peek(5) == 0xac9;
      assert s11.Peek(10) == 0xaf5;
      assert s11.Peek(14) == 0x1da;
      var s12 := Swap1(s11);
      var s13 := Pop(s12);
      var s14 := Push2(s13, 0x0a6f);
      var s15 := Jump(s14);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(4) == 0xaf5;
      assert s1.Peek(8) == 0x1da;
      var s2 := Push2(s1, 0x0ad2);
      var s3 := Dup2(s2);
      var s4 := Push2(s3, 0x0a95);
      var s5 := Jump(s4);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Pop(s9);
      var s11 := Swap2(s10);
      assert s11.Peek(0) == 0xad2;
      assert s11.Peek(7) == 0xaf5;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Dup6(s5);
      var s7 := Dup6(s6);
      var s8 := Push2(s7, 0x0380);
      var s9 := Dup6(s8);
      var s10 := Dup10(s9);
      var s11 := Push2(s10, 0x0506);
      assert s11.Peek(0) == 0x506;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Dup2(s9);
      var s11 := MStore(s10);
      assert s11.Peek(5) == 0x380;
      assert s11.Peek(9) == 0x38f;
      ...
      var s30 := Add(s29);
      var s31 := Swap1(s30);
      assert s31.Peek(5) == 0x380;
      assert s31.Peek(9) == 0x38f;
      assert s31.Peek(14) == 0x17f;
      var s32 := Dup2(s31);
      var s33 := MStore(s32);
      var s34 := Push1(s33, 0x20);
      var s35 := Add(s34);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(10) == 0x17f;
      var s2 := Push0(s1);
      var s3 := Push2(s2, 0x0da8);
      var s4 := Dup3(s3);
      var s5 := Push2(s4, 0x0b5b);
      var s6 := Jump(s5);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s293(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0xda8

    requires s0.stack[5] == 0x38a
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0xda8;
      assert s1.Peek(5) == 0x38a;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(4) == 0x38a;
      assert s1.Peek(7) == 0x38f;
      assert s1.Peek(12) == 0x17f;
      var s2 := Swap2(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x0db3);
      var s5 := Dup4(s4);
      var s6 := Push2(s5, 0x0b5b);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Dup3(s9);
      var s11 := Gt(s10);
      assert s11.Peek(4) == 0x38a;
      assert s11.Peek(7) == 0x38f;
      assert s11.Peek(12) == 0x17f;
      var s12 := IsZero(s11);
      var s13 := Push2(s12, 0x0dcb);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0dca);
      assert s1.Peek(0) == 0xdca;
      assert s1.Peek(4) == 0x38a;
      assert s1.Peek(7) == 0x38f;
      assert s1.Peek(12) == 0x17f;
      var s2 := Push2(s1, 0x0d71);
      var s3 := Jump(s2);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s325(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[15] == 0x38f

    requires s0.stack[20] == 0x17f
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Swap1(s5);
      var s7 := Pop(s6);
      var s8 := Push2(s7, 0x0ca5);
      var s9 := Push0(s8);
      var s10 := Dup4(s9);
      var s11 := Add(s10);
      assert s11.Peek(1) == 0xca5;
      assert s11.Peek(5) == 0x15c;
      var s12 := Dup5(s11);
      var s13 := Push2(s12, 0x0c83);
      var s14 := Jump(s13);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0xca5;
      assert s1.Peek(6) == 0x15c;
      var s2 := Push2(s1, 0x0c8c);
      var s3 := Dup2(s2);
      var s4 := Push2(s3, 0x0c77);
      var s5 := Jump(s4);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s347(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0xc8c

    requires s0.stack[4] == 0xca5
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0xc8c;
      assert s1.Peek(4) == 0xca5;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x0c3e);
      assert s11.Peek(0) == 0xc3e;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0c3d);
      assert s1.Peek(0) == 0xc3d;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Swap1(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x0345);
      var s5 := Dup6(s4);
      var s6 := Dup3(s5);
      var s7 := Dup6(s6);
      var s8 := Push2(s7, 0x0752);
      var s9 := Jump(s8);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0x345;
      assert s1.Peek(9) == 0x131;
      var s2 := Push0(s1);
      var s3 := Push2(s2, 0x075d);
      var s4 := Dup5(s3);
      var s5 := Dup5(s4);
      var s6 := Push2(s5, 0x0506);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Dup2(s9);
      var s11 := MStore(s10);
      assert s11.Peek(5) == 0x75d;
      assert s11.Peek(10) == 0x345;
      ...
      var s20 := Keccak256(s19);
      var s21 := Push0(s20);
      assert s21.Peek(5) == 0x75d;
      assert s21.Peek(10) == 0x345;
      assert s21.Peek(16) == 0x131;
      var s22 := Dup4(s21);
      var s23 := Push20(s22, 0xffffffffffffffffffffffffffffffffffffffff);
      var s24 := And(s23);
      var s25 := Push20(s24, 0xffffffffffffffffffffffffffffffffffffffff);
      ...
      var s30 := Add(s29);
      var s31 := Swap1(s30);
      assert s31.Peek(5) == 0x75d;
      assert s31.Peek(10) == 0x345;
      assert s31.Peek(16) == 0x131;
      var s32 := Dup2(s31);
      var s33 := MStore(s32);
      var s34 := Push1(s33, 0x20);
      var s35 := Add(s34);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s390(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[0] == 0x75d

    requires s0.stack[8] == 0x345
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(9) == 0x345;
      assert s11.Peek(15) == 0x131;
      var s12 := Dup4(s11);
      var s13 := Add(s12);
      var s14 := MStore(s13);
      var s15 := Push2(s14, 0x0fdc);
      var s16 := Dup2(s15);
      var s17 := Push2(s16, 0x0fa3);
      var s18 := Jump(s17);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(4) == 0x7c0;
      assert s1.Peek(9) == 0x345;
      assert s1.Peek(15) == 0x131;
      var s2 := Push0(s1);
      var s3 := Push2(s2, 0x0faf);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s396(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[5] == 0xfdc

    requires s0.stack[8] == 0x7c0

    requires s0.stack[13] == 0x345
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(5) == 0xfdc;
      assert s1.Peek(8) == 0x7c0;
      assert s1.Peek(13) == 0x345;
      ...
      var s10 := Pop(s9);
      var s11 := Swap3(s10);
      assert s11.Peek(0) == 0xfaf;
      assert s11.Peek(6) == 0xfdc;
      assert s11.Peek(9) == 0x7c0;
      assert s11.Peek(14) == 0x345;
      assert s11.Peek(20) == 0x131;
      var s12 := Swap2(s11);
      var s13 := Pop(s12);
      var s14 := Pop(s13);
      var s15 := Jump(s14);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s397(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0xfdc

    requires s0.stack[6] == 0x7c0

    requires s0.stack[11] == 0x345
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(6) == 0x7c0;
      assert s1.Peek(11) == 0x345;
      assert s1.Peek(17) == 0x131;
      var s2 := Swap2(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x0fba);
      var s5 := Dup3(s4);
      var s6 := Push2(s5, 0x0f7b);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s398(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[4] == 0xfdc

    requires s0.stack[7] == 0x7c0

    requires s0.stack[12] == 0x345
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(4) == 0xfdc;
      assert s1.Peek(7) == 0x7c0;
      assert s1.Peek(12) == 0x345;
      assert s1.Peek(18) == 0x131;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s399(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[5] == 0x7c0

    requires s0.stack[10] == 0x345
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(5) == 0x7c0;
      assert s1.Peek(10) == 0x345;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Push0(s10);
      assert s11.Peek(4) == 0x5f4;
      assert s11.Peek(8) == 0x7d6;
      assert s11.Peek(13) == 0x345;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s407(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[12] == 0x7d6

    requires s0.stack[17] == 0x345

    requires s0.stack[23] == 0x131
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(5) == 0xee6;
      assert s1.Peek(8) == 0x5f4;
      assert s1.Peek(12) == 0x7d6;
      assert s1.Peek(17) == 0x345;
      assert s1.Peek(23) == 0x131;
      var s2 := Push0(s1);
      var s3 := Dup3(s2);
      var s4 := Dup3(s3);
      var s5 := MStore(s4);
      ...
      assert s11.Peek(6) == 0xee6;
      assert s11.Peek(9) == 0x5f4;
      assert s11.Peek(13) == 0x7d6;
      assert s11.Peek(18) == 0x345;
      assert s11.Peek(24) == 0x131;
      var s12 := Swap2(s11);
      var s13 := Pop(s12);
      var s14 := Pop(s13);
      var s15 := Jump(s14);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s408(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[10] == 0x7d6

    requires s0.stack[15] == 0x345
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(3) == 0xee6;
      assert s1.Peek(6) == 0x5f4;
      assert s1.Peek(10) == 0x7d6;
      assert s1.Peek(15) == 0x345;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s409(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[11] == 0x7d6

    requires s0.stack[16] == 0x345

    requires s0.stack[22] == 0x131
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(4) == 0xee6;
      assert s1.Peek(7) == 0x5f4;
      assert s1.Peek(11) == 0x7d6;
      assert s1.Peek(16) == 0x345;
      assert s1.Peek(22) == 0x131;
      var s2 := Push32(s1, 0x45524332303a20617070726f76652066726f6d20746865207a65726f20616464);
      var s3 := Push0(s2);
      var s4 := Dup3(s3);
      var s5 := Add(s4);
      ...
      assert s11.Peek(4) == 0xee6;
      assert s11.Peek(7) == 0x5f4;
      assert s11.Peek(11) == 0x7d6;
      assert s11.Peek(16) == 0x345;
      assert s11.Peek(22) == 0x131;
      var s12 := Pop(s11);
      var s13 := Jump(s12);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s410(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[9] == 0x7d6

    requires s0.stack[14] == 0x345
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(2) == 0xee6;
      assert s1.Peek(5) == 0x5f4;
      assert s1.Peek(9) == 0x7d6;
      assert s1.Peek(14) == 0x345;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Keccak256(s19);
      var s21 := Push0(s20);
      assert s21.Peek(6) == 0x7d6;
      assert s21.Peek(11) == 0x345;
      assert s21.Peek(17) == 0x131;
      var s22 := Dup5(s21);
      var s23 := Push20(s22, 0xffffffffffffffffffffffffffffffffffffffff);
      var s24 := And(s23);
      var s25 := Push20(s24, 0xffffffffffffffffffffffffffffffffffffffff);
      ...
      var s30 := Add(s29);
      var s31 := Swap1(s30);
      assert s31.Peek(6) == 0x7d6;
      assert s31.Peek(11) == 0x345;
      assert s31.Peek(17) == 0x131;
      var s32 := Dup2(s31);
      var s33 := MStore(s32);
      var s34 := Push1(s33, 0x20);
      var s35 := Add(s34);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(1) == 0xc21;
      assert s11.Peek(5) == 0x745;
      assert s11.Peek(12) == 0x7d6;
      assert s11.Peek(17) == 0x345;
      assert s11.Peek(23) == 0x131;
      var s12 := Dup5(s11);
      var s13 := Push2(s12, 0x0bff);
      var s14 := Jump(s13);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s426(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[13] == 0x7d6

    requires s0.stack[18] == 0x345

    requires s0.stack[24] == 0x131
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(2) == 0xc21;
      assert s1.Peek(6) == 0x745;
      assert s1.Peek(13) == 0x7d6;
      assert s1.Peek(18) == 0x345;
      assert s1.Peek(24) == 0x131;
      var s2 := Push2(s1, 0x0c08);
      var s3 := Dup2(s2);
      var s4 := Push2(s3, 0x0b5b);
      var s5 := Jump(s4);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s427(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[15] == 0x7d6

    requires s0.stack[20] == 0x345

    requires s0.stack[26] == 0x131
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(4) == 0xc21;
      assert s1.Peek(8) == 0x745;
      assert s1.Peek(15) == 0x7d6;
      assert s1.Peek(20) == 0x345;
      assert s1.Peek(26) == 0x131;
      var s2 := Push0(s1);
      var s3 := Dup2(s2);
      var s4 := Swap1(s3);
      var s5 := Pop(s4);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s428(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[14] == 0x7d6

    requires s0.stack[19] == 0x345

    requires s0.stack[25] == 0x131
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(3) == 0xc21;
      assert s1.Peek(7) == 0x745;
      assert s1.Peek(14) == 0x7d6;
      assert s1.Peek(19) == 0x345;
      assert s1.Peek(25) == 0x131;
      var s2 := Dup3(s1);
      var s3 := MStore(s2);
      var s4 := Pop(s3);
      var s5 := Pop(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Pop(s9);
      var s11 := Pop(s10);
      assert s11.Peek(0) == 0x7d6;
      assert s11.Peek(5) == 0x345;
      assert s11.Peek(11) == 0x131;
      var s12 := Jump(s11);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Keccak256(s19);
      var s21 := SLoad(s20);
      assert s21.Peek(5) == 0x350;
      assert s21.Peek(11) == 0x131;
      var s22 := Swap1(s21);
      var s23 := Pop(s22);
      var s24 := Dup2(s23);
      var s25 := Dup2(s24);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Add(s19);
      var s21 := Push0(s20);
      assert s21.Peek(7) == 0x350;
      assert s21.Peek(13) == 0x131;
      var s22 := Keccak256(s21);
      var s23 := Dup2(s22);
      var s24 := Swap1(s23);
      var s25 := SStore(s24);
      ...
      var s30 := Dup6(s29);
      var s31 := Push20(s30, 0xffffffffffffffffffffffffffffffffffffffff);
      assert s31.Peek(9) == 0x350;
      assert s31.Peek(15) == 0x131;
      var s32 := And(s31);
      var s33 := Push20(s32, 0xffffffffffffffffffffffffffffffffffffffff);
      var s34 := And(s33);
      var s35 := Dup2(s34);
