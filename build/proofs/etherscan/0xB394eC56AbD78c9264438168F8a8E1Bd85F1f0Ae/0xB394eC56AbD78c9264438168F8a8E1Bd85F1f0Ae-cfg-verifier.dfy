...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push1(s1, 0x00);
      var s3 := Push32(s2, 0x0000000000000000000000006a65d46645bc7c1ae4c95f5f00968e48add009c3);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push32(s1, 0x00000000000000000000000000000000000000000000000000000000666d9b47);
      var s3 := TimeStamp(s2);
      var s4 := Gt(s3);
      var s5 := IsZero(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Push32(s10, 0x0000000000000000000000006a65d46645bc7c1ae4c95f5f00968e48add009c3);
      assert s11.Peek(3) == 0x1f3;
      var s12 := Push32(s11, 0x8d56f5149ab50c0f290a4942cc692ce72111d4e98473f8f7ead1d0c4e37a1724);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s27 := Push32(s26, 0x0000000000000000000000006a65d46645bc7c1ae4c95f5f00968e48add009c3);
      var s28 := Push32(s27, 0x8d56f5149ab50c0f290a4942cc692ce72111d4e98473f8f7ead1d0c4e37a1724);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push32(s1, 0x8d56f5149ab50c0f290a4942cc692ce72111d4e98473f8f7ead1d0c4e37a1724);
      var s3 := Dup2(s2);
      var s4 := Jump(s3);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push32(s1, 0x0000000000000000000000006a65d46645bc7c1ae4c95f5f00968e48add009c3);
      var s3 := Dup2(s2);
      var s4 := Jump(s3);
      //  JUMP to the target at Peek(0)
