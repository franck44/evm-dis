...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x9ad;
      assert s11.Peek(9) == 0x1d4;
      assert s11.Peek(10) == 0x122;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x0840);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x05f0);
      assert s1.Peek(0) == 0x5f0;
      assert s1.Peek(4) == 0x761;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(7) == 0x761;
      assert s11.Peek(11) == 0x29a;
      assert s11.Peek(15) == 0xf9;
      var s12 := Swap1(s11);
      var s13 := Push2(s12, 0x07df);
      var s14 := Jump(s13);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s32 := SLoad(s31);
      var s33 := Push2(s32, 0x078f);
      var s34 := Swap1(s33);
      var s35 := Dup3(s34);
      var s36 := Push2(s35, 0x061b);
      var s37 := Jump(s36);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push0(s1);
      var s3 := Push2(s2, 0x0626);
      var s4 := Dup3(s3);
      var s5 := Dup5(s4);
      var s6 := Push2(s5, 0x0a3c);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x0953);
      assert s11.Peek(0) == 0x953;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Add(s10);
      assert s11.Peek(3) == 0x46e;
      assert s11.Peek(6) == 0x473;
      assert s11.Peek(11) == 0xf9;
      var s12 := Push1(s11, 0x40);
      var s13 := MStore(s12);
      var s14 := Dup1(s13);
      ...
      var s19 := Add(s18);
      var s20 := Push2(s19, 0x0a76);
      var s21 := Push1(s20, 0x28);
      assert s21.Peek(5) == 0x46e;
      assert s21.Peek(8) == 0x473;
      assert s21.Peek(13) == 0xf9;
      var s22 := Swap2(s21);
      ...
      var s30 := And(s29);
      var s31 := Push0(s30);
      assert s31.Peek(4) == 0x46e;
      assert s31.Peek(7) == 0x473;
      assert s31.Peek(12) == 0xf9;
      var s32 := Swap1(s31);
      var s33 := Dup2(s32);
      var s34 := MStore(s33);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s147(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[6] == 0x46e

    requires s0.stack[9] == 0x473
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Dup4(s0);
      assert s1.Peek(7) == 0x46e;
      assert s1.Peek(10) == 0x473;
      assert s1.Peek(15) == 0xf9;
      var s2 := Keccak256(s1);
      var s3 := Caller(s2);
      var s4 := Dup5(s3);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s148(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0x46e

    requires s0.stack[6] == 0x473
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s149(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[5] == 0x46e

    requires s0.stack[8] == 0x473
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push1(s0, 0x40);
      assert s1.Peek(6) == 0x46e;
      assert s1.Peek(9) == 0x473;
      assert s1.Peek(14) == 0xf9;
      var s2 := MLoad(s1);
      var s3 := Push3(s2, 0x461bcd);
      var s4 := Push1(s3, 0xe5);
      ...
      var s11 := Swap2(s10);
      assert s11.Peek(2) == 0x2fa;
      assert s11.Peek(7) == 0x46e;
      assert s11.Peek(10) == 0x473;
      assert s11.Peek(15) == 0xf9;
      var s12 := Swap1(s11);
      var s13 := Push2(s12, 0x07df);
      var s14 := Jump(s13);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s150(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[7] == 0x46e

    requires s0.stack[10] == 0x473
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Dup6(s10);
      assert s11.Peek(8) == 0x2fa;
      assert s11.Peek(13) == 0x46e;
      assert s11.Peek(16) == 0x473;
      assert s11.Peek(21) == 0xf9;
      var s12 := Add(s11);
      var s13 := MStore(s12);
      var s14 := Push0(s13);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s151(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[11] == 0x46e

    requires s0.stack[14] == 0x473
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(6) == 0x2fa;
      assert s1.Peek(11) == 0x46e;
      assert s1.Peek(14) == 0x473;
      assert s1.Peek(19) == 0xf9;
      var s2 := Dup2(s1);
      var s3 := Dup2(s2);
      var s4 := Lt(s3);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Dup6(s0);
      assert s1.Peek(7) == 0x2fa;
      assert s1.Peek(12) == 0x46e;
      assert s1.Peek(15) == 0x473;
      assert s1.Peek(20) == 0xf9;
      var s2 := Dup2(s1);
      var s3 := Add(s2);
      var s4 := Dup4(s3);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Push1(s10, 0x1f);
      assert s11.Peek(7) == 0x2fa;
      assert s11.Peek(12) == 0x46e;
      assert s11.Peek(15) == 0x473;
      assert s11.Peek(20) == 0xf9;
      var s12 := Not(s11);
      var s13 := Push1(s12, 0x1f);
      var s14 := Dup4(s13);
      ...
      var s21 := Pop(s20);
      assert s21.Peek(5) == 0x2fa;
      assert s21.Peek(10) == 0x46e;
      assert s21.Peek(13) == 0x473;
      assert s21.Peek(18) == 0xf9;
      var s22 := Pop(s21);
      var s23 := Pop(s22);
      var s24 := Swap3(s23);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(5) == 0x46e;
      assert s1.Peek(8) == 0x473;
      assert s1.Peek(13) == 0xf9;
      var s2 := Push1(s1, 0x40);
      var s3 := MLoad(s2);
      var s4 := Dup1(s3);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x08ce);
      assert s1.Peek(0) == 0x8ce;
      assert s1.Peek(8) == 0x117;
      assert s1.Peek(9) == 0x11c;
      var s2 := Push2(s1, 0x086d);
      var s3 := Jump(s2);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0926);
      assert s1.Peek(0) == 0x926;
      assert s1.Peek(10) == 0x117;
      assert s1.Peek(11) == 0x11c;
      var s2 := Dup6(s1);
      var s3 := Push2(s2, 0x082a);
      var s4 := Jump(s3);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s29 := Swap1(s28);
      var s30 := Dup3(s29);
      var s31 := Push2(s30, 0x061b);
      assert s31.Peek(0) == 0x61b;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s12 := Swap1(s11);
      var s13 := Pop(s12);
      var s14 := Push2(s13, 0x040a);
      var s15 := Dup2(s14);
      var s16 := Push2(s15, 0x0a24);
      var s17 := Jump(s16);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x40a;
      assert s1.Peek(5) == 0x11c;
      var s2 := Push0(s1);
      var s3 := Push1(s2, 0x01);
      var s4 := Dup3(s3);
      var s5 := Add(s4);
      var s6 := Push2(s5, 0x0a35);
      var s7 := JumpI(s6);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s6.stack[1] > 0 then
