...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0604);
      assert s1.Peek(0) == 0x604;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x99e;
      assert s11.Peek(10) == 0x16f;
      assert s11.Peek(11) == 0xff;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x085d);
      var s14 := JumpI(s13);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push1(s0, 0x00);
      assert s1.Peek(3) == 0x99e;
      assert s1.Peek(9) == 0x16f;
      assert s1.Peek(10) == 0xff;
      var s2 := Dup1(s1);
      var s3 := Revert(s2);
      // Segment is terminal (Revert, Stop or Return)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s31 := Jump(s30);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s116(s31, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s37 := Jump(s36);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s130(s37, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s12 := Swap2(s11);
      var s13 := Swap1(s12);
      var s14 := Push2(s13, 0x0604);
      var s15 := Jump(s14);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s140(s15, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x090c);
      assert s1.Peek(0) == 0x90c;
      assert s1.Peek(8) == 0x11d;
      assert s1.Peek(9) == 0x122;
      var s2 := Push2(s1, 0x088c);
      var s3 := Jump(s2);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0931);
      assert s1.Peek(0) == 0x931;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0965);
      assert s1.Peek(0) == 0x965;
      assert s1.Peek(10) == 0x11d;
      assert s1.Peek(11) == 0x122;
      var s2 := Dup6(s1);
