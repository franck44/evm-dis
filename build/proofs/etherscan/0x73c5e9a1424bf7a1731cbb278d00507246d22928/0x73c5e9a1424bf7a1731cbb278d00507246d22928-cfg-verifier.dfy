...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s27 := Jump(s26);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s188(s27, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s34 := SLoad(s33);
      var s35 := Push2(s34, 0x05a1);
      var s36 := Swap2(s35);
      var s37 := Swap1(s36);
      var s38 := Push2(s37, 0x0fd4);
      var s39 := Jump(s38);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Dup3(s9);
      var s11 := Gt(s10);
      assert s11.Peek(4) == 0x5a1;
      assert s11.Peek(7) == 0x5a6;
      assert s11.Peek(11) == 0x1af;
      var s12 := IsZero(s11);
      var s13 := Push2(s12, 0x1001);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(13) == 0x5a6;
      assert s11.Peek(17) == 0x1af;
      var s12 := Swap2(s11);
      var s13 := Pop(s12);
      var s14 := Pop(s13);
      var s15 := Jump(s14);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s18 := Jump(s17);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s246(s18, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(12) == 0x5a6;
      assert s11.Peek(16) == 0x1af;
      var s12 := Dup5(s11);
      var s13 := Push2(s12, 0x0d19);
      var s14 := Jump(s13);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s257(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[15] == 0x5a6

    requires s0.stack[19] == 0x1af
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(15) == 0x5a6;
      assert s1.Peek(19) == 0x1af;
      var s2 := Push0(s1);
      var s3 := Dup2(s2);
      var s4 := Swap1(s3);
      var s5 := Pop(s4);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s258(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[14] == 0x5a6

    requires s0.stack[18] == 0x1af
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      if s0.stack[1] > 0 then
        ExecuteFromCFGNode_s320(s1, gas - 1)
      else
        ExecuteFromCFGNode_s311(s1, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(9) == 0x161;
      var s12 := Dup4(s11);
      var s13 := Add(s12);
      var s14 := MStore(s13);
      var s15 := Push2(s14, 0x0fa0);
      var s16 := Dup2(s15);
      var s17 := Push2(s16, 0x0f67);
      var s18 := Jump(s17);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(5) == 0xfa0;
      assert s1.Peek(8) == 0x4d9;
      assert s1.Peek(13) == 0x161;
      var s2 := Push0(s1);
      var s3 := Dup3(s2);
      var s4 := Dup3(s3);
      ...
      var s10 := Pop(s9);
      var s11 := Swap3(s10);
      assert s11.Peek(0) == 0xf73;
      assert s11.Peek(6) == 0xfa0;
      assert s11.Peek(9) == 0x4d9;
      assert s11.Peek(14) == 0x161;
      var s12 := Swap2(s11);
      var s13 := Pop(s12);
      var s14 := Pop(s13);
      var s15 := Jump(s14);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(6) == 0x4d9;
      assert s1.Peek(11) == 0x161;
      var s2 := Swap2(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x0f7e);
      var s5 := Dup3(s4);
      var s6 := Push2(s5, 0x0f19);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0xf7e;
      assert s1.Peek(4) == 0xfa0;
      assert s1.Peek(7) == 0x4d9;
      assert s1.Peek(12) == 0x161;
      ...
      var s10 := Add(s9);
      var s11 := MStore(s10);
      assert s11.Peek(1) == 0xf7e;
      assert s11.Peek(4) == 0xfa0;
      assert s11.Peek(7) == 0x4d9;
      assert s11.Peek(12) == 0x161;
      var s12 := Pop(s11);
      var s13 := Jump(s12);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Push0(s10);
      assert s11.Peek(4) == 0x790;
      assert s11.Peek(8) == 0x4f6;
      assert s11.Peek(13) == 0x161;
      var s12 := Dup4(s11);
      var s13 := Add(s12);
      var s14 := MStore(s13);
      var s15 := Push2(s14, 0x108e);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(6) == 0x108e;
      assert s11.Peek(9) == 0x790;
      assert s11.Peek(13) == 0x4f6;
      assert s11.Peek(18) == 0x161;
      var s12 := Swap2(s11);
      var s13 := Pop(s12);
      var s14 := Pop(s13);
      var s15 := Jump(s14);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(4) == 0x108e;
      assert s11.Peek(7) == 0x790;
      assert s11.Peek(11) == 0x4f6;
      assert s11.Peek(16) == 0x161;
      var s12 := Pop(s11);
      var s13 := Jump(s12);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Add(s29);
      var s31 := Swap1(s30);
      assert s31.Peek(6) == 0x4f6;
      assert s31.Peek(11) == 0x161;
      var s32 := Dup2(s31);
      var s33 := MStore(s32);
      var s34 := Push1(s33, 0x20);
      var s35 := Add(s34);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(2) == 0xd3b;
      assert s1.Peek(6) == 0x8e1;
      assert s1.Peek(13) == 0x4f6;
      assert s1.Peek(18) == 0x161;
      var s2 := Push2(s1, 0x0d22);
      var s3 := Dup2(s2);
      var s4 := Push2(s3, 0x0c75);
      var s5 := Jump(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(4) == 0xd3b;
      assert s1.Peek(8) == 0x8e1;
      assert s1.Peek(15) == 0x4f6;
      assert s1.Peek(20) == 0x161;
      var s2 := Push0(s1);
      var s3 := Dup2(s2);
      var s4 := Swap1(s3);
      var s5 := Pop(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(3) == 0xd3b;
      assert s1.Peek(7) == 0x8e1;
      assert s1.Peek(14) == 0x4f6;
      assert s1.Peek(19) == 0x161;
      var s2 := Dup3(s1);
      var s3 := MStore(s2);
      var s4 := Pop(s3);
      var s5 := Pop(s4);
