...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x05cb);
      assert s1.Peek(0) == 0x5cb;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(7) == 0x6fa;
      assert s11.Peek(11) == 0x2a5;
      assert s11.Peek(15) == 0xff;
      var s12 := Swap1(s11);
      var s13 := Push2(s12, 0x077a);
      var s14 := Jump(s13);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s31.Peek(8) == 0xff;
      var s32 := SLoad(s31);
      var s33 := Push2(s32, 0x0729);
      var s34 := Swap1(s33);
      var s35 := Dup3(s34);
      var s36 := Push2(s35, 0x0493);
      var s37 := Jump(s36);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x49f;
      assert s11.Peek(8) == 0x16c;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x08fe);
      assert s11.Peek(0) == 0x8fe;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push2(s1, 0x046d);
      var s3 := Dup5(s2);
      var s4 := Caller(s3);
      var s5 := Push2(s4, 0x0468);
      var s6 := Dup6(s5);
      ...
      var s19 := Add(s18);
      var s20 := Push2(s19, 0x0a2c);
      var s21 := Push1(s20, 0x28);
      assert s21.Peek(5) == 0x468;
      assert s21.Peek(8) == 0x46d;
      assert s21.Peek(13) == 0xff;
      var s22 := Swap2(s21);
      ...
      assert s31.Peek(4) == 0x468;
      assert s31.Peek(7) == 0x46d;
      assert s31.Peek(12) == 0xff;
      var s32 := Swap1(s31);
      var s33 := Dup2(s32);
      var s34 := MStore(s33);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0875);
      assert s1.Peek(0) == 0x875;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x089a);
      assert s1.Peek(0) == 0x89a;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Dup3(s19);
      var s21 := Swap1(s20);
      assert s21.Peek(2) == 0x381;
      assert s21.Peek(7) == 0x122;
      var s22 := Dup2(s21);
      var s23 := Swap1(s22);
      var s24 := Push2(s23, 0x05cb);
      var s25 := Jump(s24);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s27 := SLoad(s26);
      var s28 := Push2(s27, 0x03cb);
      var s29 := Swap1(s28);
      var s30 := Dup3(s29);
      var s31 := Push2(s30, 0x0493);
      assert s31.Peek(0) == 0x493;
      assert s31.Peek(3) == 0x3cb;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s12 := Swap1(s11);
      var s13 := Pop(s12);
      var s14 := Push2(s13, 0x0402);
      var s15 := Dup2(s14);
      var s16 := Push2(s15, 0x09d9);
      var s17 := Jump(s16);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x09eb);
      assert s1.Peek(0) == 0x9eb;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x24);
      var s11 := Push1(s10, 0x00);
      assert s11.Peek(2) == 0x9eb;
      assert s11.Peek(5) == 0x402;
      assert s11.Peek(9) == 0x122;
      var s12 := Revert(s11);
      // Segment is terminal (Revert, Stop or Return)
      s12
