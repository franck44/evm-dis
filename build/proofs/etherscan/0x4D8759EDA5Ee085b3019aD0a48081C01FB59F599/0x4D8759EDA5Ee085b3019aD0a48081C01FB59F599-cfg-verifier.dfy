...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      var s2 := Push2(s1, 0x019a);
      var s3 := Push2(s2, 0x0249);
      var s4 := CallDataSize(s3);
      var s5 := Push1(s4, 0x04);
      var s6 := Push2(s5, 0x0ae3);
      var s7 := Jump(s6);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(8) == 0x249;
      assert s11.Peek(9) == 0x19a;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x0a66);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(3) == 0x19a;
      var s12 := Push2(s11, 0x0359);
      var s13 := JumpI(s12);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s21 := Dup3(s20);
      assert s21.Peek(4) == 0x441;
      assert s21.Peek(6) == 0x19a;
      var s22 := Add(s21);
      var s23 := MStore(s22);
      var s24 := Push1(s23, 0x64);
      var s25 := Add(s24);
      var s26 := Push2(s25, 0x03ec);
      var s27 := Jump(s26);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s31 := Add(s30);
      assert s31.Peek(2) == 0x19a;
      var s32 := Push2(s31, 0x03ec);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Swap2(s29);
      var s31 := Swap1(s30);
      assert s31.Peek(4) == 0x345;
      assert s31.Peek(6) == 0x19a;
      var s32 := Dup3(s31);
      var s33 := Swap1(s32);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s3 := Push2(s2, 0x0223);
      var s4 := CallDataSize(s3);
      var s5 := Push1(s4, 0x04);
      var s6 := Push2(s5, 0x0a6b);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s51(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0xa85

    requires s0.stack[6] == 0x223
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0xa85;
      assert s1.Peek(6) == 0x223;
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0xa85;
      assert s11.Peek(9) == 0x223;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s52(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0xa85

    requires s0.stack[7] == 0x223
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push0(s0);
      assert s1.Peek(3) == 0xa85;
      assert s1.Peek(8) == 0x223;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0xa85;
      assert s1.Peek(7) == 0x223;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := SLoad(s19);
      var s21 := Dup2(s20);
      assert s21.Peek(5) == 0x2eb;
      assert s21.Peek(10) == 0x130;
      var s22 := Dup2(s21);
      var s23 := Lt(s22);
      var s24 := IsZero(s23);
      var s25 := Push2(s24, 0x0788);
      var s26 := JumpI(s25);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Push1(s29, 0x84);
      var s31 := Add(s30);
      assert s31.Peek(5) == 0x2eb;
      assert s31.Peek(10) == 0x130;
      var s32 := Push2(s31, 0x03ec);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s66(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0x7be

    requires s0.stack[9] == 0x2eb

    requires s0.stack[14] == 0x130
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(4) == 0x7be;
      assert s1.Peek(12) == 0x2eb;
      assert s1.Peek(17) == 0x130;
      var s2 := Push2(s1, 0x0b6c);
      var s3 := Jump(s2);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s69(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[4] == 0x7be

    requires s0.stack[12] == 0x2eb

    requires s0.stack[17] == 0x130
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(6) == 0x7be;
      assert s11.Peek(14) == 0x2eb;
      assert s11.Peek(19) == 0x130;
      var s12 := Revert(s11);
      // Segment is terminal (Revert, Stop or Return)
      s12
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s26 := MLoad(s25);
      var s27 := Push2(s26, 0x080a);
      var s28 := Swap2(s27);
      var s29 := Dup2(s28);
      var s30 := MStore(s29);
      var s31 := Push1(s30, 0x20);
      assert s31.Peek(2) == 0x80a;
      assert s31.Peek(10) == 0x2eb;
      assert s31.Peek(15) == 0x130;
      var s32 := Add(s31);
      var s33 := Swap1(s32);
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Add(s9);
      var s11 := Push2(s10, 0x0114);
      assert s11.Peek(0) == 0x114;
      var s12 := Jump(s11);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s31 := Add(s30);
      //  Go to the next instruction at pc + 1
      ExecuteFromCFGNode_s90(s31, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Dup1(s19);
      var s21 := Dup4(s20);
      assert s21.Peek(10) == 0x30f;
      assert s21.Peek(16) == 0x130;
      var s22 := Keccak256(s21);
      var s23 := Swap5(s22);
      var s24 := Dup8(s23);
      var s25 := And(s24);
      ...
      var s30 := Dup3(s29);
      var s31 := MStore(s30);
      assert s31.Peek(8) == 0x30f;
      assert s31.Peek(14) == 0x130;
      var s32 := Swap2(s31);
      var s33 := Dup3(s32);
      var s34 := Swap1(s33);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s29 := Dup1(s28);
      var s30 := SLoad(s29);
      var s31 := Push2(s30, 0x0289);
      assert s31.Peek(0) == 0x289;
      assert s31.Peek(8) == 0x107;
      var s32 := Swap1(s31);
      var s33 := Push2(s32, 0x0b34);
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(6) == 0x19a;
      var s2 := Push0(s1);
      var s3 := Push2(s2, 0x05de);
      var s4 := Dup5(s3);
      var s5 := Dup5(s4);
      var s6 := Push2(s5, 0x040f);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s143(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x5de

    requires s0.stack[7] == 0x366

    requires s0.stack[10] == 0x19a
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x5de;
      assert s1.Peek(7) == 0x366;
      assert s1.Peek(10) == 0x19a;
      var s2 := Push1(s1, 0x01);
      var s3 := Push1(s2, 0x01);
      var s4 := Push1(s3, 0xa0);
      var s5 := Shl(s4);
      ...
      var s10 := Push0(s9);
      var s11 := Swap1(s10);
      assert s11.Peek(4) == 0x5de;
      assert s11.Peek(9) == 0x366;
      assert s11.Peek(12) == 0x19a;
      var s12 := Dup2(s11);
      var s13 := MStore(s12);
      var s14 := Push1(s13, 0x01);
      var s15 := Push1(s14, 0x20);
      ...
      var s20 := Dup1(s19);
      var s21 := Dup4(s20);
      assert s21.Peek(7) == 0x5de;
      assert s21.Peek(12) == 0x366;
      assert s21.Peek(15) == 0x19a;
      var s22 := Keccak256(s21);
      var s23 := Swap4(s22);
      var s24 := Swap1(s23);
      var s25 := Swap5(s24);
      ...
      var s30 := Swap1(s29);
      var s31 := Swap2(s30);
      assert s31.Peek(4) == 0x5de;
      assert s31.Peek(9) == 0x366;
      assert s31.Peek(12) == 0x19a;
      var s32 := MStore(s31);
      var s33 := Keccak256(s32);
      var s34 := SLoad(s33);
      var s35 := Swap1(s34);
      var s36 := Jump(s35);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s144(s36, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s21.Peek(10) == 0x19a;
      var s22 := MStore(s21);
      var s23 := Push1(s22, 0x64);
      var s24 := Add(s23);
      var s25 := Push2(s24, 0x03ec);
      var s26 := Jump(s25);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s147(s26, gas - 1)
  }
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s149(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[8] == 0x366

    requires s0.stack[11] == 0x19a
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(8) == 0x366;
      assert s1.Peek(11) == 0x19a;
      var s2 := Push1(s1, 0x01);
      var s3 := Push1(s2, 0x01);
      var s4 := Push1(s3, 0xa0);
      var s5 := Shl(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(11) == 0x366;
      assert s11.Peek(14) == 0x19a;
      var s12 := MStore(s11);
      var s13 := Push1(s12, 0x24);
      var s14 := Dup1(s13);
      var s15 := Dup3(s14);
      ...
      var s20 := Dup3(s19);
      var s21 := Add(s20);
      assert s21.Peek(6) == 0x645;
      assert s21.Peek(11) == 0x366;
      assert s21.Peek(14) == 0x19a;
      var s22 := MStore(s21);
      var s23 := Push4(s22, 0x72657373);
      var s24 := Push1(s23, 0xe0);
      var s25 := Shl(s24);
      ...
      var s30 := Push1(s29, 0x84);
      var s31 := Add(s30);
      assert s31.Peek(4) == 0x645;
      assert s31.Peek(9) == 0x366;
      assert s31.Peek(12) == 0x19a;
      var s32 := Push2(s31, 0x03ec);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s151(s33, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(12) == 0x366;
      assert s11.Peek(15) == 0x19a;
      var s12 := Dup2(s11);
      var s13 := MStore(s12);
      var s14 := Push1(s13, 0x01);
      var s15 := Push1(s14, 0x20);
      ...
      var s20 := Dup1(s19);
      var s21 := Dup4(s20);
      assert s21.Peek(10) == 0x645;
      assert s21.Peek(15) == 0x366;
      assert s21.Peek(18) == 0x19a;
      var s22 := Keccak256(s21);
      var s23 := Swap5(s22);
      var s24 := Dup8(s23);
      var s25 := And(s24);
      ...
      var s30 := Dup3(s29);
      var s31 := MStore(s30);
      assert s31.Peek(8) == 0x645;
      assert s31.Peek(13) == 0x366;
      assert s31.Peek(16) == 0x19a;
      var s32 := Swap2(s31);
      var s33 := Dup3(s32);
      var s34 := Swap1(s33);
      var s35 := Keccak256(s34);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s155(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[8] == 0x645

    requires s0.stack[13] == 0x366

    requires s0.stack[16] == 0x19a
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Dup2(s0);
      assert s1.Peek(9) == 0x645;
      assert s1.Peek(14) == 0x366;
      assert s1.Peek(17) == 0x19a;
      var s2 := MStore(s1);
      var s3 := Push32(s2, 0x8c5be1e5ebec7d5bd14f71427d1e84f3dd0314c0f7b2291e5b200ac8c7c3b925);
      var s4 := Swap2(s3);
      var s5 := Add(s4);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s156(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[7] == 0x645

    requires s0.stack[12] == 0x366

    requires s0.stack[15] == 0x19a
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(7) == 0x645;
      assert s1.Peek(12) == 0x366;
      assert s1.Peek(15) == 0x19a;
      var s2 := Push1(s1, 0x40);
      var s3 := MLoad(s2);
      var s4 := Dup1(s3);
      var s5 := Swap2(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := SLoad(s19);
      var s21 := Dup2(s20);
      assert s21.Peek(4) == 0x370;
      assert s21.Peek(7) == 0x19a;
      var s22 := Dup2(s21);
      var s23 := Lt(s22);
      var s24 := IsZero(s23);
      var s25 := Push2(s24, 0x08ea);
      var s26 := JumpI(s25);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s25.stack[1] > 0 then
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Push1(s29, 0x84);
      var s31 := Add(s30);
      assert s31.Peek(4) == 0x370;
      assert s31.Peek(7) == 0x19a;
      var s32 := Push2(s31, 0x03ec);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s29 := Swap3(s28);
      var s30 := Swap1(s29);
      var s31 := Push2(s30, 0x0918);
      assert s31.Peek(0) == 0x918;
      assert s31.Peek(8) == 0x370;
      assert s31.Peek(11) == 0x19a;
      var s32 := Swap1(s31);
      var s33 := Dup5(s32);
      var s34 := Swap1(s33);
      var s35 := Push2(s34, 0x0b93);
      var s36 := Jump(s35);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s166(s36, gas - 1)
  }
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s166(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x918

    requires s0.stack[9] == 0x370
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x918;
      assert s1.Peek(9) == 0x370;
      assert s1.Peek(12) == 0x19a;
      var s2 := Dup2(s1);
      var s3 := Dup2(s2);
      var s4 := Sub(s3);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s167(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[10] == 0x370

    requires s0.stack[13] == 0x19a
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(11) == 0x370;
      assert s1.Peek(14) == 0x19a;
      var s2 := Push2(s1, 0x0b6c);
      var s3 := Jump(s2);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s168(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[11] == 0x370

    requires s0.stack[14] == 0x19a
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(13) == 0x370;
      assert s11.Peek(16) == 0x19a;
      var s12 := Revert(s11);
      // Segment is terminal (Revert, Stop or Return)
      s12
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(10) == 0x370;
      assert s1.Peek(13) == 0x19a;
      var s2 := Swap3(s1);
      var s3 := Swap2(s2);
      var s4 := Pop(s3);
      var s5 := Pop(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Push1(s19, 0x44);
      var s21 := Dup3(s20);
      assert s21.Peek(4) == 0x350;
      assert s21.Peek(5) == 0x19a;
      var s22 := Add(s21);
      var s23 := MStore(s22);
      var s24 := Push1(s23, 0x64);
      var s25 := Add(s24);
      ...
      var s27 := Jump(s26);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s177(s27, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0xafc;
      assert s11.Peek(8) == 0x1aa;
      assert s11.Peek(9) == 0x144;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x0a66);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s25.stack[1] > 0 then
        ExecuteFromCFGNode_s209(s26, gas - 1)
      else
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s31 := Push2(s30, 0x0918);
      assert s31.Peek(0) == 0x918;
      assert s31.Peek(8) == 0x345;
      assert s31.Peek(10) == 0x19a;
      var s32 := Swap1(s31);
      var s33 := Dup5(s32);
      var s34 := Swap1(s33);
      var s35 := Push2(s34, 0x0b93);
      var s36 := Jump(s35);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s210(s36, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := Dup4(s8);
      var s10 := Dup4(s9);
      var s11 := Push2(s10, 0x040f);
      assert s11.Peek(0) == 0x40f;
      assert s11.Peek(3) == 0x32c;
      assert s11.Peek(7) == 0x2eb;
      assert s11.Peek(12) == 0x130;
      var s12 := Jump(s11);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Dup1(s19);
      var s21 := Dup4(s20);
      assert s21.Peek(7) == 0x32c;
      assert s21.Peek(11) == 0x2eb;
      assert s21.Peek(16) == 0x130;
      var s22 := Keccak256(s21);
      var s23 := Swap4(s22);
      var s24 := Swap1(s23);
      ...
      var s30 := Swap1(s29);
      var s31 := Swap2(s30);
      assert s31.Peek(4) == 0x32c;
      assert s31.Peek(8) == 0x2eb;
      assert s31.Peek(13) == 0x130;
      var s32 := MStore(s31);
      var s33 := Keccak256(s32);
      var s34 := SLoad(s33);
      var s35 := Swap1(s34);
      var s36 := Jump(s35);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s227(s36, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s21 := Dup4(s20);
      assert s21.Peek(7) == 0x5de;
      assert s21.Peek(12) == 0x304;
      assert s21.Peek(18) == 0x130;
      var s22 := Keccak256(s21);
      var s23 := Swap4(s22);
      var s24 := Swap1(s23);
      var s25 := Swap5(s24);
      ...
      var s36 := Jump(s35);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s262(s36, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s26 := Jump(s25);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s265(s26, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Add(s10);
      assert s11.Peek(6) == 0x645;
      assert s11.Peek(11) == 0x304;
      assert s11.Peek(17) == 0x130;
      var s12 := MStore(s11);
      var s13 := Push1(s12, 0x24);
      var s14 := Dup1(s13);
      var s15 := Dup3(s14);
      ...
      var s21 := Add(s20);
      assert s21.Peek(6) == 0x645;
      assert s21.Peek(11) == 0x304;
      assert s21.Peek(17) == 0x130;
      var s22 := MStore(s21);
      var s23 := Push4(s22, 0x72657373);
      var s24 := Push1(s23, 0xe0);
      var s25 := Shl(s24);
      ...
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s269(s33, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Dup2(s10);
      assert s11.Peek(7) == 0x645;
      assert s11.Peek(12) == 0x304;
      assert s11.Peek(18) == 0x130;
      var s12 := Dup2(s11);
      var s13 := MStore(s12);
      var s14 := Push1(s13, 0x01);
      var s15 := Push1(s14, 0x20);
      ...
      var s21 := Dup4(s20);
      assert s21.Peek(10) == 0x645;
      assert s21.Peek(15) == 0x304;
      assert s21.Peek(21) == 0x130;
      var s22 := Keccak256(s21);
      var s23 := Swap5(s22);
      var s24 := Dup8(s23);
      var s25 := And(s24);
      ...
      var s31 := MStore(s30);
      assert s31.Peek(8) == 0x645;
      assert s31.Peek(13) == 0x304;
      assert s31.Peek(19) == 0x130;
      var s32 := Swap2(s31);
      var s33 := Dup3(s32);
      var s34 := Swap1(s33);
      var s35 := Keccak256(s34);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s273(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[13] == 0x304

    requires s0.stack[19] == 0x130
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Dup2(s0);
      assert s1.Peek(9) == 0x645;
      assert s1.Peek(14) == 0x304;
      assert s1.Peek(20) == 0x130;
      var s2 := MStore(s1);
      var s3 := Push32(s2, 0x8c5be1e5ebec7d5bd14f71427d1e84f3dd0314c0f7b2291e5b200ac8c7c3b925);
      var s4 := Swap2(s3);
      var s5 := Add(s4);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s274(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[12] == 0x304

    requires s0.stack[18] == 0x130
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(7) == 0x645;
      assert s1.Peek(12) == 0x304;
      assert s1.Peek(18) == 0x130;
      var s2 := Push1(s1, 0x40);
      var s3 := MLoad(s2);
      var s4 := Dup1(s3);
      var s5 := Swap2(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s31 := Push1(s30, 0x20);
      assert s31.Peek(2) == 0x80a;
      assert s31.Peek(10) == 0x30f;
      assert s31.Peek(16) == 0x130;
      var s32 := Add(s31);
      var s33 := Swap1(s32);
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s291(s34, gas - 1)
  }
