...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0971);
      assert s1.Peek(0) == 0x971;
      assert s1.Peek(4) == 0x5e9;
      assert s1.Peek(11) == 0xea;
      var s2 := Push2(s1, 0x0949);
      var s3 := Jump(s2);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0867);
      assert s1.Peek(0) == 0x867;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Swap1(s29);
      var s31 := Push2(s30, 0x09a4);
      assert s31.Peek(0) == 0x9a4;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x09b6);
      assert s1.Peek(0) == 0x9b6;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x07b2);
      assert s11.Peek(0) == 0x7b2;
