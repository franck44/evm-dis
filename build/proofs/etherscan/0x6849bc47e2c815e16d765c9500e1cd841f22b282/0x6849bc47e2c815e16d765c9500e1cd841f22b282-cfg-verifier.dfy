...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x098a);
      assert s1.Peek(0) == 0x98a;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Swap1(s29);
      var s31 := Push2(s30, 0x09a5);
      assert s31.Peek(0) == 0x9a5;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x09b9);
      assert s1.Peek(0) == 0x9b9;
