...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s21.Peek(12) == 0x16c;
      var s22 := IsZero(s21);
      var s23 := Push2(s22, 0x092c);
      var s24 := JumpI(s23);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x092c);
      assert s1.Peek(0) == 0x92c;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x24);
      var s11 := Push0(s10);
      assert s11.Peek(2) == 0x92c;
      assert s11.Peek(13) == 0x167;
      assert s11.Peek(14) == 0x16c;
      var s12 := Revert(s11);
      // Segment is terminal (Revert, Stop or Return)
      s12
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s21.Peek(11) == 0x16c;
      var s22 := Push2(s21, 0x0949);
      var s23 := JumpI(s22);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x095f);
      assert s1.Peek(0) == 0x95f;
      assert s1.Peek(10) == 0x167;
      assert s1.Peek(11) == 0x16c;
      var s2 := Dup6(s1);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x95f;
      assert s11.Peek(14) == 0x167;
      assert s11.Peek(15) == 0x16c;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x0840);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push0(s0);
      assert s1.Peek(3) == 0x95f;
      assert s1.Peek(13) == 0x167;
      assert s1.Peek(14) == 0x16c;
      var s2 := Dup1(s1);
      var s3 := Revert(s2);
      // Segment is terminal (Revert, Stop or Return)
      s3
