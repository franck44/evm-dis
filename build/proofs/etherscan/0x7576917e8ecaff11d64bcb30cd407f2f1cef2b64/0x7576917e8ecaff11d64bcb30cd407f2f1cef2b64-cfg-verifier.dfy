...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := Add(s8);
      var s10 := Push2(s9, 0x03f1);
      var s11 := Swap1(s10);
      assert s11.Peek(1) == 0x3f1;
      assert s11.Peek(2) == 0x20e;
      var s12 := Push2(s11, 0x10c0);
      var s13 := Jump(s12);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s4 := Push2(s3, 0x0f8c);
      var s5 := Dup2(s4);
      var s6 := Push2(s5, 0x0ed9);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := Dup2(s8);
      var s10 := Eq(s9);
      var s11 := Push2(s10, 0x0904);
      assert s11.Peek(0) == 0x904;
      assert s11.Peek(3) == 0xf8c;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s17 := Swap2(s16);
      var s18 := SStore(s17);
      var s19 := Push2(s18, 0x05cb);
      var s20 := Swap1(s19);
      var s21 := Address(s20);
      assert s21.Peek(2) == 0x5cb;
      assert s21.Peek(3) == 0x20e;
      var s22 := Swap1(s21);
      var s23 := Push2(s22, 0x05bd);
      var s24 := Push1(s23, 0x09);
      var s25 := Push1(s24, 0x0a);
      var s26 := Push2(s25, 0x109b);
      var s27 := Jump(s26);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(5) == 0x5cb;
      assert s1.Peek(6) == 0x20e;
      var s2 := Push0(s1);
      var s3 := Push2(s2, 0x0e28);
      var s4 := Push1(s3, 0xff);
      var s5 := Dup5(s4);
      var s6 := And(s5);
      var s7 := Dup4(s6);
      var s8 := Push2(s7, 0x0ffd);
      var s9 := Jump(s8);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s45(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0xe28

    requires s0.stack[6] == 0x5bd

    requires s0.stack[9] == 0x5cb
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0xe28;
      assert s1.Peek(6) == 0x5bd;
      assert s1.Peek(9) == 0x5cb;
      assert s1.Peek(10) == 0x20e;
      var s2 := Push0(s1);
      var s3 := Dup3(s2);
      var s4 := Push2(s3, 0x100b);
      var s5 := JumpI(s4);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s4.stack[1] > 0 then
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s46(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0xe28

    requires s0.stack[7] == 0x5bd

    requires s0.stack[10] == 0x5cb
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0xe28;
      assert s1.Peek(7) == 0x5bd;
      assert s1.Peek(10) == 0x5cb;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Dup5(s9);
      var s11 := Eq(s10);
      assert s11.Peek(5) == 0x3b9;
      assert s11.Peek(8) == 0x5cb;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s51(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0x3b9

    requires s0.stack[6] == 0x5cb
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x033b);
      assert s1.Peek(0) == 0x33b;
      assert s1.Peek(4) == 0x3b9;
      assert s1.Peek(7) == 0x5cb;
      assert s1.Peek(8) == 0x20e;
      var s2 := Push2(s1, 0x0fa7);
      var s3 := Jump(s2);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Push0(s10);
      assert s11.Peek(2) == 0x33b;
      assert s11.Peek(6) == 0x3b9;
      assert s11.Peek(9) == 0x5cb;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0x3b9;
      assert s1.Peek(6) == 0x5cb;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s31 := Add(s30);
      assert s31.Peek(4) == 0x5cb;
      assert s31.Peek(5) == 0x20e;
      var s32 := Push2(s31, 0x03f1);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s22 := Add(s21);
      var s23 := Swap1(s22);
      var s24 := Push2(s23, 0x063f);
      var s25 := Swap2(s24);
      var s26 := Swap1(s25);
      var s27 := Push2(s26, 0x10f5);
      var s28 := Jump(s27);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0x63f;
      assert s1.Peek(4) == 0x20e;
      var s2 := Dup2(s1);
      var s3 := MLoad(s2);
      var s4 := Push2(s3, 0x0e28);
      var s5 := Dup2(s4);
      var s6 := Push2(s5, 0x0ed9);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s70(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0xe28

    requires s0.stack[6] == 0x63f
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0xe28;
      assert s1.Peek(6) == 0x63f;
      assert s1.Peek(7) == 0x20e;
      var s2 := Push1(s1, 0x01);
      var s3 := Push1(s2, 0x01);
      var s4 := Push1(s3, 0xa0);
      ...
      var s11 := Push2(s10, 0x0904);
      assert s11.Peek(0) == 0x904;
      assert s11.Peek(3) == 0xe28;
      assert s11.Peek(8) == 0x63f;
      assert s11.Peek(9) == 0x20e;
      var s12 := JumpI(s11);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s11.stack[1] > 0 then
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Address(s29);
      var s31 := Push2(s30, 0x0777);
      assert s31.Peek(0) == 0x777;
      assert s31.Peek(5) == 0x20e;
      var s32 := Dup2(s31);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s23 := Add(s22);
      var s24 := Swap1(s23);
      var s25 := Push2(s24, 0x0815);
      var s26 := Swap2(s25);
      var s27 := Swap1(s26);
      var s28 := Push2(s27, 0x1110);
      var s29 := Jump(s28);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x1122);
      assert s11.Peek(0) == 0x1122;
      assert s11.Peek(7) == 0x815;
      assert s11.Peek(8) == 0x20e;
      var s12 := JumpI(s11);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s11.stack[1] > 0 then
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s22 := Add(s21);
      var s23 := Swap1(s22);
      var s24 := Push2(s23, 0x088e);
      var s25 := Swap2(s24);
      var s26 := Swap1(s25);
      var s27 := Push2(s26, 0x113b);
      var s28 := Jump(s27);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s119(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[4] == 0xe28

    requires s0.stack[8] == 0x5bd

    requires s0.stack[11] == 0x5cb
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(5) == 0xe28;
      assert s1.Peek(9) == 0x5bd;
      assert s1.Peek(12) == 0x5cb;
      assert s1.Peek(13) == 0x20e;
      var s2 := Dup2(s1);
      var s3 := Eq(s2);
      var s4 := Push2(s3, 0x1037);
      var s5 := JumpI(s4);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s4.stack[1] > 0 then
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x1053);
      assert s1.Peek(0) == 0x1053;
      assert s1.Peek(5) == 0xe28;
      assert s1.Peek(9) == 0x5bd;
      assert s1.Peek(12) == 0x5cb;
      assert s1.Peek(13) == 0x20e;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(4) == 0xe28;
      assert s1.Peek(8) == 0x5bd;
      assert s1.Peek(11) == 0x5cb;
      ...
      var s11 := Dup5(s10);
      assert s11.Peek(6) == 0xe28;
      assert s11.Peek(10) == 0x5bd;
      assert s11.Peek(13) == 0x5cb;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s124(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[6] == 0xe28

    requires s0.stack[10] == 0x5bd

    requires s0.stack[13] == 0x5cb
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(6) == 0xe28;
      assert s1.Peek(10) == 0x5bd;
      assert s1.Peek(13) == 0x5cb;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s125(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[5] == 0x1080

    requires s0.stack[9] == 0xe28

    requires s0.stack[13] == 0x5bd

    requires s0.stack[16] == 0x5cb
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(5) == 0x1080;
      assert s1.Peek(9) == 0xe28;
      assert s1.Peek(13) == 0x5bd;
      assert s1.Peek(16) == 0x5cb;
      assert s1.Peek(17) == 0x20e;
      var s2 := Dup1(s1);
      var s3 := Dup6(s2);
      var s4 := Gt(s3);
      var s5 := IsZero(s4);
      var s6 := Push2(s5, 0x0ff5);
      var s7 := JumpI(s6);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s6.stack[1] > 0 then
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(10) == 0xe28;
      assert s1.Peek(14) == 0x5bd;
      assert s1.Peek(17) == 0x5cb;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0fdb);
      assert s1.Peek(0) == 0xfdb;
      assert s1.Peek(6) == 0x1080;
      assert s1.Peek(10) == 0xe28;
      assert s1.Peek(14) == 0x5bd;
      assert s1.Peek(17) == 0x5cb;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s128(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[0] == 0xfdb

    requires s0.stack[6] == 0x1080

    requires s0.stack[10] == 0xe28

    requires s0.stack[14] == 0x5bd

    requires s0.stack[17] == 0x5cb
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x24);
      var s11 := Push0(s10);
      assert s11.Peek(2) == 0xfdb;
      assert s11.Peek(8) == 0x1080;
      assert s11.Peek(12) == 0xe28;
      assert s11.Peek(16) == 0x5bd;
      assert s11.Peek(19) == 0x5cb;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s133(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[5] == 0xe28

    requires s0.stack[9] == 0x5bd

    requires s0.stack[12] == 0x5cb
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x1093);
      assert s1.Peek(0) == 0x1093;
      assert s1.Peek(6) == 0xe28;
      assert s1.Peek(10) == 0x5bd;
      assert s1.Peek(13) == 0x5cb;
      assert s1.Peek(14) == 0x20e;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x24);
      var s11 := Push0(s10);
      assert s11.Peek(2) == 0x1093;
      assert s11.Peek(8) == 0xe28;
      assert s11.Peek(12) == 0x5bd;
      assert s11.Peek(15) == 0x5cb;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x1048);
      assert s1.Peek(0) == 0x1048;
      assert s1.Peek(5) == 0xe28;
      assert s1.Peek(9) == 0x5bd;
      assert s1.Peek(12) == 0x5cb;
      assert s1.Peek(13) == 0x20e;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x24);
      var s11 := Push0(s10);
      assert s11.Peek(2) == 0x1048;
      assert s11.Peek(7) == 0xe28;
      assert s11.Peek(11) == 0x5bd;
      assert s11.Peek(14) == 0x5cb;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Dup3(s19);
      var s21 := Add(s20);
      assert s21.Peek(6) == 0x337;
      assert s21.Peek(10) == 0x15a;
      var s22 := MStore(s21);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Shl(s9);
      var s11 := Sub(s10);
      assert s11.Peek(2) == 0xc25;
      assert s11.Peek(8) == 0x337;
      ...
      var s21 := Swap1(s20);
      assert s21.Peek(2) == 0xc25;
      assert s21.Peek(8) == 0x337;
      assert s21.Peek(12) == 0x15a;
      var s22 := Keccak256(s21);
      var s23 := SLoad(s22);
      var s24 := Swap1(s23);
      var s25 := Jump(s24);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(6) == 0x337;
      assert s1.Peek(10) == 0x15a;
      var s2 := Push2(s1, 0x0c2f);
      var s3 := Swap2(s2);
      var s4 := Swap1(s3);
      var s5 := Push2(s4, 0x115a);
      var s6 := Jump(s5);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s171(s0: EState, gas: nat): (s': EState)
    // PC requirement for this node.
    requires s0.pc == 0x115a as nat
    // Stack requirements for this node.
    requires s0.Operands() >= 13

    requires s0.stack[2] == 0xc2f

    requires s0.stack[7] == 0x337
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s172(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0xc2f

    requires s0.stack[8] == 0x337
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x033b);
      assert s1.Peek(0) == 0x33b;
      assert s1.Peek(4) == 0xc2f;
      assert s1.Peek(9) == 0x337;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s173(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[4] == 0xc2f

    requires s0.stack[9] == 0x337
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Push0(s10);
      assert s11.Peek(2) == 0x33b;
      assert s11.Peek(6) == 0xc2f;
      assert s11.Peek(11) == 0x337;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(5) == 0x337;
      assert s1.Peek(9) == 0x15a;
      var s2 := Gt(s1);
      var s3 := IsZero(s2);
      var s4 := Push2(s3, 0x0c7d);
      var s5 := JumpI(s4);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s4.stack[1] > 0 then
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Sub(s9);
      var s11 := And(s10);
      assert s11.Peek(1) == 0xcb4;
      assert s11.Peek(7) == 0x337;
      ...
      assert s21.Peek(1) == 0xcb4;
      assert s21.Peek(7) == 0x337;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s19 := SLoad(s18);
      var s20 := Push2(s19, 0x0d2e);
      var s21 := Swap1(s20);
      assert s21.Peek(1) == 0xd2e;
      assert s21.Peek(5) == 0x337;
      assert s21.Peek(9) == 0x15a;
      var s22 := Dup3(s21);
      var s23 := Push2(s22, 0x0de7);
      var s24 := Jump(s23);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Add(s9);
      var s11 := Push1(s10, 0x40);
      assert s11.Peek(5) == 0xe28;
      assert s11.Peek(9) == 0xd2e;
      assert s11.Peek(13) == 0x337;
      ...
      var s20 := Dup2(s19);
      var s21 := MStore(s20);
      assert s21.Peek(4) == 0xe28;
      assert s21.Peek(8) == 0xd2e;
      assert s21.Peek(12) == 0x337;
      assert s21.Peek(16) == 0x15a;
      var s22 := Pop(s21);
      var s23 := Push2(s22, 0x0daf);
      var s24 := Jump(s23);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s188(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[7] == 0xd2e

    requires s0.stack[11] == 0x337
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push2(s9, 0x03f1);
      var s11 := Swap2(s10);
      assert s11.Peek(2) == 0x3f1;
      assert s11.Peek(7) == 0xe28;
      assert s11.Peek(11) == 0xd2e;
      assert s11.Peek(15) == 0x337;
      assert s11.Peek(19) == 0x15a;
      var s12 := Swap1(s11);
      var s13 := Push2(s12, 0x0e8d);
      var s14 := Jump(s13);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s190(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[7] == 0xe28

    requires s0.stack[11] == 0xd2e

    requires s0.stack[15] == 0x337
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(7) == 0xe28;
      assert s1.Peek(11) == 0xd2e;
      assert s1.Peek(15) == 0x337;
      ...
      assert s11.Peek(13) == 0xe28;
      assert s11.Peek(17) == 0xd2e;
      assert s11.Peek(21) == 0x337;
      assert s11.Peek(25) == 0x15a;
      var s12 := Add(s11);
      var s13 := MStore(s12);
      var s14 := Push0(s13);
      //  Go to the next instruction at pc + 1
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s191(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[11] == 0xe28

    requires s0.stack[15] == 0xd2e

    requires s0.stack[19] == 0x337
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(11) == 0xe28;
      assert s1.Peek(15) == 0xd2e;
      assert s1.Peek(19) == 0x337;
      assert s1.Peek(23) == 0x15a;
      var s2 := Dup2(s1);
      var s3 := Dup2(s2);
      var s4 := Lt(s3);
      var s5 := IsZero(s4);
      var s6 := Push2(s5, 0x0eb9);
      var s7 := JumpI(s6);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s6.stack[1] > 0 then
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(12) == 0xe28;
      assert s1.Peek(16) == 0xd2e;
      assert s1.Peek(20) == 0x337;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x40);
      var s11 := Push1(s10, 0x1f);
      assert s11.Peek(7) == 0x3f1;
      assert s11.Peek(12) == 0xe28;
      assert s11.Peek(16) == 0xd2e;
      assert s11.Peek(20) == 0x337;
      ...
      var s20 := Swap3(s19);
      var s21 := Pop(s20);
      assert s21.Peek(5) == 0x3f1;
      assert s21.Peek(10) == 0xe28;
      assert s21.Peek(14) == 0xd2e;
      assert s21.Peek(18) == 0x337;
      assert s21.Peek(22) == 0x15a;
      var s22 := Pop(s21);
      var s23 := Pop(s22);
      var s24 := Swap3(s23);
      var s25 := Swap2(s24);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s196(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[8] == 0xe28

    requires s0.stack[12] == 0xd2e

    requires s0.stack[16] == 0x337
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(8) == 0xe28;
      assert s1.Peek(12) == 0xd2e;
      assert s1.Peek(16) == 0x337;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s197(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[13] == 0xd2e

    requires s0.stack[17] == 0x337
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(10) == 0xe28;
      assert s1.Peek(14) == 0xd2e;
      assert s1.Peek(18) == 0x337;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s198(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[14] == 0xd2e

    requires s0.stack[18] == 0x337
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s31.Peek(4) == 0x337;
      assert s31.Peek(8) == 0x15a;
      var s32 := Push2(s31, 0x0d5c);
      var s33 := Swap1(s32);
      var s34 := Dup3(s33);
      var s35 := Push2(s34, 0x0e2f);
      var s36 := Jump(s35);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0xd5c;
      assert s1.Peek(6) == 0x337;
      assert s1.Peek(10) == 0x15a;
      var s2 := Push0(s1);
      var s3 := Dup1(s2);
      var s4 := Push2(s3, 0x0e3b);
      var s5 := Dup4(s4);
      var s6 := Dup6(s5);
      var s7 := Push2(s6, 0x115a);
      var s8 := Jump(s7);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s204(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0xe3b

    requires s0.stack[7] == 0xd5c
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0xe3b;
      assert s1.Peek(7) == 0xd5c;
      assert s1.Peek(11) == 0x337;
      assert s1.Peek(15) == 0x15a;
      var s2 := Dup1(s1);
      var s3 := Dup3(s2);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s205(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0xe3b

    requires s0.stack[8] == 0xd5c

    requires s0.stack[12] == 0x337
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x033b);
      assert s1.Peek(0) == 0x33b;
      assert s1.Peek(4) == 0xe3b;
      assert s1.Peek(9) == 0xd5c;
      assert s1.Peek(13) == 0x337;
      assert s1.Peek(17) == 0x15a;
      var s2 := Push2(s1, 0x0fa7);
      var s3 := Jump(s2);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s206(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[4] == 0xe3b

    requires s0.stack[9] == 0xd5c
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Push0(s10);
      assert s11.Peek(2) == 0x33b;
      assert s11.Peek(6) == 0xe3b;
      assert s11.Peek(11) == 0xd5c;
      assert s11.Peek(15) == 0x337;
      assert s11.Peek(19) == 0x15a;
      var s12 := Revert(s11);
      // Segment is terminal (Revert, Stop or Return)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0xe3b;
      assert s1.Peek(8) == 0xd5c;
      assert s1.Peek(12) == 0x337;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Dup3(s19);
      var s21 := Add(s20);
      assert s21.Peek(7) == 0xd5c;
      assert s21.Peek(11) == 0x337;
      assert s21.Peek(15) == 0x15a;
      var s22 := MStore(s21);
      var s23 := Push1(s22, 0x64);
      var s24 := Add(s23);
      var s25 := Push2(s24, 0x03f1);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s3 := SStore(s2);
      var s4 := Push2(s3, 0x0494);
      var s5 := Push1(s4, 0x09);
      var s6 := Push1(s5, 0x0a);
      var s7 := Push2(s6, 0x109b);
      var s8 := Jump(s7);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x0f29);
      assert s11.Peek(0) == 0xf29;
      assert s11.Peek(7) == 0x1a6;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(13) == 0xe28;
      assert s11.Peek(17) == 0xd2e;
      assert s11.Peek(21) == 0x36d;
      assert s11.Peek(26) == 0x15a;
      var s12 := Add(s11);
      var s13 := MStore(s12);
      var s14 := Push0(s13);
      //  Go to the next instruction at pc + 1
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s21.Peek(10) == 0xe28;
      assert s21.Peek(14) == 0xd2e;
      assert s21.Peek(18) == 0x36d;
      assert s21.Peek(23) == 0x15a;
      var s22 := Pop(s21);
      var s23 := Pop(s22);
      var s24 := Swap3(s23);
      var s25 := Swap2(s24);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := And(s29);
      var s31 := Swap1(s30);
      assert s31.Peek(6) == 0x36d;
      assert s31.Peek(11) == 0x15a;
      var s32 := Push32(s31, 0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef);
      var s33 := Swap1(s32);
      var s34 := Push2(s33, 0x0a1e);
      var s35 := Swap1(s34);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s18 := Push1(s17, 0x20);
      var s19 := Add(s18);
      var s20 := Push2(s19, 0x1181);
      var s21 := Push1(s20, 0x28);
      assert s21.Peek(5) == 0x3b9;
      assert s21.Peek(8) == 0x3be;
      assert s21.Peek(13) == 0x15a;
      var s22 := Swap2(s21);
      ...
      var s30 := And(s29);
      var s31 := Push0(s30);
      assert s31.Peek(4) == 0x3b9;
      assert s31.Peek(7) == 0x3be;
      assert s31.Peek(12) == 0x15a;
      var s32 := Swap1(s31);
      var s33 := Dup2(s32);
      var s34 := MStore(s33);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Swap2(s10);
      assert s11.Peek(2) == 0x3f1;
      assert s11.Peek(7) == 0x3b9;
      assert s11.Peek(10) == 0x3be;
      assert s11.Peek(15) == 0x15a;
      var s12 := Swap1(s11);
      var s13 := Push2(s12, 0x0e8d);
      var s14 := Jump(s13);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Dup6(s10);
      assert s11.Peek(8) == 0x3f1;
      assert s11.Peek(13) == 0x3b9;
      assert s11.Peek(16) == 0x3be;
      assert s11.Peek(21) == 0x15a;
      var s12 := Add(s11);
      var s13 := MStore(s12);
      var s14 := Push0(s13);
      //  Go to the next instruction at pc + 1
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s472(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[11] == 0x3b9

    requires s0.stack[14] == 0x3be
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(6) == 0x3f1;
      assert s1.Peek(11) == 0x3b9;
      assert s1.Peek(14) == 0x3be;
      assert s1.Peek(19) == 0x15a;
      var s2 := Dup2(s1);
      var s3 := Dup2(s2);
      var s4 := Lt(s3);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Dup6(s0);
      assert s1.Peek(7) == 0x3f1;
      assert s1.Peek(12) == 0x3b9;
      assert s1.Peek(15) == 0x3be;
      assert s1.Peek(20) == 0x15a;
      var s2 := Dup2(s1);
      var s3 := Add(s2);
      var s4 := Dup4(s3);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Push1(s10, 0x1f);
      assert s11.Peek(7) == 0x3f1;
      assert s11.Peek(12) == 0x3b9;
      assert s11.Peek(15) == 0x3be;
      assert s11.Peek(20) == 0x15a;
      var s12 := Not(s11);
      var s13 := Push1(s12, 0x1f);
      var s14 := Dup4(s13);
      ...
      var s21 := Pop(s20);
      assert s21.Peek(5) == 0x3f1;
      assert s21.Peek(10) == 0x3b9;
      assert s21.Peek(13) == 0x3be;
      assert s21.Peek(18) == 0x15a;
      var s22 := Pop(s21);
      var s23 := Pop(s22);
      var s24 := Swap3(s23);
      var s25 := Swap2(s24);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(0) == 0x33b;
      assert s1.Peek(4) == 0xdde;
      assert s1.Peek(10) == 0x3b9;
      assert s1.Peek(13) == 0x3be;
      assert s1.Peek(18) == 0x15a;
      var s2 := Push2(s1, 0x0fa7);
      var s3 := Jump(s2);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s479(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[10] == 0x3b9

    requires s0.stack[13] == 0x3be
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(0) == 0x17e;
      var s2 := Push0(s1);
      var s3 := Push2(s2, 0x034e);
      var s4 := Push1(s3, 0x09);
      var s5 := Push1(s4, 0x0a);
      var s6 := Push2(s5, 0x109b);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Dup1(s19);
      var s21 := Dup4(s20);
      assert s21.Peek(10) == 0x337;
      assert s21.Peek(14) == 0x15a;
      var s22 := Keccak256(s21);
      var s23 := Swap5(s22);
      var s24 := Dup8(s23);
      var s25 := And(s24);
