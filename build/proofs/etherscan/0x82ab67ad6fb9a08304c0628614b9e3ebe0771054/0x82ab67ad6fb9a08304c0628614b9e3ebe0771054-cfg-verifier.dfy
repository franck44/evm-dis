...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x913;
      assert s11.Peek(9) == 0x1d4;
      assert s11.Peek(10) == 0x10d;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x07a6);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := Add(s8);
      var s10 := Push2(s9, 0x02e8);
      var s11 := Swap2(s10);
      assert s11.Peek(2) == 0x2e8;
      assert s11.Peek(7) == 0x6c6;
      assert s11.Peek(11) == 0x29a;
      assert s11.Peek(15) == 0xf9;
      var s12 := Swap1(s11);
      var s13 := Push2(s12, 0x0744);
      var s14 := Jump(s13);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Swap3(s19);
      var s21 := Pop(s20);
      assert s21.Peek(5) == 0x2e8;
      assert s21.Peek(10) == 0x6c6;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s31.Peek(8) == 0xf9;
      var s32 := SLoad(s31);
      var s33 := Push2(s32, 0x06f4);
      var s34 := Swap1(s33);
      var s35 := Dup3(s34);
      var s36 := Push2(s35, 0x05b2);
      var s37 := Jump(s36);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s17 := Jump(s16);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s100(s17, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x08b9);
      assert s11.Peek(0) == 0x8b9;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s19 := Add(s18);
      var s20 := Push2(s19, 0x09bc);
      var s21 := Push1(s20, 0x28);
      assert s21.Peek(5) == 0x439;
      assert s21.Peek(8) == 0x43e;
      assert s21.Peek(13) == 0xf9;
      var s22 := Swap2(s21);
      ...
      var s30 := And(s29);
      var s31 := Push0(s30);
      assert s31.Peek(4) == 0x439;
      assert s31.Peek(7) == 0x43e;
      assert s31.Peek(12) == 0xf9;
      var s32 := Swap1(s31);
      var s33 := Dup2(s32);
      var s34 := MStore(s33);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Dup6(s10);
      assert s11.Peek(8) == 0x2e8;
      assert s11.Peek(13) == 0x439;
      assert s11.Peek(16) == 0x43e;
      assert s11.Peek(21) == 0xf9;
      var s12 := Add(s11);
      var s13 := MStore(s12);
      var s14 := Push0(s13);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s149(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[11] == 0x439

    requires s0.stack[14] == 0x43e
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(6) == 0x2e8;
      assert s1.Peek(11) == 0x439;
      assert s1.Peek(14) == 0x43e;
      assert s1.Peek(19) == 0xf9;
      var s2 := Dup2(s1);
      var s3 := Dup2(s2);
      var s4 := Lt(s3);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Dup6(s0);
      assert s1.Peek(7) == 0x2e8;
      assert s1.Peek(12) == 0x439;
      assert s1.Peek(15) == 0x43e;
      assert s1.Peek(20) == 0xf9;
      var s2 := Dup2(s1);
      var s3 := Add(s2);
      var s4 := Dup4(s3);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s21 := Pop(s20);
      assert s21.Peek(5) == 0x2e8;
      assert s21.Peek(10) == 0x439;
      assert s21.Peek(13) == 0x43e;
      assert s21.Peek(18) == 0xf9;
      var s22 := Pop(s21);
      var s23 := Pop(s22);
      var s24 := Swap3(s23);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0834);
      assert s1.Peek(0) == 0x834;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x088c);
      assert s1.Peek(0) == 0x88c;
      assert s1.Peek(10) == 0x129;
      assert s1.Peek(11) == 0x12e;
      var s2 := Dup6(s1);
      var s3 := Push2(s2, 0x0790);
      var s4 := Jump(s3);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s16 := Pop(s15);
      var s17 := Swap1(s16);
      var s18 := Push2(s17, 0x0361);
      var s19 := Swap1(s18);
      var s20 := Dup3(s19);
      var s21 := Swap1(s20);
      assert s21.Peek(2) == 0x361;
      assert s21.Peek(7) == 0x12e;
      var s22 := Dup2(s21);
      var s23 := Swap1(s22);
      var s24 := Push2(s23, 0x0587);
      var s25 := Jump(s24);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s21 := Pop(s20);
      assert s21.Peek(5) == 0x2e8;
      assert s21.Peek(10) == 0x361;
      assert s21.Peek(15) == 0x12e;
      var s22 := Pop(s21);
      var s23 := Pop(s22);
      var s24 := Swap3(s23);
      var s25 := Swap2(s24);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s27 := SLoad(s26);
      var s28 := Push2(s27, 0x03aa);
      var s29 := Swap1(s28);
      var s30 := Dup3(s29);
      var s31 := Push2(s30, 0x05b2);
      assert s31.Peek(0) == 0x5b2;
      assert s31.Peek(3) == 0x3aa;
      assert s31.Peek(8) == 0x12e;
      var s32 := Jump(s31);
      //  JUMP to the target at Peek(0)
