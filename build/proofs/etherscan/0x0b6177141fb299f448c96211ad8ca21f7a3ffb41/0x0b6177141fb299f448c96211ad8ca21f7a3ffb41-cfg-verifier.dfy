...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x9b8;
      assert s11.Peek(9) == 0x1d0;
      assert s11.Peek(10) == 0x134;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x0832);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Swap2(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x09c6);
      var s5 := Push1(s4, 0x20);
      var s6 := Dup5(s5);
      var s7 := Add(s6);
      var s8 := Push2(s7, 0x081c);
      var s9 := Jump(s8);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Dup2(s29);
      var s31 := MStore(s30);
      assert s31.Peek(3) == 0x715;
      assert s31.Peek(7) == 0x296;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0793);
      assert s1.Peek(0) == 0x793;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s21.Peek(10) == 0x715;
      assert s21.Peek(14) == 0x296;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s32 := SLoad(s31);
      var s33 := Push2(s32, 0x0743);
      var s34 := Swap1(s33);
      var s35 := Dup3(s34);
      var s36 := Push2(s35, 0x07be);
      var s37 := Jump(s36);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push0(s1);
      var s3 := Push2(s2, 0x07c9);
      var s4 := Dup3(s3);
      var s5 := Dup5(s4);
      var s6 := Push2(s5, 0x0a4d);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s52(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0x7c9

    requires s0.stack[7] == 0x743
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(4) == 0x7c9;
      assert s1.Peek(8) == 0x743;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Add(s9);
      var s11 := Push2(s10, 0x00ef);
      assert s11.Peek(0) == 0xef;
      var s12 := Jump(s11);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s29 := Dup1(s28);
      var s30 := SLoad(s29);
      var s31 := Push2(s30, 0x0235);
      assert s31.Peek(0) == 0x235;
      assert s31.Peek(8) == 0x100;
      var s32 := Swap1(s31);
      var s33 := Push2(s32, 0x09cf);
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      var s2 := Push2(s1, 0x017d);
      var s3 := Push2(s2, 0x0178);
      var s4 := CallDataSize(s3);
      var s5 := Push1(s4, 0x04);
      var s6 := Push2(s5, 0x08c5);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s21.Peek(12) == 0x17d;
      var s22 := IsZero(s21);
      var s23 := Push2(s22, 0x0937);
      var s24 := JumpI(s23);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0937);
      assert s1.Peek(0) == 0x937;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s21.Peek(11) == 0x17d;
      var s22 := Push2(s21, 0x0954);
      var s23 := JumpI(s22);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x096a);
      assert s1.Peek(0) == 0x96a;
      assert s1.Peek(10) == 0x178;
      assert s1.Peek(11) == 0x17d;
      var s2 := Dup6(s1);
      var s3 := Push2(s2, 0x081c);
      var s4 := Jump(s3);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(14) == 0x178;
      assert s11.Peek(15) == 0x17d;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x0832);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(10) == 0x17d;
      var s12 := Push2(s11, 0x0959);
      var s13 := Jump(s12);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s24 := Add(s23);
      //  Go to the next instruction at pc + 1
      ExecuteFromCFGNode_s124(s24, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s14 := Pop(s13);
      var s15 := Swap1(s14);
      var s16 := Push2(s15, 0x03ee);
      var s17 := Swap1(s16);
      var s18 := Dup3(s17);
      var s19 := Swap1(s18);
      var s20 := Dup2(s19);
      var s21 := Swap1(s20);
      assert s21.Peek(3) == 0x3ee;
      assert s21.Peek(8) == 0x17d;
      var s22 := Push2(s21, 0x0793);
      var s23 := Jump(s22);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s132(s23, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s21 := Pop(s20);
      assert s21.Peek(5) == 0x35d;
      assert s21.Peek(10) == 0x3ee;
      assert s21.Peek(15) == 0x17d;
      var s22 := Pop(s21);
      var s23 := Pop(s22);
      var s24 := Swap3(s23);
      var s25 := Swap2(s24);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s27 := SLoad(s26);
      var s28 := Push2(s27, 0x0437);
      var s29 := Swap1(s28);
      var s30 := Dup3(s29);
      var s31 := Push2(s30, 0x07be);
      assert s31.Peek(0) == 0x7be;
      assert s31.Peek(3) == 0x437;
      assert s31.Peek(8) == 0x17d;
      var s32 := Jump(s31);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s141(s32, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x0871);
      assert s11.Peek(0) == 0x871;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s31 := Jump(s30);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s171(s31, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s37 := Jump(s36);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s185(s37, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s19 := Add(s18);
      var s20 := Push2(s19, 0x0aac);
      var s21 := Push1(s20, 0x28);
      assert s21.Peek(5) == 0x2f8;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s31 := Jump(s30);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s205(s31, gas - 1)
  }
