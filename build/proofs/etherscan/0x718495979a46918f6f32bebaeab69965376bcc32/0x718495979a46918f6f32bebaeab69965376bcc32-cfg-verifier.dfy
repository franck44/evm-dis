...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Dup1(s0);
      var s2 := Push4(s1, 0x56bccf91);
      var s3 := Eq(s2);
      var s4 := Push2(s3, 0x007a);
      var s5 := JumpI(s4);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Dup1(s0);
      var s2 := Push4(s1, 0x5e35359e);
      var s3 := Eq(s2);
      var s4 := Push2(s3, 0x008f);
      var s5 := JumpI(s4);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s4.stack[1] > 0 then
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x05ca);
      assert s11.Peek(0) == 0x5ca;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(10) == 0x9d;
      assert s11.Peek(11) == 0x8d;
      var s12 := Eq(s11);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Caller(s9);
      var s11 := Eq(s10);
      assert s11.Peek(4) == 0x8d;
      var s12 := Push2(s11, 0x043e);
      var s13 := JumpI(s12);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := Add(s8);
      var s10 := MStore(s9);
      var s11 := Push32(s10, 0x4f6e6c7920746865206f776e65722063616e2063616c6c20746869732066756e);
      assert s11.Peek(2) == 0x164;
      assert s11.Peek(6) == 0x8d;
      var s12 := Push1(s11, 0x40);
      var s13 := Dup3(s12);
      var s14 := Add(s13);
      var s15 := MStore(s14);
      var s16 := PushN(s15, 5, 0x31ba34b7b7);
      var s17 := Push1(s16, 0xd9);
      var s18 := Shl(s17);
      var s19 := Push1(s18, 0x60);
      var s20 := Dup3(s19);
      var s21 := Add(s20);
      assert s21.Peek(3) == 0x164;
      assert s21.Peek(7) == 0x8d;
      var s22 := MStore(s21);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := Add(s8);
      var s10 := MStore(s9);
      var s11 := PushN(s10, 21, 0x496e76616c696420746f6b656e2061646472657373);
      assert s11.Peek(2) == 0x164;
      assert s11.Peek(6) == 0x8d;
      var s12 := Push1(s11, 0x58);
      var s13 := Shl(s12);
      ...
      var s21 := Jump(s20);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s29(s21, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s4 := Dup3(s3);
      var s5 := MStore(s4);
      var s6 := Push1(s5, 0x19);
      var s7 := Swap1(s6);
      var s8 := Dup3(s7);
      var s9 := Add(s8);
      var s10 := MStore(s9);
      var s11 := Push32(s10, 0x496e76616c696420726563697069656e74206164647265737300000000000000);
      assert s11.Peek(2) == 0x164;
      assert s11.Peek(6) == 0x8d;
      var s12 := Push1(s11, 0x40);
      var s13 := Dup3(s12);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s17 := And(s16);
      var s18 := Swap1(s17);
      var s19 := Push4(s18, 0xa9059cbb);
      var s20 := Swap1(s19);
      var s21 := Push2(s20, 0x04bb);
      assert s21.Peek(0) == 0x4bb;
      assert s21.Peek(8) == 0x8d;
      var s22 := Swap1(s21);
      var s23 := Dup7(s22);
      var s24 := Swap1(s23);
      var s25 := Dup7(s24);
      ...
      var s28 := Add(s27);
      var s29 := Push2(s28, 0x067b);
      var s30 := Jump(s29);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s37(s30, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Jump(s19);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s38(s20, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Dup8(s9);
      var s11 := Dup1(s10);
      assert s11.Peek(14) == 0x8d;
      var s12 := ExtCodeSize(s11);
      var s13 := IsZero(s12);
      var s14 := Dup1(s13);
      var s15 := IsZero(s14);
      var s16 := Push2(s15, 0x04d5);
      var s17 := JumpI(s16);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s22 := Add(s21);
      var s23 := Swap1(s22);
      var s24 := Push2(s23, 0x050d);
      var s25 := Swap2(s24);
      var s26 := Swap1(s25);
      var s27 := Push2(s26, 0x05f1);
      var s28 := Jump(s27);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s4 := Dup3(s3);
      var s5 := MStore(s4);
      var s6 := Push1(s5, 0x0f);
      var s7 := Swap1(s6);
      var s8 := Dup3(s7);
      var s9 := Add(s8);
      var s10 := MStore(s9);
      var s11 := PushN(s10, 15, 0x151c985b9cd9995c8819985a5b1959);
      assert s11.Peek(2) == 0x164;
      assert s11.Peek(7) == 0x8d;
      var s12 := Push1(s11, 0x8a);
      var s13 := Shl(s12);
      var s14 := Push1(s13, 0x40);
      var s15 := Dup3(s14);
      var s16 := Add(s15);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s14 := Sub(s13);
      var s15 := And(s14);
      var s16 := Push32(s15, 0x9b1bfa7fa9ee420a16e124f794c35ac9f90472acc99140eb2f6447c714cad8eb);
      var s17 := Dup5(s16);
      var s18 := Push1(s17, 0x40);
      var s19 := MLoad(s18);
      var s20 := Push2(s19, 0x0406);
      var s21 := Swap2(s20);
      assert s21.Peek(2) == 0x406;
      assert s21.Peek(10) == 0x8d;
      var s22 := Swap1(s21);
      var s23 := Push2(s22, 0x0835);
      var s24 := Jump(s23);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      var s2 := Push2(s1, 0x008d);
      var s3 := Push2(s2, 0x0088);
      var s4 := CallDataSize(s3);
      var s5 := Push1(s4, 0x04);
      var s6 := Push2(s5, 0x0595);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x5af;
      assert s11.Peek(8) == 0x88;
      assert s11.Peek(9) == 0x8d;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x0139);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s17 := And(s16);
      var s18 := Swap1(s17);
      var s19 := Push4(s18, 0x70a08231);
      var s20 := Swap1(s19);
      var s21 := Push2(s20, 0x019c);
      assert s21.Peek(0) == 0x19c;
      assert s21.Peek(6) == 0x8d;
      var s22 := Swap1(s21);
      var s23 := Caller(s22);
      var s24 := Swap1(s23);
      var s25 := Push1(s24, 0x04);
      var s26 := Add(s25);
      var s27 := Push2(s26, 0x0629);
      var s28 := Jump(s27);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s22 := Add(s21);
      var s23 := Swap1(s22);
      var s24 := Push2(s23, 0x01ec);
      var s25 := Swap2(s24);
      var s26 := Swap1(s25);
      var s27 := Push2(s26, 0x0611);
      var s28 := Jump(s27);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s4 := Dup3(s3);
      var s5 := MStore(s4);
      var s6 := Push1(s5, 0x1a);
      var s7 := Swap1(s6);
      var s8 := Dup3(s7);
      var s9 := Add(s8);
      var s10 := MStore(s9);
      var s11 := Push32(s10, 0x496e73756666696369656e7420746f6b656e2062616c616e6365000000000000);
      assert s11.Peek(2) == 0x164;
      assert s11.Peek(5) == 0x8d;
      var s12 := Push1(s11, 0x40);
      var s13 := Dup3(s12);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x8d;
      var s2 := Push32(s1, 0x3c5ad147104e56be34a9176a6692f7df8d2f4b29a5af06bc6b98970d329d6577);
      var s3 := Dup2(s2);
      var s4 := Push1(s3, 0x40);
      var s5 := MLoad(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := Add(s8);
      var s10 := MStore(s9);
      var s11 := PushN(s10, 12, 0x557365722042616c616e6365);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := MLoad(s9);
      var s11 := Push4(s10, 0x6eb1769f);
      assert s11.Peek(4) == 0x8d;
      var s12 := Push1(s11, 0xe1);
      var s13 := Shl(s12);
      var s14 := Dup2(s13);
      var s15 := MStore(s14);
      ...
      var s24 := And(s23);
      var s25 := Swap1(s24);
      var s26 := Push4(s25, 0xdd62ed3e);
      var s27 := Swap1(s26);
      var s28 := Push2(s27, 0x0276);
      var s29 := Swap1(s28);
      var s30 := Caller(s29);
      var s31 := Swap1(s30);
      assert s31.Peek(2) == 0x276;
      assert s31.Peek(8) == 0x8d;
      var s32 := Address(s31);
      var s33 := Swap1(s32);
      var s34 := Push1(s33, 0x04);
      var s35 := Add(s34);
      var s36 := Push2(s35, 0x063d);
      var s37 := Jump(s36);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s86(s37, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Dup1(s9);
      var s11 := ExtCodeSize(s10);
      assert s11.Peek(12) == 0x8d;
      var s12 := IsZero(s11);
      var s13 := Dup1(s12);
      var s14 := IsZero(s13);
      var s15 := Push2(s14, 0x028e);
      var s16 := JumpI(s15);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s15.stack[1] > 0 then
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := Add(s8);
      var s10 := MStore(s9);
      var s11 := Push32(s10, 0x436865636b2074686520746f6b656e20616c6c6f77616e636500000000000000);
      assert s11.Peek(2) == 0x164;
      assert s11.Peek(6) == 0x8d;
      var s12 := Push1(s11, 0x40);
      var s13 := Dup3(s12);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s4 := Push1(s3, 0x40);
      var s5 := MLoad(s4);
      var s6 := Push2(s5, 0x0317);
      var s7 := Swap2(s6);
      var s8 := Swap1(s7);
      var s9 := Push2(s8, 0x0702);
      var s10 := Jump(s9);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := Add(s8);
      var s10 := MStore(s9);
      var s11 := PushN(s10, 15, 0x546f6b656e20416c6c6f77616e6365);
      assert s11.Peek(3) == 0x317;
      assert s11.Peek(8) == 0x8d;
      var s12 := Push1(s11, 0x88);
      var s13 := Shl(s12);
      var s14 := Push1(s13, 0x60);
      var s15 := Dup3(s14);
      var s16 := Add(s15);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s24 := And(s23);
      var s25 := Swap1(s24);
      var s26 := Push4(s25, 0x23b872dd);
      var s27 := Swap1(s26);
      var s28 := Push2(s27, 0x0352);
      var s29 := Swap1(s28);
      var s30 := Caller(s29);
      var s31 := Swap1(s30);
      assert s31.Peek(2) == 0x352;
      assert s31.Peek(9) == 0x8d;
      var s32 := Address(s31);
      var s33 := Swap1(s32);
      var s34 := Dup9(s33);
      var s35 := Swap1(s34);
      ...
      var s37 := Add(s36);
      var s38 := Push2(s37, 0x0657);
      var s39 := Jump(s38);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s101(s39, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s21 := Dup2(s20);
      assert s21.Peek(4) == 0x352;
      assert s21.Peek(11) == 0x8d;
      var s22 := Add(s21);
      var s23 := Swap2(s22);
      var s24 := Swap1(s23);
      var s25 := Swap2(s24);
      ...
      var s30 := Jump(s29);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s102(s30, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s14 := Sub(s13);
      var s15 := And(s14);
      var s16 := Push32(s15, 0x5548c837ab068cf56a2c2479df0882a4922fd203edb7517321831d95078c5f62);
      var s17 := Dup6(s16);
      var s18 := Push1(s17, 0x40);
      var s19 := MLoad(s18);
      var s20 := Push2(s19, 0x0406);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s19 := Push4(s18, 0x70a08231);
      var s20 := Swap1(s19);
      var s21 := Push2(s20, 0x00e6);
      assert s21.Peek(0) == 0xe6;
      ...
      var s28 := Jump(s27);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s125(s28, gas - 1)
  }
