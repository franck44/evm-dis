...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push2(s1, 0x07af);
      var s3 := Dup4(s2);
      var s4 := Push2(s3, 0x06ef);
      var s5 := Jump(s4);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x7af;
      assert s11.Peek(9) == 0x19b;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s31 := Add(s30);
      assert s31.Peek(4) == 0x240;
      assert s31.Peek(9) == 0xdf;
      var s32 := Push2(s31, 0x0309);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Dup1(s29);
      var s31 := Dup4(s30);
      assert s31.Peek(11) == 0x240;
      assert s31.Peek(16) == 0xdf;
      var s32 := MStore(s31);
      var s33 := Swap2(s32);
      var s34 := Dup5(s33);
      var s35 := Swap1(s34);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s31 := Add(s30);
      //  Go to the next instruction at pc + 1
      ExecuteFromCFGNode_s63(s31, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s4 := Dup1(s3);
      var s5 := SLoad(s4);
      var s6 := Push2(s5, 0x01af);
      var s7 := Swap1(s6);
      var s8 := Push2(s7, 0x07c6);
      var s9 := Jump(s8);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s29 := Dup1(s28);
      var s30 := SLoad(s29);
      var s31 := Push2(s30, 0x01db);
      assert s31.Peek(0) == 0x1db;
      assert s31.Peek(8) == 0xb6;
      var s32 := Swap1(s31);
      var s33 := Push2(s32, 0x07c6);
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s81(s34, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Dup6(s5);
      var s7 := Dup6(s6);
      var s8 := Push2(s7, 0x0281);
      var s9 := Dup4(s8);
      var s10 := Dup4(s9);
      var s11 := Push2(s10, 0x032d);
      assert s11.Peek(0) == 0x32d;
      assert s11.Peek(3) == 0x281;
      assert s11.Peek(7) == 0x240;
      assert s11.Peek(12) == 0xdf;
      var s12 := Jump(s11);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Dup1(s19);
      var s21 := Dup4(s20);
      assert s21.Peek(7) == 0x281;
      assert s21.Peek(11) == 0x240;
      assert s21.Peek(16) == 0xdf;
      var s22 := Keccak256(s21);
      var s23 := Swap4(s22);
      var s24 := Swap1(s23);
      ...
      var s36 := Jump(s35);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s120(s36, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(4) == 0x240;
      assert s1.Peek(9) == 0xdf;
      var s2 := Push2(s1, 0x028b);
      var s3 := Swap2(s2);
      var s4 := Swap1(s3);
      var s5 := Push2(s4, 0x0801);
      var s6 := Jump(s5);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(9) == 0xdf;
      var s2 := Push1(s1, 0x00);
      var s3 := Push2(s2, 0x0488);
      var s4 := Dup5(s3);
      var s5 := Dup5(s4);
      var s6 := Push2(s5, 0x032d);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Dup1(s19);
      var s21 := Dup4(s20);
      assert s21.Peek(7) == 0x488;
      assert s21.Peek(12) == 0x258;
      assert s21.Peek(18) == 0xdf;
      var s22 := Keccak256(s21);
      var s23 := Swap4(s22);
      var s24 := Swap1(s23);
      var s25 := Swap5(s24);
      ...
      var s30 := Swap1(s29);
      var s31 := Swap2(s30);
      assert s31.Peek(4) == 0x488;
      assert s31.Peek(9) == 0x258;
      ...
      var s36 := Jump(s35);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s154(s36, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Dup3(s19);
      var s21 := Add(s20);
      assert s21.Peek(7) == 0x258;
      assert s21.Peek(13) == 0xdf;
      var s22 := MStore(s21);
      var s23 := Push1(s22, 0x64);
      var s24 := Add(s23);
      var s25 := Push2(s24, 0x0309);
      var s26 := Jump(s25);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Dup3(s9);
      var s11 := Add(s10);
      assert s11.Peek(6) == 0x4f0;
      assert s11.Peek(11) == 0x258;
      assert s11.Peek(17) == 0xdf;
      var s12 := MStore(s11);
      var s13 := Push1(s12, 0x24);
      var s14 := Dup1(s13);
      var s15 := Dup3(s14);
      ...
      var s20 := Dup3(s19);
      var s21 := Add(s20);
      assert s21.Peek(6) == 0x4f0;
      assert s21.Peek(11) == 0x258;
      assert s21.Peek(17) == 0xdf;
      var s22 := MStore(s21);
      var s23 := Push4(s22, 0x72657373);
      var s24 := Push1(s23, 0xe0);
      var s25 := Shl(s24);
      ...
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s161(s33, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x00);
      var s11 := Dup2(s10);
      assert s11.Peek(7) == 0x4f0;
      assert s11.Peek(12) == 0x258;
      ...
      var s20 := Dup1(s19);
      var s21 := Dup4(s20);
      assert s21.Peek(10) == 0x4f0;
      assert s21.Peek(15) == 0x258;
      assert s21.Peek(21) == 0xdf;
      var s22 := Keccak256(s21);
      var s23 := Swap5(s22);
      var s24 := Dup8(s23);
      var s25 := And(s24);
      ...
      var s30 := Dup3(s29);
      var s31 := MStore(s30);
      assert s31.Peek(8) == 0x4f0;
      assert s31.Peek(13) == 0x258;
      assert s31.Peek(19) == 0xdf;
      var s32 := Swap2(s31);
      var s33 := Dup3(s32);
      var s34 := Swap1(s33);
      var s35 := Keccak256(s34);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Dup2(s0);
      assert s1.Peek(9) == 0x4f0;
      assert s1.Peek(14) == 0x258;
      assert s1.Peek(20) == 0xdf;
      var s2 := MStore(s1);
      var s3 := Push32(s2, 0x8c5be1e5ebec7d5bd14f71427d1e84f3dd0314c0f7b2291e5b200ac8c7c3b925);
      var s4 := Swap2(s3);
      var s5 := Add(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Dup1(s29);
      var s31 := Dup4(s30);
      assert s31.Peek(11) == 0x263;
      assert s31.Peek(17) == 0xdf;
      var s32 := MStore(s31);
      var s33 := Swap2(s32);
      var s34 := Dup5(s33);
      var s35 := Swap1(s34);
