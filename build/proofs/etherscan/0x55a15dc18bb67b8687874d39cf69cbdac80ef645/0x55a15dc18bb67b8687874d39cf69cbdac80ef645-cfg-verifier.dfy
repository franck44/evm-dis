...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s8 := Push2(s7, 0x0f6b);
      var s9 := Dup2(s8);
      var s10 := Push2(s9, 0x0ea8);
      var s11 := Jump(s10);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x1022);
      assert s1.Peek(0) == 0x1022;
      assert s1.Peek(5) == 0xdf8;
      assert s1.Peek(9) == 0x58d;
      assert s1.Peek(12) == 0x59b;
      assert s1.Peek(13) == 0x20a;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0faa);
      assert s1.Peek(0) == 0xfaa;
      assert s1.Peek(6) == 0x104f;
      assert s1.Peek(10) == 0xdf8;
      assert s1.Peek(14) == 0x58d;
      assert s1.Peek(17) == 0x59b;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s128(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[0] == 0xfaa

    requires s0.stack[6] == 0x104f
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x24);
      var s11 := Push0(s10);
      assert s11.Peek(2) == 0xfaa;
      assert s11.Peek(8) == 0x104f;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x1017);
      assert s1.Peek(0) == 0x1017;
      assert s1.Peek(5) == 0xdf8;
      assert s1.Peek(9) == 0x58d;
      assert s1.Peek(12) == 0x59b;
      assert s1.Peek(13) == 0x20a;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x0ef8);
      assert s11.Peek(0) == 0xef8;
