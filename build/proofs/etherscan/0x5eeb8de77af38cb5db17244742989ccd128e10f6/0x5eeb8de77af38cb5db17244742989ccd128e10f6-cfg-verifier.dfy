...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s8 := Add(s7);
      var s9 := Swap1(s8);
      var s10 := Push2(s9, 0x015b);
      var s11 := Swap2(s10);
      assert s11.Peek(2) == 0x15b;
      assert s11.Peek(3) == 0x160;
      var s12 := Swap1(s11);
      var s13 := Push2(s12, 0x0690);
      var s14 := Jump(s13);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s5 := Swap1(s4);
      var s6 := Pop(s5);
      var s7 := Push2(s6, 0x05df);
      var s8 := Dup2(s7);
      var s9 := Push2(s8, 0x05bb);
      var s10 := Jump(s9);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s16(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0x5df

    requires s0.stack[5] == 0x6b2
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x5df;
      assert s1.Peek(5) == 0x6b2;
      assert s1.Peek(10) == 0x15b;
      assert s1.Peek(11) == 0x160;
      var s2 := Push2(s1, 0x05c4);
      var s3 := Dup2(s2);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s17(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0x5c4

    requires s0.stack[3] == 0x5df

    requires s0.stack[7] == 0x6b2

    requires s0.stack[12] == 0x15b

    requires s0.stack[13] == 0x160
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x5c4;
      assert s1.Peek(3) == 0x5df;
      assert s1.Peek(7) == 0x6b2;
      assert s1.Peek(12) == 0x15b;
      assert s1.Peek(13) == 0x160;
      var s2 := Push0(s1);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s18(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[4] == 0x5c4

    requires s0.stack[6] == 0x5df

    requires s0.stack[10] == 0x6b2

    requires s0.stack[15] == 0x15b

    requires s0.stack[16] == 0x160
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(4) == 0x5c4;
      assert s1.Peek(6) == 0x5df;
      assert s1.Peek(10) == 0x6b2;
      assert s1.Peek(15) == 0x15b;
      assert s1.Peek(16) == 0x160;
      var s2 := Push0(s1);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s19(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0x5c4

    requires s0.stack[5] == 0x5df

    requires s0.stack[9] == 0x6b2
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0x5c4;
      assert s1.Peek(5) == 0x5df;
      assert s1.Peek(9) == 0x6b2;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s20(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x5df

    requires s0.stack[6] == 0x6b2
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x5df;
      assert s1.Peek(6) == 0x6b2;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s23(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0x6b2

    requires s0.stack[8] == 0x15b

    requires s0.stack[9] == 0x160
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s17 := Jump(s16);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s30(s17, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Sub(s9);
      var s11 := Push0(s10);
      assert s11.Peek(4) == 0x43c;
      assert s11.Peek(6) == 0x160;
      var s12 := Dup4(s11);
      var s13 := Add(s12);
      var s14 := MStore(s13);
      var s15 := Push2(s14, 0x07d8);
      var s16 := Dup2(s15);
      var s17 := Push2(s16, 0x079f);
      var s18 := Jump(s17);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x7d8;
      assert s1.Peek(4) == 0x43c;
      assert s1.Peek(6) == 0x160;
      var s2 := Push0(s1);
      var s3 := Push2(s2, 0x07ab);
      var s4 := Push1(s3, 0x20);
      var s5 := Dup4(s4);
      var s6 := Push2(s5, 0x06bb);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s34(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x7ab

    requires s0.stack[5] == 0x7d8
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x7ab;
      assert s1.Peek(5) == 0x7d8;
      ...
      var s10 := Pop(s9);
      var s11 := Swap3(s10);
      assert s11.Peek(0) == 0x7ab;
      assert s11.Peek(6) == 0x7d8;
      assert s11.Peek(9) == 0x43c;
      assert s11.Peek(11) == 0x160;
      var s12 := Swap2(s11);
      var s13 := Pop(s12);
      var s14 := Pop(s13);
      var s15 := Jump(s14);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s36(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0x7b6

    requires s0.stack[4] == 0x7d8
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s37(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x7d8

    requires s0.stack[5] == 0x43c
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x7d8;
      assert s1.Peek(5) == 0x43c;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Push1(s5, 0x04);
      var s7 := Add(s6);
      var s8 := Push2(s7, 0x04aa);
      var s9 := Swap1(s8);
      var s10 := Push2(s9, 0x084f);
      var s11 := Jump(s10);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x866;
      assert s1.Peek(4) == 0x4aa;
      assert s1.Peek(6) == 0x160;
      var s2 := Push0(s1);
      var s3 := Push2(s2, 0x0839);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s44(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x839

    requires s0.stack[5] == 0x866

    requires s0.stack[8] == 0x4aa
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x839;
      assert s1.Peek(5) == 0x866;
      assert s1.Peek(8) == 0x4aa;
      assert s1.Peek(10) == 0x160;
      var s2 := Push0(s1);
      var s3 := Dup3(s2);
      var s4 := Dup3(s3);
      ...
      var s10 := Pop(s9);
      var s11 := Swap3(s10);
      assert s11.Peek(0) == 0x839;
      assert s11.Peek(6) == 0x866;
      assert s11.Peek(9) == 0x4aa;
      assert s11.Peek(11) == 0x160;
      var s12 := Swap2(s11);
      var s13 := Pop(s12);
      var s14 := Pop(s13);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s45(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0x866

    requires s0.stack[6] == 0x4aa
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0x866;
      assert s1.Peek(6) == 0x4aa;
      assert s1.Peek(8) == 0x160;
      var s2 := Swap2(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x0844);
      var s5 := Dup3(s4);
      var s6 := Push2(s5, 0x07df);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s46(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[4] == 0x866

    requires s0.stack[7] == 0x4aa
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(4) == 0x866;
      assert s1.Peek(7) == 0x4aa;
      assert s1.Peek(9) == 0x160;
      ...
      var s10 := Add(s9);
      var s11 := MStore(s10);
      assert s11.Peek(1) == 0x844;
      assert s11.Peek(4) == 0x866;
      assert s11.Peek(7) == 0x4aa;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Exp(s19);
      var s21 := Dup2(s20);
      assert s21.Peek(6) == 0x4bc;
      assert s21.Peek(8) == 0x160;
      var s22 := SLoad(s21);
      var s23 := Dup2(s22);
      ...
      var s31 := And(s30);
      assert s31.Peek(7) == 0x4bc;
      assert s31.Peek(9) == 0x160;
      var s32 := Mul(s31);
      var s33 := Or(s32);
      var s34 := Swap1(s33);
      var s35 := SStore(s34);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Swap1(s5);
      var s7 := Pop(s6);
      var s8 := Push2(s7, 0x068a);
      var s9 := Push0(s8);
      var s10 := Dup4(s9);
      var s11 := Add(s10);
      assert s11.Peek(1) == 0x68a;
      assert s11.Peek(5) == 0x13d;
      var s12 := Dup5(s11);
      var s13 := Push2(s12, 0x0668);
      var s14 := Jump(s13);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s59(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x68a

    requires s0.stack[6] == 0x13d
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x68a;
      assert s1.Peek(6) == 0x13d;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s60(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0x671

    requires s0.stack[4] == 0x68a

    requires s0.stack[8] == 0x13d
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x671;
      assert s1.Peek(4) == 0x68a;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s61(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[4] == 0x671

    requires s0.stack[7] == 0x68a

    requires s0.stack[11] == 0x13d
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x5b4;
      assert s1.Peek(4) == 0x671;
      assert s1.Peek(7) == 0x68a;
      assert s1.Peek(11) == 0x13d;
      var s2 := Push0(s1);
      var s3 := Push20(s2, 0xffffffffffffffffffffffffffffffffffffffff);
      var s4 := Dup3(s3);
      var s5 := And(s4);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s62(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0x671

    requires s0.stack[6] == 0x68a

    requires s0.stack[10] == 0x13d
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0x671;
      assert s1.Peek(6) == 0x68a;
      assert s1.Peek(10) == 0x13d;
      var s2 := Swap1(s1);
      var s3 := Pop(s2);
      var s4 := Swap2(s3);
      var s5 := Swap1(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Jump(s1);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s111(s2, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x062f);
      assert s11.Peek(0) == 0x62f;
      assert s11.Peek(7) == 0x9f;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x062e);
      assert s1.Peek(0) == 0x62e;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s142(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[10] == 0x63c

    requires s0.stack[17] == 0x9f

    requires s0.stack[18] == 0xa4
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(4) == 0x5c4;
      assert s1.Peek(6) == 0x5df;
      assert s1.Peek(10) == 0x63c;
      assert s1.Peek(17) == 0x9f;
      assert s1.Peek(18) == 0xa4;
      var s2 := Push0(s1);
      var s3 := Push20(s2, 0xffffffffffffffffffffffffffffffffffffffff);
      var s4 := Dup3(s3);
      var s5 := And(s4);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s143(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[9] == 0x63c

    requires s0.stack[16] == 0x9f

    requires s0.stack[17] == 0xa4
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(3) == 0x5c4;
      assert s1.Peek(5) == 0x5df;
      assert s1.Peek(9) == 0x63c;
      assert s1.Peek(16) == 0x9f;
      assert s1.Peek(17) == 0xa4;
      var s2 := Swap1(s1);
      var s3 := Pop(s2);
      var s4 := Swap2(s3);
      var s5 := Swap1(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Push2(s5, 0x064d);
      var s7 := Dup7(s6);
      var s8 := Dup3(s7);
      var s9 := Dup8(s8);
      var s10 := Add(s9);
      var s11 := Push2(s10, 0x05d1);
      assert s11.Peek(0) == 0x5d1;
      assert s11.Peek(3) == 0x64d;
      assert s11.Peek(10) == 0x9f;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s4 := Pop(s3);
      var s5 := Push1(s4, 0x40);
      var s6 := Push2(s5, 0x065e);
      var s7 := Dup7(s6);
      var s8 := Dup3(s7);
      var s9 := Dup8(s8);
      var s10 := Add(s9);
      var s11 := Push2(s10, 0x0604);
      assert s11.Peek(0) == 0x604;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s5 := Swap1(s4);
      var s6 := Pop(s5);
      var s7 := Push2(s6, 0x0612);
      var s8 := Dup2(s7);
      var s9 := Push2(s8, 0x05ee);
      var s10 := Jump(s9);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s160(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0x612

    requires s0.stack[5] == 0x65e
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x612;
      assert s1.Peek(5) == 0x65e;
      assert s1.Peek(12) == 0x9f;
      assert s1.Peek(13) == 0xa4;
      var s2 := Push2(s1, 0x05f7);
      var s3 := Dup2(s2);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s161(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0x612

    requires s0.stack[7] == 0x65e
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x612;
      assert s1.Peek(6) == 0x65e;
      assert s1.Peek(13) == 0x9f;
      assert s1.Peek(14) == 0xa4;
      var s2 := Dup2(s1);
      var s3 := Eq(s2);
      var s4 := Push2(s3, 0x0601);
      var s5 := JumpI(s4);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s4.stack[1] > 0 then
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s17 := And(s16);
      var s18 := Eq(s17);
      var s19 := Push2(s18, 0x01f1);
      var s20 := JumpI(s19);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s19.stack[1] > 0 then
        ExecuteFromCFGNode_s178(s20, gas - 1)
      else
        ExecuteFromCFGNode_s169(s20, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Sub(s9);
      var s11 := Push0(s10);
      assert s11.Peek(4) == 0x1e8;
      assert s11.Peek(8) == 0xa4;
      var s12 := Dup4(s11);
      var s13 := Add(s12);
      var s14 := MStore(s13);
      var s15 := Push2(s14, 0x072c);
      var s16 := Dup2(s15);
      var s17 := Push2(s16, 0x06f3);
      var s18 := Jump(s17);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x72c;
      assert s1.Peek(4) == 0x1e8;
      assert s1.Peek(8) == 0xa4;
      var s2 := Push0(s1);
      var s3 := Push2(s2, 0x06ff);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s172(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x6ff

    requires s0.stack[5] == 0x72c
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x6ff;
      assert s1.Peek(5) == 0x72c;
      ...
      var s10 := Pop(s9);
      var s11 := Swap3(s10);
      assert s11.Peek(0) == 0x6ff;
      assert s11.Peek(6) == 0x72c;
      assert s11.Peek(9) == 0x1e8;
      assert s11.Peek(13) == 0xa4;
      var s12 := Swap2(s11);
      var s13 := Pop(s12);
      var s14 := Pop(s13);
      var s15 := Jump(s14);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0x72c;
      assert s1.Peek(6) == 0x1e8;
      assert s1.Peek(10) == 0xa4;
      var s2 := Swap2(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x070a);
      var s5 := Dup3(s4);
      var s6 := Push2(s5, 0x06cb);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s174(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0x70a

    requires s0.stack[4] == 0x72c
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x70a;
      assert s1.Peek(4) == 0x72c;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s29 := Add(s28);
      var s30 := Push2(s29, 0x024f);
      var s31 := Swap4(s30);
      assert s31.Peek(4) == 0x24f;
      assert s31.Peek(10) == 0xa4;
      var s32 := Swap3(s31);
      var s33 := Swap2(s32);
      var s34 := Swap1(s33);
      var s35 := Push2(s34, 0x0742);
      var s36 := Jump(s35);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s179(s36, gas - 1)
  }
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s182(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[7] == 0x755

    requires s0.stack[13] == 0x24f

    requires s0.stack[19] == 0xa4
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(1) == 0x5b4;
      assert s1.Peek(4) == 0x671;
      assert s1.Peek(7) == 0x755;
      assert s1.Peek(13) == 0x24f;
      assert s1.Peek(19) == 0xa4;
      var s2 := Push0(s1);
      var s3 := Push20(s2, 0xffffffffffffffffffffffffffffffffffffffff);
      var s4 := Dup3(s3);
      var s5 := And(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(5) == 0x24f;
      assert s1.Peek(11) == 0xa4;
      var s2 := Push2(s1, 0x0762);
      var s3 := Push1(s2, 0x20);
      var s4 := Dup4(s3);
      var s5 := Add(s4);
      var s6 := Dup6(s5);
      var s7 := Push2(s6, 0x0668);
      var s8 := Jump(s7);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(5) == 0x24f;
      assert s1.Peek(11) == 0xa4;
      var s2 := Push2(s1, 0x076f);
      var s3 := Push1(s2, 0x40);
      var s4 := Dup4(s3);
      var s5 := Add(s4);
      var s6 := Dup5(s5);
      var s7 := Push2(s6, 0x0733);
      var s8 := Jump(s7);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s14 := Dup1(s13);
      var s15 := IsZero(s14);
      var s16 := Push2(s15, 0x0266);
      var s17 := JumpI(s16);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s16.stack[1] > 0 then
        ExecuteFromCFGNode_s198(s17, gas - 1)
      else
