...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s3 := Push32(s2, 0x000000000000000000000000268ca24daeff1fac2ed883c598200ccbb79e931d);
      var s4 := Dup2(s3);
      var s5 := Jump(s4);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s3 := Caller(s2);
      var s4 := Push20(s3, 0xffffffffffffffffffffffffffffffffffffffff);
      var s5 := Push32(s4, 0x000000000000000000000000268ca24daeff1fac2ed883c598200ccbb79e931d);
      var s6 := And(s5);
      var s7 := Eq(s6);
