...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s8 := Add(s7);
      var s9 := Swap1(s8);
      var s10 := Push2(s9, 0x0221);
      var s11 := Swap2(s10);
      assert s11.Peek(2) == 0x221;
      assert s11.Peek(3) == 0x226;
      var s12 := Swap1(s11);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s137(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[10] == 0x221

    requires s0.stack[11] == 0x226
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(10) == 0x221;
      assert s1.Peek(11) == 0x226;
      var s2 := Push2(s1, 0x0de2);
      var s3 := Dup2(s2);
      var s4 := Push2(s3, 0x0dc8);
      var s5 := Jump(s4);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s139(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[15] == 0x221

    requires s0.stack[16] == 0x226
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s19 := Dup1(s18);
      var s20 := IsZero(s19);
      var s21 := Push2(s20, 0x059c);
      assert s21.Peek(0) == 0x59c;
      assert s21.Peek(4) == 0x226;
      var s22 := JumpI(s21);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s21.stack[1] > 0 then
        ExecuteFromCFGNode_s149(s22, gas - 1)
      else
        ExecuteFromCFGNode_s148(s22, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x226;
      var s2 := Dup1(s1);
      var s3 := IsZero(s2);
      var s4 := Push2(s3, 0x05db);
      var s5 := JumpI(s4);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s4.stack[1] > 0 then
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s3 := Push20(s2, 0xffffffffffffffffffffffffffffffffffffffff);
      var s4 := And(s3);
      var s5 := Push2(s4, 0x05c2);
      var s6 := Push2(s5, 0x044b);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := MLoad(s9);
      var s11 := Dup4(s10);
      assert s11.Peek(7) == 0x5c2;
      assert s11.Peek(10) == 0x226;
      ...
      var s19 := Add(s18);
      var s20 := Push2(s19, 0x04af);
      var s21 := Swap3(s20);
      assert s21.Peek(3) == 0x4af;
      assert s21.Peek(7) == 0x5c2;
      assert s21.Peek(10) == 0x226;
      var s22 := Swap2(s21);
      var s23 := Swap1(s22);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(6) == 0x4af;
      assert s11.Peek(10) == 0x5c2;
      assert s11.Peek(13) == 0x226;
      var s12 := Dup6(s11);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s153(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[11] == 0x5c2

    requires s0.stack[14] == 0x226
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(11) == 0x5c2;
      assert s1.Peek(14) == 0x226;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s155(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[12] == 0x4af

    requires s0.stack[16] == 0x5c2

    requires s0.stack[19] == 0x226
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(12) == 0x4af;
      assert s1.Peek(16) == 0x5c2;
      assert s1.Peek(19) == 0x226;
      var s2 := Push0(s1);
      var s3 := Push20(s2, 0xffffffffffffffffffffffffffffffffffffffff);
      var s4 := Dup3(s3);
      var s5 := And(s4);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s156(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[11] == 0x4af

    requires s0.stack[15] == 0x5c2

    requires s0.stack[18] == 0x226
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(11) == 0x4af;
      assert s1.Peek(15) == 0x5c2;
      assert s1.Peek(18) == 0x226;
      var s2 := Swap1(s1);
      var s3 := Pop(s2);
      var s4 := Swap2(s3);
      var s5 := Swap1(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(8) == 0x226;
      var s12 := IsZero(s11);
      var s13 := Dup1(s12);
      var s14 := IsZero(s13);
      var s15 := Push2(s14, 0x04ca);
      var s16 := JumpI(s15);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s21.Peek(7) == 0x226;
      var s22 := Add(s21);
      var s23 := Swap1(s22);
      var s24 := Push2(s23, 0x04ee);
      var s25 := Swap2(s24);
      var s26 := Swap1(s25);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s175(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[17] == 0x5c2

    requires s0.stack[20] == 0x226
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(17) == 0x5c2;
      assert s1.Peek(20) == 0x226;
      var s2 := Push0(s1);
      var s3 := Push20(s2, 0xffffffffffffffffffffffffffffffffffffffff);
      var s4 := Dup3(s3);
      var s5 := And(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s25 := Jump(s24);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s192(s25, gas - 1)
  }
