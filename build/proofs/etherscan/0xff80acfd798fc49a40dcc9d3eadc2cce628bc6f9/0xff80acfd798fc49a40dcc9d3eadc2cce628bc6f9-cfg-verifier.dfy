...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x8d2;
      assert s11.Peek(9) == 0x194;
      assert s11.Peek(10) == 0xef;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x0839);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Dup1(s9);
      var s11 := IsZero(s10);
      assert s11.Peek(5) == 0x25b;
      assert s11.Peek(10) == 0xdb;
      var s12 := Swap1(s11);
      var s13 := Push2(s12, 0x050b);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s13.stack[1] > 0 then
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s17 := Add(s16);
      var s18 := MStore(s17);
      var s19 := Push32(s18, 0x45524332303a207472616e7366657220746865207a65726f2061646472657373);
      var s20 := Push1(s19, 0x44);
      var s21 := Dup3(s20);
      assert s21.Peek(7) == 0x25b;
      assert s21.Peek(12) == 0xdb;
      var s22 := Add(s21);
      var s23 := MStore(s22);
      var s24 := Push1(s23, 0x64);
      var s25 := Add(s24);
      var s26 := Push2(s25, 0x02de);
      var s27 := Jump(s26);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s40(s27, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Swap1(s29);
      var s31 := Dup8(s30);
      assert s31.Peek(4) == 0x583;
      assert s31.Peek(9) == 0x25b;
      assert s31.Peek(14) == 0xdb;
      var s32 := Push2(s31, 0x066e);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0683);
      assert s1.Peek(0) == 0x683;
      assert s1.Peek(6) == 0x583;
      assert s1.Peek(11) == 0x25b;
      assert s1.Peek(16) == 0xdb;
      var s2 := Dup5(s1);
      var s3 := Dup5(s2);
      var s4 := Dup5(s3);
      var s5 := Push2(s4, 0x075e);
      var s6 := Jump(s5);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(9) == 0x583;
      assert s1.Peek(14) == 0x25b;
      assert s1.Peek(19) == 0xdb;
      var s2 := Push1(s1, 0x40);
      var s3 := MLoad(s2);
      var s4 := Push4(s3, 0x5f94f14f);
      ...
      assert s11.Peek(13) == 0x583;
      assert s11.Peek(18) == 0x25b;
      assert s11.Peek(23) == 0xdb;
      var s12 := Add(s11);
      var s13 := Dup2(s12);
      var s14 := Swap1(s13);
      var s15 := MStore(s14);
      ...
      var s20 := Swap1(s19);
      var s21 := MStore(s20);
      assert s21.Peek(5) == 0x683;
      assert s21.Peek(11) == 0x583;
      assert s21.Peek(16) == 0x25b;
      ...
      var s31 := Dup5(s30);
      assert s31.Peek(9) == 0x683;
      assert s31.Peek(15) == 0x583;
      assert s31.Peek(20) == 0x25b;
      assert s31.Peek(25) == 0xdb;
      var s32 := Add(s31);
      var s33 := MStore(s32);
      var s34 := Swap1(s33);
      var s35 := Swap2(s34);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s45(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[7] == 0x683

    requires s0.stack[13] == 0x583

    requires s0.stack[18] == 0x25b
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(8) == 0x683;
      assert s1.Peek(14) == 0x583;
      assert s1.Peek(19) == 0x25b;
      ...
      var s10 := Dup7(s9);
      var s11 := Gas(s10);
      assert s11.Peek(13) == 0x683;
      assert s11.Peek(19) == 0x583;
      assert s11.Peek(24) == 0x25b;
      assert s11.Peek(29) == 0xdb;
      var s12 := StaticCall(s11);
      var s13 := IsZero(s12);
      var s14 := Dup1(s13);
      var s15 := IsZero(s14);
      var s16 := Push2(s15, 0x07b4);
      var s17 := JumpI(s16);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s46(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[8] == 0x683

    requires s0.stack[14] == 0x583

    requires s0.stack[19] == 0x25b
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(15) == 0x583;
      assert s1.Peek(20) == 0x25b;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(14) == 0x583;
      assert s11.Peek(19) == 0x25b;
      assert s11.Peek(24) == 0xdb;
      var s12 := Dup3(s11);
      var s13 := Add(s12);
      var s14 := And(s13);
      var s15 := Dup3(s14);
      ...
      var s20 := Pop(s19);
      var s21 := Dup2(s20);
      assert s21.Peek(7) == 0x683;
      assert s21.Peek(13) == 0x583;
      assert s21.Peek(18) == 0x25b;
      assert s21.Peek(23) == 0xdb;
      var s22 := Add(s21);
      var s23 := Swap1(s22);
      var s24 := Push2(s23, 0x0695);
      var s25 := Swap2(s24);
      var s26 := Swap1(s25);
      var s27 := Push2(s26, 0x095b);
      var s28 := Jump(s27);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(7) == 0x683;
      assert s1.Peek(13) == 0x583;
      assert s1.Peek(18) == 0x25b;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s16 := Add(s15);
      var s17 := MStore(s16);
      var s18 := Push32(s17, 0x45524332303a20616d6f756e74206f7665722062616c616e6365000000000000);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Dup3(s9);
      var s11 := Add(s10);
      assert s11.Peek(6) == 0x5df;
      assert s11.Peek(11) == 0x25b;
      ...
      var s16 := Add(s15);
      var s17 := MStore(s16);
      var s18 := Push32(s17, 0x536166654d6174683a207375627472616374696f6e206f766572666c6f770000);
      var s19 := Push1(s18, 0x44);
      var s20 := Dup3(s19);
      var s21 := Add(s20);
      assert s21.Peek(6) == 0x5df;
      assert s21.Peek(11) == 0x25b;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0261);
      assert s1.Peek(0) == 0x261;
      assert s1.Peek(4) == 0x695;
      assert s1.Peek(9) == 0x5df;
      assert s1.Peek(14) == 0x25b;
      assert s1.Peek(19) == 0xdb;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s64(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[0] == 0x261

    requires s0.stack[4] == 0x695

    requires s0.stack[9] == 0x5df
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(6) == 0x695;
      assert s11.Peek(11) == 0x5df;
      assert s11.Peek(16) == 0x25b;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s31 := SLoad(s30);
      assert s31.Peek(5) == 0x25b;
      assert s31.Peek(10) == 0xdb;
      var s32 := Push2(s31, 0x060d);
      var s33 := Swap1(s32);
      var s34 := Dup4(s33);
      var s35 := Push2(s34, 0x06f9);
      var s36 := Jump(s35);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s68(s36, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push0(s1);
      var s3 := Dup1(s2);
      var s4 := Push2(s3, 0x0705);
      var s5 := Dup4(s4);
      var s6 := Dup6(s5);
      var s7 := Push2(s6, 0x0948);
      var s8 := Jump(s7);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Jump(s0);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s79(s1, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s4 := Dup1(s3);
      var s5 := SLoad(s4);
      var s6 := Push2(s5, 0x01cd);
      var s7 := Swap1(s6);
      var s8 := Push2(s7, 0x08e9);
      var s9 := Jump(s8);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s29 := Dup1(s28);
      var s30 := SLoad(s29);
      var s31 := Push2(s30, 0x01f9);
      assert s31.Peek(0) == 0x1f9;
      assert s31.Peek(8) == 0xb2;
      var s32 := Swap1(s31);
      var s33 := Push2(s32, 0x08e9);
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := And(s29);
      var s31 := Swap1(s30);
      assert s31.Peek(2) == 0x14f;
      var s32 := SStore(s31);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s115(s33, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x0878);
      assert s11.Peek(0) == 0x878;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s33 := Dup2(s32);
      var s34 := Eq(s33);
      var s35 := Push2(s34, 0x02f4);
      var s36 := JumpI(s35);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s35.stack[1] > 0 then
        ExecuteFromCFGNode_s157(s36, gas - 1)
      else
        ExecuteFromCFGNode_s146(s36, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s24 := Add(s23);
      //  Go to the next instruction at pc + 1
      ExecuteFromCFGNode_s148(s24, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s32 := Push2(s31, 0x02de);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s152(s33, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s31 := Dup8(s30);
      assert s31.Peek(4) == 0x583;
      assert s31.Peek(9) == 0x2ff;
      assert s31.Peek(16) == 0xdb;
      var s32 := Push2(s31, 0x066e);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s164(s33, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s31.Peek(9) == 0x683;
      assert s31.Peek(15) == 0x583;
      assert s31.Peek(20) == 0x2ff;
      assert s31.Peek(27) == 0xdb;
      var s32 := Add(s31);
      var s33 := MStore(s32);
      var s34 := Swap1(s33);
      var s35 := Swap2(s34);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(8) == 0x683;
      assert s1.Peek(14) == 0x583;
      assert s1.Peek(19) == 0x2ff;
      assert s1.Peek(26) == 0xdb;
      var s2 := Add(s1);
      var s3 := Push1(s2, 0x20);
      var s4 := Push1(s3, 0x40);
      var s5 := MLoad(s4);
      ...
      assert s11.Peek(13) == 0x683;
      assert s11.Peek(19) == 0x583;
      assert s11.Peek(24) == 0x2ff;
      assert s11.Peek(31) == 0xdb;
      var s12 := StaticCall(s11);
      var s13 := IsZero(s12);
      var s14 := Dup1(s13);
      var s15 := IsZero(s14);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s168(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[19] == 0x2ff

    requires s0.stack[26] == 0xdb
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(8) == 0x683;
      assert s11.Peek(14) == 0x583;
      assert s11.Peek(19) == 0x2ff;
      assert s11.Peek(26) == 0xdb;
      var s12 := Dup3(s11);
      var s13 := Add(s12);
      var s14 := And(s13);
      var s15 := Dup3(s14);
      ...
      assert s21.Peek(7) == 0x683;
      assert s21.Peek(13) == 0x583;
      assert s21.Peek(18) == 0x2ff;
      assert s21.Peek(25) == 0xdb;
      var s22 := Add(s21);
      var s23 := Swap1(s22);
      var s24 := Push2(s23, 0x0695);
      var s25 := Swap2(s24);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s36 := Jump(s35);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s190(s36, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s21 := Add(s20);
      assert s21.Peek(7) == 0x60d;
      assert s21.Peek(12) == 0x2ff;
      assert s21.Peek(19) == 0xdb;
      var s22 := MStore(s21);
      var s23 := Push1(s22, 0x64);
      var s24 := Add(s23);
      var s25 := Push2(s24, 0x02de);
      var s26 := Jump(s25);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s197(s26, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Jump(s0);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s201(s1, gas - 1)
  }
