...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push2(s1, 0x07f2);
      var s3 := Dup4(s2);
      var s4 := Push2(s3, 0x073c);
      var s5 := Jump(s4);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x7f2;
      assert s11.Peek(9) == 0x196;
      assert s11.Peek(10) == 0xef;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x0752);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s26 := MLoad(s25);
      var s27 := Push2(s26, 0x06e3);
      var s28 := Swap2(s27);
      var s29 := Dup2(s28);
      var s30 := MStore(s29);
      var s31 := Push1(s30, 0x20);
      assert s31.Peek(2) == 0x6e3;
      assert s31.Peek(10) == 0x25c;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s4 := Dup1(s3);
      var s5 := SLoad(s4);
      var s6 := Push2(s5, 0x01cf);
      var s7 := Swap1(s6);
      var s8 := Push2(s7, 0x0809);
      var s9 := Jump(s8);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s29 := Dup1(s28);
      var s30 := SLoad(s29);
      var s31 := Push2(s30, 0x01fb);
      assert s31.Peek(0) == 0x1fb;
      assert s31.Peek(8) == 0xb2;
      var s32 := Swap1(s31);
      var s33 := Push2(s32, 0x0809);
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s31.Peek(5) == 0xdb;
      var s32 := Swap2(s31);
      var s33 := Push2(s32, 0x025c);
      var s34 := Swap2(s33);
      var s35 := Dup6(s34);
      var s36 := Swap1(s35);
      var s37 := Push2(s36, 0x0349);
      var s38 := Swap1(s37);
      var s39 := Dup7(s38);
      var s40 := Swap1(s39);
      var s41 := Push2(s40, 0x0841);
      //  Go to the next instruction at pc + 1
