...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0a11);
      assert s1.Peek(0) == 0xa11;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0a87);
      assert s1.Peek(0) == 0xa87;
      assert s1.Peek(10) == 0x151;
      assert s1.Peek(11) == 0x156;
      var s2 := Dup6(s1);
