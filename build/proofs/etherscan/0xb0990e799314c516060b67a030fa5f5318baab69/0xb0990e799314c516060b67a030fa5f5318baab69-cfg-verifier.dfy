...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x9d1;
      assert s11.Peek(9) == 0x243;
      assert s11.Peek(10) == 0x148;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x08e5);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s31 := Add(s30);
      assert s31.Peek(4) == 0x2b5;
      assert s31.Peek(8) == 0x107;
      var s32 := Push2(s31, 0x045f);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s21 := And(s20);
      assert s21.Peek(4) == 0x2b5;
      assert s21.Peek(8) == 0x107;
      var s22 := IsZero(s21);
      var s23 := IsZero(s22);
      var s24 := Push1(s23, 0x01);
      var s25 := Sub(s24);
      var s26 := Push2(s25, 0x06fd);
      var s27 := JumpI(s26);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s26 := Dup2(s25);
      var s27 := Swap1(s26);
      var s28 := Push2(s27, 0x06e6);
      var s29 := Swap1(s28);
      var s30 := Dup3(s29);
      var s31 := Push2(s30, 0x0a47);
      assert s31.Peek(0) == 0xa47;
      assert s31.Peek(3) == 0x6e6;
      assert s31.Peek(9) == 0x2b5;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push2(s1, 0x06f0);
      var s3 := Swap2(s2);
      var s4 := Swap1(s3);
      var s5 := Push2(s4, 0x0a47);
      var s6 := Jump(s5);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s18 := Keccak256(s17);
      var s19 := SLoad(s18);
      var s20 := Push2(s19, 0x0797);
      var s21 := Swap1(s20);
      assert s21.Peek(1) == 0x797;
      assert s21.Peek(6) == 0x2b5;
      assert s21.Peek(10) == 0x107;
      var s22 := Dup4(s21);
      var s23 := Swap1(s22);
      var s24 := Push2(s23, 0x0a34);
      var s25 := Jump(s24);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s31.Peek(5) == 0x2b5;
      assert s31.Peek(9) == 0x107;
      var s32 := Push2(s31, 0x07c6);
      var s33 := Swap1(s32);
      var s34 := Dup4(s33);
      var s35 := Swap1(s34);
      var s36 := Push2(s35, 0x0a47);
      var s37 := Jump(s36);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s66(s37, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s29 := Dup1(s28);
      var s30 := SLoad(s29);
      var s31 := Push2(s30, 0x02f9);
      assert s31.Peek(0) == 0x2f9;
      assert s31.Peek(8) == 0x124;
      var s32 := Swap1(s31);
      var s33 := Push2(s32, 0x09e8);
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s21 := Dup3(s20);
      assert s21.Peek(4) == 0x3db;
      assert s21.Peek(5) == 0x18b;
      var s22 := Add(s21);
      var s23 := MStore(s22);
      var s24 := Push1(s23, 0x64);
      var s25 := Add(s24);
      var s26 := Push2(s25, 0x045f);
      var s27 := Jump(s26);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := And(s29);
      var s31 := Swap3(s30);
      assert s31.Peek(5) == 0x3e4;
      assert s31.Peek(6) == 0x18b;
      var s32 := Dup4(s31);
      var s33 := Swap2(s32);
      ...
      var s40 := Jump(s39);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s115(s40, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x0990);
      assert s11.Peek(0) == 0x990;
      assert s11.Peek(7) == 0x164;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s35 := Dup2(s34);
      var s36 := Eq(s35);
      var s37 := Push2(s36, 0x05ba);
      var s38 := JumpI(s37);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s37.stack[1] > 0 then
        ExecuteFromCFGNode_s191(s38, gas - 1)
      else
        ExecuteFromCFGNode_s175(s38, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s24 := Add(s23);
      var s25 := Push2(s24, 0x045f);
      var s26 := Jump(s25);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s177(s26, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(9) == 0x5ba;
      assert s11.Peek(14) == 0x36d;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      if s26.stack[1] > 0 then
        ...
        ExecuteFromCFGNode_s199(s27, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s31.Peek(0) == 0xa47;
      assert s31.Peek(3) == 0x6e6;
      assert s31.Peek(9) == 0x378;
      assert s31.Peek(15) == 0x107;
      var s32 := Jump(s31);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s200(s32, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      if s24.stack[1] > 0 then
        ...
        ExecuteFromCFGNode_s216(s25, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Jump(s0);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s230(s1, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      var s2 := Push2(s1, 0x0124);
      var s3 := Push2(s2, 0x02be);
      var s4 := Jump(s3);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s254(s4, gas - 1)
  }
