...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := IsZero(s8);
      var s10 := Dup1(s9);
      var s11 := Push2(s10, 0x05eb);
      assert s11.Peek(0) == 0x5eb;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := IsZero(s8);
      var s10 := Dup1(s9);
      var s11 := Push2(s10, 0x04c4);
      assert s11.Peek(0) == 0x4c4;
      assert s11.Peek(4) == 0x163;
      var s12 := JumpI(s11);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s11.stack[1] > 0 then
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(5) == 0x525;
      assert s11.Peek(9) == 0x163;
      var s12 := Dup2(s11);
      var s13 := Sub(s12);
      var s14 := Push2(s13, 0x0ca4);
      var s15 := JumpI(s14);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0ca4);
      assert s1.Peek(0) == 0xca4;
      assert s1.Peek(5) == 0x525;
      assert s1.Peek(9) == 0x163;
      var s2 := Push2(s1, 0x0c72);
      var s3 := Jump(s2);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s80(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[0] == 0xca4

    requires s0.stack[5] == 0x525
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(2) == 0xca4;
      assert s11.Peek(7) == 0x525;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(10) == 0x1fa;
      assert s1.Peek(11) == 0xe7;
      var s2 := Push2(s1, 0x0ad0);
      var s3 := Dup11(s2);
      var s4 := Dup4(s3);
      var s5 := Dup12(s4);
      var s6 := Add(s5);
      var s7 := Push2(s6, 0x09d8);
      var s8 := Jump(s7);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s97(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0xad0

    requires s0.stack[14] == 0x1fa
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0xad0;
      assert s1.Peek(14) == 0x1fa;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0a04);
      assert s1.Peek(0) == 0xa04;
      assert s1.Peek(6) == 0xad0;
      assert s1.Peek(17) == 0x1fa;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s100(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[0] == 0xa04

    requires s0.stack[6] == 0xad0

    requires s0.stack[17] == 0x1fa
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x24);
      var s11 := Push1(s10, 0x00);
      assert s11.Peek(2) == 0xa04;
      assert s11.Peek(8) == 0xad0;
      assert s11.Peek(19) == 0x1fa;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Gt(s19);
      var s21 := Dup2(s20);
      assert s21.Peek(9) == 0xad0;
      assert s21.Peek(20) == 0x1fa;
      assert s21.Peek(21) == 0xe7;
      var s22 := Dup4(s21);
      var s23 := Lt(s22);
      var s24 := Or(s23);
      var s25 := IsZero(s24);
      var s26 := Push2(s25, 0x0a2c);
      var s27 := JumpI(s26);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s102(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[7] == 0xad0

    requires s0.stack[18] == 0x1fa
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0a2c);
      assert s1.Peek(0) == 0xa2c;
      assert s1.Peek(8) == 0xad0;
      assert s1.Peek(19) == 0x1fa;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s103(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[8] == 0xad0

    requires s0.stack[19] == 0x1fa
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x24);
      var s11 := Push1(s10, 0x00);
      assert s11.Peek(2) == 0xa2c;
      assert s11.Peek(10) == 0xad0;
      assert s11.Peek(21) == 0x1fa;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(7) == 0xad0;
      assert s1.Peek(18) == 0x1fa;
      ...
      var s10 := Dup6(s9);
      var s11 := Dup9(s10);
      assert s11.Peek(11) == 0xad0;
      assert s11.Peek(22) == 0x1fa;
      assert s11.Peek(23) == 0xe7;
      var s12 := Add(s11);
      var s13 := Add(s12);
      var s14 := Gt(s13);
      var s15 := IsZero(s14);
      var s16 := Push2(s15, 0x0a45);
      var s17 := JumpI(s16);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(9) == 0xad0;
      assert s11.Peek(20) == 0x1fa;
      ...
      var s20 := Pop(s19);
      var s21 := Pop(s20);
      assert s21.Peek(5) == 0xad0;
      assert s21.Peek(16) == 0x1fa;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Dup1(s9);
      var s11 := Dup3(s10);
      assert s11.Peek(12) == 0x1fa;
      assert s11.Peek(13) == 0xe7;
      var s12 := Gt(s11);
      var s13 := IsZero(s12);
      var s14 := Push2(s13, 0x0ae6);
      var s15 := JumpI(s14);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s14.stack[1] > 0 then
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(11) == 0xe7;
      var s2 := Pop(s1);
      var s3 := Push2(s2, 0x0af3);
      var s4 := Dup10(s3);
      var s5 := Dup3(s4);
      var s6 := Dup11(s5);
      var s7 := Add(s6);
      var s8 := Push2(s7, 0x09d8);
      var s9 := Jump(s8);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Push1(s10, 0x00);
      assert s11.Peek(2) == 0xa04;
      assert s11.Peek(8) == 0xaf3;
      assert s11.Peek(18) == 0x1fa;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Gt(s19);
      var s21 := Dup2(s20);
      assert s21.Peek(9) == 0xaf3;
      assert s21.Peek(19) == 0x1fa;
      ...
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s26.stack[1] > 0 then
        ExecuteFromCFGNode_s118(s27, gas - 1)
      else
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Pop(s19);
      var s21 := Pop(s20);
      assert s21.Peek(5) == 0xaf3;
      assert s21.Peek(15) == 0x1fa;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0xb09;
      assert s11.Peek(13) == 0x1fa;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Swap3(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x0b17);
      var s5 := Push1(s4, 0x80);
      var s6 := Dup9(s5);
      var s7 := Add(s6);
      var s8 := Push2(s7, 0x0a81);
      var s9 := Jump(s8);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0912);
      assert s1.Peek(0) == 0x912;
      assert s1.Peek(4) == 0x749;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s147(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[0] == 0x912

    requires s0.stack[4] == 0x749
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x24);
      var s11 := Push1(s10, 0x00);
      assert s11.Peek(2) == 0x912;
      assert s11.Peek(6) == 0x749;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s31 := Dup2(s30);
      assert s31.Peek(8) == 0x5c2;
      assert s31.Peek(10) == 0x357;
      assert s31.Peek(18) == 0xe7;
      var s32 := Eq(s31);
      var s33 := Push2(s32, 0x07f4);
      var s34 := JumpI(s33);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s33.stack[1] > 0 then
        ExecuteFromCFGNode_s221(s34, gas - 1)
      else
        ExecuteFromCFGNode_s166(s34, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s31 := Jump(s30);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s169(s31, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s5 := MLoad(s4);
      var s6 := Push2(s5, 0x03b9);
      var s7 := Swap2(s6);
      var s8 := Push1(s7, 0x01);
      var s9 := Push1(s8, 0x01);
      var s10 := Push1(s9, 0xa0);
      var s11 := Shl(s10);
      assert s11.Peek(4) == 0x3b9;
      assert s11.Peek(12) == 0xe7;
      var s12 := Sub(s11);
      var s13 := And(s12);
      var s14 := Swap1(s13);
      var s15 := Push2(s14, 0x039e);
      var s16 := Swap1(s15);
      var s17 := Caller(s16);
      var s18 := Swap1(s17);
      var s19 := Dup12(s18);
      var s20 := Swap1(s19);
      var s21 := Dup12(s20);
      assert s21.Peek(4) == 0x39e;
      assert s21.Peek(6) == 0x3b9;
      assert s21.Peek(14) == 0xe7;
      var s22 := Swap1(s21);
      var s23 := Dup12(s22);
      var s24 := Swap1(s23);
      ...
      var s30 := Add(s29);
      var s31 := Push2(s30, 0x0b77);
      assert s31.Peek(0) == 0xb77;
      assert s31.Peek(8) == 0x39e;
      assert s31.Peek(10) == 0x3b9;
      assert s31.Peek(18) == 0xe7;
      var s32 := Jump(s31);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s172(s32, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Shl(s9);
      var s11 := And(s10);
      assert s11.Peek(8) == 0x39e;
      assert s11.Peek(10) == 0x3b9;
      assert s11.Peek(18) == 0xe7;
      var s12 := Dup2(s11);
      var s13 := MStore(s12);
      ...
      var s15 := Dup7(s14);
      var s16 := MLoad(s15);
      var s17 := Push2(s16, 0x0b9c);
      var s18 := Dup2(s17);
      var s19 := Push1(s18, 0x14);
      var s20 := Dup6(s19);
      var s21 := Add(s20);
      assert s21.Peek(2) == 0xb9c;
      assert s21.Peek(12) == 0x39e;
      assert s21.Peek(14) == 0x3b9;
      assert s21.Peek(22) == 0xe7;
      var s22 := Push1(s21, 0x20);
      var s23 := Dup12(s22);
      var s24 := Add(s23);
      var s25 := Push2(s24, 0x0b53);
      var s26 := Jump(s25);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s173(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[13] == 0x39e

    requires s0.stack[15] == 0x3b9
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(13) == 0x39e;
      assert s1.Peek(15) == 0x3b9;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s174(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[14] == 0x39e

    requires s0.stack[16] == 0x3b9
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(14) == 0x39e;
      assert s1.Peek(16) == 0x3b9;
      assert s1.Peek(24) == 0xe7;
      var s2 := Dup4(s1);
      var s3 := Dup2(s2);
      var s4 := Lt(s3);
      var s5 := IsZero(s4);
      var s6 := Push2(s5, 0x0b6e);
      var s7 := JumpI(s6);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s6.stack[1] > 0 then
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(15) == 0x39e;
      assert s1.Peek(17) == 0x3b9;
      ...
      var s9 := Push1(s8, 0x20);
      var s10 := Add(s9);
      var s11 := Push2(s10, 0x0b56);
      assert s11.Peek(0) == 0xb56;
      assert s11.Peek(5) == 0xb9c;
      assert s11.Peek(15) == 0x39e;
      assert s11.Peek(17) == 0x3b9;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Add(s5);
      var s7 := Swap1(s6);
      var s8 := Push2(s7, 0x0bb3);
      var s9 := Dup2(s8);
      var s10 := Push1(s9, 0x14);
      var s11 := Dup5(s10);
      assert s11.Peek(3) == 0xbb3;
      assert s11.Peek(14) == 0x39e;
      assert s11.Peek(16) == 0x3b9;
      assert s11.Peek(24) == 0xe7;
      var s12 := Add(s11);
      var s13 := Push1(s12, 0x20);
      var s14 := Dup12(s13);
      var s15 := Add(s14);
      var s16 := Push2(s15, 0x0b53);
      var s17 := Jump(s16);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s178(s17, gas - 1)
  }
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s179(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[4] == 0xbb3

    requires s0.stack[15] == 0x39e

    requires s0.stack[17] == 0x3b9
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(16) == 0x39e;
      assert s1.Peek(18) == 0x3b9;
      ...
      var s11 := Push2(s10, 0x0b56);
      assert s11.Peek(0) == 0xb56;
      assert s11.Peek(5) == 0xbb3;
      assert s11.Peek(16) == 0x39e;
      assert s11.Peek(18) == 0x3b9;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s182(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[10] == 0x39e

    requires s0.stack[12] == 0x3b9
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s29 := Shl(s28);
      var s30 := And(s29);
      var s31 := Push1(s30, 0x36);
      assert s31.Peek(6) == 0x39e;
      assert s31.Peek(8) == 0x3b9;
      assert s31.Peek(16) == 0xe7;
      var s32 := Dup3(s31);
      var s33 := Add(s32);
      var s34 := MStore(s33);
      var s35 := Push1(s34, 0x38);
      var s36 := Add(s35);
      var s37 := Swap4(s36);
      var s38 := Swap3(s37);
      var s39 := Pop(s38);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Jump(s0);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s184(s1, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Sub(s29);
      var s31 := Dup2(s30);
      assert s31.Peek(5) == 0x3b9;
      assert s31.Peek(13) == 0xe7;
      var s32 := And(s31);
      var s33 := Push2(s32, 0x0912);
      var s34 := JumpI(s33);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s33.stack[1] > 0 then
        ExecuteFromCFGNode_s188(s34, gas - 1)
      else
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s18 := And(s17);
      var s19 := Swap1(s18);
      var s20 := Push4(s19, 0x8a7fb3e5);
      var s21 := Swap1(s20);
      assert s21.Peek(10) == 0xe7;
      var s22 := Push2(s21, 0x03f4);
      var s23 := Swap1(s22);
      var s24 := Caller(s23);
      var s25 := Swap1(s24);
      var s26 := Dup12(s25);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s16 := Add(s15);
      var s17 := MStore(s16);
      var s18 := Push2(s17, 0x0c33);
      var s19 := Push1(s18, 0xe0);
      var s20 := Dup5(s19);
      var s21 := Add(s20);
      assert s21.Peek(1) == 0xc33;
      assert s21.Peek(12) == 0x3f4;
      assert s21.Peek(22) == 0xe7;
      var s22 := Dup11(s21);
      var s23 := Push2(s22, 0x0be5);
      var s24 := Jump(s23);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Dup5(s5);
      var s7 := MStore(s6);
      var s8 := Push2(s7, 0x0bfd);
      var s9 := Dup2(s8);
      var s10 := Push1(s9, 0x20);
      var s11 := Dup7(s10);
      assert s11.Peek(3) == 0xbfd;
      assert s11.Peek(8) == 0xc33;
      assert s11.Peek(19) == 0x3f4;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s192(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[8] == 0xc33

    requires s0.stack[19] == 0x3f4

    requires s0.stack[29] == 0xe7
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(8) == 0xc33;
      assert s1.Peek(19) == 0x3f4;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s193(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[4] == 0xbfd

    requires s0.stack[9] == 0xc33

    requires s0.stack[20] == 0x3f4
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(4) == 0xbfd;
      assert s1.Peek(9) == 0xc33;
      assert s1.Peek(20) == 0x3f4;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(21) == 0x3f4;
      assert s1.Peek(31) == 0xe7;
      var s2 := Dup2(s1);
      var s3 := Add(s2);
      var s4 := MLoad(s3);
      var s5 := Dup4(s4);
      ...
      assert s11.Peek(10) == 0xc33;
      assert s11.Peek(21) == 0x3f4;
      assert s11.Peek(31) == 0xe7;
      var s12 := Jump(s11);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s196(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[4] == 0xc33

    requires s0.stack[15] == 0x3f4
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(4) == 0xc33;
      assert s1.Peek(15) == 0x3f4;
      assert s1.Peek(25) == 0xe7;
      ...
      var s10 := Add(s9);
      var s11 := Push1(s10, 0x20);
      assert s11.Peek(4) == 0xc33;
      assert s11.Peek(15) == 0x3f4;
      assert s11.Peek(25) == 0xe7;
      var s12 := Add(s11);
      var s13 := Swap3(s12);
      var s14 := Swap2(s13);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s7 := Add(s6);
      var s8 := MStore(s7);
      var s9 := Push2(s8, 0x0c45);
      var s10 := Dup2(s9);
      var s11 := Dup11(s10);
      assert s11.Peek(2) == 0xc45;
      assert s11.Peek(14) == 0x3f4;
      assert s11.Peek(24) == 0xe7;
      var s12 := Push2(s11, 0x0be5);
      var s13 := Jump(s12);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s198(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0xc45

    requires s0.stack[14] == 0x3f4
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0xc45;
      assert s1.Peek(14) == 0x3f4;
      assert s1.Peek(24) == 0xe7;
      var s2 := Push1(s1, 0x00);
      var s3 := Dup2(s2);
      var s4 := MLoad(s3);
      ...
      var s11 := Dup7(s10);
      assert s11.Peek(3) == 0xbfd;
      assert s11.Peek(8) == 0xc45;
      assert s11.Peek(20) == 0x3f4;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0xbfd;
      assert s1.Peek(8) == 0xc45;
      assert s1.Peek(20) == 0x3f4;
      assert s1.Peek(30) == 0xe7;
      var s2 := Push1(s1, 0x00);
      //  Go to the next instruction at pc + 1
      ExecuteFromCFGNode_s200(s2, gas - 1)
  }
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s200(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[9] == 0xc45

    requires s0.stack[21] == 0x3f4

    requires s0.stack[31] == 0xe7
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Dup2(s0);
      assert s1.Peek(5) == 0xbfd;
      assert s1.Peek(10) == 0xc45;
      assert s1.Peek(22) == 0x3f4;
      ...
      assert s11.Peek(0) == 0xb56;
      assert s11.Peek(5) == 0xbfd;
      assert s11.Peek(10) == 0xc45;
      assert s11.Peek(22) == 0x3f4;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s203(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[4] == 0xc45

    requires s0.stack[16] == 0x3f4
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(4) == 0xc45;
      assert s1.Peek(16) == 0x3f4;
      assert s1.Peek(26) == 0xe7;
      var s2 := Push1(s1, 0x1f);
      var s3 := Add(s2);
      var s4 := Push1(s3, 0x1f);
      ...
      var s10 := Add(s9);
      var s11 := Push1(s10, 0x20);
      assert s11.Peek(4) == 0xc45;
      assert s11.Peek(16) == 0x3f4;
      assert s11.Peek(26) == 0xe7;
      var s12 := Add(s11);
      var s13 := Swap3(s12);
      var s14 := Swap2(s13);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Swap5(s9);
      var s11 := Swap1(s10);
      assert s11.Peek(10) == 0x3f4;
      assert s11.Peek(20) == 0xe7;
      var s12 := Swap5(s11);
      var s13 := And(s12);
      var s14 := Push1(s13, 0x80);
      var s15 := Dup3(s14);
      var s16 := Add(s15);
      var s17 := MStore(s16);
      var s18 := Push2(s17, 0xffff);
      var s19 := Swap3(s18);
      var s20 := Dup4(s19);
      var s21 := And(s20);
      assert s21.Peek(9) == 0x3f4;
      ...
      var s39 := Jump(s38);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s205(s39, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s4 := Pop(s3);
      var s5 := Pop(s4);
      var s6 := Push2(s5, 0x0432);
      var s7 := Caller(s6);
      var s8 := Dup3(s7);
      var s9 := Push1(s8, 0x01);
      var s10 := Push2(s9, 0x0918);
      var s11 := Jump(s10);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s27 := Jump(s26);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s239(s27, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s40 := Jump(s39);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s243(s40, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s27 := Jump(s26);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s262(s27, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s19 := Jump(s18);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s270(s19, gas - 1)
  }
