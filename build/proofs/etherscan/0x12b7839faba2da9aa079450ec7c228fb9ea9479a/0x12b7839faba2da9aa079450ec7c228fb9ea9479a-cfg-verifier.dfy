...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := Add(s8);
      var s10 := Push2(s9, 0x0361);
      var s11 := Swap2(s10);
      assert s11.Peek(2) == 0x361;
      assert s11.Peek(7) == 0x724;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s32 := SLoad(s31);
      var s33 := Push2(s32, 0x0752);
      var s34 := Swap1(s33);
      var s35 := Dup3(s34);
      var s36 := Push2(s35, 0x07cd);
      var s37 := Jump(s36);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Add(s9);
      var s11 := SLt(s10);
      assert s11.Peek(7) == 0x1a4;
      assert s11.Peek(8) == 0x1a9;
      var s12 := Push2(s11, 0x090e);
      var s13 := JumpI(s12);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0920);
      assert s1.Peek(0) == 0x920;
      assert s1.Peek(8) == 0x1a4;
      assert s1.Peek(9) == 0x1a9;
      var s2 := Push2(s1, 0x08bf);
      var s3 := Jump(s2);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x24);
      var s11 := Push0(s10);
      assert s11.Peek(2) == 0x920;
      assert s11.Peek(10) == 0x1a4;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Gt(s19);
      var s21 := Or(s20);
      assert s21.Peek(11) == 0x1a4;
      assert s21.Peek(12) == 0x1a9;
      var s22 := IsZero(s21);
      var s23 := Push2(s22, 0x0945);
      var s24 := JumpI(s23);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x24);
      var s11 := Push0(s10);
      assert s11.Peek(2) == 0x945;
      assert s11.Peek(13) == 0x1a4;
      assert s11.Peek(14) == 0x1a9;
      var s12 := Revert(s11);
      // Segment is terminal (Revert, Stop or Return)
      s12
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Gt(s19);
      var s21 := IsZero(s20);
      assert s21.Peek(10) == 0x1a4;
      assert s21.Peek(11) == 0x1a9;
      var s22 := Push2(s21, 0x0962);
      var s23 := JumpI(s22);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0978);
      assert s1.Peek(0) == 0x978;
      assert s1.Peek(10) == 0x1a4;
      assert s1.Peek(11) == 0x1a9;
      var s2 := Dup6(s1);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x978;
      assert s11.Peek(14) == 0x1a4;
      assert s11.Peek(15) == 0x1a9;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x0840);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s109(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x978

    requires s0.stack[12] == 0x1a4
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push0(s0);
      assert s1.Peek(3) == 0x978;
      assert s1.Peek(13) == 0x1a4;
      assert s1.Peek(14) == 0x1a9;
      var s2 := Dup1(s1);
      var s3 := Revert(s2);
      // Segment is terminal (Revert, Stop or Return)
      s3
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x978;
      assert s1.Peek(12) == 0x1a4;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Dup2(s19);
      var s21 := Swap1(s20);
      assert s21.Peek(3) == 0x3f2;
      assert s21.Peek(8) == 0x1a9;
      var s22 := Push2(s21, 0x07a2);
      var s23 := Jump(s22);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Dup6(s10);
      assert s11.Peek(8) == 0x361;
      assert s11.Peek(13) == 0x3f2;
      assert s11.Peek(18) == 0x1a9;
      var s12 := Add(s11);
      var s13 := MStore(s12);
      var s14 := Push0(s13);
      //  Go to the next instruction at pc + 1
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Dup6(s0);
      assert s1.Peek(7) == 0x361;
      assert s1.Peek(12) == 0x3f2;
      assert s1.Peek(17) == 0x1a9;
      var s2 := Dup2(s1);
      var s3 := Add(s2);
      var s4 := Dup4(s3);
      var s5 := Add(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Push1(s10, 0x1f);
      assert s11.Peek(7) == 0x361;
      assert s11.Peek(12) == 0x3f2;
      assert s11.Peek(17) == 0x1a9;
      var s12 := Not(s11);
      var s13 := Push1(s12, 0x1f);
      var s14 := Dup4(s13);
      var s15 := Add(s14);
      ...
      var s21 := Pop(s20);
      assert s21.Peek(5) == 0x361;
      assert s21.Peek(10) == 0x3f2;
      assert s21.Peek(15) == 0x1a9;
      var s22 := Pop(s21);
      var s23 := Pop(s22);
      var s24 := Swap3(s23);
      var s25 := Swap2(s24);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s27 := SLoad(s26);
      var s28 := Push2(s27, 0x043b);
      var s29 := Swap1(s28);
      var s30 := Dup3(s29);
      var s31 := Push2(s30, 0x07cd);
      assert s31.Peek(0) == 0x7cd;
      assert s31.Peek(3) == 0x43b;
      assert s31.Peek(8) == 0x1a9;
      var s32 := Jump(s31);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0x17c;
      assert s1.Peek(4) == 0x138;
      var s2 := Push2(s1, 0x07d8);
      var s3 := Dup3(s2);
      var s4 := Push2(s3, 0x082a);
      var s5 := Jump(s4);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x7d8;
      assert s11.Peek(8) == 0x17c;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      var s2 := Push2(s1, 0x00f9);
      var s3 := Push2(s2, 0x0154);
      var s4 := CallDataSize(s3);
      var s5 := Push1(s4, 0x04);
      var s6 := Push2(s5, 0x086d);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x087f);
      assert s11.Peek(0) == 0x87f;
