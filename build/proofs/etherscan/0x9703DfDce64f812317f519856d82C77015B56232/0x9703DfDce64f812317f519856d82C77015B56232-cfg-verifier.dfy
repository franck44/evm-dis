...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0e80);
      assert s1.Peek(0) == 0xe80;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s20(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0xcaa

    requires s0.stack[4] == 0xcba

    requires s0.stack[6] == 0xcd7

    requires s0.stack[10] == 0xe8f
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0xcaa;
      assert s1.Peek(4) == 0xcba;
      assert s1.Peek(6) == 0xcd7;
      assert s1.Peek(10) == 0xe8f;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s21(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0xcba

    requires s0.stack[5] == 0xcd7

    requires s0.stack[9] == 0xe8f
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0xcba;
      assert s1.Peek(5) == 0xcd7;
      assert s1.Peek(9) == 0xe8f;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Push2(s5, 0x0ea0);
      var s7 := Dup6(s6);
      var s8 := Dup3(s7);
      var s9 := Dup7(s8);
      var s10 := Add(s9);
      var s11 := Push2(s10, 0x0cc8);
      assert s11.Peek(0) == 0xcc8;
      assert s11.Peek(3) == 0xea0;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Swap1(s5);
      var s7 := Pop(s6);
      var s8 := Push2(s7, 0x0dad);
      var s9 := Push1(s8, 0x00);
      var s10 := Dup4(s9);
      var s11 := Add(s10);
      assert s11.Peek(1) == 0xdad;
      assert s11.Peek(5) == 0x26d;
      var s12 := Dup5(s11);
      var s13 := Push2(s12, 0x0d89);
      var s14 := Jump(s13);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push2(s1, 0x0d92);
      var s3 := Dup2(s2);
      var s4 := Push2(s3, 0x0cdd);
      var s5 := Jump(s4);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0d29);
      assert s1.Peek(0) == 0xd29;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s4 := Pop(s3);
      var s5 := Push1(s4, 0x20);
      var s6 := Push2(s5, 0x0d49);
      var s7 := Dup6(s6);
      var s8 := Dup3(s7);
      var s9 := Dup7(s8);
      var s10 := Add(s9);
      var s11 := Push2(s10, 0x0cfe);
      assert s11.Peek(0) == 0xcfe;
      assert s11.Peek(3) == 0xd49;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s63(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0xd0d

    requires s0.stack[5] == 0xd49
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0xd0d;
      assert s1.Peek(5) == 0xd49;
      assert s1.Peek(11) == 0x22b;
      assert s1.Peek(12) == 0x230;
      var s2 := Push2(s1, 0x0cf0);
      var s3 := Dup2(s2);
      var s4 := Push2(s3, 0x0cdd);
      var s5 := Jump(s4);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s64(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0xd0d

    requires s0.stack[7] == 0xd49
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(3) == 0xd0d;
      assert s1.Peek(7) == 0xd49;
      assert s1.Peek(13) == 0x22b;
      assert s1.Peek(14) == 0x230;
      var s2 := Push1(s1, 0x00);
      var s3 := Dup2(s2);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(6) == 0xd49;
      assert s1.Peek(12) == 0x22b;
      assert s1.Peek(13) == 0x230;
      var s2 := Dup2(s1);
      var s3 := Eq(s2);
      var s4 := Push2(s3, 0x0cfb);
      var s5 := JumpI(s4);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s4.stack[1] > 0 then
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(2) == 0x230;
      var s2 := Push1(s1, 0x00);
      var s3 := Push2(s2, 0x06dd);
      var s4 := Push2(s3, 0x06d6);
      var s5 := Push2(s4, 0x076e);
      var s6 := Jump(s5);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s76(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0x9a5

    requires s0.stack[5] == 0x6dd
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x9a5;
      assert s1.Peek(5) == 0x6dd;
      assert s1.Peek(9) == 0x230;
      var s2 := Push1(s1, 0x00);
      var s3 := Push1(s2, 0x20);
      var s4 := Dup3(s3);
      ...
      assert s11.Peek(4) == 0x9a5;
      assert s11.Peek(8) == 0x6dd;
      assert s11.Peek(12) == 0x230;
      var s12 := Dup4(s11);
      var s13 := Add(s12);
      var s14 := MStore(s13);
      var s15 := Push2(s14, 0x1240);
      var s16 := Dup2(s15);
      var s17 := Push2(s16, 0x1204);
      var s18 := Jump(s17);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s77(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0x1240

    requires s0.stack[4] == 0x9a5
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x1240;
      assert s1.Peek(4) == 0x9a5;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s78(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x1211

    requires s0.stack[5] == 0x1240

    requires s0.stack[8] == 0x9a5

    requires s0.stack[12] == 0x6dd
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x1211;
      assert s1.Peek(5) == 0x1240;
      assert s1.Peek(8) == 0x9a5;
      assert s1.Peek(12) == 0x6dd;
      assert s1.Peek(16) == 0x230;
      var s2 := Push1(s1, 0x00);
      var s3 := Dup3(s2);
      var s4 := Dup3(s3);
      ...
      var s10 := Pop(s9);
      var s11 := Swap3(s10);
      assert s11.Peek(0) == 0x1211;
      assert s11.Peek(6) == 0x1240;
      assert s11.Peek(9) == 0x9a5;
      assert s11.Peek(13) == 0x6dd;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s79(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[6] == 0x9a5

    requires s0.stack[10] == 0x6dd
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(6) == 0x9a5;
      assert s1.Peek(10) == 0x6dd;
      assert s1.Peek(14) == 0x230;
      var s2 := Swap2(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x121c);
      var s5 := Dup3(s4);
      var s6 := Push2(s5, 0x11b5);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s80(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0x121c

    requires s0.stack[4] == 0x1240

    requires s0.stack[7] == 0x9a5

    requires s0.stack[11] == 0x6dd
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x121c;
      assert s1.Peek(4) == 0x1240;
      assert s1.Peek(7) == 0x9a5;
      assert s1.Peek(11) == 0x6dd;
      ...
      var s10 := Add(s9);
      var s11 := MStore(s10);
      assert s11.Peek(1) == 0x121c;
      assert s11.Peek(4) == 0x1240;
      assert s11.Peek(7) == 0x9a5;
      assert s11.Peek(11) == 0x6dd;
      assert s11.Peek(15) == 0x230;
      var s12 := Pop(s11);
      var s13 := Jump(s12);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s81(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[5] == 0x9a5

    requires s0.stack[9] == 0x6dd
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(5) == 0x9a5;
      assert s1.Peek(9) == 0x6dd;
      assert s1.Peek(13) == 0x230;
      var s2 := Push1(s1, 0x40);
      var s3 := Dup3(s2);
      var s4 := Add(s3);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Push1(s5, 0x04);
      var s7 := Add(s6);
      var s8 := Push2(s7, 0x0a14);
      var s9 := Swap1(s8);
      var s10 := Push2(s9, 0x12b9);
      var s11 := Jump(s10);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Sub(s9);
      var s11 := Push1(s10, 0x00);
      assert s11.Peek(4) == 0xa14;
      assert s11.Peek(8) == 0x6dd;
      assert s11.Peek(12) == 0x230;
      var s12 := Dup4(s11);
      var s13 := Add(s12);
      var s14 := MStore(s13);
      var s15 := Push2(s14, 0x12d2);
      var s16 := Dup2(s15);
      var s17 := Push2(s16, 0x1296);
      var s18 := Jump(s17);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x12d2;
      assert s1.Peek(4) == 0xa14;
      assert s1.Peek(8) == 0x6dd;
      assert s1.Peek(12) == 0x230;
      var s2 := Push1(s1, 0x00);
      var s3 := Push2(s2, 0x12a3);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s88(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x12a3

    requires s0.stack[5] == 0x12d2
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x12a3;
      assert s1.Peek(5) == 0x12d2;
      ...
      var s10 := Pop(s9);
      var s11 := Swap3(s10);
      assert s11.Peek(0) == 0x12a3;
      assert s11.Peek(6) == 0x12d2;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0x12d2;
      assert s1.Peek(6) == 0xa14;
      assert s1.Peek(10) == 0x6dd;
      assert s1.Peek(14) == 0x230;
      var s2 := Swap2(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x12ae);
      var s5 := Dup3(s4);
      var s6 := Push2(s5, 0x1247);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s90(s0: EState, gas: nat): (s': EState)
    // PC requirement for this node.
    requires s0.pc == 0x1247 as nat
    // Stack requirements for this node.
    requires s0.Operands() >= 17

    requires s0.stack[1] == 0x12ae

    requires s0.stack[4] == 0x12d2
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x12ae;
      assert s1.Peek(4) == 0x12d2;
      ...
      var s10 := Add(s9);
      var s11 := MStore(s10);
      assert s11.Peek(1) == 0x12ae;
      assert s11.Peek(4) == 0x12d2;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Keccak256(s19);
      var s21 := SLoad(s20);
      assert s21.Peek(5) == 0x6dd;
      assert s21.Peek(9) == 0x230;
      var s22 := Swap1(s21);
      var s23 := Pop(s22);
      var s24 := Dup2(s23);
      var s25 := Dup2(s24);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Push1(s5, 0x04);
      var s7 := Add(s6);
      var s8 := Push2(s7, 0x0aa5);
      var s9 := Swap1(s8);
      var s10 := Push2(s9, 0x134b);
      var s11 := Jump(s10);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s98(s0: EState, gas: nat): (s': EState)
    // PC requirement for this node.
    requires s0.pc == 0x134b as nat
    // Stack requirements for this node.
    requires s0.Operands() >= 12

    requires s0.stack[1] == 0xaa5
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Sub(s9);
      var s11 := Push1(s10, 0x00);
      assert s11.Peek(4) == 0xaa5;
      assert s11.Peek(9) == 0x6dd;
      assert s11.Peek(13) == 0x230;
      var s12 := Dup4(s11);
      var s13 := Add(s12);
      var s14 := MStore(s13);
      var s15 := Push2(s14, 0x1364);
      var s16 := Dup2(s15);
      var s17 := Push2(s16, 0x1328);
      var s18 := Jump(s17);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s99(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0x1364

    requires s0.stack[4] == 0xaa5
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x1364;
      assert s1.Peek(4) == 0xaa5;
      assert s1.Peek(9) == 0x6dd;
      assert s1.Peek(13) == 0x230;
      var s2 := Push1(s1, 0x00);
      var s3 := Push2(s2, 0x1335);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s100(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x1335

    requires s0.stack[5] == 0x1364

    requires s0.stack[8] == 0xaa5

    requires s0.stack[13] == 0x6dd
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x1335;
      assert s1.Peek(5) == 0x1364;
      assert s1.Peek(8) == 0xaa5;
      assert s1.Peek(13) == 0x6dd;
      assert s1.Peek(17) == 0x230;
      var s2 := Push1(s1, 0x00);
      var s3 := Dup3(s2);
      var s4 := Dup3(s3);
      ...
      var s10 := Pop(s9);
      var s11 := Swap3(s10);
      assert s11.Peek(0) == 0x1335;
      assert s11.Peek(6) == 0x1364;
      assert s11.Peek(9) == 0xaa5;
      assert s11.Peek(14) == 0x6dd;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s101(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0x1364

    requires s0.stack[6] == 0xaa5
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0x1364;
      assert s1.Peek(6) == 0xaa5;
      assert s1.Peek(11) == 0x6dd;
      assert s1.Peek(15) == 0x230;
      var s2 := Swap2(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x1340);
      var s5 := Dup3(s4);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s102(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[4] == 0x1364

    requires s0.stack[7] == 0xaa5
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(4) == 0x1364;
      assert s1.Peek(7) == 0xaa5;
      assert s1.Peek(12) == 0x6dd;
      assert s1.Peek(16) == 0x230;
      ...
      var s10 := Add(s9);
      var s11 := MStore(s10);
      assert s11.Peek(1) == 0x1340;
      assert s11.Peek(4) == 0x1364;
      assert s11.Peek(7) == 0xaa5;
      assert s11.Peek(12) == 0x6dd;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s103(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x1364

    requires s0.stack[5] == 0xaa5
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x1364;
      assert s1.Peek(5) == 0xaa5;
      assert s1.Peek(10) == 0x6dd;
      assert s1.Peek(14) == 0x230;
      var s2 := Push1(s1, 0x40);
      var s3 := Dup3(s2);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s104(s0: EState, gas: nat): (s': EState)
    // PC requirement for this node.
    requires s0.pc == 0x1364 as nat
    // Stack requirements for this node.
    requires s0.Operands() >= 14

    requires s0.stack[3] == 0xaa5
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Add(s19);
      var s21 := Push1(s20, 0x00);
      assert s21.Peek(7) == 0x6dd;
      assert s21.Peek(11) == 0x230;
      ...
      assert s31.Peek(9) == 0x6dd;
      assert s31.Peek(13) == 0x230;
      var s32 := And(s31);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s7 := Dup3(s6);
      var s8 := SLoad(s7);
      var s9 := Push2(s8, 0x0b41);
      var s10 := Swap2(s9);
      var s11 := Swap1(s10);
      assert s11.Peek(2) == 0xb41;
      assert s11.Peek(10) == 0x6dd;
      assert s11.Peek(14) == 0x230;
      var s12 := Push2(s11, 0x0fcb);
      var s13 := Jump(s12);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0xfd6;
      assert s1.Peek(5) == 0xb41;
      assert s1.Peek(13) == 0x6dd;
      assert s1.Peek(17) == 0x230;
      var s2 := Push1(s1, 0x00);
      var s3 := Dup2(s2);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(4) == 0xb41;
      assert s1.Peek(12) == 0x6dd;
      assert s1.Peek(16) == 0x230;
      var s2 := Swap2(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x0fe1);
      var s5 := Dup4(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Dup3(s9);
      var s11 := Gt(s10);
      assert s11.Peek(4) == 0xb41;
      assert s11.Peek(12) == 0x6dd;
      assert s11.Peek(16) == 0x230;
      var s12 := IsZero(s11);
      var s13 := Push2(s12, 0x0ff9);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s18 := MLoad(s17);
      var s19 := Push2(s18, 0x0ba5);
      var s20 := Swap2(s19);
      var s21 := Swap1(s20);
      assert s21.Peek(2) == 0xba5;
      assert s21.Peek(10) == 0x6dd;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s118(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[6] == 0xba5

    requires s0.stack[14] == 0x6dd
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0xdad;
      assert s1.Peek(6) == 0xba5;
      assert s1.Peek(14) == 0x6dd;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s119(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[8] == 0xba5

    requires s0.stack[16] == 0x6dd
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(1) == 0xd92;
      assert s1.Peek(4) == 0xdad;
      assert s1.Peek(8) == 0xba5;
      assert s1.Peek(16) == 0x6dd;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s120(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[7] == 0xba5

    requires s0.stack[15] == 0x6dd
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0xdad;
      assert s1.Peek(7) == 0xba5;
      assert s1.Peek(15) == 0x6dd;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s7 := Swap1(s6);
      var s8 := Log3(s7);
      var s9 := Push2(s8, 0x0bb8);
      var s10 := Dup5(s9);
      var s11 := Dup5(s10);
      assert s11.Peek(2) == 0xbb8;
      assert s11.Peek(7) == 0x6dd;
      assert s11.Peek(11) == 0x230;
      var s12 := Dup5(s11);
      var s13 := Push2(s12, 0x0bc3);
      var s14 := Jump(s13);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Swap1(s5);
      var s7 := Pop(s6);
      var s8 := Push2(s7, 0x0d83);
      var s9 := Push1(s8, 0x00);
      var s10 := Dup4(s9);
      var s11 := Add(s10);
      assert s11.Peek(1) == 0xd83;
      assert s11.Peek(5) == 0x23d;
      var s12 := Dup5(s11);
      var s13 := Push2(s12, 0x0d5f);
      var s14 := Jump(s13);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s129(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0xd68

    requires s0.stack[4] == 0xd83
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0xd68;
      assert s1.Peek(4) == 0xd83;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s5 := Push1(s4, 0x00);
      var s6 := Push2(s5, 0x05ed);
      var s7 := Push2(s6, 0x076e);
      var s8 := Jump(s7);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      if s0.stack[1] > 0 then
        ExecuteFromCFGNode_s170(s1, gas - 1)
      else
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s13 := Add(s12);
      var s14 := MStore(s13);
      var s15 := Push2(s14, 0x108a);
      var s16 := Dup2(s15);
      var s17 := Push2(s16, 0x104e);
      var s18 := Jump(s17);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s163(s18, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x108a;
      assert s1.Peek(4) == 0x6a1;
      assert s1.Peek(9) == 0x200;
      var s2 := Push1(s1, 0x00);
      var s3 := Push2(s2, 0x105b);
      var s4 := Push1(s3, 0x25);
      var s5 := Dup4(s4);
      var s6 := Push2(s5, 0x0bd3);
      var s7 := Jump(s6);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s164(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x105b

    requires s0.stack[5] == 0x108a
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x105b;
      assert s1.Peek(5) == 0x108a;
      ...
      var s10 := Pop(s9);
      var s11 := Swap3(s10);
      assert s11.Peek(0) == 0x105b;
      assert s11.Peek(6) == 0x108a;
      ...
      var s15 := Jump(s14);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s165(s15, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0x108a;
      assert s1.Peek(6) == 0x6a1;
      assert s1.Peek(11) == 0x200;
      var s2 := Swap2(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x1066);
      var s5 := Dup3(s4);
      var s6 := Push2(s5, 0x0fff);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s166(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0x1066

    requires s0.stack[4] == 0x108a
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x1066;
      assert s1.Peek(4) == 0x108a;
      ...
      var s10 := Add(s9);
      var s11 := MStore(s10);
      assert s11.Peek(1) == 0x1066;
      assert s11.Peek(4) == 0x108a;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push2(s1, 0x06be);
      var s3 := Push2(s2, 0x06b5);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Push1(s5, 0x04);
      var s7 := Add(s6);
      var s8 := Push2(s7, 0x07dc);
      var s9 := Swap1(s8);
      var s10 := Push2(s9, 0x1103);
      var s11 := Jump(s10);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s175(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0x7dc

    requires s0.stack[5] == 0x6be
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x7dc;
      assert s1.Peek(5) == 0x6be;
      assert s1.Peek(10) == 0x200;
      var s2 := Push1(s1, 0x00);
      var s3 := Push1(s2, 0x20);
      var s4 := Dup3(s3);
      ...
      var s10 := Sub(s9);
      var s11 := Push1(s10, 0x00);
      assert s11.Peek(4) == 0x7dc;
      assert s11.Peek(8) == 0x6be;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(8) == 0x6be;
      assert s1.Peek(13) == 0x200;
      var s2 := Push1(s1, 0x00);
      var s3 := Push2(s2, 0x10ed);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s177(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[8] == 0x7dc

    requires s0.stack[12] == 0x6be
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(8) == 0x7dc;
      assert s1.Peek(12) == 0x6be;
      assert s1.Peek(17) == 0x200;
      var s2 := Push1(s1, 0x00);
      var s3 := Dup3(s2);
      var s4 := Dup3(s3);
      ...
      var s10 := Pop(s9);
      var s11 := Swap3(s10);
      assert s11.Peek(0) == 0x10ed;
      assert s11.Peek(6) == 0x111c;
      assert s11.Peek(9) == 0x7dc;
      assert s11.Peek(13) == 0x6be;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s178(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[6] == 0x7dc

    requires s0.stack[10] == 0x6be
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(6) == 0x7dc;
      assert s1.Peek(10) == 0x6be;
      assert s1.Peek(15) == 0x200;
      var s2 := Swap2(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x10f8);
      var s5 := Dup3(s4);
      var s6 := Push2(s5, 0x1091);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s179(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0x10f8

    requires s0.stack[4] == 0x111c

    requires s0.stack[7] == 0x7dc

    requires s0.stack[11] == 0x6be
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x10f8;
      assert s1.Peek(4) == 0x111c;
      assert s1.Peek(7) == 0x7dc;
      assert s1.Peek(11) == 0x6be;
      assert s1.Peek(16) == 0x200;
      ...
      var s10 := Add(s9);
      var s11 := MStore(s10);
      assert s11.Peek(1) == 0x10f8;
      assert s11.Peek(4) == 0x111c;
      assert s11.Peek(7) == 0x7dc;
      assert s11.Peek(11) == 0x6be;
      assert s11.Peek(16) == 0x200;
      var s12 := Pop(s11);
      var s13 := Jump(s12);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s180(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[5] == 0x7dc

    requires s0.stack[9] == 0x6be
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(5) == 0x7dc;
      assert s1.Peek(9) == 0x6be;
      assert s1.Peek(14) == 0x200;
      var s2 := Push1(s1, 0x40);
      var s3 := Dup3(s2);
      var s4 := Add(s3);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s185(s0: EState, gas: nat): (s': EState)
    // PC requirement for this node.
    requires s0.pc == 0x1195 as nat
    // Stack requirements for this node.
    requires s0.Operands() >= 12

    requires s0.stack[1] == 0x84b
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Sub(s9);
      var s11 := Push1(s10, 0x00);
      assert s11.Peek(4) == 0x84b;
      assert s11.Peek(8) == 0x6be;
      assert s11.Peek(13) == 0x200;
      var s12 := Dup4(s11);
      var s13 := Add(s12);
      var s14 := MStore(s13);
      var s15 := Push2(s14, 0x11ae);
      var s16 := Dup2(s15);
      var s17 := Push2(s16, 0x1172);
      var s18 := Jump(s17);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s186(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0x11ae

    requires s0.stack[4] == 0x84b
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x11ae;
      assert s1.Peek(4) == 0x84b;
      assert s1.Peek(8) == 0x6be;
      assert s1.Peek(13) == 0x200;
      var s2 := Push1(s1, 0x00);
      var s3 := Push2(s2, 0x117f);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s187(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x117f

    requires s0.stack[5] == 0x11ae

    requires s0.stack[8] == 0x84b
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x117f;
      assert s1.Peek(5) == 0x11ae;
      assert s1.Peek(8) == 0x84b;
      assert s1.Peek(12) == 0x6be;
      assert s1.Peek(17) == 0x200;
      var s2 := Push1(s1, 0x00);
      var s3 := Dup3(s2);
      ...
      var s10 := Pop(s9);
      var s11 := Swap3(s10);
      assert s11.Peek(0) == 0x117f;
      assert s11.Peek(6) == 0x11ae;
      assert s11.Peek(9) == 0x84b;
      assert s11.Peek(13) == 0x6be;
      assert s11.Peek(18) == 0x200;
      var s12 := Swap2(s11);
      var s13 := Pop(s12);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s188(s0: EState, gas: nat): (s': EState)
    // PC requirement for this node.
    requires s0.pc == 0x117f as nat
    // Stack requirements for this node.
    requires s0.Operands() >= 17

    requires s0.stack[3] == 0x11ae

    requires s0.stack[6] == 0x84b
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0x11ae;
      assert s1.Peek(6) == 0x84b;
      assert s1.Peek(10) == 0x6be;
      assert s1.Peek(15) == 0x200;
      var s2 := Swap2(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x118a);
      var s5 := Dup3(s4);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s189(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0x118a

    requires s0.stack[4] == 0x11ae

    requires s0.stack[7] == 0x84b
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0x118a;
      assert s1.Peek(4) == 0x11ae;
      assert s1.Peek(7) == 0x84b;
      assert s1.Peek(11) == 0x6be;
      assert s1.Peek(16) == 0x200;
      ...
      var s10 := Add(s9);
      var s11 := MStore(s10);
      assert s11.Peek(1) == 0x118a;
      assert s11.Peek(4) == 0x11ae;
      assert s11.Peek(7) == 0x84b;
      assert s11.Peek(11) == 0x6be;
      assert s11.Peek(16) == 0x200;
      var s12 := Pop(s11);
      var s13 := Jump(s12);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s190(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x11ae

    requires s0.stack[5] == 0x84b
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x11ae;
      assert s1.Peek(5) == 0x84b;
      assert s1.Peek(9) == 0x6be;
      assert s1.Peek(14) == 0x200;
      var s2 := Push1(s1, 0x40);
      var s3 := Dup3(s2);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := MLoad(s9);
      var s11 := Push2(s10, 0x0932);
      assert s11.Peek(0) == 0x932;
      assert s11.Peek(9) == 0x6be;
      assert s11.Peek(14) == 0x200;
      var s12 := Swap2(s11);
      var s13 := Swap1(s12);
      var s14 := Push2(s13, 0x0d98);
      var s15 := Jump(s14);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Add(s10);
      assert s11.Peek(1) == 0xdad;
      assert s11.Peek(5) == 0x932;
      assert s11.Peek(12) == 0x6be;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s196(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[6] == 0x932

    requires s0.stack[13] == 0x6be
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0xdad;
      assert s1.Peek(6) == 0x932;
      assert s1.Peek(13) == 0x6be;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s197(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[8] == 0x932

    requires s0.stack[15] == 0x6be
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(1) == 0xd92;
      assert s1.Peek(4) == 0xdad;
      assert s1.Peek(8) == 0x932;
      assert s1.Peek(15) == 0x6be;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s198(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[7] == 0x932

    requires s0.stack[14] == 0x6be
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0xdad;
      assert s1.Peek(7) == 0x932;
      assert s1.Peek(14) == 0x6be;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s4 := Dup1(s3);
      var s5 := SLoad(s4);
      var s6 := Push2(s5, 0x055b);
      var s7 := Swap1(s6);
      var s8 := Push2(s7, 0x0ed9);
      var s9 := Jump(s8);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup1(s10);
      assert s11.Peek(4) == 0x55b;
      assert s11.Peek(7) == 0x1d0;
      var s12 := Push2(s11, 0x0ef1);
      var s13 := JumpI(s12);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0f03);
      assert s1.Peek(0) == 0xf03;
      assert s1.Peek(4) == 0x55b;
      assert s1.Peek(7) == 0x1d0;
      var s2 := Push2(s1, 0x0eaa);
      var s3 := Jump(s2);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s215(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[0] == 0xf03

    requires s0.stack[4] == 0x55b
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s29 := Dup1(s28);
      var s30 := SLoad(s29);
      var s31 := Push2(s30, 0x0587);
      assert s31.Peek(0) == 0x587;
      assert s31.Peek(8) == 0x1d0;
      var s32 := Swap1(s31);
      var s33 := Push2(s32, 0x0ed9);
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s16 := Dup2(s15);
      var s17 := Dup5(s16);
      var s18 := Push2(s17, 0x0c1f);
      var s19 := Jump(s18);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s230(s19, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0xc72;
      assert s1.Peek(6) == 0x1dd;
      var s2 := Push1(s1, 0x00);
      var s3 := Push2(s2, 0x0c2a);
      var s4 := Dup3(s3);
      var s5 := Push2(s4, 0x0bc8);
      var s6 := Jump(s5);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(4) == 0xc72;
      assert s1.Peek(8) == 0x1dd;
      var s2 := Push2(s1, 0x0c34);
      var s3 := Dup2(s2);
      var s4 := Dup6(s3);
      var s5 := Push2(s4, 0x0bd3);
      var s6 := Jump(s5);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Swap4(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x0c44);
      var s5 := Dup2(s4);
      var s6 := Dup6(s5);
      var s7 := Push1(s6, 0x20);
      var s8 := Dup7(s7);
      var s9 := Add(s8);
      var s10 := Push2(s9, 0x0be4);
      var s11 := Jump(s10);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Dup1(s0);
      assert s1.Peek(5) == 0xc44;
      assert s1.Peek(10) == 0xc72;
      ...
      assert s11.Peek(10) == 0xc72;
      assert s11.Peek(14) == 0x1dd;
      var s12 := Swap1(s11);
      var s13 := Pop(s12);
      var s14 := Push2(s13, 0x0be7);
      var s15 := Jump(s14);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Pop(s9);
      var s11 := Swap2(s10);
      assert s11.Peek(0) == 0xc4d;
      assert s11.Peek(7) == 0xc72;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0e52);
      assert s1.Peek(0) == 0xe52;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Swap1(s5);
      var s7 := Pop(s6);
      var s8 := Push2(s7, 0x0e37);
      var s9 := Push1(s8, 0x00);
      var s10 := Dup4(s9);
      var s11 := Add(s10);
      assert s11.Peek(1) == 0xe37;
      assert s11.Peek(5) == 0x15f;
      var s12 := Dup5(s11);
      var s13 := Push2(s12, 0x0e13);
      var s14 := Jump(s13);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0xe37;
      assert s1.Peek(6) == 0x15f;
      var s2 := Push2(s1, 0x0e1c);
      var s3 := Dup2(s2);
      var s4 := Push2(s3, 0x0e06);
      var s5 := Jump(s4);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s355(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0xe1c

    requires s0.stack[4] == 0xe37
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0xe1c;
      assert s1.Peek(4) == 0xe37;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x0dcc);
      assert s11.Peek(0) == 0xdcc;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0dcb);
      assert s1.Peek(0) == 0xdcb;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s23 := Push2(s22, 0x037c);
      var s24 := Push2(s23, 0x076e);
      var s25 := Jump(s24);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s394(s25, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s18 := Swap1(s17);
      var s19 := Pop(s18);
      var s20 := Push32(s19, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff);
      var s21 := Dup2(s20);
      assert s21.Peek(7) == 0x134;
      var s22 := Eq(s21);
      var s23 := Push2(s22, 0x0438);
      var s24 := JumpI(s23);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s23.stack[1] > 0 then
        ExecuteFromCFGNode_s438(s24, gas - 1)
      else
        ExecuteFromCFGNode_s396(s24, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s6 := Push1(s5, 0x04);
      var s7 := Add(s6);
      var s8 := Push2(s7, 0x041a);
      var s9 := Swap1(s8);
      var s10 := Push2(s9, 0x0f7c);
      var s11 := Jump(s10);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s398(s11, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s13 := Add(s12);
      var s14 := MStore(s13);
      var s15 := Push2(s14, 0x0f95);
      var s16 := Dup2(s15);
      var s17 := Push2(s16, 0x0f59);
      var s18 := Jump(s17);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Pop(s9);
      var s11 := Swap3(s10);
      assert s11.Peek(0) == 0xf66;
      assert s11.Peek(6) == 0xf95;
      assert s11.Peek(9) == 0x41a;
      ...
      var s15 := Jump(s14);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s401(s15, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Swap2(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x0f71);
      var s5 := Dup3(s4);
      var s6 := Push2(s5, 0x0f0a);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Add(s9);
      var s11 := MStore(s10);
      assert s11.Peek(1) == 0xf71;
      assert s11.Peek(4) == 0xf95;
      assert s11.Peek(7) == 0x41a;
      assert s11.Peek(13) == 0x134;
      var s12 := Pop(s11);
      var s13 := Jump(s12);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s403(s13, gas - 1)
  }
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s403(s0: EState, gas: nat): (s': EState)
    // PC requirement for this node.
    requires s0.pc == 0xf71 as nat
    // Stack requirements for this node.
    requires s0.Operands() >= 13

    requires s0.stack[2] == 0xf95
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Keccak256(s19);
      var s21 := Push1(s20, 0x00);
      assert s21.Peek(6) == 0x437;
      assert s21.Peek(12) == 0x134;
      var s22 := Dup5(s21);
      var s23 := Push20(s22, 0xffffffffffffffffffffffffffffffffffffffff);
      var s24 := And(s23);
      var s25 := Push20(s24, 0xffffffffffffffffffffffffffffffffffffffff);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      //  Go to the next instruction at pc + 1
      ExecuteFromCFGNode_s438(s1, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s28.stack[1] > 0 then
        ExecuteFromCFGNode_s471(s29, gas - 1)
      else
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s18 := Jump(s17);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s464(s18, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s15 := Jump(s14);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s466(s15, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s41 := MStore(s40);
      //  Go to the next instruction at pc + 1
      ExecuteFromCFGNode_s472(s41, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s21 := Swap1(s20);
      assert s21.Peek(2) == 0xba5;
      assert s21.Peek(10) == 0x443;
      assert s21.Peek(16) == 0x134;
      var s22 := Push2(s21, 0x0d98);
      var s23 := Jump(s22);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s482(s23, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s14 := Jump(s13);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s493(s14, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s3 := Jump(s2);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s510(s3, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s12 := Jump(s11);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s522(s12, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := Jump(s8);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s525(s9, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s18 := Jump(s17);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s537(s18, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s13 := Jump(s12);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s541(s13, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Jump(s10);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s546(s11, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s18 := Jump(s17);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s547(s18, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s13 := Jump(s12);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s551(s13, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s579(s34, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      if s12.stack[1] > 0 then
        ...
        ExecuteFromCFGNode_s580(s13, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s19 := Jump(s18);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s591(s19, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push1(s1, 0x00);
      //  Go to the next instruction at pc + 1
      ExecuteFromCFGNode_s597(s2, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s6.stack[1] > 0 then
        ExecuteFromCFGNode_s599(s7, gas - 1)
      else
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s15 := Jump(s14);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s597(s15, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Swap1(s10);
      //  Go to the next instruction at pc + 1
      ExecuteFromCFGNode_s606(s11, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s15.stack[1] > 0 then
        ExecuteFromCFGNode_s606(s16, gas - 1)
      else
        ExecuteFromCFGNode_s607(s16, gas - 1)
  }
