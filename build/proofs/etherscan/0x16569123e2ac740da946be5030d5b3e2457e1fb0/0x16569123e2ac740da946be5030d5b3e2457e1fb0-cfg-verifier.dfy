...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      var s2 := Push2(s1, 0x019b);
      var s3 := Push2(s2, 0x0196);
      var s4 := CallDataSize(s3);
      var s5 := Push1(s4, 0x04);
      var s6 := Push2(s5, 0x0a60);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0aad);
      assert s1.Peek(0) == 0xaad;
      assert s1.Peek(8) == 0x196;
      assert s1.Peek(9) == 0x19b;
      var s2 := Push2(s1, 0x0a33);
      var s3 := Jump(s2);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Add(s9);
      var s11 := And(s10);
      assert s11.Peek(10) == 0x196;
      assert s11.Peek(11) == 0x19b;
      var s12 := Dup2(s11);
      var s13 := Add(s12);
      var s14 := Dup2(s13);
      var s15 := Dup2(s14);
      ...
      assert s21.Peek(12) == 0x19b;
      var s22 := Push2(s21, 0x0af0);
      var s23 := JumpI(s22);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0af0);
      assert s1.Peek(0) == 0xaf0;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Gt(s19);
      var s21 := IsZero(s20);
      assert s21.Peek(10) == 0x196;
      assert s21.Peek(11) == 0x19b;
      var s22 := Push2(s21, 0x0b0d);
      var s23 := JumpI(s22);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s22.stack[1] > 0 then
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(10) == 0x19b;
      var s12 := Push2(s11, 0x0b12);
      var s13 := Jump(s12);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Pop(s9);
      var s11 := Pop(s10);
      assert s11.Peek(0) == 0x196;
      assert s11.Peek(2) == 0x19b;
      var s12 := Jump(s11);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x03f0);
      assert s1.Peek(0) == 0x3f0;
      assert s1.Peek(6) == 0x19b;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Push32(s10, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0);
      assert s11.Peek(7) == 0x3c9;
      assert s11.Peek(12) == 0x467;
      assert s11.Peek(17) == 0x19b;
      var s12 := Push1(s11, 0x1f);
      var s13 := Dup4(s12);
      var s14 := Add(s13);
      var s15 := And(s14);
      ...
      var s27 := Jump(s26);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s137(s27, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s29 := Jump(s28);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s170(s29, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s29 := Jump(s28);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s203(s29, gas - 1)
  }
