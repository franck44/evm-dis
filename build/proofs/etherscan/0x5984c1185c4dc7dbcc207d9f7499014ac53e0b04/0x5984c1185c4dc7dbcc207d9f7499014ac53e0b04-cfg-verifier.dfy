...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push2(s1, 0x0df1);
      var s3 := Dup3(s2);
      var s4 := Push2(s3, 0x0d95);
      var s5 := Jump(s4);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(7) == 0x207;
      var s2 := Push2(s1, 0x0e5c);
      var s3 := Dup6(s2);
      var s4 := Push2(s3, 0x0e31);
      var s5 := Jump(s4);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x0e0a);
      assert s11.Peek(0) == 0xe0a;
