...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x94d;
      assert s11.Peek(9) == 0x203;
      assert s11.Peek(10) == 0x134;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x08ab);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s29 := Dup1(s28);
      var s30 := SLoad(s29);
      var s31 := Push2(s30, 0x0438);
      assert s31.Peek(0) == 0x438;
      assert s31.Peek(7) == 0xf7;
      var s32 := Swap1(s31);
      var s33 := Push2(s32, 0x0964);
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Swap3(s19);
      var s21 := Pop(s20);
      assert s21.Peek(5) == 0x104;
      assert s21.Peek(6) == 0xf7;
      var s22 := Pop(s21);
      var s23 := Pop(s22);
      var s24 := Swap3(s23);
      var s25 := Swap2(s24);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Dup3(s19);
      var s21 := Add(s20);
      assert s21.Peek(6) == 0x2cd;
      assert s21.Peek(10) == 0x120;
      var s22 := MStore(s21);
      var s23 := Push1(s22, 0x64);
      var s24 := Add(s23);
      var s25 := Push2(s24, 0x04ec);
      var s26 := Jump(s25);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := SLoad(s19);
      var s21 := Dup2(s20);
      assert s21.Peek(5) == 0x2cd;
      assert s21.Peek(9) == 0x120;
      var s22 := Gt(s21);
      var s23 := IsZero(s22);
      var s24 := Push2(s23, 0x06c1);
      var s25 := JumpI(s24);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s19 := Keccak256(s18);
      var s20 := SLoad(s19);
      var s21 := Push2(s20, 0x06e4);
      assert s21.Peek(0) == 0x6e4;
      assert s21.Peek(5) == 0x2cd;
      assert s21.Peek(9) == 0x120;
      var s22 := Swap1(s21);
      var s23 := Dup3(s22);
      var s24 := Push2(s23, 0x0804);
      var s25 := Jump(s24);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(5) == 0x7fd;
      assert s11.Peek(9) == 0x6e4;
      ...
      var s20 := Dup2(s19);
      var s21 := MStore(s20);
      assert s21.Peek(4) == 0x7fd;
      assert s21.Peek(8) == 0x6e4;
      assert s21.Peek(12) == 0x2cd;
      assert s21.Peek(16) == 0x120;
      var s22 := Pop(s21);
      var s23 := Push2(s22, 0x0764);
      var s24 := Jump(s23);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s72(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0x7fd

    requires s0.stack[7] == 0x6e4
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0x7fd;
      assert s1.Peek(7) == 0x6e4;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s73(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[5] == 0x7fd

    requires s0.stack[9] == 0x6e4

    requires s0.stack[13] == 0x2cd
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push1(s0, 0x40);
      assert s1.Peek(6) == 0x7fd;
      assert s1.Peek(10) == 0x6e4;
      assert s1.Peek(14) == 0x2cd;
      ...
      var s9 := Add(s8);
      var s10 := Push2(s9, 0x04ec);
      var s11 := Swap2(s10);
      assert s11.Peek(2) == 0x4ec;
      assert s11.Peek(7) == 0x7fd;
      assert s11.Peek(11) == 0x6e4;
      assert s11.Peek(15) == 0x2cd;
      assert s11.Peek(19) == 0x120;
      var s12 := Swap1(s11);
      var s13 := Push2(s12, 0x0846);
      var s14 := Jump(s13);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s74(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x4ec

    requires s0.stack[7] == 0x7fd

    requires s0.stack[11] == 0x6e4

    requires s0.stack[15] == 0x2cd
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x4ec;
      assert s1.Peek(7) == 0x7fd;
      assert s1.Peek(11) == 0x6e4;
      assert s1.Peek(15) == 0x2cd;
      ...
      assert s11.Peek(13) == 0x7fd;
      assert s11.Peek(17) == 0x6e4;
      assert s11.Peek(21) == 0x2cd;
      assert s11.Peek(25) == 0x120;
      var s12 := Add(s11);
      var s13 := MStore(s12);
      var s14 := Push1(s13, 0x00);
      //  Go to the next instruction at pc + 1
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s75(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[11] == 0x7fd

    requires s0.stack[15] == 0x6e4

    requires s0.stack[19] == 0x2cd

    requires s0.stack[23] == 0x120
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(11) == 0x7fd;
      assert s1.Peek(15) == 0x6e4;
      assert s1.Peek(19) == 0x2cd;
      assert s1.Peek(23) == 0x120;
      var s2 := Dup2(s1);
      var s3 := Dup2(s2);
      var s4 := Lt(s3);
      var s5 := IsZero(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(12) == 0x7fd;
      assert s1.Peek(16) == 0x6e4;
      assert s1.Peek(20) == 0x2cd;
      assert s1.Peek(24) == 0x120;
      var s2 := Dup2(s1);
      var s3 := Add(s2);
      var s4 := Dup4(s3);
      var s5 := Add(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(12) == 0x7fd;
      assert s11.Peek(16) == 0x6e4;
      assert s11.Peek(20) == 0x2cd;
      assert s11.Peek(24) == 0x120;
      var s12 := Not(s11);
      var s13 := Push1(s12, 0x1f);
      var s14 := Dup4(s13);
      var s15 := Add(s14);
      ...
      var s20 := Swap3(s19);
      var s21 := Pop(s20);
      assert s21.Peek(5) == 0x4ec;
      assert s21.Peek(10) == 0x7fd;
      assert s21.Peek(14) == 0x6e4;
      assert s21.Peek(18) == 0x2cd;
      assert s21.Peek(22) == 0x120;
      var s22 := Pop(s21);
      var s23 := Pop(s22);
      var s24 := Swap3(s23);
      var s25 := Swap2(s24);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(5) == 0x7fd;
      assert s1.Peek(9) == 0x6e4;
      assert s1.Peek(13) == 0x2cd;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Pop(s1);
      var s3 := Push1(s2, 0x00);
      var s4 := Push2(s3, 0x0795);
      var s5 := Dup5(s4);
      var s6 := Dup7(s5);
      var s7 := Push2(s6, 0x09b4);
      var s8 := Jump(s7);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s80(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x795

    requires s0.stack[8] == 0x7fd

    requires s0.stack[12] == 0x6e4

    requires s0.stack[16] == 0x2cd
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x795;
      assert s1.Peek(8) == 0x7fd;
      assert s1.Peek(12) == 0x6e4;
      assert s1.Peek(16) == 0x2cd;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s81(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0x795

    requires s0.stack[9] == 0x7fd

    requires s0.stack[13] == 0x6e4

    requires s0.stack[17] == 0x2cd
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x02d1);
      assert s1.Peek(0) == 0x2d1;
      assert s1.Peek(4) == 0x795;
      assert s1.Peek(10) == 0x7fd;
      assert s1.Peek(14) == 0x6e4;
      assert s1.Peek(18) == 0x2cd;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s82(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[0] == 0x2d1

    requires s0.stack[4] == 0x795

    requires s0.stack[10] == 0x7fd

    requires s0.stack[14] == 0x6e4

    requires s0.stack[18] == 0x2cd
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0x795;
      assert s1.Peek(9) == 0x7fd;
      assert s1.Peek(13) == 0x6e4;
      assert s1.Peek(17) == 0x2cd;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s84(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[6] == 0x7fd

    requires s0.stack[10] == 0x6e4

    requires s0.stack[14] == 0x2cd
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s31.Peek(4) == 0x2cd;
      assert s31.Peek(8) == 0x120;
      var s32 := SLoad(s31);
      var s33 := Push2(s32, 0x0713);
      var s34 := Swap1(s33);
      var s35 := Dup3(s34);
      var s36 := Push2(s35, 0x079e);
      var s37 := Jump(s36);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s87(s37, gas - 1)
  }
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s89(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0x7ab

    requires s0.stack[8] == 0x713

    requires s0.stack[12] == 0x2cd
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x02d1);
      assert s1.Peek(0) == 0x2d1;
      assert s1.Peek(4) == 0x7ab;
      assert s1.Peek(9) == 0x713;
      assert s1.Peek(13) == 0x2cd;
      assert s1.Peek(17) == 0x120;
      var s2 := Push2(s1, 0x099e);
      var s3 := Jump(s2);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s90(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[4] == 0x7ab

    requires s0.stack[9] == 0x713
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Dup3(s9);
      var s11 := Add(s10);
      assert s11.Peek(7) == 0x713;
      assert s11.Peek(11) == 0x2cd;
      ...
      var s20 := Dup3(s19);
      var s21 := Add(s20);
      assert s21.Peek(7) == 0x713;
      assert s21.Peek(11) == 0x2cd;
      ...
      var s26 := Jump(s25);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s94(s26, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s8 := Swap1(s7);
      var s9 := Swap3(s8);
      var s10 := Push2(s9, 0x02cd);
      var s11 := Swap3(s10);
      assert s11.Peek(3) == 0x2cd;
      assert s11.Peek(7) == 0x120;
      var s12 := Swap1(s11);
      var s13 := Swap2(s12);
      var s14 := Dup7(s13);
      var s15 := Swap2(s14);
      var s16 := Push2(s15, 0x0331);
      var s17 := Swap2(s16);
      var s18 := Swap1(s17);
      var s19 := Dup8(s18);
      var s20 := Swap1(s19);
      var s21 := Push2(s20, 0x0764);
      assert s21.Peek(0) == 0x764;
      assert s21.Peek(4) == 0x331;
      assert s21.Peek(7) == 0x2cd;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s21.Peek(13) == 0x2cd;
      assert s21.Peek(17) == 0x120;
      var s22 := Pop(s21);
      var s23 := Pop(s22);
      var s24 := Swap3(s23);
      var s25 := Swap2(s24);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s24 := Add(s23);
      //  Go to the next instruction at pc + 1
      ExecuteFromCFGNode_s65(s24, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x7fd;
      assert s11.Peek(8) == 0x19c;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s32 := Swap2(s31);
      var s33 := Push2(s32, 0x02cd);
      var s34 := Swap2(s33);
      var s35 := Dup6(s34);
      var s36 := Swap1(s35);
      var s37 := Push2(s36, 0x0331);
      var s38 := Swap1(s37);
      var s39 := Dup7(s38);
      var s40 := Push2(s39, 0x079e);
      var s41 := Jump(s40);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x08ef);
      assert s11.Peek(0) == 0x8ef;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s26 := Jump(s25);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s215(s26, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s21.Peek(4) == 0x7fd;
      assert s21.Peek(8) == 0x6e4;
      assert s21.Peek(12) == 0x2e4;
      assert s21.Peek(17) == 0x120;
      var s22 := Pop(s21);
      var s23 := Push2(s22, 0x0764);
      var s24 := Jump(s23);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s222(s24, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(13) == 0x7fd;
      assert s11.Peek(17) == 0x6e4;
      assert s11.Peek(21) == 0x2e4;
      assert s11.Peek(26) == 0x120;
      var s12 := Add(s11);
      var s13 := MStore(s12);
      var s14 := Push1(s13, 0x00);
      //  Go to the next instruction at pc + 1
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s21.Peek(10) == 0x7fd;
      assert s21.Peek(14) == 0x6e4;
      assert s21.Peek(18) == 0x2e4;
      assert s21.Peek(23) == 0x120;
      var s22 := Pop(s21);
      var s23 := Pop(s22);
      var s24 := Swap3(s23);
      var s25 := Swap2(s24);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s37 := Jump(s36);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s237(s37, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s19 := Add(s18);
      var s20 := Push2(s19, 0x09db);
      var s21 := Push1(s20, 0x21);
      assert s21.Peek(5) == 0x331;
      assert s21.Peek(8) == 0x336;
      assert s21.Peek(13) == 0x120;
      var s22 := Swap2(s21);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s21.Peek(5) == 0x4ec;
      assert s21.Peek(10) == 0x331;
      assert s21.Peek(13) == 0x336;
      assert s21.Peek(18) == 0x120;
      var s22 := Pop(s21);
      var s23 := Pop(s22);
      var s24 := Swap3(s23);
      var s25 := Swap2(s24);
