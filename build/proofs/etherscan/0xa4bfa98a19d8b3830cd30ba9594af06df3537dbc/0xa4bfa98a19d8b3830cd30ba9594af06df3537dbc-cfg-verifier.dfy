...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x24);
      var s11 := Push0(s10);
      assert s11.Peek(2) == 0x93b;
      assert s11.Peek(13) == 0x179;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x096e);
      assert s1.Peek(0) == 0x96e;
      assert s1.Peek(10) == 0x179;
      assert s1.Peek(11) == 0x17e;
      var s2 := Dup6(s1);
