...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(7) == 0x676;
      assert s11.Peek(11) == 0x27c;
      assert s11.Peek(15) == 0xdb;
      var s12 := Swap1(s11);
      var s13 := Push2(s12, 0x0731);
      var s14 := Jump(s13);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s31.Peek(8) == 0xdb;
      var s32 := SLoad(s31);
      var s33 := Push2(s32, 0x06a4);
      var s34 := Swap1(s33);
      var s35 := Dup3(s34);
      var s36 := Push2(s35, 0x071f);
      var s37 := Jump(s36);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push0(s1);
      var s3 := Push2(s2, 0x072a);
      var s4 := Dup3(s3);
      var s5 := Dup5(s4);
      var s6 := Push2(s5, 0x098e);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0280);
      assert s1.Peek(0) == 0x280;
      assert s1.Peek(4) == 0x72a;
      assert s1.Peek(8) == 0x6a4;
      assert s1.Peek(12) == 0x27c;
      assert s1.Peek(16) == 0xdb;
      var s2 := Push2(s1, 0x0962);
      var s3 := Jump(s2);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s55(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[0] == 0x280

    requires s0.stack[4] == 0x72a

    requires s0.stack[8] == 0x6a4

    requires s0.stack[12] == 0x27c
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Push0(s10);
      assert s11.Peek(2) == 0x280;
      assert s11.Peek(6) == 0x72a;
      assert s11.Peek(10) == 0x6a4;
      assert s11.Peek(14) == 0x27c;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s32 := Swap1(s31);
      var s33 := Push2(s32, 0x0916);
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s71(s34, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0859);
      assert s1.Peek(0) == 0x859;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x087e);
      assert s1.Peek(0) == 0x87e;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x08b1);
      assert s1.Peek(0) == 0x8b1;
      assert s1.Peek(10) == 0x133;
      assert s1.Peek(11) == 0x138;
      var s2 := Dup6(s1);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s29 := Swap1(s28);
      var s30 := Dup3(s29);
      var s31 := Push2(s30, 0x071f);
      assert s31.Peek(0) == 0x71f;
      assert s31.Peek(3) == 0x3f3;
      assert s31.Peek(8) == 0x138;
      var s32 := Jump(s31);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s143(s32, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0987);
      assert s1.Peek(0) == 0x987;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x24);
      var s11 := Push0(s10);
      assert s11.Peek(2) == 0x987;
      assert s11.Peek(5) == 0x429;
      assert s11.Peek(9) == 0x138;
      var s12 := Revert(s11);
      // Segment is terminal (Revert, Stop or Return)
      s12
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x07d1);
      assert s11.Peek(0) == 0x7d1;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s180(s33, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s12 := Jump(s11);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s221(s12, gas - 1)
  }
