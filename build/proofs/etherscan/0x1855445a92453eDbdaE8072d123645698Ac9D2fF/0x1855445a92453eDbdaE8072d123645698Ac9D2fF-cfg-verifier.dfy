...
module  {:disableNonlinearArithmetic} EVMProofObject {
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s15(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0x8e9

    requires s0.stack[6] == 0x25a

    requires s0.stack[7] == 0x140
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x8e9;
      assert s11.Peek(9) == 0x25a;
      assert s11.Peek(10) == 0x140;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x0830);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := IsZero(s10);
      assert s11.Peek(1) == 0x1dd;
      var s12 := Push2(s11, 0x03c8);
      var s13 := JumpI(s12);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(0) == 0x1dd;
      var s2 := Push20(s1, 0x9078be5e16d002c57d094a80b832074fa3f460ca);
      var s3 := Not(s2);
      var s4 := Caller(s3);
      var s5 := Add(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0xa8);
      var s11 := Shl(s10);
      assert s11.Peek(3) == 0x1dd;
      var s12 := Or(s11);
      var s13 := Swap1(s12);
      var s14 := SStore(s13);
      var s15 := Jump(s14);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(6) == 0x3ab;
      assert s11.Peek(10) == 0x11c;
      var s12 := And(s11);
      var s13 := Dup1(s12);
      var s14 := Push2(s13, 0x042f);
      var s15 := JumpI(s14);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s7 := Dup5(s6);
      var s8 := And(s7);
      var s9 := Push20(s8, 0x9078be5e16d002c57d094a80b832074fa3f460cb);
      var s10 := Eq(s9);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := SLoad(s19);
      var s21 := Dup5(s20);
      assert s21.Peek(8) == 0x3ab;
      assert s21.Peek(12) == 0x11c;
      var s22 := Swap3(s21);
      var s23 := Swap1(s22);
      var s24 := Push2(s23, 0x04d4);
      var s25 := Swap1(s24);
      var s26 := Dup5(s25);
      var s27 := Swap1(s26);
      var s28 := Push2(s27, 0x0a19);
      var s29 := Jump(s28);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Dup1(s19);
      var s21 := IsZero(s20);
      assert s21.Peek(6) == 0x3ab;
      assert s21.Peek(10) == 0x11c;
      var s22 := Push2(s21, 0x0500);
      var s23 := JumpI(s22);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s3 := Swap1(s2);
      var s4 := PushN(s3, 5, 0x174876e800);
      var s5 := Push2(s4, 0x0a02);
      var s6 := Jump(s5);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Push0(s10);
      assert s11.Peek(2) == 0x2dc;
      assert s11.Peek(6) == 0x524;
      assert s11.Peek(12) == 0x3ab;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(6) == 0x3ab;
      assert s1.Peek(10) == 0x11c;
      var s2 := Push2(s1, 0x052e);
      var s3 := Swap2(s2);
      var s4 := Swap1(s3);
      var s5 := Push2(s4, 0x0a2c);
      var s6 := Jump(s5);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Dup4(s29);
      var s31 := Add(s30);
      assert s31.Peek(9) == 0x3ab;
      assert s31.Peek(13) == 0x11c;
      var s32 := Swap1(s31);
      var s33 := Dup1(s32);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s25 := Push2(s24, 0x0613);
      var s26 := Push1(s25, 0x12);
      var s27 := Push1(s26, 0x0a);
      var s28 := Push2(s27, 0x09f4);
      var s29 := Jump(s28);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Push0(s10);
      assert s11.Peek(2) == 0x2dc;
      assert s11.Peek(6) == 0x622;
      assert s11.Peek(15) == 0x3ab;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s16 := Add(s15);
      var s17 := Push2(s16, 0x0650);
      var s18 := Swap6(s17);
      var s19 := Swap5(s18);
      var s20 := Swap4(s19);
      var s21 := Swap3(s20);
      assert s21.Peek(6) == 0x650;
      assert s21.Peek(14) == 0x3ab;
      assert s21.Peek(18) == 0x11c;
      var s22 := Swap2(s21);
      var s23 := Swap1(s22);
      var s24 := Push2(s23, 0x0a5f);
      var s25 := Jump(s24);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Dup8(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(11) == 0x650;
      assert s11.Peek(19) == 0x3ab;
      assert s11.Peek(23) == 0x11c;
      var s12 := Dup6(s11);
      var s13 := Add(s12);
      var s14 := MStore(s13);
      ...
      var s20 := Dup2(s19);
      var s21 := Dup8(s20);
      assert s21.Peek(11) == 0x650;
      assert s21.Peek(19) == 0x3ab;
      assert s21.Peek(23) == 0x11c;
      var s22 := MLoad(s21);
      var s23 := Dup1(s22);
      var s24 := Dup5(s23);
      var s25 := MStore(s24);
      ...
      var s30 := Pop(s29);
      var s31 := Dup3(s30);
      assert s31.Peek(12) == 0x650;
      assert s31.Peek(20) == 0x3ab;
      assert s31.Peek(24) == 0x11c;
      var s32 := Dup10(s31);
      var s33 := Add(s32);
      var s34 := Swap4(s33);
      var s35 := Pop(s34);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s108(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[12] == 0x650

    requires s0.stack[20] == 0x3ab

    requires s0.stack[24] == 0x11c
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(12) == 0x650;
      assert s1.Peek(20) == 0x3ab;
      assert s1.Peek(24) == 0x11c;
      var s2 := Dup2(s1);
      var s3 := Dup2(s2);
      var s4 := Lt(s3);
      var s5 := IsZero(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Dup5(s0);
      assert s1.Peek(13) == 0x650;
      assert s1.Peek(21) == 0x3ab;
      assert s1.Peek(25) == 0x11c;
      var s2 := MLoad(s1);
      var s3 := Push1(s2, 0x01);
      var s4 := Push1(s3, 0x01);
      var s5 := Push1(s4, 0xa0);
      ...
      var s10 := MStore(s9);
      var s11 := Swap4(s10);
      assert s11.Peek(12) == 0x650;
      assert s11.Peek(20) == 0x3ab;
      assert s11.Peek(24) == 0x11c;
      var s12 := Dup4(s11);
      var s13 := Add(s12);
      var s14 := Swap4(s13);
      var s15 := Swap2(s14);
      ...
      assert s21.Peek(13) == 0x650;
      assert s21.Peek(21) == 0x3ab;
      assert s21.Peek(25) == 0x11c;
      var s22 := Jump(s21);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s4 := Push1(s3, 0x40);
      var s5 := MLoad(s4);
      var s6 := Push20(s5, 0x9078be5e16d002c57d094a80b832074fa3f460cb);
      var s7 := Swap3(s6);
      var s8 := Pop(s7);
      ...
      var s30 := IsZero(s29);
      var s31 := Dup1(s30);
      assert s31.Peek(7) == 0x3ab;
      assert s31.Peek(11) == 0x11c;
      var s32 := IsZero(s31);
      var s33 := Push2(s32, 0x06bb);
      var s34 := JumpI(s33);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s33.stack[1] > 0 then
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := Address(s8);
      var s10 := Eq(s9);
      var s11 := Push2(s10, 0x074a);
      assert s11.Peek(0) == 0x74a;
      assert s11.Peek(6) == 0x3ab;
      assert s11.Peek(10) == 0x11c;
      var s12 := JumpI(s11);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Swap1(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x0720);
      var s5 := Dup2(s4);
      var s6 := Dup5(s5);
      var s7 := Push2(s6, 0x0a19);
      var s8 := Jump(s7);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Swap1(s19);
      var s21 := Swap2(s20);
      assert s21.Peek(9) == 0x3ab;
      assert s21.Peek(13) == 0x11c;
      var s22 := Swap1(s21);
      var s23 := Push2(s22, 0x0743);
      var s24 := Swap1(s23);
      var s25 := Dup5(s24);
      var s26 := Swap1(s25);
      var s27 := Push2(s26, 0x0ace);
      var s28 := Jump(s27);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s22 := Swap3(s21);
      var s23 := Swap1(s22);
      var s24 := Push2(s23, 0x0771);
      var s25 := Swap1(s24);
      var s26 := Dup5(s25);
      var s27 := Swap1(s26);
      var s28 := Push2(s27, 0x0ace);
      var s29 := Jump(s28);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s26 := MLoad(s25);
      var s27 := Push2(s26, 0x07bd);
      var s28 := Swap2(s27);
      var s29 := Dup2(s28);
      var s30 := MStore(s29);
      var s31 := Push1(s30, 0x20);
      assert s31.Peek(2) == 0x7bd;
      assert s31.Peek(10) == 0x3ab;
      assert s31.Peek(14) == 0x11c;
      var s32 := Add(s31);
      var s33 := Swap1(s32);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := Push1(s8, 0x20);
      var s10 := Add(s9);
      var s11 := Push2(s10, 0x00f4);
      assert s11.Peek(0) == 0xf4;
      var s12 := Jump(s11);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s155(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[8] == 0x613

    requires s0.stack[17] == 0x3ab

    requires s0.stack[21] == 0x11c
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(5) == 0x3ab;
      assert s1.Peek(9) == 0x613;
      assert s1.Peek(18) == 0x3ab;
      assert s1.Peek(22) == 0x11c;
      var s2 := Dup2(s1);
      var s3 := Eq(s2);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x09ac);
      assert s1.Peek(0) == 0x9ac;
      assert s1.Peek(5) == 0x3ab;
      assert s1.Peek(9) == 0x613;
      assert s1.Peek(18) == 0x3ab;
      assert s1.Peek(22) == 0x11c;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(16) == 0x3ab;
      assert s1.Peek(20) == 0x11c;
      var s2 := Push2(s1, 0x09d9);
      var s3 := Dup4(s2);
      var s4 := Dup4(s3);
      var s5 := Push2(s4, 0x0914);
      var s6 := Jump(s5);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s160(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x9d9

    requires s0.stack[6] == 0x3ab

    requires s0.stack[10] == 0x613

    requires s0.stack[19] == 0x3ab

    requires s0.stack[23] == 0x11c
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x9d9;
      assert s1.Peek(6) == 0x3ab;
      assert s1.Peek(10) == 0x613;
      assert s1.Peek(19) == 0x3ab;
      assert s1.Peek(23) == 0x11c;
      var s2 := Push1(s1, 0x01);
      var s3 := Dup2(s2);
      var s4 := Dup2(s3);
      //  Go to the next instruction at pc + 1
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s161(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[5] == 0x9d9

    requires s0.stack[9] == 0x3ab

    requires s0.stack[13] == 0x613

    requires s0.stack[22] == 0x3ab

    requires s0.stack[26] == 0x11c
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(5) == 0x9d9;
      assert s1.Peek(9) == 0x3ab;
      assert s1.Peek(13) == 0x613;
      assert s1.Peek(22) == 0x3ab;
      assert s1.Peek(26) == 0x11c;
      var s2 := Dup1(s1);
      var s3 := Dup6(s2);
      var s4 := Gt(s3);
      var s5 := IsZero(s4);
      var s6 := Push2(s5, 0x094e);
      var s7 := JumpI(s6);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s6.stack[1] > 0 then
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Dup2(s0);
      assert s1.Peek(6) == 0x9d9;
      assert s1.Peek(10) == 0x3ab;
      assert s1.Peek(14) == 0x613;
      assert s1.Peek(23) == 0x3ab;
      assert s1.Peek(27) == 0x11c;
      var s2 := Push0(s1);
      var s3 := Not(s2);
      var s4 := Div(s3);
      var s5 := Dup3(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0934);
      assert s1.Peek(0) == 0x934;
      assert s1.Peek(6) == 0x9d9;
      assert s1.Peek(10) == 0x3ab;
      assert s1.Peek(14) == 0x613;
      assert s1.Peek(23) == 0x3ab;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s164(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[0] == 0x934

    requires s0.stack[6] == 0x9d9

    requires s0.stack[10] == 0x3ab

    requires s0.stack[14] == 0x613

    requires s0.stack[23] == 0x3ab

    requires s0.stack[27] == 0x11c
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x24);
      var s11 := Push0(s10);
      assert s11.Peek(2) == 0x934;
      assert s11.Peek(8) == 0x9d9;
      assert s11.Peek(12) == 0x3ab;
      assert s11.Peek(16) == 0x613;
      assert s11.Peek(25) == 0x3ab;
      assert s11.Peek(29) == 0x11c;
      var s12 := Revert(s11);
      // Segment is terminal (Revert, Stop or Return)
      s12
  }
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s169(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[9] == 0x613

    requires s0.stack[18] == 0x3ab

    requires s0.stack[22] == 0x11c
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x09ec);
      assert s1.Peek(0) == 0x9ec;
      assert s1.Peek(6) == 0x3ab;
      assert s1.Peek(10) == 0x613;
      assert s1.Peek(19) == 0x3ab;
      assert s1.Peek(23) == 0x11c;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x24);
      var s11 := Push0(s10);
      assert s11.Peek(2) == 0x9ec;
      assert s11.Peek(8) == 0x3ab;
      assert s11.Peek(12) == 0x613;
      assert s11.Peek(21) == 0x3ab;
      assert s11.Peek(25) == 0x11c;
      var s12 := Revert(s11);
      // Segment is terminal (Revert, Stop or Return)
      s12
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x09a1);
      assert s1.Peek(0) == 0x9a1;
      assert s1.Peek(5) == 0x3ab;
      assert s1.Peek(9) == 0x613;
      assert s1.Peek(18) == 0x3ab;
      assert s1.Peek(22) == 0x11c;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x24);
      var s11 := Push0(s10);
      assert s11.Peek(2) == 0x9a1;
      assert s11.Peek(7) == 0x3ab;
      assert s11.Peek(11) == 0x613;
      assert s11.Peek(20) == 0x3ab;
      assert s11.Peek(24) == 0x11c;
      var s12 := Revert(s11);
      // Segment is terminal (Revert, Stop or Return)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Dup5(s10);
      assert s11.Peek(6) == 0x3ab;
      assert s11.Peek(10) == 0x515;
      assert s11.Peek(16) == 0x3ab;
      assert s11.Peek(20) == 0x11c;
      var s12 := Lt(s11);
      var s13 := Push1(s12, 0x0b);
      var s14 := Dup5(s13);
      var s15 := Lt(s14);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(8) == 0x9d9;
      assert s11.Peek(12) == 0x3ab;
      assert s11.Peek(16) == 0x515;
      assert s11.Peek(22) == 0x3ab;
      assert s11.Peek(26) == 0x11c;
      var s12 := Revert(s11);
      // Segment is terminal (Revert, Stop or Return)
      s12
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s16 := Add(s15);
      var s17 := Push3(s16, 0x2129a7);
      var s18 := Push1(s17, 0xe9);
      var s19 := Shl(s18);
      var s20 := Dup2(s19);
      var s21 := MStore(s20);
      assert s21.Peek(2) == 0xe7;
      var s22 := Pop(s21);
      var s23 := Dup2(s22);
      var s24 := Jump(s23);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x20);
      var s11 := Add(s10);
      assert s11.Peek(1) == 0x181;
      var s12 := Push2(s11, 0x00f4);
      var s13 := Jump(s12);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x086f);
      assert s11.Peek(0) == 0x86f;
      assert s11.Peek(7) == 0x168;
      assert s11.Peek(8) == 0x11c;
      var s12 := JumpI(s11);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s11.stack[1] > 0 then
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s251(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0x878

    requires s0.stack[7] == 0x168
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x878;
      assert s11.Peek(10) == 0x168;
      assert s11.Peek(11) == 0x11c;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x0830);
      var s14 := JumpI(s13);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Dup1(s29);
      var s31 := SLoad(s30);
      assert s31.Peek(6) == 0x11c;
      var s32 := Dup4(s31);
      var s33 := Swap2(s32);
      var s34 := Swap1(s33);
      var s35 := Dup4(s34);
      var s36 := Swap1(s35);
      var s37 := Push2(s36, 0x0334);
      var s38 := Swap1(s37);
      var s39 := Dup5(s38);
      var s40 := Swap1(s39);
      var s41 := Push2(s40, 0x0a19);
      //  Go to the next instruction at pc + 1
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s21 := Swap3(s20);
      assert s21.Peek(6) == 0x650;
      assert s21.Peek(14) == 0x345;
      assert s21.Peek(19) == 0x11c;
      var s22 := Swap2(s21);
      var s23 := Swap1(s22);
      var s24 := Push2(s23, 0x0a5f);
      var s25 := Jump(s24);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s21 := Dup8(s20);
      assert s21.Peek(11) == 0x650;
      assert s21.Peek(19) == 0x345;
      assert s21.Peek(24) == 0x11c;
      var s22 := MLoad(s21);
      var s23 := Dup1(s22);
      var s24 := Dup5(s23);
      var s25 := MStore(s24);
      ...
      var s31 := Dup3(s30);
      assert s31.Peek(12) == 0x650;
      assert s31.Peek(20) == 0x345;
      assert s31.Peek(25) == 0x11c;
      var s32 := Dup10(s31);
      var s33 := Add(s32);
      var s34 := Swap4(s33);
      var s35 := Pop(s34);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s21.Peek(0) == 0xa88;
      assert s21.Peek(13) == 0x650;
      assert s21.Peek(21) == 0x345;
      assert s21.Peek(26) == 0x11c;
      var s22 := Jump(s21);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(10) == 0x3ab;
      assert s1.Peek(14) == 0x613;
      assert s1.Peek(23) == 0x345;
      assert s1.Peek(28) == 0x11c;
      var s2 := Push0(s1);
      var s3 := Not(s2);
      var s4 := Div(s3);
      var s5 := Dup3(s4);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s382(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[23] == 0x345

    requires s0.stack[28] == 0x11c
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(12) == 0x3ab;
      assert s11.Peek(16) == 0x613;
      assert s11.Peek(25) == 0x345;
      assert s11.Peek(30) == 0x11c;
      var s12 := Revert(s11);
      // Segment is terminal (Revert, Stop or Return)
      s12
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(12) == 0x3ab;
      assert s11.Peek(16) == 0x515;
      assert s11.Peek(22) == 0x345;
      assert s11.Peek(27) == 0x11c;
      var s12 := Revert(s11);
      // Segment is terminal (Revert, Stop or Return)
      s12
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push1(s0, 0x02);
      assert s1.Peek(5) == 0x3ab;
      assert s1.Peek(9) == 0x2ee;
      assert s1.Peek(10) == 0x140;
      var s2 := Dup2(s1);
      var s3 := Eq(s2);
      var s4 := Push2(s3, 0x0990);
      var s5 := JumpI(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Dup5(s10);
      assert s11.Peek(6) == 0x3ab;
      assert s11.Peek(10) == 0x2ee;
      assert s11.Peek(11) == 0x140;
      var s12 := Lt(s11);
      var s13 := Push1(s12, 0x0b);
      var s14 := Dup5(s13);
      var s15 := Lt(s14);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s446(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[13] == 0x2ee

    requires s0.stack[14] == 0x140
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(5) == 0x9d9;
      assert s1.Peek(9) == 0x3ab;
      assert s1.Peek(13) == 0x2ee;
      assert s1.Peek(14) == 0x140;
      var s2 := Dup1(s1);
      var s3 := Dup6(s2);
      var s4 := Gt(s3);
      var s5 := IsZero(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(8) == 0x9d9;
      assert s11.Peek(12) == 0x3ab;
      assert s11.Peek(16) == 0x2ee;
      assert s11.Peek(17) == 0x140;
      var s12 := Revert(s11);
      // Segment is terminal (Revert, Stop or Return)
      s12
  }
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s454(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[9] == 0x2ee

    requires s0.stack[10] == 0x140
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(2) == 0x9ec;
      assert s11.Peek(8) == 0x3ab;
      assert s11.Peek(12) == 0x2ee;
      assert s11.Peek(13) == 0x140;
      var s12 := Revert(s11);
      // Segment is terminal (Revert, Stop or Return)
      s12
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(2) == 0x9a1;
      assert s11.Peek(7) == 0x3ab;
      assert s11.Peek(11) == 0x2ee;
      assert s11.Peek(12) == 0x140;
      var s12 := Revert(s11);
      // Segment is terminal (Revert, Stop or Return)
      s12
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s15 := Push1(s14, 0x20);
      var s16 := Add(s15);
      var s17 := Push20(s16, 0x426c6f636b20536f6369616c204e6574776f726b);
