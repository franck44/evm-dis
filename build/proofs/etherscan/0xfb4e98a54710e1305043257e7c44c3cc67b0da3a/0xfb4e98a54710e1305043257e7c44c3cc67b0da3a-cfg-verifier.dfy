...
module  {:disableNonlinearArithmetic} EVMProofObject {
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s14(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0xae0

    requires s0.stack[5] == 0x2ee
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0xae0;
      assert s1.Peek(5) == 0x2ee;
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0xae0;
      assert s11.Peek(8) == 0x2ee;
      assert s11.Peek(9) == 0x20e;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x0a5a);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s33(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[1] == 0xb03

    requires s0.stack[6] == 0x2a8
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(1) == 0xb03;
      assert s1.Peek(6) == 0x2a8;
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0xb03;
      assert s11.Peek(9) == 0x2a8;
      assert s11.Peek(10) == 0x159;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x0a5a);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Swap2(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x0b11);
      var s5 := Push1(s4, 0x20);
      var s6 := Dup5(s5);
      var s7 := Add(s6);
      var s8 := Push2(s7, 0x0a43);
      var s9 := Jump(s8);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(2) == 0x138;
      var s2 := Push1(s1, 0x00);
      var s3 := Push2(s2, 0x0392);
      var s4 := Caller(s3);
      var s5 := Dup5(s4);
      var s6 := Dup5(s5);
      var s7 := Push2(s6, 0x0826);
      var s8 := Jump(s7);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s23 := Lt(s22);
      var s24 := IsZero(s23);
      var s25 := Push2(s24, 0x0964);
      var s26 := JumpI(s25);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s25.stack[1] > 0 then
        ExecuteFromCFGNode_s64(s26, gas - 1)
      else
        ExecuteFromCFGNode_s62(s26, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Dup2(s29);
      var s31 := MStore(s30);
      assert s31.Peek(6) == 0x392;
      assert s31.Peek(10) == 0x138;
      var s32 := Swap1(s31);
      var s33 := Dup2(s32);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(10) == 0x392;
      assert s1.Peek(14) == 0x138;
      var s2 := Swap1(s1);
      var s3 := Push2(s2, 0x0b54);
      var s4 := Jump(s3);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s31.Peek(10) == 0x392;
      assert s31.Peek(14) == 0x138;
      var s32 := Add(s31);
      var s33 := Swap1(s32);
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := SLoad(s29);
      var s31 := Dup3(s30);
      assert s31.Peek(5) == 0x138;
      var s32 := Dup2(s31);
      var s33 := Lt(s32);
      var s34 := IsZero(s33);
      var s35 := Push2(s34, 0x05c3);
      var s36 := JumpI(s35);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s91(s33, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s4 := Dup1(s3);
      var s5 := SLoad(s4);
      var s6 := Push2(s5, 0x0302);
      var s7 := Swap1(s6);
      var s8 := Push2(s7, 0x0b1a);
      var s9 := Jump(s8);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s29 := Dup1(s28);
      var s30 := SLoad(s29);
      var s31 := Push2(s30, 0x032e);
      assert s31.Peek(0) == 0x32e;
      assert s31.Peek(8) == 0x102;
      var s32 := Swap1(s31);
      var s33 := Push2(s32, 0x0b1a);
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s111(s34, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s31.Peek(5) == 0x138;
      var s32 := Swap2(s31);
      var s33 := Push2(s32, 0x0392);
      var s34 := Swap2(s33);
      var s35 := Dup6(s34);
      var s36 := Swap1(s35);
      var s37 := Push2(s36, 0x0489);
      var s38 := Swap1(s37);
      var s39 := Dup7(s38);
      var s40 := Swap1(s39);
      var s41 := Push2(s40, 0x0b54);
      //  Go to the next instruction at pc + 1
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s167(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[0] == 0xb54

    requires s0.stack[3] == 0x489
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Jump(s0);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s168(s1, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x0a9e);
      assert s11.Peek(0) == 0xa9e;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s33 := Dup2(s32);
      var s34 := Eq(s33);
      var s35 := Push2(s34, 0x043c);
      var s36 := JumpI(s35);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s35.stack[1] > 0 then
        ExecuteFromCFGNode_s208(s36, gas - 1)
      else
        ExecuteFromCFGNode_s197(s36, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Push1(s29, 0x84);
      var s31 := Add(s30);
      assert s31.Peek(5) == 0x447;
      assert s31.Peek(11) == 0x138;
      var s32 := Push2(s31, 0x0426);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s31 := Push1(s30, 0x20);
      assert s31.Peek(2) == 0x9e7;
      assert s31.Peek(10) == 0x447;
      assert s31.Peek(16) == 0x138;
      var s32 := Add(s31);
      var s33 := Swap1(s32);
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s223(s34, gas - 1)
  }
