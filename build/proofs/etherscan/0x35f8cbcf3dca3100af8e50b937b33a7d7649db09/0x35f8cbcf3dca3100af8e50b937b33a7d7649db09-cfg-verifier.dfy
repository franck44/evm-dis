...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      var s2 := Push2(s1, 0x01fc);
      var s3 := Push2(s2, 0x01f7);
      var s4 := CallDataSize(s3);
      var s5 := Push1(s4, 0x04);
      var s6 := Push2(s5, 0x0886);
      var s7 := Jump(s6);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x08d3);
      assert s1.Peek(0) == 0x8d3;
      assert s1.Peek(8) == 0x1f7;
      assert s1.Peek(9) == 0x1fc;
      var s2 := Push2(s1, 0x0872);
      var s3 := Jump(s2);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Push0(s10);
      assert s11.Peek(2) == 0x8d3;
      assert s11.Peek(10) == 0x1f7;
      assert s11.Peek(11) == 0x1fc;
      var s12 := Revert(s11);
      // Segment is terminal (Revert, Stop or Return)
      s12
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Gt(s19);
      var s21 := Or(s20);
      assert s21.Peek(11) == 0x1f7;
      assert s21.Peek(12) == 0x1fc;
      var s22 := IsZero(s21);
      var s23 := Push2(s22, 0x08f8);
      var s24 := JumpI(s23);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Gt(s19);
      var s21 := IsZero(s20);
      assert s21.Peek(10) == 0x1f7;
      assert s21.Peek(11) == 0x1fc;
      var s22 := Push2(s21, 0x0915);
      var s23 := JumpI(s22);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x092b);
      assert s1.Peek(0) == 0x92b;
      assert s1.Peek(10) == 0x1f7;
      assert s1.Peek(11) == 0x1fc;
      var s2 := Dup6(s1);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x92b;
      assert s11.Peek(14) == 0x1f7;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(13) == 0x1f7;
      assert s1.Peek(14) == 0x1fc;
      var s2 := Dup1(s1);
      var s3 := Revert(s2);
      // Segment is terminal (Revert, Stop or Return)
      s3
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s25 := Jump(s24);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s43(s25, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s31.Peek(8) == 0x1fc;
      var s32 := Jump(s31);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s52(s32, gas - 1)
  }
