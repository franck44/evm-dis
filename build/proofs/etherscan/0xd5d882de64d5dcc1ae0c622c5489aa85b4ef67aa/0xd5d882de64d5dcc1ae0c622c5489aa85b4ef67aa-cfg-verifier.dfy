...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push2(s1, 0x08f5);
      var s3 := Dup4(s2);
      var s4 := Push2(s3, 0x0772);
      var s5 := Jump(s4);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x8f5;
      assert s11.Peek(9) == 0x1b6;
      assert s11.Peek(10) == 0x11a;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x0788);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x06e9);
      assert s1.Peek(0) == 0x6e9;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := Add(s8);
      var s10 := Push2(s9, 0x0331);
      var s11 := Swap2(s10);
      assert s11.Peek(2) == 0x331;
      assert s11.Peek(7) == 0x66b;
      assert s11.Peek(11) == 0x27c;
      assert s11.Peek(15) == 0xdb;
      var s12 := Swap1(s11);
      var s13 := Push2(s12, 0x0726);
      var s14 := Jump(s13);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(13) == 0x66b;
      assert s11.Peek(17) == 0x27c;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s46(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[11] == 0x66b

    requires s0.stack[15] == 0x27c
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(11) == 0x66b;
      assert s1.Peek(15) == 0x27c;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(12) == 0x66b;
      assert s1.Peek(16) == 0x27c;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(12) == 0x66b;
      assert s11.Peek(16) == 0x27c;
      ...
      var s20 := Swap3(s19);
      var s21 := Pop(s20);
      assert s21.Peek(5) == 0x331;
      assert s21.Peek(10) == 0x66b;
      assert s21.Peek(14) == 0x27c;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s31.Peek(8) == 0xdb;
      var s32 := SLoad(s31);
      var s33 := Push2(s32, 0x0699);
      var s34 := Swap1(s33);
      var s35 := Dup3(s34);
      var s36 := Push2(s35, 0x0714);
      var s37 := Jump(s36);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s52(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x699

    requires s0.stack[6] == 0x27c
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x699;
      assert s1.Peek(6) == 0x27c;
      assert s1.Peek(10) == 0xdb;
      var s2 := Push0(s1);
      var s3 := Push2(s2, 0x071f);
      var s4 := Dup3(s3);
      var s5 := Dup5(s4);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s53(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x71f

    requires s0.stack[6] == 0x699

    requires s0.stack[10] == 0x27c
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(4) == 0x71f;
      assert s1.Peek(8) == 0x699;
      assert s1.Peek(12) == 0x27c;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(8) == 0x14e;
      var s12 := Push2(s11, 0x083d);
      var s13 := JumpI(s12);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x084f);
      assert s1.Peek(0) == 0x84f;
      assert s1.Peek(8) == 0x149;
      assert s1.Peek(9) == 0x14e;
      var s2 := Push2(s1, 0x07ee);
      var s3 := Jump(s2);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s106(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[0] == 0x84f

    requires s0.stack[8] == 0x149

    requires s0.stack[9] == 0x14e
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Push0(s10);
      assert s11.Peek(2) == 0x84f;
      assert s11.Peek(10) == 0x149;
      assert s11.Peek(11) == 0x14e;
      var s12 := Revert(s11);
      // Segment is terminal (Revert, Stop or Return)
      s12
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0874);
      assert s1.Peek(0) == 0x874;
      assert s1.Peek(11) == 0x149;
      assert s1.Peek(12) == 0x14e;
      var s2 := Push2(s1, 0x07ee);
      var s3 := Jump(s2);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s109(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[0] == 0x874

    requires s0.stack[11] == 0x149

    requires s0.stack[12] == 0x14e
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x24);
      var s11 := Push0(s10);
      assert s11.Peek(2) == 0x874;
      assert s11.Peek(13) == 0x149;
      assert s11.Peek(14) == 0x14e;
      var s12 := Revert(s11);
      // Segment is terminal (Revert, Stop or Return)
      s12
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s21.Peek(11) == 0x14e;
      var s22 := Push2(s21, 0x0891);
      var s23 := JumpI(s22);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x08a7);
      assert s1.Peek(0) == 0x8a7;
      assert s1.Peek(10) == 0x149;
      assert s1.Peek(11) == 0x14e;
      var s2 := Dup6(s1);
      var s3 := Push2(s2, 0x0772);
      var s4 := Jump(s3);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x8a7;
      assert s11.Peek(14) == 0x149;
      assert s11.Peek(15) == 0x14e;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x0788);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(10) == 0x14e;
      var s12 := Push2(s11, 0x0896);
      var s13 := Jump(s12);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Pop(s9);
      var s11 := Pop(s10);
      assert s11.Peek(0) == 0x149;
      assert s11.Peek(2) == 0x14e;
      var s12 := Jump(s11);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0358);
      assert s1.Peek(0) == 0x358;
      assert s1.Peek(6) == 0x14e;
      var s2 := Push2(s1, 0x0944);
      var s3 := Jump(s2);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s16 := Pop(s15);
      var s17 := Swap1(s16);
      var s18 := Push2(s17, 0x03aa);
      var s19 := Swap1(s18);
      var s20 := Dup3(s19);
      var s21 := Swap1(s20);
      assert s21.Peek(2) == 0x3aa;
      assert s21.Peek(7) == 0x14e;
      var s22 := Dup2(s21);
      var s23 := Swap1(s22);
      var s24 := Push2(s23, 0x06e9);
      var s25 := Jump(s24);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Dup6(s10);
      assert s11.Peek(8) == 0x331;
      assert s11.Peek(13) == 0x3aa;
      assert s11.Peek(18) == 0x14e;
      var s12 := Add(s11);
      var s13 := MStore(s12);
      var s14 := Push0(s13);
      //  Go to the next instruction at pc + 1
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s134(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[11] == 0x3aa

    requires s0.stack[16] == 0x14e
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(6) == 0x331;
      assert s1.Peek(11) == 0x3aa;
      assert s1.Peek(16) == 0x14e;
      var s2 := Dup2(s1);
      var s3 := Dup2(s2);
      var s4 := Lt(s3);
      var s5 := IsZero(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Dup6(s0);
      assert s1.Peek(7) == 0x331;
      assert s1.Peek(12) == 0x3aa;
      assert s1.Peek(17) == 0x14e;
      var s2 := Dup2(s1);
      var s3 := Add(s2);
      var s4 := Dup4(s3);
      var s5 := Add(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Push1(s10, 0x1f);
      assert s11.Peek(7) == 0x331;
      assert s11.Peek(12) == 0x3aa;
      assert s11.Peek(17) == 0x14e;
      var s12 := Not(s11);
      var s13 := Push1(s12, 0x1f);
      var s14 := Dup4(s13);
      var s15 := Add(s14);
      ...
      var s21 := Pop(s20);
      assert s21.Peek(5) == 0x331;
      assert s21.Peek(10) == 0x3aa;
      assert s21.Peek(15) == 0x14e;
      var s22 := Pop(s21);
      var s23 := Pop(s22);
      var s24 := Swap3(s23);
      var s25 := Swap2(s24);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s27 := SLoad(s26);
      var s28 := Push2(s27, 0x03f3);
      var s29 := Swap1(s28);
      var s30 := Dup3(s29);
      var s31 := Push2(s30, 0x0714);
      assert s31.Peek(0) == 0x714;
      assert s31.Peek(3) == 0x3f3;
      assert s31.Peek(8) == 0x14e;
      var s32 := Jump(s31);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x07c7);
      assert s11.Peek(0) == 0x7c7;
      assert s11.Peek(7) == 0x136;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Add(s10);
      assert s11.Peek(3) == 0x2de;
      assert s11.Peek(6) == 0x2e3;
      assert s11.Peek(11) == 0xdb;
      var s12 := Push1(s11, 0x40);
      var s13 := MStore(s12);
      var s14 := Dup1(s13);
      ...
      var s19 := Add(s18);
      var s20 := Push2(s19, 0x099e);
      var s21 := Push1(s20, 0x28);
      assert s21.Peek(5) == 0x2de;
      assert s21.Peek(8) == 0x2e3;
      assert s21.Peek(13) == 0xdb;
      var s22 := Swap2(s21);
      ...
      var s30 := And(s29);
      var s31 := Push0(s30);
      assert s31.Peek(4) == 0x2de;
      assert s31.Peek(7) == 0x2e3;
      assert s31.Peek(12) == 0xdb;
      var s32 := Swap1(s31);
      var s33 := Dup2(s32);
      var s34 := MStore(s33);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Push1(s10, 0x1f);
      assert s11.Peek(7) == 0x331;
      assert s11.Peek(12) == 0x2de;
      assert s11.Peek(15) == 0x2e3;
      assert s11.Peek(20) == 0xdb;
      var s12 := Not(s11);
      var s13 := Push1(s12, 0x1f);
      var s14 := Dup4(s13);
      ...
      var s21 := Pop(s20);
      assert s21.Peek(5) == 0x331;
      assert s21.Peek(10) == 0x2de;
      assert s21.Peek(13) == 0x2e3;
      assert s21.Peek(18) == 0xdb;
      var s22 := Pop(s21);
      var s23 := Pop(s22);
      var s24 := Swap3(s23);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Swap2(s9);
      var s11 := And(s10);
      assert s11.Peek(2) == 0xfe;
      var s12 := Dup2(s11);
      var s13 := MStore(s12);
      var s14 := Push1(s13, 0x20);
      var s15 := Add(s14);
      var s16 := Push2(s15, 0x00bf);
      var s17 := Jump(s16);
      //  JUMP to the target at Peek(0)
