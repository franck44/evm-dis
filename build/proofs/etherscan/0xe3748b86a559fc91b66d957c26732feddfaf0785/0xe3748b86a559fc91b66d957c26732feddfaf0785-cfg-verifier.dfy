...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0af7);
      assert s1.Peek(0) == 0xaf7;
      assert s1.Peek(8) == 0x22b;
      assert s1.Peek(9) == 0x230;
      var s2 := Push2(s1, 0x0a7d);
      var s3 := Jump(s2);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s29 := Jump(s28);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s87(s29, gas - 1)
  }
