...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x75c;
      assert s11.Peek(9) == 0x1be;
      assert s11.Peek(10) == 0xfe;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x0719);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s16 := Swap3(s15);
      var s17 := Swap1(s16);
      var s18 := Push2(s17, 0x05e9);
      var s19 := Swap1(s18);
      var s20 := Dup5(s19);
      var s21 := Swap1(s20);
      assert s21.Peek(2) == 0x5e9;
      assert s21.Peek(9) == 0xea;
      var s22 := Push2(s21, 0x0918);
      var s23 := Jump(s22);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s27 := Swap3(s26);
      var s28 := Swap1(s27);
      var s29 := Push2(s28, 0x0616);
      var s30 := Swap1(s29);
      var s31 := Dup5(s30);
      assert s31.Peek(2) == 0x616;
      assert s31.Peek(9) == 0xea;
      var s32 := Swap1(s31);
      var s33 := Push2(s32, 0x0900);
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0913);
      assert s1.Peek(0) == 0x913;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x082c);
      assert s1.Peek(0) == 0x82c;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0851);
      assert s1.Peek(0) == 0x851;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x04ce);
      assert s1.Peek(0) == 0x4ce;
      assert s1.Peek(7) == 0x147;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s27 := Dup1(s26);
      var s28 := Dup1(s27);
      var s29 := Push2(s28, 0x0543);
      var s30 := Swap1(s29);
      var s31 := Push2(s30, 0x096a);
      assert s31.Peek(0) == 0x96a;
      assert s31.Peek(2) == 0x543;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x097e);
      assert s1.Peek(0) == 0x97e;
      assert s1.Peek(3) == 0x543;
      assert s1.Peek(8) == 0x147;
      var s2 := Push2(s1, 0x0985);
      var s3 := Jump(s2);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s137(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[0] == 0x97e

    requires s0.stack[3] == 0x543
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x24);
      var s11 := Push1(s10, 0x00);
      assert s11.Peek(2) == 0x97e;
      assert s11.Peek(5) == 0x543;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x0788);
      assert s11.Peek(0) == 0x788;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s32 := Gt(s31);
      var s33 := IsZero(s32);
      var s34 := Push2(s33, 0x0369);
      var s35 := JumpI(s34);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s34.stack[1] > 0 then
        ExecuteFromCFGNode_s158(s35, gas - 1)
      else
        ExecuteFromCFGNode_s156(s35, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s22 := Swap3(s21);
      var s23 := Swap1(s22);
      var s24 := Push2(s23, 0x0391);
      var s25 := Swap1(s24);
      var s26 := Dup5(s25);
      var s27 := Swap1(s26);
      var s28 := Push2(s27, 0x0918);
      var s29 := Jump(s28);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s159(s29, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s27 := Swap3(s26);
      var s28 := Swap1(s27);
      var s29 := Push2(s28, 0x03be);
      var s30 := Swap1(s29);
      var s31 := Dup5(s30);
      assert s31.Peek(2) == 0x3be;
      assert s31.Peek(10) == 0xea;
      var s32 := Swap1(s31);
      var s33 := Push2(s32, 0x0900);
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s164(s34, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s31.Peek(2) == 0x442;
      assert s31.Peek(10) == 0xea;
      var s32 := Add(s31);
      var s33 := Swap1(s32);
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s175(s34, gas - 1)
  }
