...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := MLoad(s0);
      var s2 := Push32(s1, 0x00000000000000000000000053773d0d0d71fc36cf403d886bc2eb3ac7f5fc24);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s3 := Swap1(s2);
      var s4 := Dup8(s3);
      var s5 := Push32(s4, 0x00000000000000000000000053773d0d0d71fc36cf403d886bc2eb3ac7f5fc24);
      var s6 := And(s5);
      var s7 := Swap2(s6);
      var s8 := Dup3(s7);
      var s9 := Dup2(s8);
