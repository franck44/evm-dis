...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s3 := Push2(s2, 0x022b);
      var s4 := CallDataSize(s3);
      var s5 := Push1(s4, 0x04);
      var s6 := Push2(s5, 0x0ab4);
      var s7 := Jump(s6);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Add(s9);
      var s11 := SLt(s10);
      assert s11.Peek(7) == 0x22b;
      assert s11.Peek(8) == 0x230;
      var s12 := Push2(s11, 0x0aef);
      var s13 := JumpI(s12);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0b01);
      assert s1.Peek(0) == 0xb01;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Or(s19);
      var s21 := IsZero(s20);
      assert s21.Peek(11) == 0x22b;
      assert s21.Peek(12) == 0x230;
      var s22 := Push2(s21, 0x0b44);
      var s23 := JumpI(s22);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0b44);
      assert s1.Peek(0) == 0xb44;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Gt(s19);
      var s21 := IsZero(s20);
      assert s21.Peek(10) == 0x22b;
      assert s21.Peek(11) == 0x230;
      var s22 := Push2(s21, 0x0b61);
      var s23 := JumpI(s22);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s22.stack[1] > 0 then
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Pop(s9);
      var s11 := Pop(s10);
      assert s11.Peek(0) == 0x22b;
      assert s11.Peek(2) == 0x230;
      var s12 := Jump(s11);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s27 := Jump(s26);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s110(s27, gas - 1)
  }
