...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Add(s9);
      var s11 := SLt(s10);
      assert s11.Peek(7) == 0x1e6;
      assert s11.Peek(8) == 0x1eb;
      var s12 := Push2(s11, 0x0abe);
      var s13 := JumpI(s12);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0ad0);
      assert s1.Peek(0) == 0xad0;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Or(s19);
      var s21 := IsZero(s20);
      assert s21.Peek(11) == 0x1e6;
      assert s21.Peek(12) == 0x1eb;
      var s22 := Push2(s21, 0x0b13);
      var s23 := JumpI(s22);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s22.stack[1] > 0 then
        ExecuteFromCFGNode_s37(s23, gas - 1)
      else
        ExecuteFromCFGNode_s35(s23, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0b13);
      assert s1.Peek(0) == 0xb13;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Gt(s19);
      var s21 := IsZero(s20);
      assert s21.Peek(10) == 0x1e6;
      assert s21.Peek(11) == 0x1eb;
      var s22 := Push2(s21, 0x0b30);
      var s23 := JumpI(s22);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s22.stack[1] > 0 then
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0b46);
      assert s1.Peek(0) == 0xb46;
      assert s1.Peek(10) == 0x1e6;
      assert s1.Peek(11) == 0x1eb;
      var s2 := Dup6(s1);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x040b);
      assert s1.Peek(0) == 0x40b;
      assert s1.Peek(6) == 0x1eb;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Swap1(s10);
      assert s11.Peek(5) == 0x1eb;
      var s12 := Push2(s11, 0x0482);
      var s13 := Swap1(s12);
      var s14 := Dup3(s13);
      var s15 := Swap1(s14);
      var s16 := Dup2(s15);
      var s17 := Swap1(s16);
      var s18 := Push2(s17, 0x08f4);
      var s19 := Jump(s18);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(3) == 0x3e4;
      assert s11.Peek(8) == 0x482;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(7) == 0x3e4;
      assert s11.Peek(12) == 0x482;
      ...
      assert s21.Peek(9) == 0x482;
      assert s21.Peek(14) == 0x1eb;
      var s22 := Pop(s21);
      var s23 := Swap3(s22);
      var s24 := Swap2(s23);
      var s25 := Pop(s24);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s68(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x944

    requires s0.stack[6] == 0x4d8
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x944;
      assert s1.Peek(6) == 0x4d8;
      assert s1.Peek(11) == 0x1eb;
      var s2 := Dup1(s1);
      var s3 := Dup3(s2);
      var s4 := Add(s3);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Pop(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x1eb;
      var s12 := Swap1(s11);
      var s13 := Pop(s12);
      var s14 := Push2(s13, 0x050e);
      var s15 := Dup2(s14);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s27 := Add(s26);
      var s28 := Push2(s27, 0x03e4);
      var s29 := Jump(s28);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s93(s29, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s36 := Swap2(s35);
      var s37 := Swap1(s36);
      var s38 := Push2(s37, 0x08f4);
      var s39 := Jump(s38);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s97(s39, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s28 := SLoad(s27);
      var s29 := Push2(s28, 0x0897);
      var s30 := Swap1(s29);
      var s31 := Dup3(s30);
      assert s31.Peek(2) == 0x897;
      assert s31.Peek(6) == 0x2ce;
      assert s31.Peek(10) == 0xf9;
      var s32 := Push2(s31, 0x0939);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s39 := Jump(s38);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s181(s39, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s37 := Jump(s36);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s197(s37, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s27 := Jump(s26);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s206(s27, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Add(s0);
      //  Go to the next instruction at pc + 1
      ExecuteFromCFGNode_s113(s1, gas - 1)
  }
