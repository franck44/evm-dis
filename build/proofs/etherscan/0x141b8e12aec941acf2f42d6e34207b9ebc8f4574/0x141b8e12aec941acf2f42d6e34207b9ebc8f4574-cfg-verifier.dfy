...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push2(s1, 0x0809);
      var s3 := Dup3(s2);
      var s4 := Push2(s3, 0x08ab);
      var s5 := Jump(s4);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0x809;
      assert s11.Peek(8) == 0x242;
      assert s11.Peek(9) == 0x1b2;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x08c1);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Dup4(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(6) == 0x529;
      assert s11.Peek(8) == 0x1b2;
      var s12 := And(s11);
      ...
      var s20 := And(s19);
      var s21 := Dup2(s20);
      assert s21.Peek(7) == 0x529;
      assert s21.Peek(9) == 0x1b2;
      var s22 := Or(s21);
      var s23 := Dup5(s22);
      var s24 := SStore(s23);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Swap2(s1);
      var s3 := Pop(s2);
      var s4 := Push2(s3, 0x0968);
      var s5 := Push1(s4, 0x20);
      var s6 := Dup5(s5);
      var s7 := Add(s6);
      var s8 := Push2(s7, 0x08ab);
      var s9 := Jump(s8);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := MStore(s9);
      var s11 := Dup1(s10);
      assert s11.Peek(3) == 0x752;
      assert s11.Peek(7) == 0x2eb;
      ...
      assert s21.Peek(3) == 0x752;
      assert s21.Peek(7) == 0x2eb;
      ...
      var s30 := Dup2(s29);
      var s31 := MStore(s30);
      assert s31.Peek(3) == 0x752;
      assert s31.Peek(7) == 0x2eb;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Swap2(s10);
      assert s11.Peek(2) == 0x3e6;
      assert s11.Peek(7) == 0x752;
      assert s11.Peek(11) == 0x2eb;
      assert s11.Peek(15) == 0x125;
      var s12 := Swap1(s11);
      var s13 := Push2(s12, 0x085f);
      var s14 := Jump(s13);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Dup6(s10);
      assert s11.Peek(8) == 0x3e6;
      assert s11.Peek(13) == 0x752;
      assert s11.Peek(17) == 0x2eb;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(7) == 0x3e6;
      assert s11.Peek(12) == 0x752;
      assert s11.Peek(16) == 0x2eb;
      ...
      var s20 := Swap3(s19);
      var s21 := Pop(s20);
      assert s21.Peek(5) == 0x3e6;
      assert s21.Peek(10) == 0x752;
      assert s21.Peek(14) == 0x2eb;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s31.Peek(4) == 0x2eb;
      assert s31.Peek(8) == 0x125;
      var s32 := Push2(s31, 0x0780);
      var s33 := Swap1(s32);
      var s34 := Dup3(s33);
      var s35 := Push2(s34, 0x07fe);
      var s36 := Jump(s35);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push0(s1);
      var s3 := Push2(s2, 0x0809);
      var s4 := Dup3(s3);
      var s5 := Dup5(s4);
      var s6 := Push2(s5, 0x09a9);
      var s7 := Jump(s6);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s4 := Caller(s3);
      var s5 := Dup5(s4);
      var s6 := Push2(s5, 0x034d);
      var s7 := Dup6(s6);
      var s8 := Push1(s7, 0x40);
      var s9 := MLoad(s8);
      var s10 := Dup1(s9);
      var s11 := Push1(s10, 0x60);
      assert s11.Peek(4) == 0x34d;
      assert s11.Peek(7) == 0x2eb;
      assert s11.Peek(11) == 0x125;
      var s12 := Add(s11);
      ...
      var s20 := Add(s19);
      var s21 := Push2(s20, 0x0a17);
      assert s21.Peek(4) == 0x34d;
      assert s21.Peek(7) == 0x2eb;
      assert s21.Peek(11) == 0x125;
      ...
      assert s31.Peek(5) == 0x34d;
      assert s31.Peek(8) == 0x2eb;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(3) == 0x34d;
      assert s11.Peek(6) == 0x2eb;
      assert s11.Peek(10) == 0x125;
      var s12 := SLoad(s11);
      var s13 := Swap2(s12);
      var s14 := Swap1(s13);
      var s15 := Push2(s14, 0x07d3);
      var s16 := Jump(s15);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Swap2(s10);
      assert s11.Peek(2) == 0x3e6;
      assert s11.Peek(7) == 0x34d;
      assert s11.Peek(10) == 0x2eb;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Push1(s10, 0x1f);
      assert s11.Peek(7) == 0x3e6;
      assert s11.Peek(12) == 0x34d;
      assert s11.Peek(15) == 0x2eb;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s29 := Dup1(s28);
      var s30 := SLoad(s29);
      var s31 := Push2(s30, 0x028a);
      assert s31.Peek(0) == 0x28a;
      assert s31.Peek(8) == 0xfc;
      var s32 := Swap1(s31);
      var s33 := Push2(s32, 0x0971);
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := And(s19);
      var s21 := Dup2(s20);
      assert s21.Peek(7) == 0x3f8;
      assert s21.Peek(8) == 0x1b2;
      var s22 := Or(s21);
      var s23 := Dup5(s22);
      var s24 := SStore(s23);
      var s25 := Push1(s24, 0x40);
      ...
      var s30 := And(s29);
      var s31 := Swap3(s30);
      assert s31.Peek(5) == 0x3f8;
      assert s31.Peek(6) == 0x1b2;
      var s32 := Dup4(s31);
      var s33 := Swap2(s32);
      var s34 := Push32(s33, 0x8be0079c531659141344cd1fd0a4f28419497f9722a3daafe3b4186f6b6457e0);
      var s35 := Swap2(s34);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s32 := Swap2(s31);
      var s33 := Push2(s32, 0x02eb);
      var s34 := Swap2(s33);
      var s35 := Dup6(s34);
      var s36 := Swap1(s35);
      var s37 := Push2(s36, 0x034d);
      var s38 := Swap1(s37);
      var s39 := Dup7(s38);
      var s40 := Push2(s39, 0x07fe);
      var s41 := Jump(s40);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s172(s41, gas - 1)
  }
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s172(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x34d

    requires s0.stack[5] == 0x2eb
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s36 := Jump(s35);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s208(s36, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s19 := Add(s18);
      var s20 := Push2(s19, 0x09ef);
      var s21 := Push1(s20, 0x28);
      assert s21.Peek(5) == 0x34d;
      assert s21.Peek(8) == 0x352;
      assert s21.Peek(13) == 0x125;
      var s22 := Swap2(s21);
      ...
      var s30 := And(s29);
      var s31 := Push0(s30);
      assert s31.Peek(4) == 0x34d;
      assert s31.Peek(7) == 0x352;
      assert s31.Peek(12) == 0x125;
      var s32 := Swap1(s31);
      var s33 := Dup2(s32);
      var s34 := MStore(s33);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s41 := Dup5(s40);
      //  Go to the next instruction at pc + 1
      ExecuteFromCFGNode_s233(s41, gas - 1)
  }
