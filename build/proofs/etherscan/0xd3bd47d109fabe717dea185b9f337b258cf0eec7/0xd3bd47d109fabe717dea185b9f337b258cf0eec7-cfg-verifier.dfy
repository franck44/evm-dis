...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s31.Peek(8) == 0x10e;
      var s32 := Push2(s31, 0x0254);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0475);
      assert s1.Peek(0) == 0x475;
      assert s1.Peek(4) == 0x6d8;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s46(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[2] == 0x254

    requires s0.stack[7] == 0x6d8
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x254;
      assert s1.Peek(7) == 0x6d8;
      ...
      var s11 := Dup6(s10);
      assert s11.Peek(8) == 0x254;
      assert s11.Peek(13) == 0x6d8;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s47(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[6] == 0x254

    requires s0.stack[11] == 0x6d8
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(6) == 0x254;
      assert s1.Peek(11) == 0x6d8;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Dup6(s0);
      assert s1.Peek(7) == 0x254;
      assert s1.Peek(12) == 0x6d8;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s11.Peek(7) == 0x254;
      assert s11.Peek(12) == 0x6d8;
      ...
      var s20 := Swap3(s19);
      var s21 := Pop(s20);
      assert s21.Peek(5) == 0x254;
      assert s21.Peek(10) == 0x6d8;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s31.Peek(8) == 0x10e;
      var s32 := SLoad(s31);
      var s33 := Push2(s32, 0x0706);
      var s34 := Swap1(s33);
      var s35 := Dup3(s34);
      var s36 := Push2(s35, 0x04a0);
      var s37 := Jump(s36);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s4 := Dup1(s3);
      var s5 := SLoad(s4);
      var s6 := Push2(s5, 0x035c);
      var s7 := Swap1(s6);
      var s8 := Push2(s7, 0x0950);
      var s9 := Jump(s8);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s29 := Dup1(s28);
      var s30 := SLoad(s29);
      var s31 := Push2(s30, 0x0388);
      assert s31.Peek(0) == 0x388;
      assert s31.Peek(8) == 0xe5;
      var s32 := Swap1(s31);
      var s33 := Push2(s32, 0x0950);
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Push1(s29, 0x84);
      var s31 := Add(s30);
      assert s31.Peek(4) == 0x3ff;
      assert s31.Peek(9) == 0x10e;
      var s32 := Push2(s31, 0x0254);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s21.Peek(5) == 0x254;
      assert s21.Peek(10) == 0x6d8;
      assert s21.Peek(14) == 0x3ff;
      assert s21.Peek(19) == 0x10e;
      var s22 := Pop(s21);
      var s23 := Pop(s22);
      var s24 := Swap3(s23);
      var s25 := Swap2(s24);
      ...
      var s28 := Jump(s27);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s134(s28, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s37 := Jump(s36);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s137(s37, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Dup3(s19);
      var s21 := Swap1(s20);
      assert s21.Peek(10) == 0x3ff;
      assert s21.Peek(15) == 0x10e;
      var s22 := Keccak256(s21);
      var s23 := Swap5(s22);
      var s24 := Swap1(s23);
      var s25 := Swap5(s24);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s19 := Add(s18);
      var s20 := Push2(s19, 0x09ce);
      var s21 := Push1(s20, 0x28);
      assert s21.Peek(5) == 0x44b;
      assert s21.Peek(8) == 0x450;
      assert s21.Peek(13) == 0x10e;
      var s22 := Swap2(s21);
      ...
      var s30 := And(s29);
      var s31 := Push0(s30);
      assert s31.Peek(4) == 0x44b;
      assert s31.Peek(7) == 0x450;
      assert s31.Peek(12) == 0x10e;
      var s32 := Swap1(s31);
      var s33 := Dup2(s32);
      var s34 := MStore(s33);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Dup6(s10);
      assert s11.Peek(8) == 0x254;
      assert s11.Peek(13) == 0x44b;
      assert s11.Peek(16) == 0x450;
      assert s11.Peek(21) == 0x10e;
      var s12 := Add(s11);
      var s13 := MStore(s12);
      var s14 := Push0(s13);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s21 := Pop(s20);
      assert s21.Peek(5) == 0x254;
      assert s21.Peek(10) == 0x44b;
      assert s21.Peek(13) == 0x450;
      assert s21.Peek(18) == 0x10e;
      var s22 := Pop(s21);
      var s23 := Pop(s22);
      var s24 := Swap3(s23);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Push1(s29, 0x84);
      var s31 := Add(s30);
      assert s31.Peek(4) == 0x450;
      assert s31.Peek(9) == 0x10e;
      var s32 := Push2(s31, 0x0254);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s157(s33, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x07d2);
      assert s1.Peek(0) == 0x7d2;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s22 := IsZero(s21);
      var s23 := Push2(s22, 0x07f7);
      var s24 := JumpI(s23);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s23.stack[1] > 0 then
        ExecuteFromCFGNode_s199(s24, gas - 1)
      else
        ExecuteFromCFGNode_s197(s24, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x07f7);
      assert s1.Peek(0) == 0x7f7;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push1(s9, 0x24);
      var s11 := Push0(s10);
      assert s11.Peek(2) == 0x7f7;
      assert s11.Peek(13) == 0xd6;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x082a);
      assert s1.Peek(0) == 0x82a;
      assert s1.Peek(10) == 0xd6;
      assert s1.Peek(11) == 0xdb;
      var s2 := Dup6(s1);
      var s3 := Push2(s2, 0x076a);
      var s4 := Jump(s3);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x027b);
      assert s1.Peek(0) == 0x27b;
      assert s1.Peek(6) == 0xdb;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s16 := Pop(s15);
      var s17 := Swap1(s16);
      var s18 := Push2(s17, 0x02cd);
      var s19 := Swap1(s18);
      var s20 := Dup3(s19);
      var s21 := Swap1(s20);
      assert s21.Peek(2) == 0x2cd;
      assert s21.Peek(7) == 0xdb;
      var s22 := Dup2(s21);
      var s23 := Swap1(s22);
      var s24 := Push2(s23, 0x0475);
      var s25 := Jump(s24);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s28 := Jump(s27);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s226(s28, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s27 := SLoad(s26);
      var s28 := Push2(s27, 0x0316);
      var s29 := Swap1(s28);
      var s30 := Dup3(s29);
      var s31 := Push2(s30, 0x04a0);
      assert s31.Peek(0) == 0x4a0;
      assert s31.Peek(3) == 0x316;
      assert s31.Peek(8) == 0xdb;
      var s32 := Jump(s31);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s229(s32, gas - 1)
  }
