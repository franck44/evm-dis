...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push0(s1);
      var s3 := Caller(s2);
      var s4 := Push20(s3, 0xb541968495d6f59dd480cb3c4c0c5505e5770b72);
      var s5 := Sub(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(3) == 0x32d;
      assert s1.Peek(8) == 0x13b;
      var s2 := Push20(s1, 0xb541968495d6f59dd480cb3c4c0c5505e5770b72);
      var s3 := Push1(s2, 0x01);
      var s4 := Push1(s3, 0x01);
      var s5 := Push1(s4, 0xa0);
      var s6 := Shl(s5);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(3) == 0x32d;
      assert s1.Peek(8) == 0x13b;
      var s2 := Push20(s1, 0x7dcadf7e652ee3ffe2b5a2833f735dc58b7e9ce3);
      var s3 := Push1(s2, 0x01);
      var s4 := Push1(s3, 0x01);
      var s5 := Push1(s4, 0xa0);
      var s6 := Shl(s5);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(3) == 0x32d;
      assert s1.Peek(8) == 0x13b;
      var s2 := Push20(s1, 0x17df6de7960ac906a967d9919ddd6b93b521c731);
      var s3 := Push1(s2, 0x01);
      var s4 := Push1(s3, 0x01);
      var s5 := Push1(s4, 0xa0);
      var s6 := Shl(s5);
