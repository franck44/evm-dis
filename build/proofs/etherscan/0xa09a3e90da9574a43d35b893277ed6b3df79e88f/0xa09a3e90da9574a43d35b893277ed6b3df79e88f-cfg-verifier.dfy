...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push2(s1, 0x0c21);
      var s3 := Dup3(s2);
      var s4 := Push2(s3, 0x0b18);
      var s5 := Jump(s4);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0xc21;
      assert s11.Peek(8) == 0x28b;
      assert s11.Peek(9) == 0x183;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x0b2e);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := And(s29);
      var s31 := Swap3(s30);
      assert s31.Peek(5) == 0x5cf;
      assert s31.Peek(7) == 0x183;
      var s32 := Dup4(s31);
      var s33 := Swap2(s32);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Push0(s1);
      var s3 := Caller(s2);
      var s4 := Push20(s3, 0x46fe3f92b3540f36e76402a0013ce5831987e6b7);
      var s5 := Sub(s4);
      var s6 := Push2(s5, 0x054c);
      var s7 := JumpI(s6);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s6.stack[1] > 0 then
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Add(s9);
      var s11 := Push2(s10, 0x011f);
      assert s11.Peek(0) == 0x11f;
      var s12 := Jump(s11);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0xc42;
      assert s11.Peek(9) == 0x240;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := SLt(s8);
      var s10 := IsZero(s9);
      var s11 := Push2(s10, 0x0b6d);
      assert s11.Peek(0) == 0xb6d;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s29 := MLoad(s28);
      var s30 := Push2(s29, 0x0507);
      var s31 := Swap2(s30);
      assert s31.Peek(2) == 0x507;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := And(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(4) == 0xb4d;
      assert s11.Peek(9) == 0x21a;
      assert s11.Peek(10) == 0x13b;
      var s12 := Eq(s11);
      var s13 := Push2(s12, 0x0b2e);
      var s14 := JumpI(s13);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Pop(s9);
      var s11 := Pop(s10);
      assert s11.Peek(1) == 0x21a;
      assert s11.Peek(4) == 0x13b;
      var s12 := Pop(s11);
      var s13 := Jump(s12);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Dup3(s9);
      var s11 := Add(s10);
      assert s11.Peek(6) == 0x32d;
      assert s11.Peek(11) == 0x13b;
      var s12 := MStore(s11);
      ...
      var s20 := Dup3(s19);
      var s21 := Add(s20);
      assert s21.Peek(6) == 0x32d;
      assert s21.Peek(11) == 0x13b;
      var s22 := MStore(s21);
      ...
      assert s31.Peek(9) == 0x13b;
      var s32 := Push2(s31, 0x05bd);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s87(s33, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(3) == 0x32d;
      assert s1.Peek(8) == 0x13b;
      var s2 := Push20(s1, 0x46fe3f92b3540f36e76402a0013ce5831987e6b7);
      var s3 := Push1(s2, 0x01);
      var s4 := Push1(s3, 0x01);
      var s5 := Push1(s4, 0xa0);
      var s6 := Shl(s5);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(3) == 0x32d;
      assert s1.Peek(8) == 0x13b;
      var s2 := Push20(s1, 0xdf54bb03b937bb1fa1d2842695aafe686193e63d);
      var s3 := Push1(s2, 0x01);
      var s4 := Push1(s3, 0x01);
      var s5 := Push1(s4, 0xa0);
      var s6 := Shl(s5);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(3) == 0x32d;
      assert s1.Peek(8) == 0x13b;
      var s2 := Push20(s1, 0xbc099f69a3a1a2fcdcfc19942214f14882a221c7);
      var s3 := Push1(s2, 0x01);
      var s4 := Push1(s3, 0x01);
      var s5 := Push1(s4, 0xa0);
      var s6 := Shl(s5);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(4) == 0x943;
      assert s1.Peek(9) == 0x32d;
      assert s1.Peek(14) == 0x13b;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      if s24.stack[1] > 0 then
        ...
        ExecuteFromCFGNode_s110(s25, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Dup3(s19);
      var s21 := Add(s20);
      assert s21.Peek(7) == 0x32d;
      assert s21.Peek(12) == 0x13b;
      var s22 := MStore(s21);
      ...
      var s30 := Push1(s29, 0x84);
      var s31 := Add(s30);
      assert s31.Peek(5) == 0x32d;
      assert s31.Peek(10) == 0x13b;
      var s32 := Push2(s31, 0x05bd);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s21 := Dup7(s20);
      assert s21.Peek(10) == 0x32d;
      assert s21.Peek(15) == 0x13b;
      var s22 := Dup7(s21);
      var s23 := Sub(s22);
      var s24 := Swap1(s23);
      var s25 := SStore(s24);
      ...
      var s30 := Dup3(s29);
      var s31 := MStore(s30);
      assert s31.Peek(8) == 0x32d;
      assert s31.Peek(13) == 0x13b;
      var s32 := Swap1(s31);
      var s33 := Dup4(s32);
      var s34 := Swap1(s33);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s7 := Push2(s6, 0x0cc5);
      var s8 := Dup4(s7);
      var s9 := CodeCopy(s8);
      var s10 := Dup2(s9);
      var s11 := MLoad(s10);
      assert s11.Peek(10) == 0x32d;
      assert s11.Peek(15) == 0x13b;
      var s12 := Swap2(s11);
      var s13 := MStore(s12);
      var s14 := Swap1(s13);
      var s15 := Push2(s14, 0x0a17);
      var s16 := Swap1(s15);
      var s17 := Dup7(s16);
      var s18 := Dup2(s17);
      var s19 := MStore(s18);
      ...
      assert s21.Peek(9) == 0x32d;
      assert s21.Peek(14) == 0x13b;
      var s22 := Swap1(s21);
      var s23 := Jump(s22);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s4 := Dup1(s3);
      var s5 := SLoad(s4);
      var s6 := Push2(s5, 0x029f);
      var s7 := Swap1(s6);
      var s8 := Push2(s7, 0x0c59);
      var s9 := Jump(s8);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s29 := Dup1(s28);
      var s30 := SLoad(s29);
      var s31 := Push2(s30, 0x02cb);
      assert s31.Peek(0) == 0x2cb;
      assert s31.Peek(8) == 0x112;
      var s32 := Swap1(s31);
      var s33 := Push2(s32, 0x0c59);
      var s34 := Jump(s33);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s27 := Jump(s26);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s153(s27, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s2 := Jump(s1);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s155(s2, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := And(s29);
      var s31 := Swap3(s30);
      assert s31.Peek(5) == 0x4b7;
      assert s31.Peek(6) == 0x183;
      var s32 := Dup4(s31);
      var s33 := Swap2(s32);
      var s34 := Push32(s33, 0x8be0079c531659141344cd1fd0a4f28419497f9722a3daafe3b4186f6b6457e0);
      var s35 := Swap2(s34);
      ...
      var s40 := Jump(s39);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s157(s40, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push2(s0, 0x0456);
      assert s1.Peek(0) == 0x456;
      assert s1.Peek(8) == 0x183;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := Add(s8);
      var s10 := Swap1(s9);
      var s11 := Push2(s10, 0x046b);
      assert s11.Peek(0) == 0x46b;
      assert s11.Peek(7) == 0x183;
      var s12 := Swap2(s11);
      var s13 := Swap1(s12);
      var s14 := Push2(s13, 0x0c08);
      var s15 := Jump(s14);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s26 := Push2(s25, 0x0cc5);
      var s27 := Dup4(s26);
      var s28 := CodeCopy(s27);
      var s29 := Dup2(s28);
      var s30 := MLoad(s29);
      var s31 := Swap2(s30);
      assert s31.Peek(10) == 0x183;
      var s32 := MStore(s31);
      var s33 := Swap1(s32);
      var s34 := Push1(s33, 0x20);
      var s35 := Add(s34);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := Add(s8);
      var s10 := Swap1(s9);
      var s11 := Push2(s10, 0x03ff);
      assert s11.Peek(0) == 0x3ff;
      assert s11.Peek(7) == 0x183;
      var s12 := Swap2(s11);
      var s13 := Swap1(s12);
      var s14 := Push2(s13, 0x0c08);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s9 := Add(s8);
      var s10 := Swap1(s9);
      var s11 := Push2(s10, 0x038d);
      assert s11.Peek(0) == 0x38d;
      assert s11.Peek(7) == 0x183;
      var s12 := Swap2(s11);
      var s13 := Swap1(s12);
      var s14 := Push2(s13, 0x0c08);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s35 := Dup2(s34);
      var s36 := Eq(s35);
      var s37 := Push2(s36, 0x03c8);
      var s38 := JumpI(s37);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s37.stack[1] > 0 then
        ExecuteFromCFGNode_s291(s38, gas - 1)
      else
        ExecuteFromCFGNode_s279(s38, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s21.Peek(13) == 0x13b;
      var s22 := MStore(s21);
      var s23 := Push1(s22, 0x64);
      var s24 := Add(s23);
      var s25 := Push2(s24, 0x05bd);
      var s26 := Jump(s25);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s281(s26, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Push1(s0, 0x40);
      assert s1.Peek(4) == 0x3c8;
      assert s1.Peek(9) == 0x346;
      assert s1.Peek(15) == 0x13b;
      var s2 := MLoad(s1);
      var s3 := Push3(s2, 0x461bcd);
      var s4 := Push1(s3, 0xe5);
      var s5 := Shl(s4);
      ...
      var s20 := Dup3(s19);
      var s21 := Add(s20);
      assert s21.Peek(6) == 0x3c8;
      assert s21.Peek(11) == 0x346;
      assert s21.Peek(17) == 0x13b;
      var s22 := MStore(s21);
      ...
      var s30 := Push1(s29, 0x84);
      var s31 := Add(s30);
      assert s31.Peek(4) == 0x3c8;
      assert s31.Peek(9) == 0x346;
      assert s31.Peek(15) == 0x13b;
      var s32 := Push2(s31, 0x05bd);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s285(s33, gas - 1)
  }
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s285(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[4] == 0x3c8

    requires s0.stack[9] == 0x346

    requires s0.stack[15] == 0x13b
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push0(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(7) == 0x3c8;
      assert s11.Peek(12) == 0x346;
      assert s11.Peek(18) == 0x13b;
      var s12 := Dup2(s11);
      var s13 := MStore(s12);
      var s14 := Push1(s13, 0x02);
      var s15 := Push1(s14, 0x20);
      ...
      var s20 := Dup1(s19);
      var s21 := Dup4(s20);
      assert s21.Peek(10) == 0x3c8;
      assert s21.Peek(15) == 0x346;
      assert s21.Peek(21) == 0x13b;
      var s22 := Keccak256(s21);
      var s23 := Swap5(s22);
      var s24 := Dup8(s23);
      var s25 := And(s24);
      ...
      var s30 := Dup3(s29);
      var s31 := MStore(s30);
      assert s31.Peek(8) == 0x3c8;
      assert s31.Peek(13) == 0x346;
      assert s31.Peek(19) == 0x13b;
      var s32 := Swap2(s31);
      var s33 := Dup3(s32);
      var s34 := Swap1(s33);
      var s35 := Keccak256(s34);
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s289(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[8] == 0x3c8

    requires s0.stack[13] == 0x346

    requires s0.stack[19] == 0x13b
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s290(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[7] == 0x3c8

    requires s0.stack[12] == 0x346

    requires s0.stack[18] == 0x13b
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(7) == 0x3c8;
      assert s1.Peek(12) == 0x346;
      assert s1.Peek(18) == 0x13b;
      var s2 := Push1(s1, 0x40);
      var s3 := MLoad(s2);
      var s4 := Dup1(s3);
      var s5 := Swap2(s4);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s295(s33, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s18.stack[1] > 0 then
        ExecuteFromCFGNode_s300(s19, gas - 1)
      else
        ExecuteFromCFGNode_s299(s19, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s24.stack[1] > 0 then
        ExecuteFromCFGNode_s320(s25, gas - 1)
      else
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Push1(s29, 0x84);
      var s31 := Add(s30);
      assert s31.Peek(5) == 0x351;
      assert s31.Peek(11) == 0x13b;
      var s32 := Push2(s31, 0x05bd);
      var s33 := Jump(s32);
      //  JUMP to the target at Peek(0)
      ExecuteFromCFGNode_s319(s33, gas - 1)
  }
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Push0(s9);
      var s11 := Dup2(s10);
      assert s11.Peek(8) == 0x351;
      assert s11.Peek(14) == 0x13b;
      var s12 := Dup2(s11);
      var s13 := MStore(s12);
      var s14 := Push1(s13, 0x01);
      var s15 := Push1(s14, 0x20);
      ...
      var s20 := Keccak256(s19);
      var s21 := Dup7(s20);
      assert s21.Peek(10) == 0x351;
      assert s21.Peek(16) == 0x13b;
      var s22 := Dup7(s21);
      var s23 := Sub(s22);
      var s24 := Swap1(s23);
      var s25 := SStore(s24);
      ...
      var s30 := Dup3(s29);
      var s31 := MStore(s30);
      assert s31.Peek(8) == 0x351;
      assert s31.Peek(14) == 0x13b;
      var s32 := Swap1(s31);
      var s33 := Dup4(s32);
      var s34 := Swap1(s33);
      var s35 := Keccak256(s34);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Dup2(s9);
      var s11 := MLoad(s10);
      assert s11.Peek(10) == 0x351;
      assert s11.Peek(16) == 0x13b;
      var s12 := Swap2(s11);
      var s13 := MStore(s12);
      var s14 := Swap1(s13);
      var s15 := Push2(s14, 0x0a17);
