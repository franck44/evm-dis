...
module  {:disableNonlinearArithmetic} EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(11) == 0x1d1;
      assert s1.Peek(12) == 0xc9;
      var s2 := Push2(s1, 0x10c2);
      var s3 := Dup12(s2);
      var s4 := Dup4(s3);
      var s5 := Dup13(s4);
      var s6 := Add(s5);
      var s7 := Push2(s6, 0x1025);
      var s8 := Jump(s7);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s10 := Dup6(s9);
      var s11 := Add(s10);
      assert s11.Peek(7) == 0x10c2;
      assert s11.Peek(19) == 0x1d1;
      assert s11.Peek(20) == 0xc9;
      var s12 := Add(s11);
      var s13 := Gt(s12);
      var s14 := IsZero(s13);
      var s15 := Push2(s14, 0x1067);
      var s16 := JumpI(s15);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s15.stack[1] > 0 then
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      assert s1.Peek(12) == 0xc9;
      var s2 := Pop(s1);
      var s3 := Push2(s2, 0x10e8);
      var s4 := Dup11(s3);
      var s5 := Dup3(s4);
      var s6 := Dup12(s5);
      var s7 := Add(s6);
      var s8 := Push2(s7, 0x1025);
      var s9 := Jump(s8);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Swap3(s19);
      var s21 := Swap2(s20);
      assert s21.Peek(8) == 0xcbe;
      assert s21.Peek(17) == 0xc9;
      var s22 := Swap1(s21);
      var s23 := Push2(s22, 0x11fa);
      var s24 := Jump(s23);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s18 := Push2(s17, 0x1230);
      var s19 := Push1(s18, 0xa0);
      var s20 := Dup4(s19);
      var s21 := Add(s20);
      assert s21.Peek(1) == 0x1230;
      assert s21.Peek(11) == 0xcbe;
      assert s21.Peek(20) == 0xc9;
      var s22 := Dup8(s21);
      var s23 := Dup10(s22);
      var s24 := Push2(s23, 0x11b1);
      var s25 := Jump(s24);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s99(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0x1230

    requires s0.stack[13] == 0xcbe
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0x1230;
      assert s1.Peek(13) == 0xcbe;
      ...
      var s11 := Pop(s10);
      assert s11.Peek(2) == 0x1230;
      assert s11.Peek(12) == 0xcbe;
      ...
      assert s21.Peek(5) == 0x1230;
      assert s21.Peek(15) == 0xcbe;
      ...
      var s30 := Pop(s29);
      var s31 := Swap3(s30);
      assert s31.Peek(0) == 0x1230;
      assert s31.Peek(13) == 0xcbe;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s7 := Add(s6);
      var s8 := MStore(s7);
      var s9 := Push2(s8, 0x1243);
      var s10 := Dup2(s9);
      var s11 := Dup7(s10);
      assert s11.Peek(2) == 0x1243;
      assert s11.Peek(13) == 0xcbe;
      assert s11.Peek(22) == 0xc9;
      var s12 := Dup9(s11);
      var s13 := Push2(s12, 0x11b1);
      var s14 := Jump(s13);
      //  JUMP to the target at Peek(0)
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s101(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0x1243

    requires s0.stack[14] == 0xcbe
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0x1243;
      assert s1.Peek(14) == 0xcbe;
      ...
      var s20 := Push1(s19, 0x20);
      var s21 := Push32(s20, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0);
      assert s21.Peek(5) == 0x1243;
      assert s21.Peek(16) == 0xcbe;
      ...
      var s30 := Pop(s29);
      var s31 := Swap3(s30);
      assert s31.Peek(0) == 0x1243;
      assert s31.Peek(14) == 0xcbe;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s28 := Swap1(s27);
      var s29 := Push2(s28, 0x0e01);
      var s30 := Swap1(s29);
      var s31 := Dup12(s30);
      assert s31.Peek(2) == 0xe01;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Swap1(s0);
      assert s1.Peek(7) == 0xe01;
      assert s1.Peek(19) == 0xc9;
      var s2 := Push2(s1, 0x1300);
      var s3 := Jump(s2);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s11 := Push2(s10, 0x131a);
      assert s11.Peek(0) == 0x131a;
      assert s11.Peek(9) == 0xe01;
      assert s11.Peek(21) == 0xc9;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s109(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0x131a

    requires s0.stack[12] == 0xe01
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0x131a;
      assert s1.Peek(12) == 0xe01;
      ...
      var s10 := CallDataCopy(s9);
      var s11 := Pop(s10);
      assert s11.Peek(2) == 0x131a;
      assert s11.Peek(11) == 0xe01;
      ...
      var s20 := Push1(s19, 0x20);
      var s21 := Push32(s20, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0);
      assert s21.Peek(5) == 0x131a;
      assert s21.Peek(14) == 0xe01;
      ...
      var s30 := Pop(s29);
      var s31 := Swap3(s30);
      assert s31.Peek(0) == 0x131a;
      assert s31.Peek(12) == 0xe01;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s7 := Add(s6);
      var s8 := MStore(s7);
      var s9 := Push2(s8, 0x132d);
      var s10 := Dup2(s9);
      var s11 := Dup7(s10);
      assert s11.Peek(2) == 0x132d;
      assert s11.Peek(12) == 0xe01;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s111(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0x132d

    requires s0.stack[13] == 0xe01
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0x132d;
      assert s1.Peek(13) == 0xe01;
      ...
      var s20 := Push1(s19, 0x20);
      var s21 := Push32(s20, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0);
      assert s21.Peek(5) == 0x132d;
      assert s21.Peek(15) == 0xe01;
      ...
      var s30 := Pop(s29);
      var s31 := Swap3(s30);
      assert s31.Peek(0) == 0x132d;
      assert s31.Peek(13) == 0xe01;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s30 := Swap1(s29);
      var s31 := Push2(s30, 0x0aef);
      assert s31.Peek(0) == 0xaef;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Swap1(s0);
      assert s1.Peek(6) == 0xaef;
      assert s1.Peek(19) == 0x188;
      var s2 := Dup13(s1);
      var s3 := Swap1(s2);
      var s4 := Push2(s3, 0x1300);
      var s5 := Jump(s4);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(2) == 0x627;
      assert s1.Peek(17) == 0xeb;
      var s2 := Push1(s1, 0x00);
      var s3 := Dup3(s2);
      var s4 := MLoad(s3);
      var s5 := Push2(s4, 0x12f6);
      var s6 := Dup2(s5);
      var s7 := Dup5(s6);
      var s8 := Push1(s7, 0x20);
      var s9 := Dup8(s8);
      var s10 := Add(s9);
      var s11 := Push2(s10, 0x1101);
      assert s11.Peek(0) == 0x1101;
      assert s11.Peek(4) == 0x12f6;
      assert s11.Peek(9) == 0x627;
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s260(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[3] == 0x12f6

    requires s0.stack[8] == 0x627
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(3) == 0x12f6;
      assert s1.Peek(8) == 0x627;
      assert s1.Peek(23) == 0xeb;
      var s2 := Push1(s1, 0x00);
      //  Go to the next instruction at pc + 1
  ...
  function {:opaque} {:verify true} ExecuteFromCFGNode_s261(s0: EState, gas: nat): (s': EState)
    ...
    requires s0.stack[4] == 0x12f6

    requires s0.stack[9] == 0x627
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := JumpDest(s0);
      assert s1.Peek(4) == 0x12f6;
      assert s1.Peek(9) == 0x627;
      assert s1.Peek(24) == 0xeb;
      var s2 := Dup4(s1);
      var s3 := Dup2(s2);
      var s4 := Lt(s3);
      var s5 := IsZero(s4);
      var s6 := Push2(s5, 0x111c);
      var s7 := JumpI(s6);
      // This is a JUMPI segment, determine next pc using second top-most element of stack
      if s6.stack[1] > 0 then
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := Dup2(s0);
      assert s1.Peek(5) == 0x12f6;
      assert s1.Peek(10) == 0x627;
      ...
      var s9 := Push1(s8, 0x20);
      var s10 := Add(s9);
      var s11 := Push2(s10, 0x1104);
      assert s11.Peek(0) == 0x1104;
      assert s11.Peek(5) == 0x12f6;
      assert s11.Peek(10) == 0x627;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s20 := Swap3(s19);
      var s21 := Swap2(s20);
      assert s21.Peek(7) == 0x732;
      assert s21.Peek(23) == 0xeb;
      var s22 := Swap1(s21);
      var s23 := Push2(s22, 0x1300);
      var s24 := Jump(s23);
      //  JUMP to the target at Peek(0)
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s19 := Dup8(s18);
      var s20 := Add(s19);
      var s21 := Push2(s20, 0x1101);
      assert s21.Peek(0) == 0x1101;
      assert s21.Peek(4) == 0x1144;
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s8 := Dup2(s7);
      var s9 := Keccak256(s8);
      var s10 := Push2(s9, 0x05ec);
      var s11 := Swap2(s10);
      assert s11.Peek(2) == 0x5ec;
      assert s11.Peek(13) == 0xeb;
      var s12 := Dup9(s11);
      var s13 := Swap1(s12);
      var s14 := Dup9(s13);
