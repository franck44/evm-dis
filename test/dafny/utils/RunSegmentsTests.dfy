...
module RuNSegTests {
  ...
  method {:test} {:verify true} Test4()
  {
    ...
    //  Good
    var s2 := y[0].Run(s0.(stack := [Random(), Random()]), 0, []);
    expect s2.EState?;
  ...
  method {:test} {:verify true} Test6()
  {
    ...
    expect s4'.EState?;
    var s5' := y[4].lastIns.NextState(s4', jd, 0);
    ...
    // y[3] starts at 0x1b, and is a JUMPI
    expect s4.pc == y[3].StartAddress();
    var s5 := y[3].Run(s4, 0, jd);
    expect s5.EState?;
    expect s5.pc == 0x24;

    expect s5.pc == y[4].StartAddress();
    var s6 := y[4].Run(s5, 0, jd);
  ...
  method {:test} Test7()
  {
    ...
    var x := DisassembleU8(
      [
        /* 00000000 */ JUMPDEST,
        /* 00000000 */ PUSH2, 0x1, 0x3f,
        /* 00000002 */ PUSH1, 0x02,
        /* 00000004 */ DUP4,
        /* 00000006 */ SUB,
        /* 00000008 */ PUSH2, 0x00, 0x00,
        /* 0000000a */ JUMP
      ]);
    ...
    var se := y[0].StackEffect();
    print "Stack effect of y[0]:", se, "\n";

    var s0 := DEFAULT_VALIDSTATE.(stack := [Random(), Random(), Value(0x77), Random()]);
    var s1 := y[0].Run(s0, 0, [0x0]);
    print s1.ToString(), "\n";
  }
