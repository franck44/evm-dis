...
module OpcodeDecoder {
  ...
  function Decode(op: u8): Opcode {
    ...
    case DUP1 => StackOp("DUP1", DUP1, minCapacity := 1, minOperands := 1 - 1)
    case DUP2 => StackOp("DUP2", DUP2, minCapacity := 1, minOperands := 2 - 1)
    case DUP3 => StackOp("DUP3", DUP3, minCapacity := 1, minOperands := 3 - 1)
    case DUP4 => StackOp("DUP4", DUP4, minCapacity := 1, minOperands := 4 - 1)
    case DUP5 => StackOp("DUP5", DUP5, minCapacity := 1, minOperands := 5 - 1)
    case DUP6 => StackOp("DUP6", DUP6, minCapacity := 1, minOperands := 6 - 1)
    case DUP7 => StackOp("DUP7", DUP7, minCapacity := 1, minOperands := 7 - 1)
    case DUP8 => StackOp("DUP8", DUP8, minCapacity := 1, minOperands := 8 - 1)
    case DUP9 => StackOp("DUP9", DUP9, minCapacity := 1, minOperands := 9 - 1)
    case DUP10 => StackOp("DUP10", DUP10, minCapacity := 1, minOperands := 10 - 1)
    case DUP11 => StackOp("DUP11", DUP11, minCapacity := 1, minOperands := 11 - 1)
    case DUP12 => StackOp("DUP12", DUP12, minCapacity := 1, minOperands := 12 - 1)
    case DUP13 => StackOp("DUP13", DUP13, minCapacity := 1, minOperands := 13 - 1)
    case DUP14 => StackOp("DUP14", DUP14, minCapacity := 1, minOperands := 14 - 1)
    case DUP15 => StackOp("DUP15", DUP15, minCapacity := 1, minOperands := 15 - 1)
    case DUP16 => StackOp("DUP16", DUP16, minCapacity := 1, minOperands := 16 - 1)
