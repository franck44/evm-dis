...
module EVMProofObject {
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s8 := PushN(s7, 1, 0x00);
      var s9 := PushN(s8, 20, 0x8dff5e27ea6b7ac08ebfdf9eb090f32ee9a30fcf);
      var s10 := Gas(s9);
      var s11 := Call(s10);
      var s12 := IsZero(s11);
      var s13 := PushN(s12, 2, 0x17ce);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s1 := PushN(s0, 20, 0x8dff5e27ea6b7ac08ebfdf9eb090f32ee9a30fcf);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s17 := PushN(s16, 20, 0x8dff5e27ea6b7ac08ebfdf9eb090f32ee9a30fcf);
      var s18 := Gas(s17);
      var s19 := Call(s18);
      var s20 := IsZero(s19);
    ...
    decreases gas
  {
    if gas == 0 then s0
      ...
      var s5 := PushN(s4, 2, 0x01c0);
      var s6 := MStore(s5);
      var s7 := PushN(s6, 20, 0x8dff5e27ea6b7ac08ebfdf9eb090f32ee9a30fcf);
